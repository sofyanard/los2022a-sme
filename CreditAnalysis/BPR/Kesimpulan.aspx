<%@ Page language="c#" Codebehind="Kesimpulan.aspx.cs" AutoEventWireup="True" Inherits="SME.CreditAnalysis.BPR.KESIMPULAN" %>
				...
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					...
					<TR>
						<TD class="td" vAlign="top" width="50%">
							<asp:TextBox id="TXT_CA_KESIMPULAN" runat="server" TextMode="MultiLine" Rows="25" Columns="125"></asp:TextBox>
						</TD>
					</TR>
					<TR>
