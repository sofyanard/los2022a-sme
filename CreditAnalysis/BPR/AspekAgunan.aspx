<%@ Page language="c#" Codebehind="AspekAgunan.aspx.cs" AutoEventWireup="True" Inherits="SME.CreditAnalysis.BPR.AspekAgunan" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>AspekAgunan</title>
				...
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					...
					<TR>
						<TD class="td" vAlign="top" width="50%">
							<asp:TextBox id="TXT_CA_AGUNAN" runat="server" TextMode="MultiLine" Rows="25" Columns="125"></asp:TextBox>
						</TD>
					</TR>
					<TR>
