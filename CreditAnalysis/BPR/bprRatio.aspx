<%@ Page language="c#" Codebehind="bprRatio.aspx.cs" AutoEventWireup="True" Inherits="SME.CreditAnalysis.BPR.bprRatio" %>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
							...
							<TBODY>
								...
								<tr>
									...
									<td class="tdSmallHeader" style="HEIGHT: 31px" align="center" width="15%" colSpan="2"><nobr><asp:textbox onkeypress="return numbersonly()" id="txt_DD_B1" tabIndex="1" runat="server" Width="22px"
												Columns="4" MaxLength="2" BackColor="White"></asp:textbox><asp:dropdownlist id="ddl_MM_B1" tabIndex="2" runat="server" BackColor="White"></asp:dropdownlist><asp:textbox onkeypress="return numbersonly()" id="txt_YY_B1" tabIndex="3" runat="server" Columns="4"
												MaxLength="4" BackColor="White"></asp:textbox></nobr></td>
									<td class="tdSmallHeader" style="HEIGHT: 31px" align="center" width="15%" colSpan="2"><nobr><asp:textbox onkeypress="return numbersonly()" id="txt_DD_B2" tabIndex="27" runat="server" Width="22px"
												Columns="4" MaxLength="2" BackColor="White" CssClass="mandatory"></asp:textbox><asp:dropdownlist id="ddl_MM_B2" tabIndex="28" runat="server" BackColor="White" CssClass="mandatory"></asp:dropdownlist><asp:textbox onkeypress="return numbersonly()" id="txt_YY_B2" tabIndex="29" runat="server" Columns="4"
												MaxLength="4" BackColor="White"></asp:textbox></nobr></td>
								...
								<tr>
									...
									<td class="tdSmallHeader" style="HEIGHT: 31px" align="center" width="15%" colSpan="2"><nobr><asp:textbox onkeypress="return numbersonly()" id="TXT_JUMLAH_BULAN1" tabIndex="1" runat="server"
												Width="100px" Columns="4" MaxLength="2" BackColor="White"></asp:textbox></nobr></td>
									<td class="tdSmallHeader" style="HEIGHT: 31px" align="center" width="15%" colSpan="2"><nobr><asp:textbox onkeypress="return numbersonly()" id="TXT_JUMLAH_BULAN2" tabIndex="1" runat="server"
												Width="100px" Columns="4" MaxLength="2" BackColor="White" CssClass="mandatory"></asp:textbox></nobr></td>
									<td class="tdSmallHeader" style="HEIGHT: 31px" align="center" width="15%" colSpan="2"></td>
								</tr>
								...
								<tr>
									...
									<td align="center" width="20%" colSpan="2"><asp:textbox onkeypress="return numbersonly()" id="TXT_TOTAL_ASSETS1" style="PADDING-RIGHT: 5px; TEXT-ALIGN: right"
											runat="server" Width="100%" MaxLength="12" BackColor="Transparent"  Font-Bold="True"></asp:textbox></td>
									...
									<td align="center" width="20%" colSpan="2"><asp:textbox onkeypress="return numbersonly()" id="TXT_TOTAL_ASSETS3" style="PADDING-RIGHT: 5px; TEXT-ALIGN: right"
											runat="server" Width="100%" MaxLength="12" BackColor="Gainsboro"  Font-Bold="True" ReadOnly="True"></asp:textbox></td>
								</tr>
								<tr>
									<td style="PADDING-LEFT: 10px; WIDTH: 401px" align="left" width="401">&nbsp;2. 
										Aktiva Tertimbang Menurut Risiko (ATMR)</td>
				...
				<tr id="HIDE6" runat="server">
					<td style="PADDING-LEFT: 10px; WIDTH: 401px" align="left" width="401">&nbsp;4. Fee 
				...
				<tr id="HIDE5" runat="server">
					...
					<td align="center" width="20%" colSpan="2"><asp:textbox onkeypress="return numbersonly()" id="TXT_NET_INTEREST_INCOME_QUICK_RISK_ASSETS1"
							style="PADDING-RIGHT: 5px; TEXT-ALIGN: right" runat="server" Width="100%" MaxLength="12" BackColor="Transparent" 
					...
					<td align="center" width="20%" colSpan="2"><asp:textbox onkeypress="return numbersonly()" id="TXT_NET_INTEREST_INCOME_QUICK_RISK_ASSETS3"
							style="PADDING-RIGHT: 5px; TEXT-ALIGN: right" runat="server" Width="100%" MaxLength="12" BackColor="Gainsboro" 
				...
				<tr>
					<td style="PADDING-LEFT: 10px; WIDTH: 401px" align="left" width="401">
						&nbsp;5. Kualitas Aktiva Produktif</td></TD>
					<td align="center" width="20%" colSpan="2"><asp:textbox onkeypress="return numbersonly()" id="TXT_KAP1" style="PADDING-RIGHT: 5px; TEXT-ALIGN: right"
							runat="server" Width="100%" MaxLength="12" BackColor="Transparent"  Font-Bold="True"></asp:textbox></td>
					<td align="center" width="20%" colSpan="2"><asp:textbox onkeypress="return numbersonly()" id="TXT_KAP2" style="PADDING-RIGHT: 5px; TEXT-ALIGN: right"
							runat="server" Width="100%" MaxLength="12" BackColor="Transparent"  Font-Bold="True"></asp:textbox></td>
					<td align="center" width="20%" colSpan="2"><asp:textbox onkeypress="return numbersonly()" id="TXT_KAP3" style="PADDING-RIGHT: 5px; TEXT-ALIGN: right"
							runat="server" Width="100%" MaxLength="12" BackColor="Gainsboro"  Font-Bold="True" ReadOnly="True"></asp:textbox></td>
				</tr>
				<tr>
					<td style="PADDING-LEFT: 10px; WIDTH: 401px" align="left" width="401">
						&nbsp;6. Ratio PPAP</td></TD>
					<td align="center" width="20%" colSpan="2"><asp:textbox onkeypress="return numbersonly()" id="TXT_RATIO_PPAP1" style="PADDING-RIGHT: 5px; TEXT-ALIGN: right"
							runat="server" Width="100%" MaxLength="12" BackColor="Transparent"  Font-Bold="True"></asp:textbox></td>
					<td align="center" width="20%" colSpan="2"><asp:textbox onkeypress="return numbersonly()" id="TXT_RATIO_PPAP2" style="PADDING-RIGHT: 5px; TEXT-ALIGN: right"
							runat="server" Width="100%" MaxLength="12" BackColor="Transparent"  Font-Bold="True"></asp:textbox></td>
					<td align="center" width="20%" colSpan="2"><asp:textbox onkeypress="return numbersonly()" id="TXT_RATIO_PPAP3" style="PADDING-RIGHT: 5px; TEXT-ALIGN: right"
							runat="server" Width="100%" MaxLength="12" BackColor="Gainsboro"  Font-Bold="True" ReadOnly="True"></asp:textbox></td>
				</tr>
				<tr class="TDBGColor">
