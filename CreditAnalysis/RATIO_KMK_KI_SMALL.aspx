<%@ Page language="c#" Codebehind="RATIO_KMK_KI_SMALL.aspx.cs" AutoEventWireup="True" Inherits="TestSME.CreditAnalysis.RATIO_KMK_KI_SMALL" %>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
				<TBODY>
						...
						<td align="center" colSpan="2" class="td">
							<TABLE cellSpacing="0" cellPadding="0" width="100%">
								<TBODY>
									...
									<tr id="br3">
										<td style="PADDING-RIGHT: 15px" align="left" width="34%" class="tdBGColor1">
											Current Ratio</td>
										<td width="1%">&nbsp;</td>
									...
									<TR>
										<TD class="tdBGColor1" style="PADDING-RIGHT: 15px" align="left" width="34%">Cash 
											Bank to Hutang Bank Hutang Dagang Ratio</TD>
										<TD width="1%"></TD>
										<TD class="tdBGColorValue" align="center" width="21%" colSpan="2">
											<asp:textbox id="TXT_B20" style="PADDING-RIGHT: 5px; TEXT-ALIGN: right" tabIndex="20" runat="server"
												Width="100%"></asp:textbox></TD>
										<TD width="1%"></TD>
										<TD class="tdBGColorValue" align="center" width="21%" colSpan="2">
											<asp:textbox id="TXT_C20" style="PADDING-RIGHT: 5px; TEXT-ALIGN: right" tabIndex="20" runat="server"
												Width="100%"></asp:textbox></TD>
										<TD width="1%"></TD>
										<TD class="tdBGColorValue" align="center" width="21%" colSpan="2">
											<asp:textbox id="TXT_D20" style="PADDING-RIGHT: 5px; TEXT-ALIGN: right" tabIndex="20" runat="server"
												Width="100%"></asp:textbox></TD>
									</TR>
									<TR>
										<TD class="tdBGColor1" style="PADDING-RIGHT: 15px" align="left" width="34%">Hutang 
											Bank Hutang Dagang to Laba Operasional Ratio</TD>
										<TD width="1%"></TD>
										<TD class="tdBGColorValue" align="center" width="21%" colSpan="2">
											<asp:textbox id="TXT_B21" style="PADDING-RIGHT: 5px; TEXT-ALIGN: right" tabIndex="20" runat="server"
												Width="100%"></asp:textbox></TD>
										<TD width="1%"></TD>
										<TD class="tdBGColorValue" align="center" width="21%" colSpan="2">
											<asp:textbox id="TXT_C21" style="PADDING-RIGHT: 5px; TEXT-ALIGN: right" tabIndex="20" runat="server"
												Width="100%"></asp:textbox></TD>
										<TD width="1%"></TD>
										<TD class="tdBGColorValue" align="center" width="21%" colSpan="2">
											<asp:textbox id="TXT_D21" style="PADDING-RIGHT: 5px; TEXT-ALIGN: right" tabIndex="20" runat="server"
												Width="100%"></asp:textbox></TD>
									</TR>
									<!--
									<TR>
					...
					-->
					<tr>
						<td width="56%" class="td">
							<table id="Table4" cellSpacing="0" cellPadding="0" width="100%">
								<tr>
									<td align="center" colspan="3" width="56%" class="tdHeader1"><B>Investasi</B></td>
								</tr>
								<tr>
									<td width="34%" class="tdBGColor1">NPV</td>
									<td width="1%">&nbsp;:</td>
									<td width="21%" class="tdBGColorValue">
										<asp:textbox id="TXT_NPV" style="PADDING-RIGHT: 5px; TEXT-ALIGN: right" tabIndex="16" runat="server"
											onblur="FormatCurrency(this)" onkeypress="return numbersonly()" Width="100%"></asp:textbox></td>
								</tr>
								<tr>
									<td width="34%" class="tdBGColor1">IRR</td>
									<td width="1%">&nbsp;:</td>
									<td width="21%" class="tdBGColorValue">
										<asp:textbox id="TXT_IRR" style="PADDING-RIGHT: 5px; TEXT-ALIGN: right" tabIndex="16" runat="server"
											onblur="FormatCurrency(this)" onkeypress="return numbersonly()" Width="100%"></asp:textbox></td>
								</tr>
								<tr>
									<td width="34%" class="tdBGColor1">PAYBACK</td>
									<td width="1%">&nbsp;:</td>
									<td width="21%" class="tdBGColorValue">
										<asp:textbox id="TXT_PAYBACK" style="PADDING-RIGHT: 5px; TEXT-ALIGN: right" tabIndex="16" runat="server"
											onblur="FormatCurrency(this)" onkeypress="return numbersonly()" Width="100%"></asp:textbox></td>
								</tr>
								<tr>
									<td colspan="3" class="tdNoBorder" width="56%"></td>
								</tr>
								<tr>
									<td colspan="3" width="56%" align="center">
										<asp:Button id="BTN_UPDATE" runat="server" Width="128px" Text="Update" CssClass="BUTTON1" onclick="BTN_UPDATE_Click"></asp:Button></td>
								</tr>
							</table>
						</td>
						<td width="44%"></td>
