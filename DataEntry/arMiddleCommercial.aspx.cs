...
namespace SME.DataEntry
{
	...
	/// </summary>
	public partial class arMiddleCommercial : System.Web.UI.Page
	{
		...
		private void ViewData()
		{
			...
			{
				conn.QueryString = "select * from VW_ASPEK_MIDDLE where AP_REGNO = '"+ Request.QueryString["curef"] + "C" + "'";
				conn.ExecuteQuery();
			}
		...
		protected void btn_Save_Click(object sender, System.EventArgs e)
		{
			...
			Response.Write("<script language='javascript'> " +
				"parent.document.Form1.action = 'arParent.aspx?de=" + DE + "&regno=" + REGNO + "&curef=" + CUREF + "&mc=" + MC + "&tc=" + TC + "&par=" + PAR + "';" +
