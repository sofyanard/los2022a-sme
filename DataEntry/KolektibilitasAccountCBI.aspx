<%@ Page language="c#" Codebehind="KolektibilitasAccountCBI.aspx.cs" AutoEventWireup="True" Inherits="Websysca.KolektibilitasAccountCBI" %>
		...
		<form id="Form1" method="post" runat="server">
			<center>
				<TABLE id="Table4" style="Z-INDEX: 101; LEFT: 0px; POSITION: absolute; TOP: 0px" width="100%"
					...
					<TR>
						<TD class="TDBGColor2" align="center" colSpan="2"><asp:button id="BTN_SAVE" runat="server" Width="70px" Text="Save" CssClass="Button1" onclick="BTN_SAVE_Click"></asp:button></TD>
					</TR>
				</TABLE>
			</center>
		</form>
