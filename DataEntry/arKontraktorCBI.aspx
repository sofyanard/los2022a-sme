<%@ Page language="c#" Codebehind="arKontraktorCBI.aspx.cs" AutoEventWireup="True" Inherits="SME.DataEntry.arKontraktorCBI" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<table width="100%" border="1">
				<tr>
					<td class="tdSmallHeader" width="100%" colSpan="2">Termijn</td>
				</tr>
				<tr>
				...
				<tr class="TblAlternating">
					<td style="HEIGHT: 24px" width="58%"><nobr>Jumlah Termijn</nobr></td>
			...
			<table width="100%" border="1">
				...
				<TR>
					<TD class="TDBGColor2" width="57%" colSpan="2"><asp:button id="btn_Save" runat="server" Text="Save" CssClass="Button1" onclick="btn_Save_Click"></asp:button>&nbsp;
						<asp:button id="btn_Delete" runat="server" CssClass="Button1" Text="Delete" onclick="btn_Delete_Click"></asp:button></TD>
				</TR>
			</table>
		</form>
	</body>
