<%@ Page language="c#" Codebehind="COLLATERAL_DEP.aspx.cs" AutoEventWireup="True" Inherits="SME.DataEntry.COLLATERAL_DEP" %>
							...
							<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%">
								...
								<TR>
									...
									<TD class="TDBGColorValue">
										<asp:dropdownlist id="DDL_CL_CURRENCY" runat="server" CssClass="mandatory"></asp:dropdownlist>
										<asp:TextBox ID="TXT_CL_FOREIGNVAL" Runat="server" MaxLength="21" CssClass="mandatory" onKeypress="return digitsonly()"
											onkeyup="HitungLimit()" onblur="FormatCurrency(this), FormatCurrency(document.Form1.TXT_CL_VALUE)"></asp:TextBox>
									</TD>
								</TR>
								<TR>
									...
									<TD class="TDBGColorValue"><asp:TextBox id="TXT_CL_EXCHANGERATE" runat="server" CssClass="angkamandatory" onKeypress="return digitsonly()"
											MaxLength="21" onkeyup="HitungLimit()" onblur="FormatCurrency(this), FormatCurrency(document.Form1.TXT_CL_VALUE)"></asp:TextBox></TD>
								</TR>
								<TR>
								...
								<TR>
									...
									<TD></TD>
									<TD class="TDBGColorValue"><asp:DropDownList id="DDL_CL_JNSAGUNAN" CssClass="mandatory" runat="server"></asp:DropDownList></TD>
								</TR>
								<TR>
									<TD class="TDBGColor1">Jenis Pengikatan</TD>
									<TD></TD>
									<TD class="TDBGColorValue"><asp:DropDownList id="DDL_CL_IKATTYPE" CssClass="mandatory" runat="server"></asp:DropDownList></TD>
								</TR>
								<TR>
								...
								<TR>
									<TD class="TDBGColor1">&nbsp;No. Rek. Deposito/Tabungan</TD>
									<TD></TD>
									<TD class="TDBGColorValue"><asp:TextBox id="TXT_CL_REKNUM" runat="server" Columns="25" MaxLength="30" CssClass="mandatory"
								...
								<TR>
									...
									<TD></TD>
									<TD class="TDBGColorValue"><asp:DropDownList id="DDL_CL_REKCURRENCY" CssClass="mandatory" runat="server"></asp:DropDownList></TD>
								</TR>
								...
								<TR runat="server" id="TR_NILAI_PASAR">
									...
									<TD></TD>
									<TD class="TDBGColorValue"><asp:TextBox id="TXT_CL_VALUE2" runat="server" Columns="25" MaxLength="21" CssClass="mandatory"
											onKeypress="return numbersonly()" onblur="FormatCurrency(this)"></asp:TextBox></TD>
								</TR>
								...
								<TR>
									...
									<TD></TD>
									<TD class="TDBGColorValue"><asp:TextBox id="TXT_CL_FDRRATE" runat="server" Columns="6" MaxLength="3" onKeypress="return digitsonly()"></asp:TextBox>%</TD>
								</TR>
								<TR>
									<TD class="TDBGColor1">Penerbit FDR</TD>
									<TD></TD>
									<TD class="TDBGColorValue"><asp:TextBox id="TXT_CL_FDRISSUEDBY" runat="server" Columns="20" MaxLength="20" onKeypress="return kutip_satu()"
								...
								<TR>
									...
									<TD></TD>
									<TD class="TDBGColorValue"><asp:TextBox id="TXT_CL_SPRDRATE" runat="server" Columns="6" MaxLength="3" onKeypress="return digitsonly()"></asp:TextBox>%</TD>
								</TR>
								<TR>
								...
								<TR>
									...
									<TD></TD>
									<TD class="TDBGColorValue"><asp:TextBox id="TXT_CL_OWNERNMFIRST" runat="server" Columns="30" MaxLength="30" CssClass="mandatory"
											onKeypress="return kutip_satu()" Width="250"></asp:TextBox></TD>
								</TR>
								<TR>
									<TD class="TDBGColor1">&nbsp;</TD>
									<TD></TD>
									<TD class="TDBGColorValue"><asp:TextBox id="TXT_CL_OWNERNMMID" runat="server" Columns="30" MaxLength="30" onKeypress="return kutip_satu()"
											Width="250"></asp:TextBox></TD>
								</TR>
								<TR>
									<TD class="TDBGColor1">&nbsp;</TD>
									<TD></TD>
									<TD class="TDBGColorValue"><asp:TextBox id="TXT_CL_OWNERNMLAST" runat="server" Columns="30" MaxLength="30" onKeypress="return kutip_satu()"
											Width="250"></asp:TextBox></TD>
								</TR>
								<TR>
								...
								<TR>
									...
									<TD></TD>
									<TD class="TDBGColorValue">
										<asp:TextBox id="TXT_CL_INSTDUE" runat="server" Columns="25" MaxLength="100" onKeypress="return kutip_satu()"
