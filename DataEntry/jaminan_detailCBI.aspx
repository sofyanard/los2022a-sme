<%@ Page language="c#" Codebehind="jaminan_detailCBI.aspx.cs" AutoEventWireup="True" Inherits="SME.DataEntry.jaminan_detailCBI" %>
			...
			<CENTER>
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					...
					<TR>
						...
						<iframe id="scol" name="scol" scrolling="auto" src="Jaminan_ListCBI.aspx?regno=<%=Request.QueryString["regno"]%>&curef=<%=Request.QueryString["curef"]%>&tc=<%=Request.QueryString["tc"]%>&de=<%=Request.QueryString["de"]%>&new=1" width="100%" height="540" frameborder="0"></iframe>
