<%@ Page language="c#" Codebehind="NasabahGroupInfoCBI.aspx.cs" AutoEventWireup="True" Inherits="SME.DataEntry.NasabahGroupInfoCBI" %>
					...
					<TR id="TR_PERSONAL" runat="server">
						<TD class="td" vAlign="top" width="50%">
							<TABLE id="Table20" cellSpacing="0" cellPadding="0" width="100%">
								...
								<TR>
									<TD class="TDBGColor1" style="WIDTH: 117px; HEIGHT: 20px">Gelar Sesudah Nama</TD>
									<TD style="WIDTH: 5px; HEIGHT: 20px"></TD>
									<TD class="TDBGColorValue" style="HEIGHT: 20px">
