<%@ Page language="c#" Codebehind="Jaminan_List.aspx.cs" AutoEventWireup="True" Inherits="SME.DataEntry.Jaminan_List" %>
			...
			<table Width="100%" class="BackGroundList">
				...
				<tr>
					<td class="TDBGColor2" vAlign="top" align="center">
						<asp:Button CssClass="Button1" Text="Tambah" runat="server" ID="BTN_SAVE" 
                            Width="70px" onclick="BTN_SAVE_Click"></asp:Button>
						<asp:Button CssClass="Button1" Text="Hapus" runat="server" ID="BTN_DELETE" 
                            Width="70px" onclick="BTN_DELETE_Click"></asp:Button>
