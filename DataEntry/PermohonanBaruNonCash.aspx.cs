...
namespace SME.DataEntry
{
	...
	public partial class PermohonanBaruNonCash : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			this.DatGrd.ItemCommand += new DataGridCommandEventHandler(DatGrd_DeleteCommand);
		...
		private void SecureData() 
		{
			...
			if (de != "1") 
			{
				...
				TXT_CP_ISSUEDATE_DD.ReadOnly = true;
				DDL_CP_ISSUEDATE_MM.Enabled = false;
				TXT_CP_ISSUEDATE_YY.ReadOnly = true;

				TXT_CP_DUEDATE_DD.ReadOnly = true;
				DDL_CP_DUEDATE_MM.Enabled = false;
				TXT_CP_DUEDATE_YY.ReadOnly = true;

				TXT_CP_REQUEST.ReadOnly = true;
				TXT_CP_ISSUETO.ReadOnly = true;
				TXT_CP_BANKADDR1.ReadOnly = true;
				TXT_CP_BANKADDR2.ReadOnly = true;
				TXT_CP_BANKADDR3.ReadOnly = true;

				TXT_CP_ISSUEADDR1.ReadOnly = true;
				TXT_CP_ISSUEADDR2.ReadOnly = true;
				TXT_CP_ISSUEADDR3.ReadOnly = true;

				TXT_CP_COMMODITYAMNT.ReadOnly = true;
				TXT_CP_COMMODITYNAME.ReadOnly = true;
				TXT_CP_VALUE.ReadOnly = true;

				DDL_CP_BANKCORR.Enabled = false;
				DDL_CP_BANKCORRCITY.Enabled = false;
		...
		private void calc_Click(object sender, System.EventArgs e)
		{
			...
			*/
			...
			//float batas		= float.Parse(conn.GetFieldValue("persen"));	//--- Endi's Code
			float batas		= 0;
			try 
			{
				batas = float.Parse(conn.GetFieldValue("persen"));
			} 
			catch {}
