<%@ Page language="c#" Codebehind="COLLATERAL_INV.aspx.cs" AutoEventWireup="True" Inherits="SME.DataEntry.COLLATERAL_INV" %>
							...
							<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%">
								...
								<TR>
									...
									<TD class="TDBGColorValue"><asp:TextBox id="TXT_CL_NOOFUNITS" runat="server" MaxLength="10" Columns="10" CssClass="mandatory"
											onKeypress="return numbersonly()" onkeyup="HitungTotal()"></asp:TextBox></TD>
								</TR>
								<TR>
									<TD class="TDBGColor1">Berat / Jenis Berat</TD>
									<TD></TD>
									<TD class="TDBGColorValue"><asp:TextBox id="TXT_CL_WEIGHT" runat="server" MaxLength="10" Columns="10" onKeypress="return numbersonly()"></asp:TextBox>
										<asp:TextBox id="TXT_CL_WEIGHTTYPE" runat="server" MaxLength="10" Columns="10" onKeypress="return kutip_satu()"></asp:TextBox> (gram, kg, ...)
									</TD>
								</TR>
								...
								<TR>
									...
									<TD></TD>
									<TD class="TDBGColorValue"><asp:TextBox id="TXT_CL_PRICEPERUNIT" runat="server" MaxLength="21" Columns="25" 
											onKeypress="return digitsonly()" onblur = "FormatCurrency(this)"  onkeyup="HitungTotal()"></asp:TextBox></TD>
								</TR>
								<TR>
								...
								<TR>
									...
									<TD></TD>
									<TD class="TDBGColorValue"><asp:TextBox id="TXT_CL_TOTALAMOUNT" runat="server" MaxLength="21" Columns="25" 
											onKeypress="return digitsonly()" onblur = "FormatCurrency(this)"></asp:TextBox></TD>
								</TR>
							</TABLE>
						</TD>
