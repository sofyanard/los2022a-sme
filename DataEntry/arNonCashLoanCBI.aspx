<%@ Page language="c#" Codebehind="arNonCashLoanCBI.aspx.cs" AutoEventWireup="True" Inherits="SME.DataEntry.arNonCashLoanCBI" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<table width="100%" border="1">
				<TR>
					<TD class="TDBGColor2" align="center" width="7%" colSpan="5"><asp:button id="btn_Save" runat="server" Text="Save" CssClass="Button1" onclick="btn_Save_Click"></asp:button>&nbsp;<asp:button id="btn_Delete" runat="server" Text="Delete" CssClass="Button1" onclick="btn_Delete_Click"></asp:button></TD>
				</TR>
			</table>
		</form>
	</body>
