<%@ Page language="c#" Codebehind="COLLATERAL_RE.aspx.cs" AutoEventWireup="True" Inherits="SME.DataEntry.Jaminan_RealEstate" %>
						...
						<TD class="td" vAlign="top" width="50%">
							<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%">
								...
								<TR>
									...
									<TD></TD>
									<TD class="TDBGColorValue"><asp:dropdownlist id="DDL_CL_CERTTYPE1" runat="server" CssClass="mandatory"></asp:dropdownlist><asp:dropdownlist id="DDL_CL_CERTTYPE2" runat="server" CssClass="mandatory" Visible="False"></asp:dropdownlist></TD>
								</TR>
								<TR>
								...
								<TR>
									...
									<TD></TD>
									<TD class="TDBGColorValue">
										<asp:textbox id="TXT_CL_CERTNO" runat="server" MaxLength="50" Columns="25" Width="400" onKeypress="return kutip_satu()" CssClass="mandatory"></asp:textbox></TD>
								</TR>
								<TR>
								...
								<TR>
									...
									<TD class="TDBGColorValue"><asp:textbox id="TXT_CL_LANDAREA" runat="server" CssClass="mandatory" MaxLength="10" Columns="10"
											onkeypress="return numbersonly()"></asp:textbox>m2 (persegi)</TD>
								</TR>
								<TR>
								...
								<TR>
									...
									<TD></TD>
									<TD class="TDBGColorValue">
										<asp:textbox id="TXT_CL_OWNER"  CssClass="mandatory" runat="server" MaxLength="100" Columns="25" Width="400" onKeypress="return kutip_satu()"></asp:textbox></TD>
								</TR>
								<TR>
								...
								<TR>
									...
									<TD></TD>
									<TD class="TDBGColorValue">
										<asp:textbox id="TXT_CL_LOCJLN" runat="server" MaxLength="50" Columns="25" Width="400" onKeypress="return kutip_satu()" CssClass="mandatory"></asp:textbox></TD>
								</TR>
								<TR>
									<TD class="TDBGColor1">RT/RW</TD>
									<TD></TD>
									<TD class="TDBGColorValue">
										<asp:textbox id="TXT_CL_LOCRT" CssClass="mandatory" runat="server" MaxLength="3" Columns="3" onKeypress="return kutip_satu()"></asp:textbox>/
										<asp:textbox id="TXT_CL_LOCRW" CssClass="mandatory" runat="server" MaxLength="3" Columns="3" onKeypress="return kutip_satu()"></asp:textbox>
									</TD>
								</TR>
								<TR>
									...
									<TD></TD>
									<TD class="TDBGColorValue">
										<asp:textbox id="TXT_CL_LOCKAVNO" CssClass="mandatory" runat="server" Columns="20" MaxLength="20" Width="300" onKeypress="return kutip_satu()"></asp:textbox>
									</TD>
								</TR>
								<TR>
									...
									<TD class="TDBGColorValue" style="HEIGHT: 17px">
										<asp:dropdownlist id="DDL_CL_COLLOC" runat="server" CssClass="mandatory"></asp:dropdownlist>
									</TD>
								</TR>
								<TR>
