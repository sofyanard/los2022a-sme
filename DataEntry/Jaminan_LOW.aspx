<%@ Page language="c#" Codebehind="Jaminan_LOW.aspx.cs" AutoEventWireup="True" Inherits="SME.DataEntry.Jaminan_LOW" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>Jaminan_LOW</title>
			...
			<table Width="100%" class="BackGroundList">
				...
				<tr>
					<td class="TDBGColor2" vAlign="top" align="center">
						<asp:Button CssClass="Button1" Text="Insert" runat="server" ID="BTN_SAVE" Width="70px"></asp:Button>
						<asp:Button CssClass="Button1" Text="Delete" runat="server" ID="BTN_DELETE" Width="70px"></asp:Button>
