<%@ Page language="c#" Codebehind="arAspekTeknis.aspx.cs" AutoEventWireup="True" Inherits="SME.DataEntry.arAspekTeknis" %>
	...
	<body leftMargin="0" topMargin="0" MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<table width="100%" border="1">
				...
				<tr>
					<td style="HEIGHT: 94px" width="100%" colSpan="2">
						<table width="100%" border="1">
							...
							<tr>
								<td class="TDBGColor2" style="HEIGHT: 2px" align="center" width="10%" colSpan="4">
                                    <asp:button id="btn_AddIzin" runat="server" Text="Simpan Perizinan" 
                                        CssClass="Button1" onclick="btn_AddIzin_Click"></asp:button>&nbsp;
									<asp:button id="btn_IzinCancel" runat="server" Text="Batal" CssClass="Button1" 
                                        onclick="btn_IzinCancel_Click"></asp:button></td>
							</tr>
						</table>
					</td>
				</tr>
					...
					<td width="100%" colSpan="2">
						<table width="100%" border="1">
							...
							<tr class="TblAlternating">
								<td class="TDBGColor2" style="HEIGHT: 16px" width="9%" colSpan="4">
                                    <asp:button id="btn_AddInves" runat="server" Text="Simpan Investasi" 
                                        CssClass="Button1" onclick="btn_AddInves_Click"></asp:button>&nbsp;
									<asp:button id="btn_InvesCancel" runat="server" Text="Batal" CssClass="Button1" 
                                        onclick="btn_InvesCancel_Click"></asp:button></td>
							</tr>
							<TR>
				...
				<TR>
					<TD class="TDBGColor2" width="79%" colSpan="2"><asp:button id="btn_Save" 
                            runat="server" Text="Simpan" CssClass="Button1" onclick="btn_Save_Click"></asp:button>&nbsp;
						<asp:button id="btn_Delete" runat="server" Text="Hapus" CssClass="Button1" 
