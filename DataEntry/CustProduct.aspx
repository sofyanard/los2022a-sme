<%@ Page language="c#" Codebehind="CustProduct.aspx.cs" AutoEventWireup="True" Inherits="SME.DataEntry.CustProductBaru" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>Credit Structure</title>
							...
							<TR>
								<TD>
									<TABLE id="Table4" cellSpacing="1" cellPadding="1" width="100%" border="0">
										...
										<TR>
											<TD class="tdbgcolor1">Nilai Earmark (Rp)</TD>
											<TD>:</TD>
											<TD>
								...
								<TD>
									<TABLE id="Table6" cellSpacing="1" cellPadding="1" width="100%" border="0">
										...
										<TR>
											<TD class="tdbgcolor1">Remaining Core Limit</TD>
											<TD>:</TD>
											<TD>
