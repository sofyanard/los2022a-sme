<%@ Page language="c#" Codebehind="jaminan_detail.aspx.cs" AutoEventWireup="True" Inherits="SME.DataEntry.jaminan_detail" %>
			...
			<CENTER>
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					...
					<TR>
						...
						<iframe id="scol" name="scol" scrolling="auto" src="Jaminan_List.aspx?regno=<%=Request.QueryString["regno"]%>&curef=<%=Request.QueryString["curef"]%>&tc=<%=Request.QueryString["tc"]%>&de=<%=Request.QueryString["de"]%>&new=<%=Request.QueryString["new"]%>" width="100%" height="540" frameborder="0"></iframe>
					
						</TD>
						<TD>
							<iframe id="coldetail" name="coldetail" width="100%" height="700" frameborder="0" scrolling="no">
							</iframe>
						</TD>
					</TR>
				</TABLE>
