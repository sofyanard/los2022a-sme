<%@ Page language="c#" Codebehind="PledgingNewCBI.aspx.cs" AutoEventWireup="True" Inherits="SME.DataEntry.PledgingNewCBI" %>
		...
		<form id="Form1" method="post" runat="server">
			<center>
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					...
					<% } %>
					<TR>
						<TD class="tdHeader1" colSpan="2">Facilities dan Collaterals yang Belum di-Pledge</TD>
					</TR>
					<TR vAlign="top">
						<TD>
							<TABLE width="100%">
								<TR>
									<TD class="tdHeader1" colSpan="2">Facilities</TD>
								</TR>
								<TR>
									<TD><ASP:DATAGRID id="DG_CUSTFAC" runat="server" ShowFooter="True" AutoGenerateColumns="False" CellPadding="1"
											...
											<Columns>
												...
												<asp:TemplateColumn>
													...
													<FooterTemplate>
														<asp:LinkButton id="lnk_allfac" runat="server" CommandName="allfac">Select All</asp:LinkButton>
													</FooterTemplate>
												</asp:TemplateColumn>
						...
						<TD>
							<TABLE width="100%">
								<TR>
									<TD class="tdHeader1" colSpan="2">Collaterals</TD>
								</TR>
								<TR>
									<TD><ASP:DATAGRID id="DG_CUSTCOL" runat="server" ShowFooter="True" AutoGenerateColumns="False" CellPadding="1"
											...
											<Columns>
												...
												<asp:BoundColumn DataField="CL_VALUE" HeaderText="Col. Value">
													<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
													<ItemStyle HorizontalAlign="Right"></ItemStyle>
												</asp:BoundColumn>
												<asp:TemplateColumn>
													...
													<FooterStyle HorizontalAlign="Center"></FooterStyle>
													<FooterTemplate>
														<asp:LinkButton id="lnk_allcol" runat="server" CommandName="allcol">Select All</asp:LinkButton>
													</FooterTemplate>
												</asp:TemplateColumn>
											</Columns>
											<PagerStyle Mode="NumericPages"></PagerStyle>
							...
							<TABLE id="Table3" cellSpacing="1" cellPadding="1" width="100%" border="0">
								<TR>
									...
									<TD><asp:dropdownlist id="DDL_GROUP" runat="server" AutoPostBack="True"></asp:dropdownlist>&nbsp;
										<asp:button id="BTN_NEW" runat="server" Text="Add New Group" onclick="BTN_NEW_Click"></asp:button></TD>
								</TR>
								<TR>
									<TD class="tdbgcolor2" colSpan="3"><asp:button id="BTN_ADD" runat="server" Width="125px" Text="Add" CssClass="button1" onclick="BTN_ADD_Click"></asp:button></TD>
								</TR>
							</TABLE>
						</TD>
					</TR>
					...
					<TR width="100%">
						<TD colSpan="2"><ASP:DATAGRID id="DG_PLEDGINGMAIN" runat="server" AutoGenerateColumns="False" CellPadding="1"
								...
								<Columns>
									...
									<asp:TemplateColumn HeaderText="Facilities">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
									...
									<asp:TemplateColumn HeaderText="Collaterals">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
										<ItemStyle HorizontalAlign="Center" VerticalAlign="Top"></ItemStyle>
										<ItemTemplate>
											<asp:datagrid id="DG_PLEDGINGCOL" runat="server" AllowPaging="True" ShowFooter="True" Width="100%"
												...
												<Columns>
													...
													<asp:TemplateColumn>
														...
														<ItemStyle HorizontalAlign="Center"></ItemStyle>
														<ItemTemplate>
															<asp:LinkButton id="lb_delcol" runat="server" CommandName="delete">Delete</asp:LinkButton>
														</ItemTemplate>
													</asp:TemplateColumn>
												</Columns>
												<PagerStyle Mode="NumericPages"></PagerStyle>
					...
					<TR>
						<TD class="tdHeader1" colSpan="2">Pledging Details</TD>
					</TR>
					<TR width="100%">
