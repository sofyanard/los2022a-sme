<%@ Page language="c#" Codebehind="M21M22PerubahanJaminan.aspx.cs" AutoEventWireup="True" Inherits="SME.DataEntry.StrucCreditDetailM22" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>Struktur Kredit Perubahan Jaminan</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					...
					<TD vAlign="top" width="50%">
						<FIELDSET>
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									<TD class="TDBGColor1" width="170">Jangka Waktu</TD>
									<TD style="WIDTH: 15px"></TD>
				...
				<TR>
					<TD class="TDBGColor2" vAlign="top" width="50%" colSpan="2"><asp:button id="update" runat="server" Width="75px" CssClass="Button1" Text="Save" onclick="update_Click"></asp:button></TD>
				</TR>
				<tr>
				...
				<TR>
					<TD class="td" vAlign="top" align="center" width="50%">
						<TABLE id="Table4" cellSpacing="0" cellPadding="0" width="100%">
							<TR>
								<TD class="TDBGColor1" style="HEIGHT: 22px" width="129">Deskripsi Agunan</TD>
								<TD style="WIDTH: 15px; HEIGHT: 22px"></TD>
								<TD class="TDBGColorValue" style="HEIGHT: 22px"><asp:dropdownlist id="DDL_CL_ID" runat="server" AutoPostBack="True" onselectedindexchanged="DDL_CL_ID_SelectedIndexChanged"></asp:dropdownlist></TD>
							</TR>
							<TR>
								<TD class="TDBGColor1">Tipe Agunan</TD>
								<TD></TD>
						...
						<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%">
							<TR>
								...
								<TD class="TDBGColorValue"><asp:textbox onkeypress="return digitsonly()" id="TXT_LC_PERCENTAGE" runat="server" ReadOnly="True"
										Width="48px" AutoPostBack="True" CssClass="angka" MaxLength="3" ontextchanged="TXT_LC_PERCENTAGE_TextChanged"></asp:textbox></TD>
							</TR>
							<TR>
				...
				<TR runat="server">
					<TD class="TDBGColor2" align="center" colSpan="2">&nbsp;
						<asp:button id="Button1" runat="server" Text="Tambah" Width="100px" 
                            CssClass="button1" onclick="insert_Click"></asp:button></TD>
				</TR>
			</TABLE>
		</form>
	</body>
