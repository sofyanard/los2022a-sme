<%@ Page language="c#" Codebehind="BankRelation.aspx.cs" AutoEventWireup="True" Inherits="SME.DataEntry.BankRelation" %>
		...
		<form id="Form1" method="post" runat="server">
			<center>
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					...
					<TR>
						<TD class="td" vAlign="top" width="50%">
							<TABLE id="Table4" cellSpacing="0" cellPadding="0" width="100%">
								...
								<TR>
									<TD class="TDBGColor1" style="WIDTH: 165px" align="right" width="165">No. Rekening Tabungan</TD>
									<TD style="WIDTH: 15px"></TD>
									<TD class="TDBGColorValue"><asp:textbox onkeypress="return numbersonly()" id="TXT_CI_BMSAVINGACCNO" runat="server" Width="300px"
					...
					<TR>
						<TD class="tdHeader1" vAlign="top" colSpan="2">Fasilitas Di Bank Papua</TD>
					</TR>
					<TR>
								...
								<TR id="TRGroup" runat="server">
									<TD align="left" colSpan="3">
										<TABLE id="Table3" cellSpacing="1" cellPadding="1" width="100%" border="1">
											<TR>
												<TD vAlign="top" align="center" width="50%" colSpan="2">
													<TABLE id="TableGroup" cellSpacing="0" cellPadding="0" runat="server">
														...
														<TR>
															<TD class="TDBGColor1" style="WIDTH: 128px" align="right" width="128">Lainnya</TD>
															<TD style="WIDTH: 15px"></TD>
											...
											<TR>
												<TD vAlign="top" align="center" width="50%" colSpan="2">
                                                    <asp:button id="BTN_SAVEGRP" runat="server" Width="75px" CssClass="button1" 
                                                        Text="Simpan"></asp:button></TD>
											</TR>
										</TABLE>
									</TD>
								</TR>
										...
										<table id="TBL_SALDO_RATA" cellSpacing="0" cellPadding="2" width="100%" border="1" runat="server">
											<tr>
												<td class="tdHeader1" width="100%" colSpan="7">SALDO RATA-RATA DAN MUTASI REKENING 
													AKTIVITAS USAHA 6 BULAN TERAKHIR (Rp. 000) UNTUK BANK PAPUA</td>
											</tr>
											<tr>
											...
											<TR>
												<TD align="center" width="100%" colSpan="7"><asp:button class="TDBGColor1" 
                                                        id="btn_SaveSaldo" runat="server" Width="220px" CssClass="Button1"
														Text="Simpan" Height="32px"></asp:button></TD>
											</TR>
											<TR>
								...
								<TR>
									<TD style="HEIGHT: 26px" align="center" colSpan="3">
										...
										<table id="TBL_SALDO_RATA_OB" cellSpacing="0" cellPadding="2" width="100%" border="1" runat="server">
											...
											<TR>
												<TD align="center" width="100%" colSpan="7"><asp:button class="TDBGColor1" 
                                                        id="btn_SaveSaldoOB" runat="server" Width="220px" CssClass="Button1"
														Text="Simpan untuk Bank Lain" Height="32px"></asp:button></TD>
											</TR>
											<TR>
												<TD width="100%" colSpan="7"></TD>
											</TR>
								...
								<TR id="br05" runat="server">
									<TD align="center" colSpan="3">
										...
										<TABLE id="Table7" cellSpacing="2" cellPadding="2" width="90%">
											...
											<TR>
												<TD align="center" colSpan="2"><asp:button id="BTN_INSERT" runat="server" 
                                                        Width="75px" CssClass="button1" Text="Tambah"></asp:button></TD>
											</TR>
										</TABLE>
										<%}%>
									</TD>
					...
					<TR id="br11" runat="server">
						<TD vAlign="top" align="center" colSpan="2">
							...
							<TABLE id="Table11" cellSpacing="2" cellPadding="2" width="90%">
								...
								<TR>
									<TD align="center" colSpan="2"><asp:label id="LBL_PAR" runat="server" Visible="False"></asp:label>
                                        <asp:button id="BtnInsert1" runat="server" Width="75px" CssClass="button1" 
                                            Text="Tambah"></asp:button></TD>
								</TR>
							</TABLE>
							<%}%>
						</TD>
