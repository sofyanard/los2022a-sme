<%@ Page language="c#" Codebehind="BankRelationCBI.aspx.cs" AutoEventWireup="True" Inherits="SME.DataEntry.BankRelationCBI" %>
		...
		<form id="Form1" method="post" runat="server">
			<center>
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					...
					<TR>
						<TD class="tdHeader1" vAlign="top" width="50%" colSpan="2">Hubungan Dengan Bank</TD>
					</TR>
					<TR>
										...
										<table id="TBL_SALDO_RATA" cellSpacing="0" cellPadding="2" width="100%" border="1" runat="server">
											...
											<TR>
												<TD align="center" width="100%" colSpan="7"><asp:button class="TDBGColor1" id="btn_SaveSaldo" runat="server" Width="220px" CssClass="Button1"
														Text="Save Saldo untuk Bank Papua" Height="32px"></asp:button></TD>
											</TR>
											<TR>
