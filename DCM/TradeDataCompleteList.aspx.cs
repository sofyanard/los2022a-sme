	...
	public partial class TradeDataCompleteList : System.Web.UI.Page
	{
		...
		private void ViewData()
		{
			if(DDL_UNIT_KERJA.SelectedValue == "")
				conn2.QueryString = "SELECT * FROM VW_DATA_INTERIM WHERE SOURCE_APPLICATION='02'";
			else
				conn2.QueryString = "SELECT * FROM VW_DATA_INTERIM WHERE SOURCE_APPLICATION='02' AND FAC_BRANCH='" + DDL_UNIT_KERJA.SelectedValue + "'";
			...
			switch (((LinkButton)e.CommandSource).CommandName)
			{
				case "view_data":
					if(e.Item.Cells[3].Text.Trim() == "LC")
						...
						Response.Redirect("BCDataComplet.aspx?cif_no=" + e.Item.Cells[1].Text.Trim());
					else if (e.Item.Cells[3].Text.Trim() == "SJ")
						Response.Redirect("SetoranJaminan.aspx?cif_no=" + e.Item.Cells[1].Text.Trim());
					break;
			}
		}
