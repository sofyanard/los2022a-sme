...
{
	/// <summary>
	/// Summary description for CifDetailDataApproval.
	/// </summary>
	public partial class CifDetailDataApproval : System.Web.UI.Page
	{
		...
		{
			Response.Redirect("CifDetailDataApproval.aspx?tc=" + Request.QueryString["tc"] + "&mc=" + Request.QueryString["mc"] );
		}
	}
}
