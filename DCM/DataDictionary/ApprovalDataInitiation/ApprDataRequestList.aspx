<%@ Page language="c#" Codebehind="ApprDataRequestList.aspx.cs" AutoEventWireup="True" Inherits="SME.DCM.DataDictionary.ApprovalDataInitiation.ApprDataRequestList" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<TITLE>ApprDataRequestList</TITLE>
				...
				<TABLE width="100%" border="0">
					<TR>
						<TD align="left" width="50%">
							<TABLE id="Table1">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>APPROVAL DATA REQUEST 
											LIST</B></TD>
								</TR>
							</TABLE>
						</TD>
					...
					<TR>
						<TD vAlign="top" align="left" width="50%" colSpan="2"><asp:datagrid id="DGR_REQUESTLIST" runat="server" Width="100%" AllowPaging="True" AutoGenerateColumns="False"
								...
								<Columns>
									...
									<asp:BoundColumn DataField="REQ_UNIT" HeaderText="Petugas">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
										<ItemStyle HorizontalAlign="Left"></ItemStyle>
									</asp:BoundColumn>
