<%@ Page language="c#" Codebehind="DataInitMain.aspx.cs" AutoEventWireup="false" Inherits="SME.DCM.DataDictionary.ApprovalRequestData.DataInitMain" %>
				...
				<TABLE width="100%" border="0">
					<TR>
						<TD align="left">
							<TABLE id="Table1">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B><B>APPROVAL REQUEST</B></B></TD>
								</TR>
							</TABLE>
						</TD>
						...
						<TD class="td" vAlign="top" width="50%">
							<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%">
								...
								<TR>
									...
									<TD class='A"TDBGColorValue"' width="50%"><asp:dropdownlist id="DDL_PURPOSE" runat="server" Width="100%" Enabled="False" CssClass="Mandatory"></asp:dropdownlist></TD>
								</TR>
							</TABLE>
						</TD>
						<TD class="td" vAlign="top" width="50%">
					...
					<TR>
						<TD vAlign="top" width="50%">
							<TABLE cellSpacing="0" cellPadding="0" width="100%">
								...
								<TR>
									<TD style="HEIGHT: 21px" align="center" colSpan="2"><asp:button id="BTN_UPLOAD" runat="server" Width="80px" Font-Bold="True" Text="Upload" Enabled="False"></asp:button></TD>
								</TR>
								<TR>
