<%@ Page language="c#" Codebehind="DataTransactionHistory.aspx.cs" AutoEventWireup="True" Inherits="SME.DCM.DataDictionary.ApprovalRequestData.DataTransactionHistory" %>
		...
		<FORM id="form1" method="post" runat="server">
			...
			<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
				<TR>
					...
					<TD align="right"><A href="../../../Body.aspx"><IMG src="../../../Image/MainMenu.jpg"></A>
				...
				<TR id="TR_FIND" runat="server">
					<TD class="td" vAlign="top" colSpan="2">
						<TABLE id="Table3" cellSpacing="1" cellPadding="1" width="100%" border="0">
							<TR>
								<TD>
									<asp:radiobuttonlist id="RDO_LOAN_ACCOUNT" runat="server" RepeatDirection="Horizontal" Width="300px"
										AutoPostBack="True" onselectedindexchanged="RDO_LOAN_ACCOUNT_SelectedIndexChanged">
				...
				<TR id="Tr2" runat="server">
					<TD class="td" vAlign="top" colSpan="2">
						<TABLE id="Table5" cellSpacing="1" cellPadding="1" width="100%" border="0">
							<TR>
								<TD>
									<asp:radiobuttonlist id="RDO_TIME_DEPOSIT" runat="server" RepeatDirection="Horizontal" Width="300px"
										AutoPostBack="True" onselectedindexchanged="RDO_TIME_DEPOSIT_SelectedIndexChanged">
