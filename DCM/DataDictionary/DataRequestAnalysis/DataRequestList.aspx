<%@ Page language="c#" Codebehind="DataRequestList.aspx.cs" AutoEventWireup="True" Inherits="SME.DCM.DataDictionary.DataRequestAnalysis.DataRequestList" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<TITLE>DataRequestList</TITLE>
				...
				<TABLE width="100%" border="0">
					<TR>
						<TD align="left">
							<TABLE id="Table1">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>DATA REQUESTED LIST</B></TD>
								</TR>
							</TABLE>
						</TD>
					...
					<TR>
						<TD vAlign="top" align="left" width="50%" colSpan="2"><asp:datagrid id="DGR_ANALYST" runat="server" Width="100%" AllowPaging="True" AutoGenerateColumns="False"
								ShowFooter="True">
