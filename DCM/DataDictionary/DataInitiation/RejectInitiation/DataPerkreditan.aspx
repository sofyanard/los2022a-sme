<%@ Page language="c#" Codebehind="DataPerkreditan.aspx.cs" AutoEventWireup="True" Inherits="SME.DCM.DataDictionary.DataInitiation.RejectInitiation.DataPerkreditan" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" > 

<HTML>
	<HEAD>
		<TITLE>DataPerkreditan</TITLE>
				...
				<TABLE width="100%" border="0">
					<TR>
						<TD align="left" width="50%">
							<TABLE id="Table1">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>DATA PERKREDITAN REQUEST</B></TD>
								</TR>
							</TABLE>
						</TD>
