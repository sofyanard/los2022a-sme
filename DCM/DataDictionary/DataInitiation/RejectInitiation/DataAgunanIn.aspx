<%@ Page language="c#" Codebehind="DataAgunanIn.aspx.cs" AutoEventWireup="false" Inherits="SME.DCM.DataDictionary.DataInitiation.RejectInitiation.DataAgunanIn" %>
				...
				<table width="100%" border="0">
					<tr>
						<td align="left">
							<TABLE id="Table31">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>DATA&nbsp;AGUNAN REQUEST</B></TD>
								</TR>
							</TABLE>
						</td>
									...
									<TD>
										<TABLE id="Table6" cellSpacing="0" cellPadding="0" width="80%">
											<TR width="100%">
												...
												<TD width="25%"><asp:button id="BTN_SRCHFIELDNAME" Width="100%" CssClass="BUTTON1" Text="Find" Runat="server"></asp:button></TD>
											</TR>
										</TABLE>
									</TD>
									<td>
										<TABLE id="Table7" cellSpacing="0" cellPadding="0" width="80%">
											<TR width="100%">
												...
												<TD width="25%"><asp:button id="BTN_SRCHDESC" Width="100%" CssClass="BUTTON1" Text="Find" Runat="server"></asp:button></TD>
											</TR>
										</TABLE>
									</td>
								</tr>
