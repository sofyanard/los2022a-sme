<%@ Page language="c#" Codebehind="DataDanaPihakKetiga.aspx.cs" AutoEventWireup="True" Inherits="SME.DCM.DataDictionary.DataInitiation.RejectInitiation.DataDanaPihakKetiga" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" > 

<HTML>
	<HEAD>
		<TITLE>DataDanaPihakKetiga</TITLE>
				...
				<TABLE width="100%" border="0">
					<TR>
						<TD align="left" width="50%">
							<TABLE id="Table1">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>DATA DANA REQUEST</B></TD>
								</TR>
							</TABLE>
						</TD>
					...
					<TR>
						<TD class="tdHeader1" colSpan="2">DATA DANA PIHAK KETIGA</TD>
					</TR>
					<TR>
