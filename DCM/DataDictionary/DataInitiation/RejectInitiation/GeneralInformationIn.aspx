<%@ Page language="c#" Codebehind="GeneralInformationIn.aspx.cs" AutoEventWireup="True" Inherits="SME.DCM.DataDictionary.DataInitiation.RejectInitiation.GeneralInformationIn" %>
				...
				<TABLE width="100%" border="0">
					...
					<TR>
						<TD class="TDBGColor2" vAlign="top" align="center" colSpan="2" height="10">
							<asp:label id="LBL_SEQ" runat="server" Visible="True"></asp:label>
							<asp:label id="LBL_TEMP" runat="server" Visible="True"></asp:label><asp:button id="BTN_SAVE" runat="server" Width="100px" CssClass="Button1" Text="SAVE" onclick="BTN_SAVE_Click"></asp:button>&nbsp;&nbsp;
							<asp:button id="BTN_UPDATE" runat="server" CssClass="button1" Text="UPDATE STATUS" onclick="BTN_UPDATE_Click"></asp:button>&nbsp;&nbsp;
							<asp:button id="BTN_FINISH" runat="server" Width="100px" CssClass="button1" Text="FINISH" onclick="BTN_FINISH_Click"></asp:button>&nbsp;&nbsp;
						</TD>
					</TR>
				</TABLE>
			</CENTER>
