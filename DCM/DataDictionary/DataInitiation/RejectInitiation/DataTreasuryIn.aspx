<%@ Page language="c#" Codebehind="DataTreasuryIn.aspx.cs" AutoEventWireup="false" Inherits="SME.DCM.DataDictionary.DataInitiation.RejectInitiation.DataTreasuryIn" %>
				...
				<table width="100%" border="0">
					<tr>
						<td align="left">
							<TABLE id="Table31">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>DATA&nbsp;TREASURY 
											REQUEST</B></TD>
								</TR>
							</TABLE>
						</td>
