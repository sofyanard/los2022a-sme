<%@ Page language="c#" Codebehind="DataCIFIn.aspx.cs" AutoEventWireup="false" Inherits="SME.DCM.DataDictionary.DataInitiation.Initiation.DataCIFIn" %>
		...
		<form id="Form1" method="post" runat="server">
			<CENTER>
				<table width="100%" border="0">
					...
					<TR>
						<TD class="TDBGColor2" vAlign="top" align="center" colSpan="2"><asp:button id="Button1" runat="server" Width="100px" Text="SAVE" CssClass="BUTTON1"></asp:button></TD>
					</TR>
				</table>
			</CENTER>
		</form>
