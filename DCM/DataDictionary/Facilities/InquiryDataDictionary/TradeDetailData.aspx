<%@ Page language="c#" Codebehind="TradeDetailData.aspx.cs" AutoEventWireup="True" Inherits="SME.DCM.DataDictionary.Facilities.InquiryDataDictionary.TradeDetailData" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>TradeDetailData</title>
			...
			<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
				<TR>
					<TD class="tdNoBorder">
						<TABLE id="Table8">
							<TR>
								<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>TRADE LIST DATA</B></TD>
							</TR>
						</TABLE>
					</TD>
				...
				<TR>
					<TD class="tdHeader1" colSpan="2">TRADE DETAIL DATA</TD>
				</TR>
