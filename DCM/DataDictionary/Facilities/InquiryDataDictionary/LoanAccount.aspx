<%@ Page language="c#" Codebehind="LoanAccount.aspx.cs" AutoEventWireup="True" Inherits="SME.DCM.DataDictionary.Facilities.InquiryDataDictionary.LoanAccount" %>
			...
			<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
				<TR>
					<TD class="tdNoBorder">
						<TABLE id="Table8">
							<TR>
								<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>LOAN ACCOUNT LIST DATA</B></TD>
							</TR>
						</TABLE>
					</TD>
				...
				<tr>
					<td><asp:label id="LBL_TEMPLATE" Visible="False" Runat="server"></asp:label></td>
				</tr>
				<TR>
