...
{
	/// <summary>
	/// Summary description for TreasuryDetailData.
	/// </summary>
	public partial class TreasuryDetailData : System.Web.UI.Page
	{
		protected System.Web.UI.WebControls.TextBox TXT_ACC_NUM;
		protected System.Web.UI.WebControls.Button BTN_SEARCH_ACC_NUMBER;
		protected System.Web.UI.WebControls.TextBox TXT_CUST;
		protected System.Web.UI.WebControls.Button BTN_SEARCH_CUST;
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			{
				ViewData();
				LBL_TEMPLATE.Text = "DD-FACILITIES-TREASURY";
		...
		{
			conn.QueryString = "select * from DD_FIELDS_TREASURY where is_active='1'";
			conn.ExecuteQuery();
			FillGrid();
		}
		...
		private void SearchDataField()
		{
			...
			{
				conn.QueryString = "select * from DD_FIELDS_TREASURY where fieldsname like '%"+ TXT_FIELD_NAME.Text +"%' and is_active='1'";
				conn.ExecuteQuery();
			}
			else
			{
		...
		private void SearchDataDesc()
		{
			if (TXT_DESC.Text!= "")
			{
				conn.QueryString = "select * from DD_FIELDS_TREASURY where fieldsdescription like '%"+ TXT_DESC.Text +"%' and is_active='1'";
				conn.ExecuteQuery();
			}
			else
			{
