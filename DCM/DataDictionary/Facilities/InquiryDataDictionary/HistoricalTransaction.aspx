<%@ Page language="c#" Codebehind="HistoricalTransaction.aspx.cs" AutoEventWireup="True" Inherits="SME.DCM.DataDictionary.Facilities.InquiryDataDictionary.HistoricalTransaction" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>HistoricalTransaction</title>
			...
			<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
				<TR>
					<TD class="tdNoBorder">
						<TABLE id="Table8">
							<TR>
								<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>HISTORICAL TRANSACTION 
										LIST DATA</B></TD>
							</TR>
						</TABLE>
					</TD>
				...
				<TR>
					<TD class="tdHeader1" colSpan="2">HISTORICAL TRANSACTION DETAIL DATA</TD>
				</TR>
					...
					<TD class="tdNoBorder" vAlign="top" width="50%">
						<TABLE id="Table20" cellSpacing="0" cellPadding="0" width="100%">
							<TR>
								...
								<TD class="TDBGColorValue" style="WIDTH: 208px"><asp:textbox id="TXT_ACC_NUM" runat="server" Width="200px" MaxLength="15"></asp:textbox></TD>
								<td><asp:button id="BTN_SEARCH_ACC_NUMBER" Text="Search" Runat="server"></asp:button></td>
							</TR>
						</TABLE>
					</TD>
					<TD class="tdNoBorder" vAlign="top" width="50%">
						<TABLE id="Table20" cellSpacing="0" cellPadding="0" width="100%">
							<TR>
								...
								<TD style="WIDTH: 15px"></TD>
								<TD class="TDBGColorValue" style="WIDTH: 208px"><asp:textbox id="TXT_CUST" runat="server" Width="200px" MaxLength="15"></asp:textbox></TD>
								<td><asp:button id="BTN_SEARCH_CUST" Text="Search" Runat="server"></asp:button></td>
							</TR>
						</TABLE>
					</TD>
				</TR>
				<TR>
					<TD colSpan="2"><ASP:DATAGRID id="DatGrd" runat="server" Width="100%" CellPadding="1" AutoGenerateColumns="False"
							...
							<Columns>
								...
								<asp:BoundColumn HeaderText="DESCRIPTION" DataField="">
									<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
								</asp:BoundColumn>
							</Columns>
