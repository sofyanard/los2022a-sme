<%@ Page language="c#" Codebehind="CIFDetailData.aspx.cs" AutoEventWireup="True" Inherits="SME.DCM.DataDictionary.Facilities.InquiryDataDictionary.CIFDetailData" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>CIFDetailData</title>
			...
			<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
				<TR>
					<TD class="tdNoBorder">
						<TABLE id="Table8">
							<TR>
								<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>CUSTOMER INFORMATION FILE 
										(CIF)</B></TD>
							</TR>
						</TABLE>
					</TD>
				...
				<TR>
					<TD class="tdHeader1" colSpan="2">CIF DETAIL DATA</TD>
				</TR>
