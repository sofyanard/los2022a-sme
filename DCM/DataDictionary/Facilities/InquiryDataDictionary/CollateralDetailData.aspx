<%@ Page language="c#" Codebehind="CollateralDetailData.aspx.cs" AutoEventWireup="True" Inherits="SME.DCM.DataDictionary.Facilities.InquiryDataDictionary.CollateralDetailData" %>
			...
			<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
				<TR>
					<TD class="tdNoBorder">
						<TABLE id="Table8">
							<TR>
								<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>COLLATERAL LIST DATA</B></TD>
							</TR>
						</TABLE>
					</TD>
				...
				<TR>
					<TD class="tdHeader1" colSpan="2">COLLATERAL DETAIL DATA</TD>
				</TR>
