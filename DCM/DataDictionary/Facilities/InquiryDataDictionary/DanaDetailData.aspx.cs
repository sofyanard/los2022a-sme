...
{
	/// <summary>
	/// Summary description for DanaDetailData.
	/// </summary>
	public partial class DanaDetailData : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			{
				ViewData();
				LBL_TEMPLATE.Text = "DD-FACILITIES-DANA";
		...
		{
			conn.QueryString = "select * from DD_FIELDS_DANA where is_active='1'";
			conn.ExecuteQuery();
			FillGrid();
		}
		...
		private void SearchDataField()
		{
			...
			{
				conn.QueryString = "select * from DD_FIELDS_DANA where fieldsname like '%"+ TXT_FIELD_NAME.Text +"%' and is_active='1'";
				conn.ExecuteQuery();
			}
			else
			{
		...
		private void SearchDataDesc()
		{
			if (TXT_DESC.Text!= "")
			{
				conn.QueryString = "select * from DD_FIELDS_CIF where fieldsdescription like '%"+ TXT_DESC.Text +"%' and is_active='1'";
				conn.ExecuteQuery();
			}
			else
			{
				conn.QueryString = "select * from DD_FIELDS_CIF where is_active='1'";
				conn.ExecuteQuery();
			}
			FillGrid();
		}		
		...
		private void DatGrd_PageIndexChanged(object source, System.Web.UI.WebControls.DataGridPageChangedEventArgs e)
		{
			...
			if (TXT_FIELD_NAME.Text== "" && TXT_DESC.Text != "")
			{
				conn.QueryString = "select * from DD_FIELDS_DANA where fieldsdescription like '%"+ TXT_DESC.Text +"%' and is_active='1' ";
				conn.ExecuteQuery();
				FillGrid();
			}
