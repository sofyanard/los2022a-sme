<%@ Page language="c#" Codebehind="InquiryPendingTaskList.aspx.cs" AutoEventWireup="True" Inherits="SME.DCM.DataDictionary.Facilities.InquiryPendingTaskList.InquiryPendingTaskList" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
  <HEAD>
		<TITLE>InquiryPendingTaskList</TITLE>
		...
		<FORM id="Form1" method="post" runat="server">
			<CENTER>
				<TABLE width="100%" border="0">
					<TR>
						<TD align="left" width="50%">
							<TABLE id="Table1">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>INQUIRY PENDING TASK LIST</B></TD>
								</TR>
							</TABLE>
						</TD>
				...
				<TABLE class="td" width="40%" align="center" cellSpacing="1" cellPadding="1" border="1">
					<TR>
						<TD class="tdHeader1" colSpan="3">INQUIRY PENDING TASK LIST</TD>
					</TR>
					<TR>
						<TD class="TDBGColor1" width="40%">Request Date :</TD>
						<TD class="TDBGColorValue" colSpan="2">
							<asp:textbox onkeypress="return numbersonly()" id="TXT_REQ_DAY" runat="server" Width="24px" Columns="4"
								MaxLength="2"></asp:textbox>
							<asp:dropdownlist id="DDL_REQ_MONTH" runat="server"></asp:dropdownlist>
							<asp:textbox onkeypress="return numbersonly()" id="TXT_REQ_YEAR" runat="server" Width="36px"
								Columns="4" MaxLength="4"></asp:textbox></TD></TD>
					</TR>
					<TR>
						<TD class="TDBGColor1" width="30%" style="HEIGHT: 1px">Requester Unit :</TD>
						<TD class="TDBGColorValue" colSpan="2" style="HEIGHT: 1px"><asp:dropdownlist id="DDL_REQ_UNIT" runat="server" Width="100%"></asp:dropdownlist></TD>
					</TR>
					<TR>
						<TD class="TDBGColor1" width="30%">PIC DSO :</TD>
						<TD class="TDBGColorValue" colSpan="2"><asp:dropdownlist id="DDL_PIC_DSO" runat="server" Width="100%"></asp:dropdownlist></TD>
					</TR>
					<TR>
						<TD class="TDBGColor1" width="30%">Track ID :</TD>
						<TD class="TDBGColorValue" colSpan="2"><asp:dropdownlist id="DDL_TRACKID" runat="server" Width="100%"></asp:dropdownlist></TD>
					</TR>
					<TR>
						<TD colSpan="3"></TD>
					</TR>
					...
					<TR>
						<TD class="td" vAlign="top" align="center" width="50%" colSpan="2"><asp:datagrid id="DATA_GRID" runat="server" Width="100%" AutoGenerateColumns="False" AllowPaging="True">
								...
								<Columns>
									...
									<asp:BoundColumn DataField="REQ_BY" HeaderText="Request By">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
									</asp:BoundColumn>
								</Columns>
