<%@ Page language="c#" Codebehind="AgunanFieldsMaker.aspx.cs" AutoEventWireup="True" Inherits="SME.DCM.Data_Dictionary.DD_Parameter.Maker.AgunanFieldsMaker" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>AgunanFieldsMaker</title>
				...
				<table width="100%" border="0">
					<tr>
						<td align="left">
							<TABLE id="Table31">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>AGUNAN FIELDS MAKER</B></TD>
								</TR>
							</TABLE>
						</td>
					...
					<TR>
						<TD class="TDBGColor2" vAlign="top" align="center" width="100%" colSpan="2"><asp:button id="BTN_SAVE" runat="server" CssClass="button1" Text="SAVE" onclick="BTN_SAVE_Click"></asp:button><asp:button id="BTN_CLEAR" runat="server" CssClass="button1" Text="CLEAR" onclick="BTN_CLEAR_Click"></asp:button>
							<asp:Label id="LBL_STATUS" runat="server" Visible="False">Label</asp:Label></TD>
					</TR>
					<tr>
					</tr>
					<tr>
