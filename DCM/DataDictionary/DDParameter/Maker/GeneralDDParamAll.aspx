<%@ Page language="c#" Codebehind="GeneralDDParamAll.aspx.cs" AutoEventWireup="True" Inherits="SME.DCM.DataDictionary.DDParameter.Maker.GeneralDDParamAll" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>GeneralDDParamAll</title>
				...
				<TABLE cellSpacing="2" cellPadding="2" width="100%">
					<TR>
						...
						<TD class="tdNoBorder" align="right">
							<A href="GeneralDDParamAll.aspx?mc=DD0801&sm=27"><IMG src="../../../../Image/back.jpg"></A>
