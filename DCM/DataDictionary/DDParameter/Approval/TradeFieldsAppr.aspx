<%@ Page language="c#" Codebehind="TradeFieldsAppr.aspx.cs" AutoEventWireup="True" Inherits="SME.DCM.Data_Dictionary.DD_Parameter.Approval.TradeFieldsAppr" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
  <HEAD>
		<title>TradeFieldsAppr</title>
				...
				<table width="100%" border="0">
					<tr>
						<td align="left">
							<TABLE id="Table31">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>TRADE FIELDS APPROVAL</B></TD>
								</TR>
							</TABLE>
						</td>
