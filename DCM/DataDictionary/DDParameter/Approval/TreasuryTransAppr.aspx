<%@ Page language="c#" Codebehind="TreasuryTransAppr.aspx.cs" AutoEventWireup="True" Inherits="SME.DCM.Data_Dictionary.DD_Parameter.Approval.TreasuryTransAppr" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>TreasuryTransAppr</title>
				...
				<table width="100%" border="0">
					<tr>
						<td align="left">
							<TABLE id="Table31">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>TREASURY TRANSACTION 
											FIELDS APPROVAL</B></TD>
								</TR>
							</TABLE>
						</td>
