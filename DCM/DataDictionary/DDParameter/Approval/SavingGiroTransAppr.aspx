<%@ Page language="c#" Codebehind="SavingGiroTransAppr.aspx.cs" AutoEventWireup="True" Inherits="SME.DCM.Data_Dictionary.DD_Parameter.Approval.SavingGiroTransAppr" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>SavingGiroTransAppr</title>
							...
							<TABLE id="Table31">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>SAVING &amp; GIRO 
											TRANSACTION FIELDS APPROVAL</B></TD>
								</TR>
							</TABLE>
						</td>
