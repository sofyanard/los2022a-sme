<%@ Page language="c#" Codebehind="AssignmentValidation.aspx.cs" AutoEventWireup="True" Inherits="SME.DCM.AssignmentValidation" %>
				...
				<TABLE cellSpacing="2" cellPadding="2" width="100%">
					...
					<TR>
						<TD class="tdNoBorder"><!--<img src="../Image/HeaderDetailDataEntry.jpg">-->
							<TABLE id="Table4">
								<TR>
									<TD class="tdBGColor2" align="center" width="30%"><B>ASSIGNMENT &amp; VALIDATION</B></TD>
								</TR>
							</TABLE>
						</TD>
								...
								<tr>
									...
									<TD class="td" vAlign="top" width="40%">
										<TABLE id="Table6" cellSpacing="0" cellPadding="0" width="100%">
											...
											<TR>
												<TD class="TDBGColor1">&nbsp;Tgl. Terbit</TD>
												<TD style="WIDTH: 15px">:</TD>
									...
									<TD class="td" vAlign="top" width="40%">
										<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%">
											<TR>
												...
												<TD style="WIDTH: 15px">:</TD>
												<TD class="TDBGColorValue"><asp:textbox id="Textbox3" runat="server" Width="300px" ReadOnly="True" BorderStyle="None"></asp:textbox></TD>
											</TR>
											<TR>
