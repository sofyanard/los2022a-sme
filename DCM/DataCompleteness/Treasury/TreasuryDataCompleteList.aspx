<%@ Page language="c#" Codebehind="TreasuryDataCompleteList.aspx.cs" AutoEventWireup="True" Inherits="SME.DCM.DataCompleteness.Treasury.TreasuryDataCompleteList" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<TITLE>TreasuryDataCompleteList</TITLE>
				...
				<TABLE width="100%" border="0">
					<TR>
						<TD align="left">
							<TABLE id="Table31">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>TREASURY DATA 
											COMPLETENESS LIST</B></TD>
								</TR>
							</TABLE>
						</TD>
					...
					<TR>
						<TD colSpan="2"><ASP:DATAGRID id="DGR_INTERIM" runat="server" AutoGenerateColumns="False" CellPadding="1" AllowPaging="True"
								...
								<Columns>
									...
									<asp:BoundColumn DataField="PRODUCT" HeaderText="Reference #">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
									</asp:BoundColumn>
									<asp:BoundColumn DataField="PRODUCT" HeaderText="Unit Kerja">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
									</asp:BoundColumn>
									<asp:BoundColumn DataField="PRODUCT" HeaderText="Error Message">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
									</asp:BoundColumn>
