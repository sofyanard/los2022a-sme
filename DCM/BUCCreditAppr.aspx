<%@ Page language="c#" Codebehind="BUCCreditAppr.aspx.cs" AutoEventWireup="True" Inherits="SME.DCM.BUCCreditAppr" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>BUCCreditAppr</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<table width="100%" border="0">
				...
				<tr align="center">
					<td class="TDBGColor2" vAlign="top" align="center" width="100%" colSpan="2"><asp:button id="BTN_SUBMIT_INVALID_DATA" runat="server" Width="76px" Text="SUBMIT" CssClass="Button1" onclick="BTN_SUBMIT_INVALID_DATA_Click"></asp:button><asp:button id="BTN_UPDATE_INVALID_DATA" runat="server" Width="121px" Text="UPDATE STATUS" CssClass="Button1"
				...
				<tr align="center">
					<td class="TDBGColor2" vAlign="top" align="center" width="100%" colSpan="2"><asp:button id="BTN_SUBMIT_CHECK_DATA" runat="server" Width="76px" Text="SUBMIT" CssClass="Button1" onclick="BTN_SUBMIT_CHECK_DATA_Click"></asp:button><asp:button id="BTN_UPDATE_CHECK_DATA" runat="server" Width="121px" Text="UPDATE STATUS" CssClass="Button1"
							Visible="False"></asp:button></td>
				</tr>
			</table>
		</form>
