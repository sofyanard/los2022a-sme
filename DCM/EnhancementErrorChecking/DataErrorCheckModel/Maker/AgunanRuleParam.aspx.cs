...
{
	/// <summary>
	/// Summary description for AgunanRuleParam.
	/// </summary>
	public partial class AgunanRuleParam : System.Web.UI.Page
	{
		...
		{
			BindData("DGR_AGUNAN_RULE", "EXEC DCM_VIEW_RULE_EXIST_PARAMETER '" + Request.QueryString["type"] + "','" + Request.QueryString["code"] + "'");
		}

		private void ViewRequestingParameter()
		{
			BindData("DGR_AGUNAN_RULE_REQ", "EXEC DCM_VIEW_RULE_REQUEST_PARAMETER '" + Request.QueryString["type"] + "','" + Request.QueryString["code"] + "'");
		}
		...
		{    
			...
			this.DGR_AGUNAN_RULE_REQ.ItemCommand += new System.Web.UI.WebControls.DataGridCommandEventHandler(this.DGR_AGUNAN_RULE_REQ_ItemCommand);
			this.DGR_AGUNAN_RULE_REQ.PageIndexChanged += new System.Web.UI.WebControls.DataGridPageChangedEventHandler(this.DGR_AGUNAN_RULE_REQ_PageIndexChanged);
		...
		private void DGR_AGUNAN_RULE_ItemCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			switch(((LinkButton)e.CommandSource).CommandName)
			{
				...
				case "delete":
					conn.QueryString = "EXEC DCM_RULE_INSERT_PARAM 'AGUNAN','" +
		...
		private void DGR_AGUNAN_RULE_REQ_PageIndexChanged(object source, System.Web.UI.WebControls.DataGridPageChangedEventArgs e)
		{
			DGR_AGUNAN_RULE_REQ.CurrentPageIndex = e.NewPageIndex;
			ViewRequestingParameter();
		}

		private void DGR_AGUNAN_RULE_REQ_ItemCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			switch(((LinkButton)e.CommandSource).CommandName)
			{
				case "edit_req":
				...
				case "delete_req":
					/*Change Table 'DCM_RF_AGUNAN_RULE_TEMP' To 'DCM_RF_CIF_RULE_TEMP'*/
		...
		protected void BTN_INSERT_Click(object sender, System.EventArgs e)
		{
			...
			else
			{
				try
				{
					/*Change Table 'DCM_RF_AGUNAN_RULE' To 'DCM_RF_CIF_RULE'*/
		...
		{
			Response.Redirect("AgunanRule.aspx?mc=" + Request.QueryString["mc"]);
		}
	}
}
