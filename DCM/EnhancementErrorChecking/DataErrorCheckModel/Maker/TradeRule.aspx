<%@ Page language="c#" Codebehind="TradeRule.aspx.cs" AutoEventWireup="True" Inherits="SME.DCM.EnhancementErrorChecking.DataErrorCheckModel.Maker.TradeRule" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" > 

<HTML>
	<HEAD>
		<TITLE>TradeRule</TITLE>
				...
				<TABLE width="100%" border="0">
					...
					<TR>
						<TD class="td" vAlign="top" align="center" width="50%" colSpan="2">
							<asp:datagrid id="DGR_TRADE_RULE" runat="server" Width="100%" AutoGenerateColumns="False" AllowPaging="True">
