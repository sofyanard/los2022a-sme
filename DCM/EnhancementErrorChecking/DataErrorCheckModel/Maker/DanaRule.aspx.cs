...
{
	/// <summary>
	/// Summary description for DanaRule.
	/// </summary>
	public partial class DanaRule : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			BindData("DGR_DANA_RULE","SELECT * FROM VW_DCM_DANA_RULE_PARAM");
		}
		...
		private void DGR_DANA_RULE_ItemCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			{
				case "edit":
					Response.Redirect("DanaRuleParam.aspx?mc=" + Request.QueryString["mc"] + "&type=" + e.Item.Cells[0].Text + "&code=" + e.Item.Cells[1].Text);
					break;
			}
		}
	}
