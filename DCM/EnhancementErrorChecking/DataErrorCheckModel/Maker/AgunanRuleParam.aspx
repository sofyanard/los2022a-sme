<%@ Page language="c#" Codebehind="AgunanRuleParam.aspx.cs" AutoEventWireup="True" Inherits="SME.DCM.EnhancementErrorChecking.DataErrorCheckModel.Maker.AgunanRuleParam" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
  <HEAD>
		<TITLE>AgunanRuleParam</TITLE>
				...
				<TABLE width="100%" border="0">
					<TR>
						<TD align="left">
							<TABLE id="Table1">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>AGUNAN RULE PARAMETER</B></TD>
								</TR>
							</TABLE>
						</TD>
					...
					<TR>
						<TD class="td" vAlign="top" align="center" width="50%" colSpan="2"><asp:datagrid id="DGR_AGUNAN_RULE" runat="server" AllowPaging="True" AutoGenerateColumns="False"
								Width="100%">
						...
						<TD class="td" vAlign="top" width="50%" style="HEIGHT: 4px">
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									...
									<TD class='A"TDBGColorValue"' style="HEIGHT: 7px" width="20%"><asp:textbox id="TEXT_VALIDATION_RULE" runat="server" Width="100%" TextMode="MultiLine" Height="200px"></asp:textbox></TD>
								</TR>
							</TABLE>
						</TD>
					</TR>
					...
					<TR>
						<TD class="td" vAlign="top" align="center" width="50%" colSpan="2"><asp:datagrid id="DGR_AGUNAN_RULE_REQ" runat="server" AllowPaging="True" AutoGenerateColumns="False"
								Width="100%">
								<AlternatingItemStyle CssClass="TblAlternating"></AlternatingItemStyle>
								<Columns>
									<asp:BoundColumn DataField="DATA_TYPE" Visible="False">
									...
									<asp:BoundColumn DataField="DATA_FIELD" HeaderText="Agunan Fields Code">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
										<ItemStyle HorizontalAlign="Left"></ItemStyle>
									</asp:BoundColumn>
									<asp:BoundColumn DataField="DESC" HeaderText="Agunan Fields Description">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
										<ItemStyle HorizontalAlign="Left"></ItemStyle>
									</asp:BoundColumn>
									<asp:BoundColumn DataField="ERR_MSG" Visible="False">
