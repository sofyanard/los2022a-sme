<%@ Page language="c#" Codebehind="CIFRule.aspx.cs" AutoEventWireup="True" Inherits="SME.DCM.EnhancementErrorChecking.DataErrorCheckModel.Maker.CIFRule" %>
				...
				<TABLE width="100%" border="0">
					...
					<TR>
						<TD class="td" vAlign="top" align="center" width="50%" colSpan="2">
							<asp:datagrid id="DGR_CIF_RULE" runat="server" Width="100%" AutoGenerateColumns="False" AllowPaging="True">
