<%@ Page language="c#" Codebehind="Agunan.aspx.cs" AutoEventWireup="True" Inherits="SME.DCM.EnhancementErrorChecking.ValidateProcess.Agunan" %>
				...
				<TABLE width="100%" border="0">
					<TR>
						<TD align="left">
							<TABLE id="Table1">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>AGUNAN VALIDATION PROCESS</B></TD>
								</TR>
							</TABLE>
						</TD>
					...
					<TR>
						<TD class="td" vAlign="top" align="center" width="50%" colSpan="2"><asp:datagrid id="DGR_AGUNAN_VALIDATION" runat="server" AllowPaging="True" AutoGenerateColumns="False"
								Width="100%">
