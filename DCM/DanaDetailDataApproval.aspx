<%@ Page language="c#" Codebehind="DanaDetailDataApproval.aspx.cs" AutoEventWireup="True" Inherits="SME.DCM.DanaDetailDataApproval" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>DanaDetailDataApproval</title>
				...
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					<TR>
						<TD class="tdNoBorder">
							<TABLE id="Table8">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>DANA DETAIL DATA APPROVAL</B></TD>
								</TR>
							</TABLE>
						</TD>
