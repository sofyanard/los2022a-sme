...
{
	/// <summary>
	/// Summary description for LoanListDataBU2.
	/// </summary>
	public partial class LoanListDataBU2 : System.Web.UI.Page
	{
		...
		private void DGR_LOANBU_LIST_ItemCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			{
				case "Edit":
					Response.Redirect("LoanBUDetailData.aspx?sta=exist&acctno=" + e.Item.Cells[2].Text + "&tc=" + Request.QueryString["tc"] + "&from_appr=0");
					break;
