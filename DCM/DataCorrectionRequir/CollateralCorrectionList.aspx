<%@ Page language="c#" Codebehind="CollateralCorrectionList.aspx.cs" AutoEventWireup="True" Inherits="SME.DCM.DataCorrectionRequir.CollateralCorrectionList" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>CollateralCorrectionList</title>
				...
				<table width="100%" border="0">
					<tr>
						<td align="left">
							<TABLE id="Table31">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>COLLATERAL CORRECTION 
											LIST</B></TD>
								</TR>
							</TABLE>
						</td>
						...
						<TD class="td" vAlign="top" width="50%">
							<TABLE id="Table6" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									...
									<TD class="TDBGColorValue" style="WIDTH: 342px; HEIGHT: 17px" width="342"><asp:textbox id="TXT_CIF_NO" runat="server" MaxLength="30" Width="280px"></asp:textbox></TD>
								</TR>
								<TR>
									<TD class="TDBGColor1" style="WIDTH: 144px; HEIGHT: 10px" width="145">Collateral ID</TD>
									<TD style="WIDTH: 4px; HEIGHT: 10px">:</TD>
									<TD class="TDBGColorValue" style="WIDTH: 342px; HEIGHT: 17px" width="342"><asp:textbox id="TXT_ID" runat="server" MaxLength="30" Width="280px"></asp:textbox></TD>
								</TR>
								<TR>
					...
					<TR>
						<TD colSpan="2"><ASP:DATAGRID id="DGR_COLLATERAL_LIST" runat="server" Width="100%" PageSize="15" AllowPaging="True"
								...
								<Columns>
									...
									<asp:BoundColumn HeaderText="CIF#" DataField="CIF#">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
									</asp:BoundColumn>
									...
									<asp:BoundColumn HeaderText="Account#" DataField="ACTNO">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
									</asp:BoundColumn>
									<asp:BoundColumn HeaderText="Collateral ID" DataField="ID">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
									</asp:BoundColumn>
									<asp:BoundColumn HeaderText="Collateral Type" DataField="TYPE">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
									</asp:BoundColumn>
