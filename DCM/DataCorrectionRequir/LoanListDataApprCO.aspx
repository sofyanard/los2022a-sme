<%@ Page language="c#" Codebehind="LoanListDataApprCO.aspx.cs" AutoEventWireup="True" Inherits="SME.DCM.DataCorrectionRequir.LoanListDataApprCO" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>LoanListDataApprCO</title>
					...
					<TR>
						<TD colSpan="2"><ASP:DATAGRID id="DGR_CIF_LIST" runat="server" AutoGenerateColumns="False" CellPadding="1" AllowPaging="True"
								...
								<Columns>
									...
									<asp:BoundColumn DataField="SNAME" HeaderText="Petugas">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
									</asp:BoundColumn>
