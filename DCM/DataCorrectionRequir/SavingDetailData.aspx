<%@ Page language="c#" Codebehind="SavingDetailData.aspx.cs" AutoEventWireup="True" Inherits="SME.DCM.DataCorrectionRequir.SavingDetailData" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>SavingDetailData</title>
			...
			<TABLE cellSpacing="2" cellPadding="2" width="100%">
				<TR>
					<TD class="tdNoBorder">
						<TABLE id="Table8">
							<TR>
								<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>SAVING DETAIL DATA</B></TD>
							</TR>
						</TABLE>
					</TD>
				...
				<TR>
					<TD class="tdHeader1" colSpan="2">Saving Data</TD>
				</TR>
				<TR>
					<TD class="td" vAlign="top" width="50%">
						<TABLE id="Table10" cellSpacing="0" cellPadding="0" width="100%">
							<TR>
								...
								<TD class="TDBGColorValue" align="left"><asp:textbox id="TXT_NO_REK" runat="server" Width="300px" MaxLength="50" ReadOnly="True"></asp:textbox></TD>
							</TR>
							<TR>
								<TD class="TDBGColor1" style="WIDTH: 276px">
									<asp:Label id="LBL_TXT_NM_NASABAH" runat="server">Nama Nasabah</asp:Label></TD>
								<TD style="WIDTH: 15px; HEIGHT: 23px">:</TD>
								<TD class="TDBGColorValue" align="left"><asp:textbox id="TXT_NM_NASABAH" runat="server" Width="300px" MaxLength="50" ReadOnly="True"></asp:textbox></TD>
							</TR>
							<TR>
								<TD class="TDBGColor1" style="WIDTH: 276px">
									<asp:Label id="LBL_TXT_BUC" runat="server">BUC</asp:Label></TD>
								<TD style="WIDTH: 15px; HEIGHT: 23px">:</TD>
								<TD class="TDBGColorValue" align="left"><asp:textbox id="TXT_BUC" runat="server" Width="300px" MaxLength="50" ReadOnly="True"></asp:textbox></TD>
							</TR>
						</TABLE>
					</TD>
