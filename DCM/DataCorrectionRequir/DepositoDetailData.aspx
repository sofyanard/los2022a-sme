<%@ Page language="c#" Codebehind="DepositoDetailData.aspx.cs" AutoEventWireup="True" Inherits="SME.DCM.DataCorrectionRequir.DepositoDetailData" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>DepositoDetailData</title>
			...
			<TABLE cellSpacing="2" cellPadding="2" width="100%">
				<TR>
					<TD class="tdNoBorder">
						<TABLE id="Table8">
							<TR>
								<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>DEPOSITO DETAIL DATA</B></TD>
							</TR>
						</TABLE>
					</TD>
