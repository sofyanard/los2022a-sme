<%@ Page language="c#" Codebehind="SuratBerharagaStock.aspx.cs" AutoEventWireup="True" Inherits="SME.DCM.DataCorrectionRequir.SuratBerharagaStock" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>SuratBerharagaStock</title>
				...
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					<TR>
						<TD class="tdNoBorder">
							<TABLE id="Table8">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>SURAT BERHARGA (STOCK)</B></TD>
								</TR>
							</TABLE>
						</TD>
					...
					<TR>
						<TD class="td" vAlign="top" width="50%">
							<TABLE id="Table6" cellSpacing="0" cellPadding="0" width="100%">
								...
								<TR>
									<TD class="TDBGColor1">
										<asp:Label id="LBL_TXT_ADD_BANK" runat="server">Alamat Bank Penyimpan Agunan</asp:Label></TD>
									<TD style="WIDTH: 15px">:</TD>
								...
								<TR>
									<TD class="TDBGColor1">
										<asp:Label id="LBL_TXT_NILAI_AGUNAN" runat="server">Nilai Agunan</asp:Label></TD>
									<TD style="WIDTH: 15px">:</TD>
						...
						<TD class="td" vAlign="top" width="50%">
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%">
								...
								<TR>
									<TD class="TDBGColor1">
										<asp:Label id="LBL_DDL_BLN_PEMERINGKAT" runat="server">Tanggal Pemeringkatan</asp:Label></TD>
									<TD style="WIDTH: 15px">:</TD>
									<TD class="TDBGColorValue" style="HEIGHT: 23px" align="left"><asp:textbox onkeypress="return numbersonly()" id="TXT_TGL_PEMERINGKAT" runat="server" Columns="4"
											MaxLength="2" Width="24px"></asp:textbox><asp:dropdownlist id="DDL_BLN_PEMERINGKAT" runat="server"></asp:dropdownlist><asp:textbox onkeypress="return numbersonly()" id="TXT_THN_PEMERINGKAT" runat="server" Columns="4"
											MaxLength="4" Width="36px"></asp:textbox></TD>
								</TR>
								<TR>
									<TD class="TDBGColor1" style="WIDTH: 200px" width="149">
										<asp:Label id="LBL_DDL_SURAT_BERHARGA" runat="server">Peringkat Surat Berharga</asp:Label></TD>
									<TD style="WIDTH: 15px">:</TD>
									<TD class='A"TDBGColorValue"' style="HEIGHT: 10px"><asp:dropdownlist id="DDL_SURAT_BERHARGA" runat="server" AutoPostBack="True"></asp:dropdownlist></TD>
								</TR>
								<TR>
									<TD class="TDBGColor1" style="WIDTH: 200px" width="149">
										<asp:Label id="LBL_TXT_NM_PENILAI" runat="server">Nama Penilaian Independen</asp:Label></TD>
									<TD style="WIDTH: 15px">:</TD>
									<TD class="TDBGColorValue"><asp:textbox id="TXT_NM_PENILAI" runat="server" Width="300px" BorderStyle="None"></asp:textbox></TD>
								</TR>
								<TR>
									<TD class="TDBGColor1">
								...
								<TR>
									...
									<TD class="TDBGColorValue" style="HEIGHT: 23px" align="left"><asp:textbox onkeypress="return numbersonly()" id="TXT_TGL_LAST" runat="server" Columns="4" MaxLength="2"
											Width="24px"></asp:textbox><asp:dropdownlist id="DDL_BLN_LAST" runat="server"></asp:dropdownlist><asp:textbox onkeypress="return numbersonly()" id="TXT_THN_LAST" runat="server" Columns="4" MaxLength="4"
								...
								<TR>
									...
									<TD class="TDBGColorValue" style="HEIGHT: 23px" align="left"><asp:textbox onkeypress="return numbersonly()" id="TXT_TGL_PENGIKATAN" runat="server" Columns="4"
											MaxLength="2" Width="24px"></asp:textbox><asp:dropdownlist id="DDL_BLN_PENGIKATAN" runat="server"></asp:dropdownlist><asp:textbox onkeypress="return numbersonly()" id="TXT_THN_PENGIKATAN" runat="server" Columns="4"
											MaxLength="4" Width="36px"></asp:textbox></TD>
								</TR>
								<TR>
									<TD class="TDBGColor1" style="WIDTH: 200px" width="149">
								...
								<TR>
									<TD class="TDBGColor1" style="WIDTH: 200px; HEIGHT: 22px" width="149">
										<asp:Label id="LBL_TXT_PARIPASU" runat="server">Paripasu(%)</asp:Label></TD>
									<TD style="WIDTH: 15px; HEIGHT: 22px">:</TD>
									<TD class="TDBGColorValue" style="HEIGHT: 22px"><asp:textbox id="TXT_PARIPASU" runat="server" Width="300px" BorderStyle="None"></asp:textbox></TD>
								</TR>
								<TR>
									<TD class="TDBGColor1" style="WIDTH: 200px" width="149">
