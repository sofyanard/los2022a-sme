...
{
	/// <summary>
	/// Summary description for PersediaanBarangINV.
	/// </summary>
	public partial class PersediaanBarangINV : System.Web.UI.Page
	{
		...
		private string VAR_AlamatPenyimpananBuktiAgunan;
		...
		private void CheckError()
		{
			...
			for (int i = 0; i < conn2.GetRowCount(); i++)
			{
				...
				conn3.QueryString = "SELECT IDCONTROL FROM DCM_TABLE_ERROR WHERE PAGE = 'PersediaanBarangINV.aspx' AND MESSAGE = '" + err_msg.Trim() + "'";
				conn3.ExecuteQuery();
		...
		private void VAR_to_CONTROL()
		{
			...
			TXT_LOKASI_AGUNAN.Text = VAR_AlamatPenyimpananBuktiAgunan;
			...
			TXT_NO_PENGIKATAN.Text = VAR_TanggalPengikatanDay;
		...
		private void CONTROL_to_VAR()
		{
			...
			VAR_AlamatPenyimpananBuktiAgunan = TXT_LOKASI_AGUNAN.Text;
			...
			VAR_TanggalPengikatanDay = TXT_NO_PENGIKATAN.Text;
