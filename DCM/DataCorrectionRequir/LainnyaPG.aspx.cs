...
{
	/// <summary>
	/// Summary description for LainnyaPG.
	/// </summary>
	public partial class LainnyaPG : System.Web.UI.Page
	{
		...
		private void CheckError()
		{
			...
			for (int i = 0; i < conn2.GetRowCount(); i++)
			{
				...
				conn3.QueryString = "SELECT IDCONTROL FROM DCM_TABLE_ERROR WHERE PAGE = 'LainnyaPG.aspx' AND MESSAGE = '" + err_msg.Trim() + "'";
				conn3.ExecuteQuery();
