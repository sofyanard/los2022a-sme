<%@ Page language="c#" Codebehind="AccountDanaListDataApproval.aspx.cs" AutoEventWireup="True" Inherits="SME.DCM.DataCorrectionRequir.AccountDanaListDataApproval" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>AccountDanaListDataApproval</title>
				...
				<table width="100%" border="0">
					<tr>
						<td align="left">
							<TABLE id="Table31">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>ACCOUNT DANA LIST DATA 
											APPROVAL</B></TD>
								</TR>
							</TABLE>
						</td>
					...
					<TR>
						<TD colSpan="2"><ASP:DATAGRID id="DGR_CIF_LIST" runat="server" AutoGenerateColumns="False" CellPadding="1" AllowPaging="True"
								...
								<Columns>
									<asp:BoundColumn DataField="CIFNO" HeaderText="Account#">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
									</asp:BoundColumn>
									<asp:BoundColumn DataField="SNAME" HeaderText="Customer Name">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
									</asp:BoundColumn>
									<asp:BoundColumn DataField="SNAME" HeaderText="Jenis Account">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
									</asp:BoundColumn>
