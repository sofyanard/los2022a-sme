<%@ Page language="c#" Codebehind="LoanListDataBU2.aspx.cs" AutoEventWireup="True" Inherits="SME.DCM.DataCorrectionRequir.LoanListDataBU2" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>LoanListDataBU2</title>
					...
					<TR>
						<TD colSpan="2"><ASP:DATAGRID id="DGR_LOANBU_LIST" runat="server" Width="100%" PageSize="15" AllowPaging="True"
								...
								<Columns>
									...
									<asp:BoundColumn HeaderText="Opening Date" DataField="OPENED_DATE">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
									</asp:BoundColumn>
