<%@ Page language="c#" Codebehind="DanaListData.aspx.cs" AutoEventWireup="True" Inherits="SME.DCM.DataCorrectionRequir.DanaListData" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>DanaListData</title>
		...
		<form id="Form1" method="post" runat="server">
			<CENTER>
				<table width="100%" border="0">
						...
						<TD class="td" vAlign="top" width="50%">
							<TABLE id="Table6" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									...
									<TD class="TDBGColorValue" style="WIDTH: 342px; HEIGHT: 17px" width="342"><asp:textbox id="TXT_ACT_NO" runat="server" Width="280px" MaxLength="30"></asp:textbox></TD>
								</TR>
								<TR>
					...
					<TR>
						<TD colSpan="2"><ASP:DATAGRID id="DGR_DANA_LIST" runat="server" Width="100%" AutoGenerateColumns="False" CellPadding="1"
								...
								<Columns>
									...
									<asp:BoundColumn HeaderText="Account Type" DataField="ACT_TYPE">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
									</asp:BoundColumn>
									<asp:BoundColumn HeaderText="Opening Date" DataField="ACT_DATE">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
									</asp:BoundColumn>
