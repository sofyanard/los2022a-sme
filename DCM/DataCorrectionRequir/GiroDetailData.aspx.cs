...
{
	/// <summary>
	/// Summary description for GiroDetailData.
	/// </summary>
	public partial class GiroDetailData : System.Web.UI.Page
	{
		...
		*/
		...
		private void CheckError()
		{
			...
			for (int i = 0; i < conn2.GetRowCount(); i++)
			{
				...
				conn3.QueryString = "SELECT IDCONTROL FROM DCM_TABLE_ERROR WHERE PAGE = 'GiroDetailData.aspx' AND MESSAGE = '" + err_msg.Trim() + "'";
				conn3.ExecuteQuery();
