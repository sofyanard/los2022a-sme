<%@ Page language="c#" Codebehind="LainnyaPG.aspx.cs" AutoEventWireup="True" Inherits="SME.DCM.DataCorrectionRequir.LainnyaPG" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>LainnyaPG</title>
				...
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					<TR>
						<TD class="tdNoBorder">
							<TABLE id="Table8">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>LAINNYA (PG, CG, BOND, 
											LC)</B></TD>
								</TR>
							</TABLE>
						</TD>
					...
					<TR>
						...
						<TD class="td" vAlign="top" width="50%">
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%">
								...
								<TR>
									<TD class="TDBGColor1" style="WIDTH: 200px" width="149">
										<asp:Label id="LBL_TXT_NAMA_PENILAI" runat="server">Nama Penilai Independen</asp:Label></TD>
									<TD style="WIDTH: 15px">:</TD>
								...
								<TR>
									<TD class="TDBGColor1">
										<asp:Label id="LBL_DDL_BLN_PENGIKAT" runat="server">Tanggal Pengikatan</asp:Label></TD>
									<TD style="WIDTH: 15px">:</TD>
									<TD class="TDBGColorValue" style="HEIGHT: 23px" align="left"><asp:textbox onkeypress="return numbersonly()" id="TXT_TGL_PENGIKAT" runat="server" Columns="4"
											MaxLength="2" Width="24px"></asp:textbox><asp:dropdownlist id="DDL_BLN_PENGIKAT" runat="server"></asp:dropdownlist><asp:textbox onkeypress="return numbersonly()" id="TXT_THN_PENGIKAT" runat="server" Columns="4"
											MaxLength="4" Width="36px"></asp:textbox></TD>
								</TR>
								<TR>
									<TD class="TDBGColor1" style="WIDTH: 200px" width="149">
										<asp:Label id="LBL_DDL_JNS_PENGIKAT" runat="server">Jenis Pengikatan</asp:Label></TD>
									<TD style="WIDTH: 15px">:</TD>
								...
								<TR>
									<TD class="TDBGColor1" style="WIDTH: 200px" width="149">
										<asp:Label id="LBL_TXT_NO_PENGIKAT" runat="server">Nomor Pengikatan</asp:Label></TD>
									<TD style="WIDTH: 15px">:</TD>
