...
{
	/// <summary>
	/// Summary description for BarangBergerakVEH.
	/// </summary>
	public partial class BarangBergerakVEH : System.Web.UI.Page
	{
		...
		private string VAR_NilaiPasarBank;
		...
		private string VAR_TanggalPengikatanYeaar;		
		...
		private void CheckError()
		{
			...
			for (int i = 0; i < conn2.GetRowCount(); i++)
			{
				...
				conn3.QueryString = "SELECT IDCONTROL FROM DCM_TABLE_ERROR WHERE PAGE = 'BarangBergerakVEH.aspx' AND MESSAGE = '" + err_msg.Trim() + "'";
				conn3.ExecuteQuery();
		...
		private void VAR_to_CONTROL()
		{
			...
			TXT_ALAT_BUKTI.Text				= VAR_AlamatBankPenyimpanAgunan;
			DDL_DATI.SelectedValue			= VAR_LokasiDatiII;
			DDL_STATUS.SelectedValue		= VAR_StatusBuktiKepemilikan;
			TXT_TGL_START.Text				= VAR_JangkaWaktuMulaiDay;
			DDL_BLN_START.SelectedValue		= VAR_JangkaWaktuMulaiMonth;
			TXT_THN_START.Text				= VAR_JangkaWaktuMulaiYear;
			...
			TXT_NILAI_PASAR.Text			= VAR_NilaiPasarBank;
			TXT_TGL_START.Text				= VAR_JangkaWaktuMulaiDay;
			DDL_BLN_START.SelectedValue		= VAR_JangkaWaktuMulaiMonth;			
			TXT_NILAI_PASAR.Text			= VAR_NilaiPasarBank;
			TXT_NILAI_APPR.Text				= VAR_NilaiAppraisal;
			TXT_NILAI_LIQUID.Text			= VAR_NilaiLikuidasi;
			TXT_NILAI_IND.Text				= VAR_NamaPenilaiIndependen;
			...
			TXT_YEAR_LAST.Text				= VAR_TanggalPenilaianTerakhirYear;
			...
			TXT_TGL_PENGIKATAN.Text			= VAR_TanggalPengikatanYeaar;
		...
		private void CONTROL_to_VAR()
		{
			...
			VAR_AlamatBankPenyimpanAgunan = TXT_ALAT_BUKTI.Text;
			...
			VAR_NilaiPasarBank = TXT_NILAI_PASAR.Text;
			VAR_JangkaWaktuMulaiDay = TXT_TGL_START.Text;
			VAR_JangkaWaktuMulaiMonth = DDL_BLN_START.SelectedValue;
			VAR_JangkaWaktuMulaiYear = TXT_THN_START.Text;
			VAR_NilaiAppraisal = TXT_NILAI_APPR.Text;
			VAR_NamaPenilaiIndependen = TXT_NILAI_IND.Text;
			...
			VAR_TanggalPenilaianTerakhirYear = TXT_YEAR_LAST.Text;
			VAR_NilaiPengikatan = TXT_NILAI_PENGIKATAN.Text;
			VAR_TanggalPengikatanDay = TXT_TGL_PENGIKATAN.Text;
			VAR_TanggalPengikatanMonth = DDL_BLN_PENGIKATAN.SelectedValue;
			VAR_TanggalPengikatanYeaar = TXT_YEAR_PENGIKATAN.Text;
