<%@ Page language="c#" Codebehind="RptCoNotaryMntr.aspx.cs" AutoEventWireup="True" Inherits="SME.SourceSMEReport.RptCoNotaryMntr" %>
<%@ Register assembly="Microsoft.ReportViewer.WebForms, Version=10.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a" namespace="Microsoft.Reporting.WebForms" tagprefix="rsweb" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>RptCoNotaryMntr</title>
		...
		function Batal()
		{
			...
			document.Form1.DDL_NOTARY.value	= "";
		}
		</script>
		...
		<form id="Form1" method="post" runat="server">
			<center>
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					...
					<tr>
						<td vAlign="top" align="center" colSpan="2" style="HEIGHT: 234px">
							<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="550">
								<TR>
									<TD class="tdHeader1">
										<asp:label id="LBL_RM" runat="server" Visible="False"></asp:label>
								...
								<TR>
									<TD class="td" vAlign="top">
										<TABLE id="Table6" cellSpacing="0" cellPadding="0" width="100%">
											<TBODY>
												<TR>
													<TD class="TDBGColor1">Notary Assignment Date</TD>
									</TD>
								...
								<TR>
									<TD class="TDBGColor1" style="HEIGHT: 10px">Team</TD>
								...
								<TR>
									<TD class="TDBGColor1">Notary</TD>
									<TD></TD>
									<TD class="TDBGColorValue">
										<asp:dropdownlist id="DDL_NOTARY" runat="server"></asp:dropdownlist></TD>
								</TR> <!-- Additional Field : Right -->
							</TABLE>
						</td>
					</tr>
					<TR>
						<TD class="TDBGColor2" vAlign="top" align="center">
							<asp:button id="BTN_LIHAT" runat="server" CssClass="Button1" Text="Find" Width="60px" onclick="BTN_LIHAT_Click"></asp:button>&nbsp;
