<%@ Page language="c#" Codebehind="RptRmPerformance.aspx.cs" AutoEventWireup="True" Inherits="SME.SourceSMEReport.RptRmPerformance" %>
<%@ Register assembly="Microsoft.ReportViewer.WebForms, Version=10.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a" namespace="Microsoft.Reporting.WebForms" tagprefix="rsweb" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>RptRmPerformance</title>
							...
							<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="550" height="160">
								<TR>
									<TD class="tdHeader1" colSpan="2">
										...
										<asp:Label id="LBL_PROGRAM" runat="server" Visible="False">LBL_PROGRAM</asp:Label>AO 
										PERFORMANCE&nbsp;REPORT
								...
								<TR>
									...
									<TD></TD>
									<TD class="TDBGColorValue">
										<asp:DropDownList id="DDL_Industri" runat="server"></asp:DropDownList></TD>
