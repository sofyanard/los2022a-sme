<%@ Page language="c#" Codebehind="RptCOBookingProcPrint.aspx.cs" AutoEventWireup="True" Inherits="SME.SourceSMEReport.RptCOBookingProcPrint" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>RptCOBookingProcPrint</title>
		...
		<form id="Form1" method="post" runat="server">
			<center>
				<TABLE id="Table1" cellSpacing="2" cellPadding="2">
					<TR>
						<TD>
							<P align="center"><B> SLA CO BOOKING PROCESS REPORT</B></P>
						</TD>
					</TR>
					<TR>
					...
					<TR>
						<TD class="TitleReport" align="center"><asp:label id="lbl_team" runat="server" ForeColor="Black">lbl_team</asp:label></TD>
					</TR>
					<TR>
						<TD class="tdNoBorder"><asp:table id="TBL_CONTENT" runat="server" CellSpacing="0" CellPadding="0" BorderWidth="1px"
								...
								<asp:TableRow>
									...
									<asp:TableCell Width="80px" Text="TOTAL AMOUNT" CssClass="HeaderPrint"></asp:TableCell>
								</asp:TableRow>
							</asp:table></TD>
					</TR>
					<TR id="TRPRINT">
