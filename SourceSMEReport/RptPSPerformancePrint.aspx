<%@ Page language="c#" Codebehind="RptPSPerformancePrint.aspx.cs" AutoEventWireup="True" Inherits="SME.SourceSMEReport.RptPSPerformancePrint" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>RptPSPerformancePrint</title>
		...
		<form id="Form1" method="post" runat="server">
			<center>
				<TABLE id="Table1" cellSpacing="2" cellPadding="2">
					<TR>
						<TD>
							<P align="center"><B>PS PERFORMANCE&nbsp;REPORT</B></P>
						</TD>
					</TR>
					<TR>
					...
					<TR>
						<TD class="tdNoBorder"><asp:table id="TBL_CONTENT" runat="server" ForeColor="Black" CellSpacing="0" CellPadding="0"
								...
								<asp:TableRow>
									...
									<asp:TableCell Width="80px" Text="START DATE" CssClass="HeaderPrint_d"></asp:TableCell>
									<asp:TableCell Width="80px" Text="END DATE" CssClass="HeaderPrint_d"></asp:TableCell>
									<asp:TableCell Width="80px" Text="#OF DAYS" CssClass="HeaderPrint_d"></asp:TableCell>
									<asp:TableCell Width="80px" Text="ANALIST" CssClass="HeaderPrint_d"></asp:TableCell>
									<asp:TableCell Width="100px" Text="BU COMMENTS" CssClass="HeaderPrint_d"></asp:TableCell>
									<asp:TableCell Width="100px" Text="ACCOUNT" CssClass="HeaderPrint_d"></asp:TableCell>
									<asp:TableCell Width="100px" Text="ACCOUNT OPINION" CssClass="HeaderPrint_d"></asp:TableCell>
									<asp:TableCell Width="150px" Text="RM" CssClass="HeaderPrint_d"></asp:TableCell>
								</asp:TableRow>
							</asp:table></TD>
					</TR>
					<TR>
					...
					<TR>
						<TD align="left">
							<asp:Label id="Label3" runat="server">Start Date - Financial Analysis Start Date</asp:Label></TD>
					</TR>
					<TR>
						<TD align="left">
							<asp:Label id="Label4" runat="server">End Date - After Nota Analisa is prepared</asp:Label></TD>
					</TR>
					<TR id="TRPRINT">
						<TD align="center">
