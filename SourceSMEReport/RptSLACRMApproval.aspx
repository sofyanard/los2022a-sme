<%@ Page language="c#" Codebehind="RptSLACRMApproval.aspx.cs" AutoEventWireup="True" Inherits="SME.SourceSMEReport.RptSLACRMApproval" %>
<%@ Register assembly="Microsoft.ReportViewer.WebForms, Version=10.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a" namespace="Microsoft.Reporting.WebForms" tagprefix="rsweb" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>RptSLACRMApproval</title>
						...
						<TD style="HEIGHT: 201px" vAlign="top" align="center" colSpan="2" height="201">
							<TABLE id="Table1" height="160" cellSpacing="2" cellPadding="2" width="550">
								<TBODY>
									...
									<TR>
										<TD class="TDBGColor1" style="HEIGHT: 3px">Cabang/CBC/Group</TD>
										<TD style="HEIGHT: 3px"></TD>
										<TD class="TDBGColorValue" style="HEIGHT: 3px"><asp:dropdownlist id="DDL_BRANCH" runat="server" AutoPostBack="True" onselectedindexchanged="DDL_BRANCH_SelectedIndexChanged"></asp:dropdownlist></TD>
									</TR>
									<TR>
