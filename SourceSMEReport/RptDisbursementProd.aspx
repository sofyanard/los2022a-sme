<%@ Page language="c#" Codebehind="RptDisbursementProd.aspx.cs" AutoEventWireup="True" Inherits="SME.SourceSMEReport.RptDisbursementProd" %>
<%@ Register assembly="Microsoft.ReportViewer.WebForms, Version=10.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a" namespace="Microsoft.Reporting.WebForms" tagprefix="rsweb" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>RptDisbursementProd</title>
							...
							<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="550">
								<TR>
									<TD class="tdHeader1"><asp:label id="LBL_RM" runat="server" Visible="False"></asp:label>DISBURSEMENT 
										REPORT BY Kantor Pusat/Kanwil, PRODUCT
								...
								<TR>
									<TD class="TDBGColor1" style="HEIGHT: 11px">Industry</TD>
									<TD style="HEIGHT: 11px"></TD>
									<TD class="TDBGColorValue" style="HEIGHT: 11px"><asp:dropdownlist id="DDL_INDUSTRI" runat="server" AutoPostBack="True"></asp:dropdownlist></TD>
								</TR>
								<TR>
									<TD class="TDBGColor1">Sub-Segment/Program</TD>
									<TD></TD>
									<TD class="TDBGColorValue"><asp:dropdownlist id="DDL_program" runat="server" 
                                            onselectedindexchanged="DDL_program_SelectedIndexChanged" AutoPostBack="True"></asp:dropdownlist></TD>
								</TR>
								<TR>
