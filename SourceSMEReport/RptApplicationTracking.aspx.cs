...
{
	/// <summary>
	/// Summary description for RptApplicationTracking.
	/// </summary>
	public partial class RptApplicationTracking : System.Web.UI.Page
	{
		...
		public void fillbusinessunit()
		{
            ...
            if (!Session["BussUnit"].Equals(""))
			{
                Conn.QueryString = "select bussunitid, bussunitdesc from rfbusinessunit where active='1' and bussunitid in ('" + Session["BussUnit"] + "') ";
		...
		private void LoadReport(string action, string tgl1, string tgl2, string branch, string area, string bussgrp, string  tanggal1_k, string tanggal2_k)
		{
            ...
            */
            ...
            {
                //ReportViewer1.ReportPath = "/SMEReports/RptAppTracking&sql_kondisi=" + Server.HtmlEncode(kriterianya) + "&Start_Date=" + tanggal1 + "&End_Date=" + tanggal2 + "&branch_code=" + branch + "&area=" + area + "&bussgrp=" + bussgrp + "&rs:Command=Render&rc:Toolbar=True";
                ReportViewer1.ServerReport.ReportPath = "/SMEReports/RptAppTracking";
                ...
                paramList.Add(new ReportParameter("branch_code", branch, false));
                ...
                Response.Redirect("RptApplicationTrackingPrint.aspx?sql_kondisi=" + Server.HtmlEncode(kriterianya.Replace("'", "''")) + "&Start_Date=" + tanggal1 + "&End_Date=" + tanggal2 + "&branch_code=" + branch + "&area=" + area + "&bussgrp=" + bussgrp);
