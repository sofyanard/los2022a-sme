<%@ Page language="c#" Codebehind="RptSPPKSentReceipt.aspx.cs" AutoEventWireup="True" Inherits="SME.SourceSMEReport.RptSPPKSentReceipt" %>
<%@ Register assembly="Microsoft.ReportViewer.WebForms, Version=10.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a" namespace="Microsoft.Reporting.WebForms" tagprefix="rsweb" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>RptSPPKSentReceipt</title>
					...
					<TR>
						<TD style="HEIGHT: 201px" vAlign="top" align="center" colSpan="2" height="201">
							<TABLE id="Table1" height="160" cellSpacing="2" cellPadding="2" width="550">
								<TBODY>
									<TR>
										<TD class="tdHeader1" colSpan="2"><asp:label id="LBL_CBC" runat="server" Visible="False">LBL_CBC</asp:label><asp:label id="LBL_BRANCH" runat="server" Visible="False">LBL_BRANCH</asp:label><asp:label id="LBL_REGION" runat="server" Visible="False">LBL_REGION</asp:label>SLA-SPPK 
											SENT RECEIPT REPORT&nbsp;
											<asp:label id="lbl_approval" runat="server" Visible="False">lbl_approval</asp:label><asp:label id="Label1" runat="server" Visible="False">Label</asp:label>
