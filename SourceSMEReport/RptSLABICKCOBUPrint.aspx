<%@ Page language="c#" Codebehind="RptSLABICKCOBUPrint.aspx.cs" AutoEventWireup="True" Inherits="SME.SourceSMEReport.RptBICKCOBUPrint" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>RptBICKCOBUPrint</title>
		...
		<form id="Form1" method="post" runat="server">
			<center>
				<TABLE id="Table1" cellSpacing="2" cellPadding="2">
					<TR>
						<TD>
							<P align="center"><B>SLA&nbsp;BI CHECKING FROM CO TO BI&nbsp;REPORT</B></P>
						</TD>
					</TR>
					<TR>
