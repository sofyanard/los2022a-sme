<%@ Page language="c#" Codebehind="MainReportPR.aspx.cs" AutoEventWireup="True" Inherits="SME.SourceSMEReport.MainReportPR" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>MainReportPR</title>
					...
					<tr>
						<td colspan="2">
							<table cellpadding="2" cellspacing="2" border="1" width="100%">
								<TR>
									<TD class="tdHeader1" colspan="2">PERFORMANCE&nbsp;REPORTING</TD>
								</TR>
								<TR>
									<TD id="id01" class="TDBGColor1" align="center" width="50" onmouseover="mouse_over('0')"
										onclick="klik('0')" onmouseout="mouse_out('0')">
										<INPUT type="radio" CHECKED value="RptProdPerform.aspx" name="RB_1" onclick="click_rb()">&nbsp;</TD>
									<td id="id02" class="TDBGColorValue" onmouseover="mouse_over('0')" onclick="klik('0')"
										onmouseout="mouse_out('0')">&nbsp;
										<asp:Label id="LBL_1" runat="server">Product Performance Report</asp:Label></td>
								</TR>
								<TR>
									<TD id="id11" class="TDBGColor1" align="center" width="50" onmouseover="mouse_over('1')"
										onclick="klik('1')" onmouseout="mouse_out('1')">
										<INPUT type="radio" value="RptRMPerformance.aspx" name="RB_1" onclick="click_rb()">&nbsp;</TD>
									<td id="id12" class="TDBGColorValue" onmouseover="mouse_over('1')" onclick="klik('1')"
										onmouseout="mouse_out('1')">&nbsp;
										<asp:Label id="LBL_2" runat="server">AO Performance Report</asp:Label></td>
								</TR>
								<TR>
