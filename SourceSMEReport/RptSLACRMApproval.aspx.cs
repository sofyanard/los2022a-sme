...
{
	/// <summary>
	/// Summary description for RptSLACRMApproval.
	/// </summary>
	public partial class RptSLACRMApproval : System.Web.UI.Page
	{
		...
		private void Load_ReportViewer(string Start_Date, string End_Date, string region, string CBC, string Branch, string teamleader, string approval)
		{
			/*
			...
			*/
            ...
            //ReportViewer1.ReportPath = "/SMEReports/SLACRMAApproval&userid=" + Session["UserID"].ToString() + "&Start_Date=" + tanggal1 + "&End_Date=" + tanggal2 + "&region=" + region + "&CBC=" + CBC + "&BRANCH=" + Branch + "&teamleader=" + teamleader + "&approval=" + approval + "&rs:Command=Render&rc:Toolbar=True";
            ...
            ReportViewer1.ServerReport.ReportPath = "/SMEReports/SLACRMAApproval";
			...
			*/
			{
				...
				if(!branch.Equals(""))
				{
					...
					if (!approval.Equals(""))
					{
						kriterianya= kriterianya + "and (crm = ''" + approval + "'') ";
					}
				}
				else
				{
				...
				Conn.QueryString="exec sp_rpt_CRM_APPROVAL '" + Session["UserID"].ToString() + "'," + tanggal1 + "," + tanggal2 + ",'" + kriterianya + "'";
				Conn.ExecuteQuery(1800);
				if (!action.Equals("PRINT"))
					Load_ReportViewer(tanggal1,tanggal2,region, cbc,branch, teamleader, approval);
				else
					Response.Redirect("RptSLACRMApprovalPrint.aspx?userid=" + Session["UserID"].ToString() + "&tanggal1=" + tanggal1 + "&tanggal2=" + tanggal2 + "&region=" + region + "&cbc=" + cbc + "&branch=" + branch + "&approval=" + approval+ "&teamleader=" +teamleader);
			}
		}
