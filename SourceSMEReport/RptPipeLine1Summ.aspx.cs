...
{
	/// <summary>
	/// Summary description for RptPipeLine1Summ.
	/// </summary>
	public partial class RptPipeLine1Summ : System.Web.UI.Page
	{
		...
		private void Load_ReportViewer(string date1, string date2, string action,string sql_kondisi, string region, string businessunit, string branch, string rm, string cbc, string teamleader)
		{
            if (!action.Equals("PRINT"))
            {
                //ReportViewer1.ReportPath = "/SMEReports/RptPipeLine1Summ&date1=" + date1 + "&date2=" + date2 + "&sql_kondisi=" + sql_kondisi + "&region=" + region + "&BU=" + businessunit.ToString() + "&rm=" + rm + "&cbc=" + cbc + "&branch=" + branch + "&teamleader=" + teamleader + "&rs:Command=Render&rc:Toolbar=True";
                ...
                ReportViewer1.ServerReport.ReportPath = "/SMEReports/RptPipeLine1Summ";
            ...
            {
                Response.Redirect("RptPipeLine1SummPrint.aspx?date1=" + date1 + "&date2=" + date2 + "&sql_kondisi=" + sql_kondisi.Replace("'", "''") + "&region=" + region + "&businessunit=" + businessunit + "&cbc=" + cbc + "&branch=" + branch + "&rm=" + rm + "&teamleader=" + teamleader);
            }
		}
			...
			*/
			{
				...
				{
					kriterianya+= " and businessunit in ('" + LBL_BU.Text + "') ";
				}
				if (!rm.Equals(""))
				{
...
//				}
				Load_ReportViewer(date1, date2, action, kriterianya, title_area, title_bu, title_branch, title_rm, title_cbc, title_tl);
			}
		}
		...
		{
			Response.Redirect("MainReportOR.aspx?mc=" + Request.QueryString["mc"] + "&BU=" + LBL_BU.Text.Trim());
		}
