<%@ Page language="c#" Codebehind="RptKoperasi.aspx.cs" AutoEventWireup="True" Inherits="SME.SourceSMEReport.RptKoperasi" %>
<%@ Register assembly="Microsoft.ReportViewer.WebForms, Version=10.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a" namespace="Microsoft.Reporting.WebForms" tagprefix="rsweb" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>RptKoperasi</title>
					...
					<tr>
						<td vAlign="top" align="center" colSpan="2" style="HEIGHT: 2px">
							<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="500">
								<TR>
									<TD class="tdHeader1" colSpan="2"><asp:label id="LBL_RM" runat="server" Visible="False"></asp:label>RELATIONSHIP 
										REPORT - KOPERASI DAN KELOMPOK
