<%@ Page language="c#" Codebehind="RptCollAppraisalAgencyPrint.aspx.cs" AutoEventWireup="True" Inherits="SME.SourceSMEReport.RptCollAppraisalAgencyPrint" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>RptCollAppraisalAgencyPrint</title>
		...
		<form id="Form1" method="post" runat="server">
			<center>
				<TABLE id="Table1" cellSpacing="2" cellPadding="2">
					<TR>
						<TD>
							<P align="center"><B>SLA COLLATERAL APPRAISAL FROM&nbsp;CO TO AGENCY REPORT</B></P>
						</TD>
					</TR>
					<TR>
					...
					<TR>
						<TD class="TitleReport" align="center"><asp:label id="LBL_TEAM" runat="server" ForeColor="Black" BorderStyle="None">TEAM 1</asp:label></TD>
					</TR>
					<TR>
						<TD class="TitleReport" align="center">
							<asp:label id="LBL_AGENCY" runat="server" ForeColor="Black">LBL_AGENCY</asp:label></TD>
					</TR>
					<TR>
