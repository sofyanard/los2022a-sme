...
{
	/// <summary>
	/// Summary description for CIFKredit.
	/// </summary>
	public partial class CIFKredit : System.Web.UI.Page
	{
...
*/
		...
		private void LoadReport_Load(string wilayah, string unit, string kelompok, string rco, string status)
		{
			...
			ReportViewer1.ReportPath = "/SMEReports/DQAControllingCIFKredit&wilayah="+ wilayah + "&unit=" + unit +  "&kelompok=" + kelompok +  "&rco=" + rco + "&status=" + status + "&rs:Command=Render";
		}
