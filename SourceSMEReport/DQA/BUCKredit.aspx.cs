...
{
	/// <summary>
	/// Summary description for BUCKredit.
	/// </summary>
	public partial class BUCKredit : System.Web.UI.Page
	{
		...
		*/
		...
		private void LoadReport_Load(string wilayah, string unit, string kelompok, string rco, string status)
		{
			...
			ReportViewer1.ReportPath = "/SMEReports/DQAControllingBUCKredit&wilayah="+ wilayah + "&unit=" + unit +  "&kelompok=" + kelompok +  "&rco=" + rco + "&status=" + status + "&rs:Command=Render";
		}
