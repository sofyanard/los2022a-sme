...
<%@ Page language="c#" Codebehind="CIFUnclean.aspx.cs" AutoEventWireup="True" Inherits="SME.SourceSMEReport.DQA.CIFUnclean" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>CIFUnclean</title>
					...
					<TR>
						<TD style="HEIGHT: 124px" vAlign="top" align="center" colSpan="2" height="124">
							<TABLE id="Table11" cellSpacing="2" cellPadding="2" width="90%">
								<TBODY>
									<TR>
										<TD class="tdHeader1" colSpan="2">Unclean CIF</TD>
									</TR>
									<TR>
										<TD class="td" style="HEIGHT: 36px" vAlign="top" width="90%">
											<TABLE id="Table6" cellSpacing="0" cellPadding="0" width="100%">
												...
												<TR id="TR_UNIT" runat="server">
													<TD class="TDBGColor1" style="WIDTH: 119px; HEIGHT: 3px">Unit Kerja</TD>
													<TD style="WIDTH: 1px; HEIGHT: 3px"></TD>
													<TD class="TDBGColorValue" style="HEIGHT: 3px"><asp:dropdownlist id="DDL_UNIT" runat="server" AutoPostBack="True" onselectedindexchanged="DDL_UNIT_SelectedIndexChanged"></asp:dropdownlist></TD>
												</TR>
												...
												<TR id="TR_CABANG" runat="server">
													...
													<TD class="TDBGColorValue" style="HEIGHT: 18px">
														<asp:dropdownlist id="DDL_CABANG" runat="server" AutoPostBack="false"></asp:dropdownlist></TD>
												</TR>
												<!--<TR>
