...
<%@ Page language="c#" Codebehind="BUCDana.aspx.cs" AutoEventWireup="True" Inherits="SME.SourceSMEReport.DQA.BUCDana" %>
					...
					<TR>
						<TD style="HEIGHT: 124px" vAlign="top" align="center" colSpan="2" height="124">
							<TABLE id="Table11" cellSpacing="2" cellPadding="2" width="90%">
								<TBODY>
									<TR>
										<TD class="tdHeader1" colSpan="2">Data Rekening Pihak Ketiga</TD>
									</TR>
									<TR>
