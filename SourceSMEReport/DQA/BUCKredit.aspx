...
<%@ Page language="c#" Codebehind="BUCKredit.aspx.cs" AutoEventWireup="True" Inherits="SME.SourceSMEReport.DQA.BUCKredit" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>BUCKredit</title>
					...
					<TR>
						<TD style="HEIGHT: 124px" vAlign="top" align="center" colSpan="2" height="124">
							<TABLE id="Table11" cellSpacing="2" cellPadding="2" width="100%">
								<TBODY>
									<TR>
										<TD class="tdHeader1" colSpan="2">BUC Kredit</TD>
									</TR>
									<TR>
