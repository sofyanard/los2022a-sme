...
{
	/// <summary>
	/// Summary description for CIFDana.
	/// </summary>
	public partial class CIFDana : System.Web.UI.Page
	{
		protected System.Web.UI.WebControls.DropDownList DDL_RCO;
		...
		private void LoadSql(string action)
		{
			...
			//LoadReport_Load(wilayah, unit, area, rco, status);	
			LoadReport_Load(wilayah, unit, area, kelompok, status, cabang);	
		}

		//private void LoadReport_Load(string wilayah, string unit, string area, string rco, string status)
		private void LoadReport_Load(string wilayah, string unit, string area, string kelompok, string status, string cabang)
		{
			string ReportAddr="";
			...
			//ReportViewer1.ReportPath = "/SMEReports/DQAControllingCIFDana&wilayah="+ wilayah + "&unit=" + unit +  "&area=" + area +  "&rco=" + rco + "&status=" + status + "&rs:Command=Render";
			ReportViewer1.ReportPath = "/SMEReports/DQAControllingCIFDana&wilayah="+ wilayah + "&unit=" + unit +  "&area=" + area +  "&kelompok=" + kelompok + "&status=" + status + "&cabang=" + cabang + "&rs:Command=Render";
		}
		...
		{
			fillUnit();
			//GlobalTools.popMessage(this,"Mohon Isi Unit Kerja");
		}
