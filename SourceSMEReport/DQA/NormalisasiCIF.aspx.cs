...
{
	/// <summary>
	/// Summary description for NormalisasiCIF.
	/// </summary>
	public partial class NormalisasiCIF : System.Web.UI.Page
	{
...
//			string unit			= DDL_UNIT.SelectedValue;
			...
			LoadReport_Load(wilayah, area, cabang, kelompok);	//status
		}

		private void LoadReport_Load(string wilayah, string area, string cabang, string kelompok)	//string status
		{
			string ReportAddr="";
			...
			ReportViewer1.ReportPath = "/SMEReports/DQMNormalisasiCIF&wilayah="+ wilayah + "&area=" + area + "&cabang=" + cabang + "&kelompok=" + kelompok + "&rs:Command=Render";	// "&status=" + status
		}
...
/*
		private void DDL_KELOMPOK_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			fillUnit();
		}
