...
{
	/// <summary>
	/// Summary description for BUCDana.
	/// </summary>
	public partial class BUCDana : System.Web.UI.Page
	{
		...
		private void fillStatus() 
		{
			...
			DDL_STATUS.Items.Add(new ListItem("DATA ERROR","ERR"));
		...
		private void LoadReport_Load(string wilayah, string unit, string area, string kelompok, string status, string cabang)
		{
			...
			ReportViewer1.ReportPath = "/SMEReports/DQAControlling&wilayah="+ wilayah + "&unit=" + unit +  "&area=" + area +  "&kelompok=" + kelompok + "&status=" + status + "&cabang=" + cabang + "&rs:Command=Render";
		}
