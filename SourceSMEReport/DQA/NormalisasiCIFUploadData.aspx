<%@ Page language="c#" Codebehind="NormalisasiCIFUploadData.aspx.cs" AutoEventWireup="True" Inherits="SME.SourceSMEReport.DQA.NormalisasiCIFUploadData" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>NormalisasiCIFUploadData</title>
				...
				<TABLE id="Table4" border="0" width="100%">
					<TR>
						<TD align="left">
							<TABLE id="Table3">
								<TR>
									<TD style="WIDTH: 400px" class="tdBGColor2" align="center"><B>Upload Data Normalisasi 
											CIF</B></TD>
								</TR>
							</TABLE>
						</TD>
					...
					<tr>
						<TD align="center"><ASP:DATAGRID id="DATA_TEMPLATE" runat="server" Width="400px" AutoGenerateColumns="False" CellPadding="1"
								...
								<Columns>
									...
									<asp:BoundColumn DataField="NAMA_TEMPLATE" HeaderText="Source File" ItemStyle-Width="350px" ItemStyle-HorizontalAlign="Center">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
									</asp:BoundColumn>
									<asp:TemplateColumn>
						...
						<TD align="center"><ASP:DATAGRID id="DATA_EXPORT" runat="server" Width="473px" AutoGenerateColumns="False" CellPadding="1"
								...
								<AlternatingItemStyle CssClass="TblAlternating"></AlternatingItemStyle>
								<Columns>
									<asp:BoundColumn Visible="True" DataField="ID_UPLOAD_NORMALISASI" HeaderText="No" ItemStyle-Width="10px">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
									</asp:BoundColumn>
									<asp:BoundColumn DataField="FILE_UPLOAD_NORMALISASI" HeaderText="Destination File">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
									</asp:BoundColumn>
									<asp:TemplateColumn>
										<HeaderStyle Width="45px" CssClass="tdSmallHeader"></HeaderStyle>
										...
										<ItemTemplate>
											<asp:HyperLink id="UPL_NORMALISASI_DOWNLOAD" runat="server" Target="_blank">Download</asp:HyperLink>
										</ItemTemplate>
									</asp:TemplateColumn>
									<asp:TemplateColumn>
										<HeaderStyle Width="45px" CssClass="tdSmallHeader"></HeaderStyle>
										...
										<ItemTemplate>
											<asp:LinkButton id="UPL_NORMALISASI_DELETE" runat="server" CommandName="delete">Delete</asp:LinkButton>
										</ItemTemplate>
									</asp:TemplateColumn>
								</Columns>
							</ASP:DATAGRID></TD>
