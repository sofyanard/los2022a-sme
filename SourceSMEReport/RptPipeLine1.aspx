<%@ Page language="c#" Codebehind="RptPipeLine1.aspx.cs" AutoEventWireup="True" Inherits="SME.SourceSMEReport.RptPipeLine1" %>
<%@ Register assembly="Microsoft.ReportViewer.WebForms, Version=10.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a" namespace="Microsoft.Reporting.WebForms" tagprefix="rsweb" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>RptPipeLine1</title>
		...
		<form id="Form1" method="post" runat="server">
			<center>
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					...
					<TR>
						<TD style="HEIGHT: 121px" vAlign="top" align="center" colSpan="2" height="121">
							<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="70%">
								<TBODY>
									<TR>
										<TD class="tdHeader1" colSpan="2">
											<asp:Label id="LBL_RM" runat="server" Visible="False">LBL_RM</asp:Label>PIPELINE&nbsp;REPORT&nbsp;BY 
											CBC/BRANCHES (DETAIL)&nbsp;
									...
									<TR>
										<TD class="td" style="HEIGHT: 36px" vAlign="top" width="70%">
											<TABLE id="Table6" cellSpacing="0" cellPadding="0" width="100%">
												...
												<TR>
													<TD class="TDBGColor1" style="HEIGHT: 5px">Region</TD>
													<TD style="HEIGHT: 5px"></TD>
													<TD class="TDBGColorValue" style="HEIGHT: 5px"><asp:dropdownlist id="DDL_REGION" runat="server" AutoPostBack="True" onselectedindexchanged="DDL_REGION_SelectedIndexChanged"></asp:dropdownlist></TD>
												</TR>
												<TR>
												...
												<TR>
													<TD class="TDBGColor1" style="HEIGHT: 6px">Area</TD>
