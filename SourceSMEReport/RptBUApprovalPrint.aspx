<%@ Page language="c#" Codebehind="RptBUApprovalPrint.aspx.cs" AutoEventWireup="True" Inherits="SME.SourceSMEReport.RptBUApprovalPrint" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>RptBUApprovalPrint</title>
		...
		<form id="Form1" method="post" runat="server">
			<center>
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					<TR>
						<TD class="TitleHeaderReport" align="center">BU APPROVAL REPORT</TD>
					</TR>
					<TR>
					...
					<TR>
						<TD align="center" style="HEIGHT: 57px"><asp:table id="TBL_CONTENT" runat="server" Width="100%" CellSpacing="0" CellPadding="0" BorderWidth="1px"
								...
								<asp:TableRow>
									...
									<asp:TableCell Width="220px" Text="PROGRAM" CssClass="HeaderPrint"></asp:TableCell>
									<asp:TableCell width="100px" Text="#APPL" CssClass="HeaderPrint"></asp:TableCell>
									<asp:TableCell Width="150px" Text="JENIS PENGAJUAN" CssClass="HeaderPrint"></asp:TableCell>
									<asp:TableCell Width="200px" Text="SEKTOR EKONOMI" CssClass="HeaderPrint"></asp:TableCell>
									...
									<asp:TableCell Width="100px" Text="REASON (IF REJECT)" CssClass="HeaderPrint"></asp:TableCell>
									<asp:TableCell Width="100px" Text="APPROVED" CssClass="HeaderPrint"></asp:TableCell>
								</asp:TableRow>
							</asp:table></TD>
					</TR>
					<TR>
