<%@ Page language="c#" Codebehind="RptSLABICKCOBU.aspx.cs" AutoEventWireup="True" Inherits="SourceSMEReport.RptSLABICKCOBU" %>
<%@ Register assembly="Microsoft.ReportViewer.WebForms, Version=10.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a" namespace="Microsoft.Reporting.WebForms" tagprefix="rsweb" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>RptSLABICKCOBU</title>
								...
								<TBODY>
									<TR>
										<TD class="tdHeader1" colSpan="2">
											...
											BI CHECKING FROM CO TO BI REPORT
									...
									<TR>
										<TD class="td" style="HEIGHT: 63px" vAlign="top" width="50%">
											<TABLE id="Table6" cellSpacing="0" cellPadding="0" width="100%">
												<TBODY>
													<TR>
														<TD class="TDBGColor1" style="">CO Request Date</TD>
										</TD>
										<TD style="WIDTH: 15px; "></TD>
										<TD class="TDBGColorValue" style=""><asp:textbox id="TXT_Day1" runat="server" Width="32px" CssClass="mandatory"></asp:textbox><asp:dropdownlist id="DDL_Month1" runat="server" CssClass="mandatory"></asp:dropdownlist><asp:textbox id="TXT_Year1" runat="server" Width="48px" CssClass="mandatory"></asp:textbox>&nbsp;TO
