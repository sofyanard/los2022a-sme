...
{
	/// <summary>
	/// Summary description for RptCollateralCoverage.
	/// </summary>
	public partial class RptCollateralCoverage : System.Web.UI.Page
	{
		...
		private void LoadReport_Load(string businessunit, string area, string branch)
		{
			...
			ReportViewer1.ReportPath = "/SMEReports/RptDashboardCollateralCoverage&businessunit=" + businessunit +  "&area=" + area + "&branch=" + branch + "&rs:Command=Render";
		}
