...
{
	/// <summary>
	/// Summary description for RptRatingProcess.
	/// </summary>
	public partial class RptRatingProcess : System.Web.UI.Page
	{
		...
		private void LoadReport_Load(string tanggal1, string tanggal2, string area, string branch)
		{
			...
			ReportViewer1.ReportPath = "/SMEReports/RptDashboardRatingProcess&date1="+ tanggal1 + "&date2=" + tanggal2 +  "&area=" + area + "&branch=" + branch + "&rs:Command=Render";
		}
