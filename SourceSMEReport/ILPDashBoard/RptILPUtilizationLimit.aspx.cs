...
{
	/// <summary>
	/// Summary description for RptILPUtilizationLimit.
	/// </summary>
	public partial class RptILPUtilizationLimit : System.Web.UI.Page
	{
		...
		private void LoadReport_Load(string tanggal1, string tanggal2, string businessunit, string area, string branch)
		{
			...
			ReportViewer1.ReportPath = "/SMEReports/RptDashboardTATLimit&date1="+ tanggal1 + "&date2=" + tanggal2 + "&businessunit=" + businessunit +  "&area=" + area + "&branch=" + branch + "&rs:Command=Render";
		}
