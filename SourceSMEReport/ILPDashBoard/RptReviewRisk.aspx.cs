...
{
	/// <summary>
	/// Summary description for RptReviewRisk.
	/// </summary>
	public partial class RptReviewRisk : System.Web.UI.Page
	{
		...
		private void LoadReport_Load(string tanggal1, string tanggal2, string area, string branch)
		{
			...
			ReportViewer1.ReportPath = "/SMEReports/RptDashboardReviewRisk&date1="+ tanggal1 + "&date2=" + tanggal2 +  "&area=" + area + "&branch=" + branch + "&rs:Command=Render";
		}
