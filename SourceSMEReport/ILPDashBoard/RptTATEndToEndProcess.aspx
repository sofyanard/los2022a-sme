<%@ Page language="c#" Codebehind="RptTATEndToEndProcess.aspx.cs" AutoEventWireup="True" Inherits="SME.SourceSMEReport.ILPDashBoard.RptTATEndToEndProcess" %>
<%@ Register TagPrefix="cc1" Namespace="Microsoft.Samples.ReportingServices" Assembly="ReportViewer" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>RptTATEndToEndProcess</title>
					...
					<TR>
						<TD style="HEIGHT: 124px" vAlign="top" align="center" colSpan="2" height="124">
							<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="70%">
								<TR>
									<TD class="tdHeader1" colSpan="2">TAT END TO END PROCESS&nbsp;
								...
								<TR>
									<TD class="td" style="HEIGHT: 36px" vAlign="top" width="70%">
										<TABLE id="Table6" cellSpacing="0" cellPadding="0" width="100%">
											...
											<TR>
												<TD class="TDBGColor1" style="HEIGHT: 13px">Region/Group</TD>
											...
											<TR>
												...
												<TD style="HEIGHT: 13px"></TD>
												<TD class="TDBGColorValue" style="HEIGHT: 13px"><asp:dropdownlist id="DDL_PROTYPE" runat="server"></asp:dropdownlist></TD>
											</TR>
											<TR>
