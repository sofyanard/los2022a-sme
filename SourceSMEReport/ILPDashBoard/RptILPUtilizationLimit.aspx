<%@ Page language="c#" Codebehind="RptILPUtilizationLimit.aspx.cs" AutoEventWireup="True" Inherits="SME.SourceSMEReport.ILPDashBoard.RptILPUtilizationLimit" %>
<%@ Register TagPrefix="cc1" Namespace="Microsoft.Samples.ReportingServices" Assembly="ReportViewer" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>RptILPUtilizationLimit</title>
					...
					<TR>
						<TD style="HEIGHT: 124px" vAlign="top" align="center" colSpan="2" height="124">
							<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="70%">
								<TR>
									<TD class="tdHeader1" colSpan="2">ILP UTILIZATION (PERUBAHAN LIMIT)&nbsp;
									...
									<TD class="td" style="HEIGHT: 36px" vAlign="top" width="70%">
										<TABLE id="Table6" cellSpacing="0" cellPadding="0" width="100%">
											...
											<TR>
												...
												<TD class="TDBGColorValue" style="HEIGHT: 11px"><asp:dropdownlist id="DDL_BUSINESSUNIT" runat="server" AutoPostBack="false" CssClass="mandatory"></asp:dropdownlist></TD>
											</TR>
											<TR>
												<TD class="TDBGColor1" style="HEIGHT: 2px">Region</TD>
												<TD style="HEIGHT: 2px"></TD>
												<TD class="TDBGColorValue" style="HEIGHT: 2px"><asp:dropdownlist id="DDL_AREA" runat="server" AutoPostBack="True" onselectedindexchanged="DDL_AREA_SelectedIndexChanged"></asp:dropdownlist></TD>
											</TR>
											<TR>
