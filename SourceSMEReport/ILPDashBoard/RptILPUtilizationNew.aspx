<%@ Page language="c#" Codebehind="RptILPUtilizationNew.aspx.cs" AutoEventWireup="True" Inherits="SME.SourceSMEReport.ILPDashBoard.RptILPUtilizationNew" %>
<%@ Register TagPrefix="cc1" Namespace="Microsoft.Samples.ReportingServices" Assembly="ReportViewer" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>RptILPUtilizationNew</title>
					...
					<TR>
						<TD style="HEIGHT: 124px" vAlign="top" align="center" colSpan="2" height="124">
							<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="70%">
								<TR>
									<TD class="tdHeader1" colSpan="2">ILP UTILIZATION (PERMOHONAN BARU)&nbsp;
								...
								<TR>
									<TD class="td" style="HEIGHT: 36px" vAlign="top" width="70%">
										<TABLE id="Table6" cellSpacing="0" cellPadding="0" width="100%">
											...
											<TR>
												<TD class="TDBGColor1" style="HEIGHT: 4px">Region</TD>
