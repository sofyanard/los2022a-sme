...
<%@ Page language="c#" Codebehind="RptOverallSLA.aspx.cs" AutoEventWireup="True" Inherits="SME.SourceSMEReport.ILPDashBoard.RptOverallSLA" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>RptOverallSLA</title>
								...
								<TR>
									<TD class="td" style="HEIGHT: 36px" vAlign="top" width="70%">
										<TABLE id="Table6" cellSpacing="0" cellPadding="0" width="100%">
											<TR>
												<TD class="TDBGColor1" style="HEIGHT: 18px">Initial Data Entry Date</TD>
											...
											<TR>
												<TD class="TDBGColor1" style="HEIGHT: 11px">Segment</TD>
											...
											<TR>
												...
												<TD class="TDBGColorValue" style="HEIGHT: 4px"><asp:dropdownlist id="DDL_AREA" runat="server" AutoPostBack="True"></asp:dropdownlist></TD>
											</TR>
											<TR>
											...
											<TR>
												<TD class="TDBGColor1" style="HEIGHT: 13px">Process Type</TD>
												<TD style="HEIGHT: 13px"></TD>
												<TD class="TDBGColorValue" style="HEIGHT: 13px"><asp:dropdownlist id="DDL_PROTYPE" runat="server" AutoPostBack="True"></asp:dropdownlist></TD>
											</TR>
											<TR>
												<TD class="TDBGColor1" style="HEIGHT: 3px">Application Type</TD>
												<TD style="HEIGHT: 3px"></TD>
												<TD class="TDBGColorValue" style="HEIGHT: 3px"><asp:dropdownlist id="DDL_APPTYPE" runat="server" AutoPostBack="false"></asp:dropdownlist></TD>
											</TR>
