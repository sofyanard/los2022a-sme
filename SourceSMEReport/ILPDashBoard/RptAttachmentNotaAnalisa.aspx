...
<%@ Page language="c#" Codebehind="RptAttachmentNotaAnalisa.aspx.cs" AutoEventWireup="True" Inherits="SME.SourceSMEReport.ILPDashBoard.RptAttachmentNotaAnalisa" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>RptAttachmentNotaAnalisa</title>
					...
					<TR>
						<TD style="HEIGHT: 124px" vAlign="top" align="center" colSpan="2" height="124">
							<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="400" style="HEIGHT: 167px">
								<TR>
									<TD class="tdHeader1" colSpan="2">ATTACHMENT NOTA ANALISA&nbsp;
								...
								<TR>
									<TD class="td" style="HEIGHT: 36px" vAlign="top" width="70%">
										<TABLE id="Table6" cellSpacing="0" cellPadding="0" width="500">
											...
											<TR>
												<TD class="TDBGColor1" style="WIDTH: 171px">Area</TD>
												<TD style="WIDTH: 1px"></TD>
											...
											<TR>
												...
												<TD style="WIDTH: 1px"></TD>
												<TD class="TDBGColorValue"><asp:dropdownlist id="DDL_UNIT" runat="server" AutoPostBack="false"></asp:dropdownlist></TD>
											</TR>
