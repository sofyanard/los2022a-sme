...
{
	/// <summary>
	/// Summary description for RptPRRKPreparation.
	/// </summary>
	public partial class RptPRRKPreparation : System.Web.UI.Page
	{
		...
		private void Load_ReportViewer(string action,string sql_kondisi, string Start_Date, string End_Date, string region, string CBC, string Branch, string PS, string teamleader)
		{
			/*
			...
			*/
            ...
            {
                //ReportViewer1.ReportPath = "/SMEReports/RptPRRKPreparation&sql_kondisi=" + Server.HtmlEncode(sql_kondisi) + "&Start_Date=" + tanggal1 + "&End_Date=" + tanggal2 + "&AREA=" + region + "&CBC=" + CBC + "&BRANCH=" + Branch + "&PS=" + PS + "&teamleader=" + teamleader + "&rs:Command=Render&rc:Toolbar=True";
                ...
                ReportViewer1.ServerReport.ReportPath = "/SMEReports/RptPRRKPreparation";
                ...
                Response.Redirect("RptPRRKPreparationPrint.aspx?sql_kondisi=" + sql_kondisi.Replace("'", "''") + "&Start_Date=" + tanggal1 + "&End_Date=" + tanggal2 + "&region=" + region + "&cbc=" + CBC + "&branch=" + Branch + "&PS=" + PS + "&teamleader=" + teamleader);
		}
		...
		private void LoadSql(string action)
		{
			...
			if (Tools.isDateValid(this,TXT_TGL1.Text,DDL_BLN1.SelectedValue,TXT_THN1.Text)&&Tools.isDateValid(this, TXT_TGL2.Text,DDL_BLN2.SelectedValue,TXT_THN2.Text))
			{
				...
				*/
				...
				Load_ReportViewer(action,kriterianya, tanggal1,tanggal2,region, cbc,branch, PS,teamleader);
			}
			else
			{
