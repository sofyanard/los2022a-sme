<%@ Page language="c#" Codebehind="RptPortfolioDebtor.aspx.cs" AutoEventWireup="True" Inherits="SME.SourceSMEReport.RptPortfolioDebtor" %>
<%@ Register TagPrefix="cc1" Namespace="Microsoft.Samples.ReportingServices" Assembly="ReportViewer" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>RptPortfolioDebtor</title>
							...
							<TABLE id="Table6" cellSpacing="2" cellPadding="2" width="500">
								<TR>
									<TD class="tdHeader1">
										...
										<asp:Label id="LBL_REGION" runat="server" Visible="False">LBL_REGION</asp:Label>PORTFOLIO&nbsp;SHARE 
										TOP 25 DEBTOR
