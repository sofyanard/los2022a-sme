...
{
	/// <summary>
	/// Summary description for RptPipeLinePerProduct.
	/// </summary>
	public partial class RptPipeLinePerProduct : System.Web.UI.Page
	{
			...
			*/
			{
                ...
                */
                ...
                {
                    /*
                    ReportViewer1.ReportPath = "/SMEReports/RptPipeLinePerProductDetail" +
                    ...
                    */
                    ...
                    ReportViewer1.ServerReport.ReportPath = "/SMEReports/RptPipeLinePerProductDetail";
                    ...
                    Response.Redirect("RptPipeLinePerProductDetailPrint.aspx?sql_kondisi=" + sql_kondisi.Replace("'", "''") + "&JProduct=" + JProduct + "&BU=" + businessunit);
			}
		}
