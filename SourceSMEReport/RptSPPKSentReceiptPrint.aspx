<%@ Page language="c#" Codebehind="RptSPPKSentReceiptPrint.aspx.cs" AutoEventWireup="True" Inherits="SME.SourceSMEReport.RptSPPKSentReceiptPrint" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>RptSPPKSentReceiptPrint</title>
		...
		<form id="Form1" method="post" runat="server">
			<center>
				<TABLE id="Table1" cellSpacing="2" cellPadding="2">
					<TR>
						<TD>
							<P align="center"><B> SLA -&nbsp;SPPK SENT AND RECEIVED REPORT</B></P>
						</TD>
					</TR>
					<TR>
