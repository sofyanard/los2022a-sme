...
{
	/// <summary>
	/// Summary description for RpttSLAAggrMntrPrint.
	/// </summary>
	public partial class RpttSLAAggrMntrPrint : System.Web.UI.Page
	{
		...
		private void loadData(string sql_kondisi, string Start_Date, string End_Date,string region, string cbc, string branch, string teamleader)
		{
			...
			Conn.QueryString = "exec RPT_AGSIGNINGMNTR '" + sql_kondisi + "' ";
