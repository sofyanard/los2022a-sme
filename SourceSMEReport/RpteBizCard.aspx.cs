...
{
	/// <summary>
	/// Summary description for RpteBizCard.
	/// </summary>
	public partial class RpteBizCard : System.Web.UI.Page
	{
		...
		private void Load_ReportViewer(string action,string sql_kondisi, string Start_Date, string End_Date, string region, string CBC, string branch)
		{
			...
			*/
            ...
            {
                //ReportViewer1.ReportPath = "/SMEReports/RptEbizCard&sql_kondisi=" + sql_kondisi + "&Start_Date=" + tanggal1 + "&End_Date=" + tanggal2 + "&region=" + region + "&CBC=" + CBC + "&branch=" + branch + "&rs:Command=Render&rc:Toolbar=True";
                ReportViewer1.ServerReport.ReportPath = "/SMEReports/RptEbizCard";
                ...
                Response.Redirect("RpteBizCardPrint.aspx?sql_kondisi=" + sql_kondisi.Replace("'", "''") + "&Start_Date=" + tanggal1 + "&End_Date=" + tanggal2 + "&Region=" + region + "&CBC=" + CBC + "&Branch=" + branch);
		}
			...
			*/
			{
				...
				Load_ReportViewer(action,kriterianya, tanggal1, tanggal2,region, cbc,branch);
			}
		}
