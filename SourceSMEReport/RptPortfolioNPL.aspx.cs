...
{
	/// <summary>
	/// Summary description for RptPortfolioNPL.
	/// </summary>
	public partial class RptPortfolioNPL : System.Web.UI.Page
	{
		...
		{	
			...
			ReportViewer1.ReportPath = "/SMEReports/RptPortfolioNPL&industry=" + industry + "&segment=" + segment +  "&buc=" + buc + "&rs:Command=Render&rc:Toolbar=True";
		}
