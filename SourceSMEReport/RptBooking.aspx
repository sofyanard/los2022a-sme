<%@ Page language="c#" Codebehind="RptBooking.aspx.cs" AutoEventWireup="True" Inherits="SourceSMEReport.RptBooking" %>
<%@ Register assembly="Microsoft.ReportViewer.WebForms, Version=10.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a" namespace="Microsoft.Reporting.WebForms" tagprefix="rsweb" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>RptBooking</title>
		...
		<form id="Form1" method="post" runat="server">
			<center>
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					...
					<tr>
						<td vAlign="top" align="center" colSpan="2" style="HEIGHT: 237px">
							<TABLE id="Table6" height="160" cellSpacing="2" cellPadding="2" width="500">
								<TR>
									<TD class="tdHeader1" colSpan="2"><asp:label id="LBL_AREA" runat="server" Visible="False"></asp:label><asp:label id="LBL_RM" runat="server" Visible="False"></asp:label><asp:label id="LBL_CBC" runat="server" Visible="False"></asp:label><asp:label id="LBL_BRANCH" runat="server" Visible="False"></asp:label>BOOKING 
										REPORT
										<asp:Label id="Label1" runat="server" Visible="False">Label</asp:Label>
										<asp:Label id="LBL_BU" runat="server">LBL_BU</asp:Label></TD>
								</TR>
								<TR>
									<TD class="td" style="HEIGHT: 137px" vAlign="top">
										<TABLE id="Table6" cellSpacing="0" cellPadding="0" width="100%">
											<TR>
												<TD class="TDBGColor1" width="100">Periode</TD>
												<TD style="WIDTH: 15px"></TD>
												<TD class="TDBGColorValue"><asp:textbox onkeypress="return numbersonly()" id="TXT_TGL1" runat="server" Columns="2" CssClass="mandatory"
											...
											<TR>
												<TD class="TDBGColor1" style="HEIGHT: 13px">Aea</TD>
												<TD style="HEIGHT: 13px"></TD>
												<TD class="TDBGColorValue" style="HEIGHT: 13px"><asp:dropdownlist id="DDL_CBC" runat="server" AutoPostBack="True" onselectedindexchanged="DDL_CBC_SelectedIndexChanged"></asp:dropdownlist></TD>
											</TR>
											<TR>
												<TD class="TDBGColor1" style="HEIGHT: 22px">Branch</TD>
												<TD style="HEIGHT: 22px"></TD>
												<TD class="TDBGColorValue" style="HEIGHT: 22px"><asp:dropdownlist id="DDL_BRANCH" runat="server" AutoPostBack="True" onselectedindexchanged="DDL_BRANCH_SelectedIndexChanged"></asp:dropdownlist><asp:label id="LBL_STATUS" runat="server" Visible="False">0</asp:label></TD>
