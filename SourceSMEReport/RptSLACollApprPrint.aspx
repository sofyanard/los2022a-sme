<%@ Page language="c#" Codebehind="RptSLACollApprPrint.aspx.cs" AutoEventWireup="True" Inherits="SME.SourceSMEReport.RptSLACollApprPrint" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>RptSLACollApprPrint</title>
		...
		<form id="Form1" method="post" runat="server">
			<center>
				<TABLE id="Table1" cellSpacing="2" cellPadding="2">
					<TR>
						<TD>
							<P align="center"><B>COLLATERAL APPRAISAL FROM BU TO CO REPORT</B></P>
						</TD>
					</TR>
					<TR>
					...
					<TR>
						<TD class="tdNoBorder">
							<asp:table id="TBL_CONTENT" runat="server" CellSpacing="0" CellPadding="0" BorderWidth="1px"
