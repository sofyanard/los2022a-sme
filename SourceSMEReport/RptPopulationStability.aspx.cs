...
{
	/// <summary>
	/// Summary description for RptPopulationStability.
	/// </summary>
	public partial class RptPopulationStability : System.Web.UI.Page
	{
		...
		private void Load_ReportViewer(string ddl_tahun)
		{
			...
			sql_kondisi += " and A.year between " + start_year.ToString() + " and " + end_year.ToString(); 
			...
			ReportViewer1.ReportPath = "/SMEReports/RptPopStability&sql_kondisi=" + Server.HtmlEncode(sql_kondisi) + "&tahun=" + ddl_tahun + "&rs:Command=Render&rc:Toolbar=True";
		}
		...
		private void Load_ReportPrint(string ddl_tahun)
		{
			...
			start_year = double.Parse(ddl_tahun.ToString())-3;
			sql_kondisi += " and A.year between " + start_year.ToString() + " and " + end_year.ToString(); 
			Response.Redirect("RptPopulationStabilityPrint.aspx?sql_kondisi=" + Server.HtmlEncode(sql_kondisi) + "&start_year=" + start_year + "&end_year=" + end_year);
		}
