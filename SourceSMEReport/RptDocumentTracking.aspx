<%@ Page language="c#" Codebehind="RptDocumentTracking.aspx.cs" AutoEventWireup="True" Inherits="SME.SourceSMEReport.RptDocumentTracking" %>
<%@ Register assembly="Microsoft.ReportViewer.WebForms, Version=10.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a" namespace="Microsoft.Reporting.WebForms" tagprefix="rsweb" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>RptDocumentTracking</title>
					...
					<tr>
						<td vAlign="top" align="center" colSpan="2">
							<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="550">
								<TR>
									<TD class="tdHeader1">DOCUMENT TRACKING REPORT
								...
								</TR> <!-- Additional Field : Right --> <!-- Additional Field : Right -->
							</TABLE>
						</td>
					</tr>
					<TR>
