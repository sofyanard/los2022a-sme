<%@ Page language="c#" Codebehind="RptDisbursementBranchPrint.aspx.cs" AutoEventWireup="True" Inherits="SME.SourceSMEReport.RptDisbursementBranchPrint" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>RptDisbursementBranchPrint</title>
		...
		<form id="Form1" method="post" runat="server">
			<center>
				<TABLE id="Table1" cellSpacing="2" cellPadding="2">
					<TR>
						<TD><P align="center"><B>DISBURSEMENT REPORT BY Kantor Pusat/Kanwil, BRANCHES</B></P>
						</TD>
					</TR>
					<TR>
					...
					<TR>
						<TD class="tdNoBorder">
							<asp:Table id="TBL_CONTENT" runat="server" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px"
								...
								<asp:TableRow>
									<asp:TableCell Width="300px" ColumnSpan ="2" Text="Kantor Pusat/Kanwil/Branch" CssClass="HeaderPrint_d"></asp:TableCell>
