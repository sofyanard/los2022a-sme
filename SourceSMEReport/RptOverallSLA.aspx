<%@ Page language="c#" Codebehind="RptOverallSLA.aspx.cs" AutoEventWireup="True" Inherits="SME.SourceSMEReport.RptOverallSLA" %>
				...
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					...
					<TR>
						<TD vAlign="top" colSpan="2" align="center" style="HEIGHT: 204px">
							<TABLE id="Table6" cellSpacing="2" cellPadding="2" width="500">
								<TR>
									<TD class="tdHeader1">
										...
										<asp:Label id="LBL_RM" runat="server" Visible="False">LBL_RM</asp:Label>
									</TD>
								</TR>
								<TR>
								...
								<TR>
									<TD class="TDBGColor1" style="HEIGHT: 12px">Region</TD>
								...
								<TR>
									<TD class="TDBGColor1" style="HEIGHT: 18px">CBC</TD>
								...
								<TR>
									...
									<TD class="TDBGColorValue">
										<asp:DropDownList id="DDL_PROGRAM" runat="server"></asp:DropDownList></TD>
								</TR>
								<TR>
							...
							<asp:DropDownList id="DDL_AREA" runat="server" Visible="False" AutoPostBack="True"></asp:DropDownList>
						</TD>
					</TR>
					<TR>
