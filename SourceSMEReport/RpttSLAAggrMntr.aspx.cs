...
{
	/// <summary>
	/// Summary description for RpttSLAAggrMntr.
	/// </summary>
	public partial class RpttSLAAggrMntr : System.Web.UI.Page
	{
		...
		private void Load_ReportViewer(string sql_kondisi, string Start_Date, string End_Date, string region, string CBC, string Branch, string teamleader)
		{
			...
			*/
            ...
            //ReportViewer1.ReportPath = "/SMEReports/RptSLAAgrMntr&sql_kondisi=" + sql_kondisi + "&Start_Date=" + tanggal1 + "&End_Date=" + tanggal2 + "&region=" + region + "&CBC=" + CBC + "&BRANCH=" + Branch + "&teamleader=" + teamleader + "&rs:Command=Render&rc:Toolbar=True";
            ...
            ReportViewer1.ServerReport.ReportPath = "/SMEReports/RptSLAAgrMntr";
		...
		private void LoadSql(string action)
		{
			...
			*/
			{
				kriterianya=" and convert(nvarchar, ap_signdate, 112) between " + tanggal1_k + " and "  + tanggal2_k + " ";
				if(!branch.Equals(""))
				{
				...
				if (!action.Equals("PRINT"))
					...
					Response.Redirect("RpttSLAAggrMntrPrint.aspx?sql_kondisi=" + kriterianya.Replace("'","''") + "&Start_Date=" + tanggal1 + "&End_Date=" + tanggal2 + "&region=" + region + "&cbc=" + cbc + "&branch=" + branch + "&teamleader=" + teamleader);
			}
		}
