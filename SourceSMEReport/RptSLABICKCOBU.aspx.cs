...
{
	/// <summary>
	/// Summary description for RptSLABICKCOBU.
	/// </summary>
	public partial class RptSLABICKCOBU : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			if (!IsPostBack)
			{
				...
				fillRegion();
                /*
				Conn.QueryString = "Delete from TMP_REPORT_SLABICKCOBU where userid='" + Session["UserID"].ToString() + "'";
				Conn.ExecuteQuery();
                */
			}
		}
		...
		private void Load_ReportViewer(string Start_Date, string End_Date, string region, string CBC, string Branch, string teamleader)
		{
			...
			*/
            ...
            //ReportViewer1.ReportPath = "/SMEReports/SLABICheckingCOBU&userid=" + Session["UserID"].ToString() + "&Start_Date=" + tanggal1 + "&End_Date=" + tanggal2 + "&area=" + region + "&CBC=" + CBC + "&BRANCH=" + Branch + "&teamleader=" + teamleader + "&rs:Command=Render&rc:Toolbar=True";
            ...
            ReportViewer1.ServerReport.ReportPath = "/SMEReports/SLABICheckingCOBU";
			...
			*/
			{
                ...
                */
				...
				Conn.QueryString = "exec RPT_SLA_BICHECKCOBU '" + Session["UserID"].ToString() + "','" + tanggal1_k + "','" + tanggal2_k + "','" + kriterianya + "'";
				Conn.ExecuteQuery(1800);
				if (!action.Equals("PRINT"))
					Load_ReportViewer(tanggal1,tanggal2,region, cbc,branch, teamleader);
				else
					Response.Redirect("RptSLABICKCOBUPrint.aspx?userid=" + Session["UserID"].ToString() + "&tanggal1=" + tanggal1 + "&tanggal2=" + tanggal2 + "&region=" + region + "&cbc=" + cbc + "&branch=" + branch + "&teamleader=" + teamleader);
			}
		}
		...
		{
			fillCBC();
			//			GetCBC(DDL_REGION.SelectedValue);
			//GetBranch("RG",DDL_REGION.SelectedValue);
		}
