...
{
	/// <summary>
	/// Summary description for RptPortfolioBUC.
	/// </summary>
	public partial class RptPortfolioBUC : System.Web.UI.Page
	{
...
*/
			ReportViewer1.ReportPath = "/SMEReports/RptPortfolioBUC&industry=" + industry + "&segment=" + segment +  "&buc=" + buc + "&rs:Command=Render&rc:Toolbar=True";
		}
