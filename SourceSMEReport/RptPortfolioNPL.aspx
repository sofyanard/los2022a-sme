...
<%@ Page language="c#" Codebehind="RptPortfolioNPL.aspx.cs" AutoEventWireup="True" Inherits="SME.SourceSMEReport.RptPortfolioNPL" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>RptPortfolioNPL</title>
									...
									<TD class="td" vAlign="top">
										<TABLE id="Table6" cellSpacing="0" cellPadding="0" width="100%">
											<TBODY>
												...
												<TR>
													<TD class="TDBGColor1" style="WIDTH: 236px">BUC</TD>
													<TD style="WIDTH: 15px"></TD>
