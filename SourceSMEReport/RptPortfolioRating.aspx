<%@ Page language="c#" Codebehind="RptPortfolioRating.aspx.cs" AutoEventWireup="True" Inherits="SME.SourceSMEReport.RptPortfolioRating" %>
<%@ Register TagPrefix="cc1" Namespace="Microsoft.Samples.ReportingServices" Assembly="ReportViewer" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>RptPortfolioRating</title>
							...
							<TABLE id="Table6" cellSpacing="2" cellPadding="2" width="500">
								<TR>
									<TD class="tdHeader1">
										...
										<asp:Label id="LBL_REGION" runat="server" Visible="False">LBL_REGION</asp:Label>PORTFOLIO&nbsp;INDUSTRY 
										vs RATING/SCORING RESULT
								...
								<TR>
									...
									<TD class="TDBGColorValue" style="HEIGHT: 15px"><asp:textbox id="TXT_TGL1" runat="server" Width="30px"></asp:textbox><asp:dropdownlist id="DDL_BLN1" runat="server"></asp:dropdownlist><asp:textbox id="TXT_THN1" runat="server" Width="40px"></asp:textbox></TD>
