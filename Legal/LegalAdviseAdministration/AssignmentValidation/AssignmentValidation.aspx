<%@ Page language="c#" Codebehind="AssignmentValidation.aspx.cs" AutoEventWireup="True" Inherits="SME.Legal.LegalAdviseAdministration.AssigmentValidation.Main" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<TITLE>AssignmentValidation</TITLE>
		...
		<FORM id="Form1" method="post" runat="server">
			<CENTER>
				<TABLE width="100%" border="0">
					...
					<TR>
						<TD class="tdHeader1" colSpan="2">DOCUMENT<asp:label id="TXT_XLSNAME" Runat="server" Visible="False"></asp:label></TD>
					</TR>
					<TR>
						<TD class="td" style="HEIGHT: 7px" vAlign="top" width="50%">
							<TABLE id="Table4" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									...
									<TD align="right" width="10%"><asp:button id="BTN_INSERT_DOC" runat="server" Width="100%" Font-Bold="True" Text="Insert"></asp:button></TD>
								</TR>
								<TR>
									<TD></TD>
								</TR>
										...
										<TABLE cellSpacing="0" cellPadding="0" width="100%">
											...
											<TR>
												...
												<TD class="TDBGColorValue" width="50%"><asp:label id="LBL_STATUS" runat="server" ForeColor="Red"></asp:label><asp:regularexpressionvalidator id="RegularExpressionValidator1" runat="server" ControlToValidate="TXT_FILE_UPLOAD"
														ErrorMessage="Only xls, doc, txt, pdf, docx, xlsx or zip files are allowed!" ValidationExpression="^(([a-zA-Z]:)|(\\{2}\w+)\$?)(\\(\w[\w].*))+(.xls|.XLS|.doc|.DOC|.txt|.TXT|.zip|.ZIP|.pdf|.PDF|.docx|.DOCX|.xlsx|.XLSX|)$"></asp:regularexpressionvalidator></TD>
											</TR>
											<TR>
												<TD></TD>
						...
						<TD class="td" style="HEIGHT: 7px" vAlign="top" width="50%">
							<TABLE id="Table6" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									...
									<TD class="TDBGColorValue" width="50%"><asp:dropdownlist id="DDL_LEGAL_OFFICER" runat="server" Width="100%"></asp:dropdownlist></TD>
								</TR>
							</TABLE>
						</TD>
						<TD class="td" style="HEIGHT: 7px" vAlign="top" width="50%">
							<TABLE id="Table7" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									<TD align="left" colSpan="3"><asp:button id="BTN_ASSIGN" runat="server" Width="100px" Text="ASSIGN" CssClass="button1" onclick="BTN_ASSIGN_Click"></asp:button>&nbsp;&nbsp;
										<asp:button id="BTN_CANCEL_ASSIGN" runat="server" Width="100px" Text="CANCEL" CssClass="button1"
											Enabled="False" onclick="BTN_CANCEL_ASSIGN_Click"></asp:button></TD>
								</TR>
							</TABLE>
						</TD>
					</TR>
