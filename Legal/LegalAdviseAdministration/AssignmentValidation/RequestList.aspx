<%@ Page language="c#" Codebehind="RequestList.aspx.cs" AutoEventWireup="True" Inherits="SME.Legal.LegalAdviseAdministration.AssigmentValidation.RequestList" %>
								...
								<Columns>
									...
									<asp:TemplateColumn HeaderText="Function">
										...
										<ItemTemplate>
											...
											<asp:LinkButton id="LNK_UPDATE" runat="server" CommandName="update">Update Status</asp:LinkButton>
										</ItemTemplate>
									</asp:TemplateColumn>
									<asp:BoundColumn DataField="AP_CURRTRACK" Visible="False">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
									</asp:BoundColumn>
									...
									<asp:BoundColumn DataField="PROCESS_STATUS" Visible="False">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
									</asp:BoundColumn>
								</Columns>
