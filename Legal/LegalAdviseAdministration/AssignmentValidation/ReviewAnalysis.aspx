<%@ Page language="c#" Codebehind="ReviewAnalysis.aspx.cs" AutoEventWireup="True" Inherits="SME.Legal.LegalAdviseAdministration.AssigmentValidation.ReviewAnalysis" %>
		...
		<FORM id="Form1" method="post" runat="server">
			<CENTER>
				<TABLE width="100%" border="0">
					...
					<TR>
						<TD class="tdHeader1" colSpan="2">RESULT<asp:label id="TXT_XLSNAME" Visible="False" Runat="server"></asp:label></TD>
					</TR>
					<TR>
						<TD class="td" style="HEIGHT: 7px" vAlign="top" width="50%">
							<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									...
									<TD class="TDBGColorValue"><asp:textbox id="TXT_SUMMARY_ADVIS" runat="server" Height="40px" TextMode="MultiLine" Width="100%"></asp:textbox></TD>
								</TR>
								<TR>
									...
									<TD class="TDBGColorValue" colSpan="2"><asp:textbox onkeypress="return numbersonly()" id="TXT_TGL_SELESAI_DAY" runat="server" Width="24px"
											Columns="4" MaxLength="2"></asp:textbox><asp:dropdownlist id="DDL_TGL_SELESAI_MONTH" runat="server"></asp:dropdownlist><asp:textbox onkeypress="return numbersonly()" id="TXT_TGL_SELESAI_YEAR" runat="server" Width="36px"
						...
						<TD class="td" style="HEIGHT: 7px" vAlign="top" width="50%"><ASP:DATAGRID id="DATA_EXPORT" runat="server" Width="100%" AllowPaging="True" CellPadding="1"
					...
					<TR>
						<TD class="TDBGColor2" vAlign="top" align="center" colSpan="3" height="10"><asp:label id="LBL_SEQ" runat="server" Visible="false"></asp:label><asp:button id="BTN_SAVE" runat="server" Width="100px" Text="SAVE" CssClass="button1" onclick="BTN_SAVE_Click"></asp:button></TD>
					</TR>
				</TABLE>
			</CENTER>
		</FORM>
