<%@ Page language="c#" Codebehind="ReviewAnalysis.aspx.cs" AutoEventWireup="True" Inherits="SME.Legal.LegalAdviseAdministration.ReviewAnalysis.ReviewAnalysis" %>
				...
				<TABLE width="100%" border="0">
						...
						<TD class="td" style="HEIGHT: 7px" vAlign="top" width="50%">
							<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									...
									<TD class="TDBGColorValue"><asp:textbox id="TXT_SUMMARY_ADVIS" runat="server" Width="100%" TextMode="MultiLine" Height="40px"></asp:textbox></TD>
								</TR>
								<TR>
									...
									<TD class="TDBGColorValue" colSpan="2"><asp:textbox onkeypress="return numbersonly()" id="TXT_TGL_SELESAI_DAY" runat="server" Width="24px"
											MaxLength="2" Columns="4"></asp:textbox><asp:dropdownlist id="DDL_TGL_SELESAI_MONTH" runat="server"></asp:dropdownlist><asp:textbox onkeypress="return numbersonly()" id="TXT_TGL_SELESAI_YEAR" runat="server" Width="36px"
					...
					<TR>
						<TD class="TDBGColor2" vAlign="top" align="center" colSpan="3" height="10">
							...
							<asp:button id="BTN_UPDATE" runat="server" Text="UPDATE STATUS" CssClass="button1" Enabled="False" onclick="BTN_UPDATE_Click"></asp:button>
						</TD>
					</TR>
				</TABLE>
			</CENTER>
