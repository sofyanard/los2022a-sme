<%@ Page language="c#" Codebehind="DetailRequestInfo.aspx.cs" AutoEventWireup="True" Inherits="SME.Legal.LegalAdviseAdministration.InquiryHistoricalData.DetailRequestInfo" %>
					...
					<TR>
						<TD class="td" style="HEIGHT: 7px" vAlign="top" width="50%">
							<TABLE id="Table7" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									...
									<TD class="TDBGColorValue" width="50%"><asp:textbox id="TXT_NOTA_KIRIM" runat="server" Width="100%" Enabled="False"></asp:textbox></TD>
								</TR>
								<TR>
									...
									<TD class="TDBGColorValue" colSpan="2"><asp:textbox onkeypress="return numbersonly()" id="TXT_TGL_KIRIM_DAY" runat="server" Width="24px"
											MaxLength="2" Columns="4" Enabled="False"></asp:textbox><asp:dropdownlist id="DDL_TGL_KIRIM_MONTH" runat="server" Enabled="False"></asp:dropdownlist><asp:textbox onkeypress="return numbersonly()" id="TXT_TGL_KIRIM_YEAR" runat="server" Width="36px"
											MaxLength="4" Columns="4" Enabled="False"></asp:textbox></TD>
								</TR>
							</TABLE>
						</TD>
						<TD class="td" style="HEIGHT: 7px" vAlign="top" width="50%">
							<TABLE id="Table8" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									<TD class="TDBGColor1" width="50%"><asp:label id="LBL_TXT_REMARK" runat="server">Renark :</asp:label></TD>
									<TD class="TDBGColorValue" width="50%"><asp:textbox id="TXT_REMARK" runat="server" Width="100%" TextMode="MultiLine" Height="40px" Enabled="False"></asp:textbox></TD>
								</TR>
							</TABLE>
						</TD>
					</TR>
