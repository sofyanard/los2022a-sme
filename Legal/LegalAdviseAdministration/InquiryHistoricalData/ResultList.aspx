<%@ Page language="c#" Codebehind="ResultList.aspx.cs" AutoEventWireup="True" Inherits="SME.Legal.LegalAdviseAdministration.InquiryHistoricalData.ResultList" %>
				...
				<TABLE width="100%" border="0">
					<TR>
						<TD align="left" width="50%">
							<TABLE id="Table1">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>HISTORICAL LIST</B></TD>
								</TR>
							</TABLE>
						</TD>
					...
					<TR>
						<TD class="td" vAlign="top" align="center" width="50%" colSpan="2"><asp:datagrid id="DATA_GRID" runat="server" Width="100%" AllowPaging="True" AutoGenerateColumns="False">
								...
								<Columns>
									...
									<asp:BoundColumn DataField="FINISH_DATE" HeaderText="Tgl.Penyelesaian">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
									</asp:BoundColumn>
									...
									<asp:BoundColumn DataField="LEGAL_OFFICER" HeaderText="Legal Officer">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
									</asp:BoundColumn>
