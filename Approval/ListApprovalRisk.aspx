<%@ Page language="c#" Codebehind="ListApprovalRisk.aspx.cs" AutoEventWireup="True" Inherits="SME.Approval.ListApprovalRisk" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>ListApprovalRisk</title>
					...
					<tr>
						<td style="WIDTH: 50%" colSpan="2"><asp:datagrid id="dgListApproval" runat="server" AutoGenerateColumns="False" Width="100%">
								...
								<Columns>
									...
									<asp:BoundColumn DataField="APPLY_LIMIT" HeaderText="Apply Limit" DataFormatString="{0:00.00,00}">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
										<ItemStyle HorizontalAlign="Right"></ItemStyle>
									</asp:BoundColumn>
									<asp:BoundColumn DataField="RM_NAME" HeaderText="Relationship Manager">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
									</asp:BoundColumn>
									<asp:BoundColumn DataField="BRANCH_NAME" HeaderText="Business Unit">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
									</asp:BoundColumn>
									<asp:BoundColumn DataField="AP_APRVNEXTBY" HeaderText="Next Approval">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
									</asp:BoundColumn>
									<asp:TemplateColumn>
