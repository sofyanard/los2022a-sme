...
{
	/// <summary>
	/// Summary description for ListApprovalCommitee.
	/// </summary>
	public partial class ListApprovalCommitee : System.Web.UI.Page
	{
		...
		{	
			...
			{
				conn.QueryString = "exec list_approval_commitee '" + txt_regno.Text + "', '" + lbl_userid.Text + "'";
			}			
			conn.ExecuteQuery();
		...
		private void dgListApproval_ItemCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			{
				case "view":
					Response.Redirect("ApprovalCommite2.aspx?regno="+e.Item.Cells[0].Text+
