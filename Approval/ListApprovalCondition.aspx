<%@ Page language="c#" Codebehind="ListApprovalCondition.aspx.cs" AutoEventWireup="True" Inherits="SME.Approval.ListApprovalCondition" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>ListApprovalCondition</title>
					...
					<tr>
						<td style="WIDTH: 50%" colSpan="2"><asp:datagrid id="dgListApproval" runat="server" AutoGenerateColumns="False" Width="100%">
								...
								<Columns>
									...
									<asp:BoundColumn DataField="AP_ISAPPEALBY" HeaderText="Appeal By">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
									</asp:BoundColumn>
									<asp:TemplateColumn>
