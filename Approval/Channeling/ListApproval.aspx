<%@ Page language="c#" Codebehind="ListApproval.aspx.cs" AutoEventWireup="True" Inherits="SME.Approval.Channeling.ListApproval" %>
			...
			<center>
				<table id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					<TR>
						...
						<TD class="tdNoBorder" align="right"><A href="ListApproval.aspx.aspx?si="></A><asp:imagebutton id="BTN_BACK" runat="server" ImageUrl="../../Image/back.jpg"></asp:imagebutton><A href="../../Body.aspx"><IMG src="../../Image/MainMenu.jpg"></A>
						...
						<td style="HEIGHT: 28px" colSpan="2">
							<table>
								...
								<tr>
									...
									<td style="WIDTH: 5px"><STRONG>:</STRONG></td>
									<td><asp:textbox onkeypress="return kutip_satu()" id="txt_cust_name" runat="server" MaxLength="20"
