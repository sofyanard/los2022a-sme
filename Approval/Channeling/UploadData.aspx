...
<%@ Page language="c#" Codebehind="UploadData.aspx.cs" AutoEventWireup="True" Inherits="SME.Approval.Channeling.UploadData" %>
			...
			<center>
				<table id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					<TR>
						...
						<TD class="tdNoBorder" align="right"><A href="ListApproval.aspx?mc=CHAN003"><IMG src="/SME/Image/back.jpg"></A><A href="../../Body.aspx"><IMG src="../../Image/MainMenu.jpg"></A>
