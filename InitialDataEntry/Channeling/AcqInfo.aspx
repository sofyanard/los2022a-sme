<%@ Page language="c#" Codebehind="AcqInfo.aspx.cs" AutoEventWireup="True" Inherits="SME.InitialDataEntry.Channeling.AcqInfo" %>
				...
				<table id="Table1" cellSpacing="0" cellPadding="0" width="100%">
					...
					<tr>
						<td class="tdNoBorder" align="center" colSpan="2">
							...
							<asp:label id="LBL_APRV" runat="server" Visible="False"></asp:label>
						</td>
					</tr>
				</table>
				<table id="Table2" cellSpacing="0" cellPadding="0" width="100%">
					<tr>
						<td style="HEIGHT: 7px"><asp:TextBox Runat="server" TextMode="MultiLine" Width="100%" Height="150" ID="txt_acqinfo" ReadOnly="True"></asp:TextBox></td>
					</tr>
					<tr>
						<td></td>
					</tr>
					<tr>
						<td align="center" class="TDBGColor2"><asp:Button Runat="server" ID="btn_send" Text="Send" Width="100px" CssClass="button1" Visible="False" onclick="btn_send_Click"></asp:Button>
							<%if (Request.QueryString["sta"] != "view") { %>
							<INPUT class="button1" style="WIDTH: 100px" type="button" value="Close" onclick="javascript:window.close()"
