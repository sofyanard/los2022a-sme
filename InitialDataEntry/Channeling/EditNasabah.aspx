<%@ Page language="c#" Codebehind="EditNasabah.aspx.cs" AutoEventWireup="True" Inherits="SME.InitialDataEntry.Channeling.EditNasabah" %>
									...
									<td>
										<TABLE class="td" id="Table30" height="35" cellSpacing="1" cellPadding="1" width="100%"
											...
											<TR>
												...
												<TD style="WIDTH: 0.87%">:</TD>
												<TD class="TDBGColorValue" style="WIDTH: 306px">
													<asp:textbox id="TXT_CU_ZIPCODE_1" runat="server" Width="88px" ontextchanged="TXT_CU_ZIPCODE_1_TextChanged"></asp:textbox>
													<asp:button id="BTN_SEARCH_ZIPCODE_1" runat="server" Text="Search" onclick="BTN_SEARCH_ZIPCODE_1_Click"></asp:button>
									...
									<td>
										<table width="100%">
											...
											<TR>
												...
												<TD class="TDBGColorValue" style="WIDTH: 307px; HEIGHT: 17px"><asp:dropdownlist id="DDL_BI_JENISPENGGUNAAN_1" runat="server" Width="100%"></asp:dropdownlist></TD>
												<!-------------------------------------------------------------------------------------------------------->
												<TD class="TDBGColor1" style="WIDTH: 18.7%; HEIGHT: 17px">Sektor Ekonomi BI 1</TD>
												<TD style="WIDTH: 1.31%; HEIGHT: 17px">:</TD>
												<TD class="TDBGColorValue" style="HEIGHT: 17px"><asp:dropdownlist id="DDL_BM_SEKTOREKONOMI_1" runat="server" Width="100%" AutoPostBack="True" onselectedindexchanged="DDL_BM_SEKTOREKONOMI_1_SelectedIndexChanged"></asp:dropdownlist></TD>
											</TR>
											<TR>
											...
											<TR>
												<TD class="TDBGColor1" style="WIDTH: 17.71%; HEIGHT: 15px">Orientasi Penggunaan</TD>
												<TD style="WIDTH: 0.87%; HEIGHT: 15px">:</TD>
												<TD class="TDBGColorValue" style="WIDTH: 307px; HEIGHT: 15px"><asp:dropdownlist id="DDL_BI_ORIENTASI_1" runat="server" Width="100%" Enabled="False"></asp:dropdownlist></TD>
												<!-------------------------------------------------------------------------------------------------------->
												<TD class="TDBGColor1" style="WIDTH: 18.7%; HEIGHT: 15px">Sektor Ekonomi BI 3</TD>
												<TD style="WIDTH: 1.31%; HEIGHT: 15px">:</TD>
												<TD class="TDBGColorValue" style="HEIGHT: 15px"><asp:dropdownlist id="DDL_BM_SUBSUBSEKTOREKON_1" runat="server" Width="100%" AutoPostBack="True" onselectedindexchanged="DDL_BM_SUBSUBSEKTOREKON_1_SelectedIndexChanged"></asp:dropdownlist></TD>
											</TR>
											<TR>
