...
namespace  SME.InitialDataEntry.Channeling
{
	...
	/// </summary>
	public partial class EditNasabahBackup : System.Web.UI.Page
	{
		...
		private void fillDropDownList()
		{
			...
			conn.QueryString = "SELECT PRODUCTDESC, PRODUCTID FROM RFPRODUCT";
			conn.ExecuteQuery();
			for (int i = 0; i < conn.GetRowCount(); i++)
		...
		private void fillDataAgunan()
		{
			...
			conn.QueryString = "SELECT CL_DESC, CL_VALUE, CL_CERTTYPE1, CL_VALUE, CL_IKATID, CL_PENILAIANDATE, CL_CURRENCY, CL_PENILAIANBY FROM COLLATERAL WHERE CU_REF = '" + Request.QueryString["curefanak"] + "'";
			conn.ExecuteQuery();
			...
			DDL_CL_CURRENCY_1.SelectedValue = conn.GetFieldValue("CL_CURRENCY");
			DDL_CL_PENILAIANBY_1.SelectedValue = conn.GetFieldValue("CL_PENILAIANBY");

			DDL_CL_CURRENCY_1.SelectedValue = "IDR";
		}
		...
		protected void btn_Save_CIF_Data_Click(object sender, System.EventArgs e)
		{
			try
			{
				conn.QueryString = "EXEC CHANNELING_UPDATE_DATA_CIF " +
					...
					"'" + DDL_CU_EDUCATION_1.SelectedValue + "'," +
					"'" + DDL_CU_BUSSTYPE_1.SelectedValue + "'," +
					"'" + DDL_CU_CITIZENSHIP_1.SelectedValue + "'," +
					"'" + DDL_CU_HOMESTA_1.SelectedValue  + "'," +
					"'" + TXT_CU_DOB_DAY_3.Text + "'," +
					"'" + DDL_CU_DOB_MONTH_3.SelectedValue + "'," +
					"'" + TXT_CU_DOB_YEAR_3.Text + "'," +

					"'" + TXT_CU_NPWP_1.Text + "'," +
					"'" + TXT_CU_KEYPERSON_1.Text + "'," +
					"'" + DDL_CU_JNSALAMAT_1.SelectedValue + "'," +
					"'" + DDL_CU_LOKASIPROYEK_1.SelectedValue + "'," +
					"'" + DDL_CU_LOKASIDATI_2.SelectedValue + "'," +
					"'" + DDL_CU_HUBEXECBM_1.SelectedValue + "'";
		...
		protected void btn_Save_Data_Agunan_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				"'" + DDL_CL_CURRENCY_1.SelectedValue + "'," +
		...
		protected void BTN_SEARCH_ZIPCODE_1_Click(object sender, System.EventArgs e)
		{
		...
		protected void BTN_SEARCH_ZIPCODE_2_Click(object sender, System.EventArgs e)
		{
		...
		protected void TXT_CU_ZIPCODE_1_TextChanged(object sender, System.EventArgs e)
		{
		...
		protected void TXT_CU_KTPZIPCODE_1_TextChanged(object sender, System.EventArgs e)
		{
			conn.QueryString = "select cityid, cityname, description from vw_zipcodecity where rtrim(ltrim(zipcode)) = '" + 
