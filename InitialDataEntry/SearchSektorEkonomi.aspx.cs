...
namespace SME.InitialDataEntry
{
	...
	public partial class SearchSektorEkonomi : System.Web.UI.Page
	{
		...
		{
			DDL_BI1.Items.Clear();
			DDL_BI1.Items.Add(new ListItem("- PILIH -", ""));
		...
		{
			DDL_BI2.Items.Clear();
			DDL_BI2.Items.Add(new ListItem("- PILIH -", ""));
		...
		{
			DDL_BI3.Items.Clear();
			DDL_BI3.Items.Add(new ListItem("- PILIH -", ""));
		...
		{
			DDL_BI4.Items.Clear();
			DDL_BI4.Items.Add(new ListItem("- PILIH -", ""));
		...
		private void ViewData()
		{
			...
			string pform	= "window.opener.document.getElementById('" + theForm.Trim() + "')";
			string frmObj	= "window.opener.document.getElementById('" + theObj.Trim() + "')";
