<%@ Page language="c#" Codebehind="SearchZipCode.aspx.cs" AutoEventWireup="True" Inherits="SME.InitialDataEntry.SearchZipCode" %>
					...
					<TD class="td" vAlign="top" width="50%">
						<TABLE id="Table2" cellSpacing="2" cellPadding="1" width="100%" border="0">
							<TR>
								...
								<TD>:</TD>
								<TD>
									<asp:dropdownlist id="DDL_CITYID" runat="server" Width="200px" AutoPostBack="True" onselectedindexchanged="DDL_CITYID_SelectedIndexChanged" CssClass="selectpicker" data-live-search="true"></asp:dropdownlist></TD>
							</TR>
							<TR>
								<TD class="tdLabel">Kabupaten</TD>
								<TD>:</TD>
								<TD><asp:dropdownlist id="DDL_REGIONID" runat="server" AutoPostBack="True" Width="200px" onselectedindexchanged="DDL_REGIONID_SelectedIndexChanged" CssClass="selectpicker" data-live-search="true"></asp:dropdownlist></TD>
							</TR>
							<TR>
