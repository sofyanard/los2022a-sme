...
namespace SME.InitialDataEntry
{
	...
	public partial class SearchZipCode : System.Web.UI.Page
	{
        ...
        private string theForm, theObj, theObj2, theObj3, theObj4;
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
            ...
            theObj2 = Request.QueryString["trgObjID2"].Trim();
            theObj3 = Request.QueryString["trgObjID3"].Trim();
            theObj4 = Request.QueryString["trgObjID4"].Trim();
		...
		protected void btn_OK_Click(object sender, System.EventArgs e)
		{
            ...
            */
            Response.Write("<script language='JavaScript'>window.opener.document.getElementById('" + theObj + "').value='" + txt_ZIPCODE.Text.Trim() + "'; " +
                "window.opener.document.getElementById('" + theObj2 + "').value='" + DDL_REGIONID.SelectedItem.Text.Trim() + "'; " +
                "window.opener.document.getElementById('" + theObj3 + "').value='" + DDL_CITYID.SelectedItem.Text.Trim() + "'; " +
                "window.opener.document.getElementById('" + theObj4 + "').value='" + DDL_CITYID.SelectedValue.Trim() + "'; " +
                "window.close();</script>");
		}
