<%@ Page language="c#" Codebehind="TargetCustomerSearch.aspx.cs" AutoEventWireup="True" Inherits="SME.TargetCustomer.TargetCustomerSearch" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>TargetCustomerSearch</title>
				...
				<TABLE id="Table4" width="100%" border="0">
					<TR>
						<TD align="left" colSpan="1">
							<TABLE id="Table3">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>Targetting Customer List</B></TD>
								</TR>
							</TABLE>
						</TD>
								...
								<TR>
									<TD vAlign="top" align="center">
										<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
											...
											<TR>
												<TD vAlign="top" align="center" colSpan="3" height="10"><asp:button id="btn_Find" runat="server" Width="180px" Text="Find Target Customer" CssClass="button1" onclick="btn_Find_Click"></asp:button>&nbsp;
													<asp:button id="BTN_NEW" runat="server" Width="180px" Text="New Target Customer" CssClass="button1" onclick="BTN_NEW_Click"></asp:button></TD>
											</TR>
										</TABLE>
									</TD>
								</TR>
					...
					<TR>
						<TD class="tdheader1" align="center" colSpan="2">Pending Pipeline</TD>
					</TR>
					<TR>
						<TD colSpan="2"><ASP:DATAGRID id="DatGrd_Pend" runat="server" Width="100%" CellPadding="1" AutoGenerateColumns="False"
								AllowPaging="True">
								<AlternatingItemStyle CssClass="TblAlternating"></AlternatingItemStyle>
								<Columns>
									<asp:BoundColumn Visible="False" DataField="TRG_CU_REF"></asp:BoundColumn>
