<%@ Page language="c#" Codebehind="ReviewICList.aspx.cs" AutoEventWireup="True" Inherits="SME.IPPS.Process.ICAssignValidation.ReviewICList" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>ReviewICList</title>
					...
					<TBODY>
						<TR>
							<TD class="tdNoBorder" style="WIDTH: 482px">
								<TABLE id="Table8">
									<TR>
										<TD class="tdBGColor2" style="WIDTH: 200px" align="center"><B> Review IC List</B></TD>
									</TR>
								</TABLE>
							</TD>
							...
							<td colspan="2">
								<ASP:DATAGRID id="dg_list_initiation" runat="server" Width="100%" AutoGenerateColumns="False">
									...
									<Columns>
										...
										<asp:BoundColumn DataField="UNIT_NAME" HeaderText="Requester Unit">
											<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
											<ItemStyle HorizontalAlign="Center"></ItemStyle>
										</asp:BoundColumn>
