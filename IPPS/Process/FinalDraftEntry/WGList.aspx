<%@ Page language="c#" Codebehind="WGList.aspx.cs" AutoEventWireup="True" Inherits="SME.IPPS.Process.FinalDraftEntry.WGList" %>
					...
					<TBODY>
						<TR>
							<TD class="tdNoBorder" style="WIDTH: 482px">
								<TABLE id="Table8">
									<TR>
										<TD class="tdBGColor2" style="WIDTH: 200px" align="center"><B> WG List</B></TD>
									</TR>
								</TABLE>
							</TD>
							...
							<td colspan="2">
								<ASP:DATAGRID id="dg_list_initiation" runat="server" Width="100%" AutoGenerateColumns="False">
									...
									<Columns>
										...
										<asp:BoundColumn DataField="unit_code" HeaderText="Requester Unit">
											<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
											<ItemStyle HorizontalAlign="Center"></ItemStyle>
										</asp:BoundColumn>
