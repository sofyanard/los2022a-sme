<%@ Page language="c#" Codebehind="UploadProcess.aspx.cs" AutoEventWireup="True" Inherits="SME.IPPS.Process.UploadProcess.UploadProcess" %>
		...
		<FORM id="Form1" method="post" runat="server">
			<CENTER>
				<TABLE width="100%" border="0">
					<TR>
						<TD align="left" width="50%">
							<TABLE id="Table1">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 200px" align="center"><B>Upload Info</B></TD>
								</TR>
							</TABLE>
						</TD>
				...
				<TABLE width="100%" align="center" border="0">
					<tr>
						<TD class="tdHeader1">Document</TD>
					</tr>
					<TR>
						<TD class="td" vAlign="top" align="center" width="50%" colSpan="2"><asp:datagrid id="dg_document" runat="server" Width="100%" AllowPaging="True" AutoGenerateColumns="False">
								...
								<Columns>
									...
									<asp:BoundColumn DataField="destinationfile" HeaderText="Destination File">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
									</asp:BoundColumn>
					...
					<tr>
						<td width="50%" border="0">
							<table id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TBODY>
									<TR>
										<TD class="TDBGColor1" style="HEIGHT: 10px" width="40%">Jenis Peraturan&nbsp;:</TD>
									...
									<TR>
										<TD class="TDBGColor1" style="HEIGHT: 10px" width="40%">Judul Peraturan&nbsp;:</TD>
										<TD class="TDBGColorValue" style="HEIGHT: 10px" width="60%">
											<asp:textbox id="txt_judul_peraturan" runat="server" CssClass="mandatory" ></asp:textbox>
										</TD>
									</TR>
								</TBODY>
							</table>
						...
						<td width="50%" border="0">
							<table id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TBODY>
									<TR>
										<TD class="TDBGColor1" style="HEIGHT: 7px" width="40%">Tanggal Upload&nbsp;:</TD>
									...
									<TR>
										...
										<TD valign="top" class="TDBGColorValue" style="HEIGHT: 10px" width="60%">
											<asp:textbox id="txt_remark" Runat="server" Width="100%"></asp:textbox></TD>
									</TR>
								</TBODY>
							</table>
						</td>
