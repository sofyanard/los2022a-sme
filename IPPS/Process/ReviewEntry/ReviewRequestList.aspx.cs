...
namespace SME.IPPS.Process.ReviewEntry
{
	...
	public partial class ReviewRequestList : System.Web.UI.Page
	{
		...
		{
			conn.QueryString = "exec IPPS_Review_Entry_List '"+ Session["UserID"].ToString()  + "'";
			conn.ExecuteQuery();
		...
		private void DATA_GRID_ItemCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			{
				case "continue":	
					Response.Redirect("GeneralInfo.aspx?regno=" + e.Item.Cells[2].Text + "&tc=" + Request.QueryString["tc"] 
