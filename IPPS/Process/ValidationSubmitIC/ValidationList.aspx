<%@ Page language="c#" Codebehind="ValidationList.aspx.cs" AutoEventWireup="True" Inherits="SME.IPPS.Process.ValidationSubmitIC.ValidationList" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>ValidationList</title>
				...
				<TABLE width="100%" border="0">
					<TR>
						<TD align="left" width="50%">
							<TABLE id="Table1">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>Validation List</B></TD>
								</TR>
							</TABLE>
						</TD>
				...
				<TABLE width="100%" align="center" border="0">
					<TR>
						<TD class="td" vAlign="top" align="center" width="50%" colSpan="2">
							<asp:datagrid id="DG_validation_list" runat="server" Width="100%" AllowPaging="True" AutoGenerateColumns="False">
