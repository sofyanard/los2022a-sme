<%@ Page language="c#" Codebehind="ReviewEntry.aspx.cs" AutoEventWireup="True" Inherits="SME.IPPS.Process.ReviewAssignmentValidation.ReviewEntry" %>
				...
				<tbody>
					...
					<TR>
						<TD class="td" style="WIDTH: 627px" vAlign="top" width="627"><TABLE id="Table9" cellSpacing="1" cellPadding="2" width="100%">
								...
								<TR>
									...
									<TD class="TDBGColorValue"><asp:textbox id="TXT_EDISI" runat="server" Width="300px" ReadOnly="True" BorderStyle="None"></asp:textbox></TD>
								</TR>
								<TR>
									<TD class="TDBGColor1">Revisi:</TD>
									<TD class="TDBGColorValue"><asp:textbox id="TXT_REVISI" runat="server" Width="300px" ReadOnly="True" BorderStyle="None"></asp:textbox></TD>
								</TR>
							</TABLE>
						</TD>
						<TD class="td" vAlign="top" width="50%">
							<TABLE id="Table65" cellSpacing="1" cellPadding="2" width="100%">
								<TR>
									...
									<TD class="TDBGColorValue"><asp:textbox id="TXT_TGL_BERLAKU" runat="server" Width="300px" ReadOnly="True" BorderStyle="None"></asp:textbox></TD>
								</TR>
								<TR>
									<TD class="TDBGColor1">Tanggal yang digantikan:</TD>
									<TD class="TDBGColorValue"><asp:textbox id="TXT_TGL_DIGANTI" runat="server" Width="300px" ReadOnly="True" BorderStyle="None"></asp:textbox></TD>
								</TR>
							</TABLE>
						</TD>
					</TR>
					...
					<tr id="TR_OUTLINE_NEW" runat="server">
						<TD class="TDBGColorValue" colSpan="2"><asp:textbox id="TXT_OUTLINENEW" runat="server" Width="100%" Enabled="False" ReadOnly="True"
								Height="128px" TextMode="MultiLine"></asp:textbox></TD>
					</tr>
					...
					<tr id="TR_COINTAIN_NEW" runat="server">
						<td colSpan="2"><ASP:DATAGRID id="DGR_COINTAINNEW" runat="server" AutoGenerateColumns="False" Width="100%">
								<AlternatingItemStyle CssClass="TblAlternating"></AlternatingItemStyle>
								<Columns>
									...
									<asp:TemplateColumn HeaderText="Review">
										...
										<ItemStyle HorizontalAlign="Left" Width="40%"></ItemStyle>
										<ItemTemplate>
											<asp:TextBox ID="TXT_REVIEW" Runat="server" TextMode="MultiLine" Width="85%"></asp:TextBox>
											<asp:Button id="BTN_SAVE_REVIEWNEW" runat="server" Text="SAVE" CssClass="Button1" CommandName="klik"></asp:Button>
										</ItemTemplate>
									</asp:TemplateColumn>
								</Columns>
							</ASP:DATAGRID></td>
					...
					<tr id="TR_CONTAIN_UPDATE" runat="server">
						<td colSpan="2"><ASP:DATAGRID id="DGR_CONTAINUPD" runat="server" AutoGenerateColumns="False" Width="100%">
								<AlternatingItemStyle CssClass="TblAlternating"></AlternatingItemStyle>
								<Columns>
									<asp:BoundColumn DataField="cnt_seq" Visible="False" />
									<asp:BoundColumn DataField="chapter" HeaderText="Bab">
									...
									<asp:TemplateColumn HeaderText="Review">
										...
										<ItemStyle HorizontalAlign="Left" Width="30%"></ItemStyle>
										<ItemTemplate>
											<asp:TextBox ID="TXT_REVIEW_UP" Runat="server" TextMode="MultiLine" Width="80%"></asp:TextBox>
											<asp:Button id="BTN_SAVE_REVIEWUP" runat="server" Text="SAVE" CssClass="Button1" CommandName="klik"></asp:Button>
										</ItemTemplate>
									</asp:TemplateColumn>
								</Columns>
							</ASP:DATAGRID></td>
