<%@ Page language="c#" Codebehind="ListProcess.aspx.cs" AutoEventWireup="True" Inherits="SME.IPPS.Facilities.P2EMAnalysis.ListProcess" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>ListProcess</title>
			...
			<CENTER>
				<TABLE width="100%" border="0">
					<TR>
						<TD align="left" width="50%">
							<TABLE id="Table1">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>List Process</B></TD>
								</TR>
							</TABLE>
						</TD>
				...
				<TABLE width="100%" align="center" border="0">
									...
									<TD vAlign="top" align="center">
										<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
											<TBODY>
												...
												<TR>
													<TD class="TDBGColor1" style="HEIGHT: 3px" width="40%"><asp:label id="Label1" runat="server">PIC Name :</asp:label></TD>
													<TD class="TDBGColorValue" style="HEIGHT: 3px" width="60%">
														<asp:dropdownlist id="ddl_pic_name" runat="server"></asp:dropdownlist></TD>
												</TR>
												<TR>
					...
					<TR>
						...
						<asp:datagrid id="dg_list_process" runat="server" Width="100%" AllowPaging="True" AutoGenerateColumns="False">
								...
								<Columns>
									...
									<asp:BoundColumn DataField="tlps_pp" HeaderText="TL/PS PP">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
									</asp:BoundColumn>
