<%@ Page language="c#" Codebehind="AssignmentList.aspx.cs" AutoEventWireup="True" Inherits="SME.IPPS.Facilities.AssignmentDH_TL_PS.AssignmentList" %>
			...
			<CENTER>
				...
				<TABLE width="100%" align="center" border="0">
					...
					<TR>
						...
						<asp:datagrid id="DG_assignment_list" runat="server" Width="100%" AllowPaging="True" AutoGenerateColumns="False">
