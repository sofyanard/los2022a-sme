<%@ Page language="c#" Codebehind="Maker.aspx.cs" AutoEventWireup="True" Inherits="SME.IPPS.ParameterMaintenance.Maker.Maker" %>
							...
							<TABLE id="Table2">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center">
										<B>
											<asp:label id="LBL_PAGETITLE" runat="server"></asp:label></B>
									</TD>
								</TR>
							</TABLE>
						</TD>
