<%@ Page language="c#" Codebehind="P2EMMaker.aspx.cs" AutoEventWireup="True" Inherits="SME.IPPS.ParameterMaintenance.Maker.P2EMMaker" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>P2EMMaker</title>
						...
						<TD class="td" style="WIDTH: 483px" vAlign="top" width="483">
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									...
									<TD class="TDBGColorValue"><asp:textbox id="TXT_CODE" runat="server" BorderStyle="None" ReadOnly="True" Width="300px"></asp:textbox></TD>
								</TR>
								<TR>
								...
								<TR>
									<TD class="TDBGColor1">Link</TD>
									<TD style="WIDTH: 15px">:</TD>
									<TD class="TDBGColorValue">
										<asp:textbox id="TXT_LNK" runat="server" BorderStyle="None" ReadOnly="True" Width="280px"></asp:textbox>
										<asp:Button ID="BTN_LINK" Text="..." Runat="server" Width="25px"></asp:Button>
									</TD>
								</TR>
							</TABLE>
						</TD>
