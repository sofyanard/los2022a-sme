<%@ Page language="c#" Codebehind="RequestTypeMaker.aspx.cs" AutoEventWireup="True" Inherits="SME.IPPS.ParameterMaintenance.Maker.RequestTypeMaker" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>RequestTypeMaker</title>
							...
							<TABLE id="Table2">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center">
										<B>Request Type Parameter : Maker</B></B>
									</TD>
								</TR>
							</TABLE>
						</TD>
					...
					<TR>
						<TD class="td" style="WIDTH: 483px" vAlign="top" width="483">
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%">
								...
								<TR>
									<TD class="TDBGColor1">Category</TD>
									<TD style="WIDTH: 15px">:</TD>
									<TD class="TDBGColorValue">
										<b>
											<asp:radiobuttonlist id="RDO_CATEGORY" runat="server" RepeatDirection="Horizontal" AutoPostBack="True">
