<%@ Page language="c#" Codebehind="Approval.aspx.cs" AutoEventWireup="True" Inherits="SME.IPPS.ParameterMaintenance.Approval.Approval" %>
				...
				<tbody>
					<TR>
						<TD class="tdNoBorder" style="WIDTH: 482px">
							<TABLE id="Table2">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B><asp:label id="LBL_PAGETITLE" runat="server"></asp:label></B></TD>
								</TR>
							</TABLE>
						</TD>
