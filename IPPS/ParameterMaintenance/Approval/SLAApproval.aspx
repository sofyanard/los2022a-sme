<%@ Page language="c#" Codebehind="SLAApproval.aspx.cs" AutoEventWireup="True" Inherits="SME.IPPS.ParameterMaintenance.Approval.SLAApproval" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>SLAApproval</title>
				...
				<tbody>
					<TR>
						<TD class="tdNoBorder" style="WIDTH: 482px">
							<TABLE id="Table2">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>SLA Parameter : Approval</B></TD>
								</TR>
							</TABLE>
						</TD>
					...
					<TR id="TR_APPROVAL" runat="server">
						<TD vAlign="top" align="left" width="50%" colSpan="2"><asp:datagrid id="DGR_APPROVAL" runat="server" Width="100%" AllowPaging="True" AutoGenerateColumns="False"
								...
								<Columns>
									...
									<asp:BoundColumn DataField="requestype" HeaderText="Request Type">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
									</asp:BoundColumn>
									...
									<asp:BoundColumn DataField="TRAKCODE" HeaderText="Track Code">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
									</asp:BoundColumn>
