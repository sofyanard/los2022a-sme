<%@ Page language="c#" Codebehind="P2EMApproval.aspx.cs" AutoEventWireup="True" Inherits="SME.IPPS.ParameterMaintenance.Approval.P2EMApproval" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>P2EMApproval</title>
				...
				<tbody>
					<TR>
						<TD class="tdNoBorder" style="WIDTH: 482px">
							<TABLE id="Table2">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>P2EM : Approval</B></TD>
								</TR>
							</TABLE>
						</TD>
