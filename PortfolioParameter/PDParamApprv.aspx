<%@ Page language="c#" Codebehind="PDParamApprv.aspx.cs" AutoEventWireup="True" Inherits="SME.PortfolioParameter.PDParamApprv" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>PDParamApprv</title>
		...
		<form id="Form1" method="post" runat="server">
			<center>
				<TABLE cellSpacing="2" cellPadding="2" width="100%">
					...
					<TR>
						<TD class="tdHeader1" colspan="2">Portfolio Parameter - Approval</TD>
					</TR>
					<TR>
