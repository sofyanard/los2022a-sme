<%@ Page language="c#" Codebehind="Process.aspx.cs" AutoEventWireup="True" Inherits="SME.ITTP.Process" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
										...
										<TD style="HEIGHT: 190px">
											<TABLE id="Table3" cellSpacing="1" cellPadding="1" width="100%" border="0">
												...
												<TR>
													...
													<TD style="HEIGHT: 21px"><FONT size="2"><asp:dropdownlist id="DDL_AANO" runat="server" AutoPostBack="True" Width="304px" Enabled="False" onselectedindexchanged="DDL_AANO_SelectedIndexChanged"></asp:dropdownlist>
														</FONT>
												...
												<TR>
													...
													<TD style="HEIGHT: 21px"><asp:dropdownlist id="DDL_PRODUCTID1" runat="server" AutoPostBack="True" Height="16px" Width="56px"
															CssClass="mandatory2" onselectedindexchanged="DDL_PRODUCTID1_SelectedIndexChanged"></asp:dropdownlist><asp:dropdownlist id="DDL_ACC_SEQ" runat="server" AutoPostBack="True" Width="48px" CssClass="mandatory2" onselectedindexchanged="DDL_ACC_SEQ_SelectedIndexChanged"></asp:dropdownlist><asp:label id="LBL_PRODUCTID1" runat="server" Visible="False"></asp:label><FONT size="2"></FONT></TD>
												</TR>
												<TR>
																	...
																	<TD>
																		<TABLE id="Table3" style="WIDTH: 1196px; HEIGHT: 132px" cellSpacing="1" cellPadding="1"
																			...
																			<TR>
																				...
																				<TD style="HEIGHT: 26px"><asp:dropdownlist id="DDL_PRODUCTID" runat="server" AutoPostBack="True" Width="296px" CssClass="mandatory" onselectedindexchanged="DDL_PRODUCTID_SelectedIndexChanged"></asp:dropdownlist></TD>
																			</TR>
																			<TR>
																			...
																			<TR>
																				...
																				<TD style="HEIGHT: 22px">:</TD>
																				<TD style="HEIGHT: 22px"><asp:textbox id="TXT_CP_LIMIT" runat="server" BorderStyle="None" ReadOnly="True"></asp:textbox></TD>
																			</TR>
																			<TR>
																...
																<TD class="td" vAlign="top" align="center" colSpan="2">
																	<TABLE id="Table4" style="WIDTH: 1206px; HEIGHT: 385px" cellSpacing="0" cellPadding="0"
																		...
																		<TR>
																			...
																			<TD class="TDBGColorValue" style="HEIGHT: 16px"><asp:dropdownlist id="DDL_CL_TYPE" runat="server"></asp:dropdownlist><asp:dropdownlist id="DDL_CL_TYPE_EXISTING" runat="server" Visible="False" AutoPostBack="True" onselectedindexchanged="DDL_CL_TYPE_EXISTING_SelectedIndexChanged"></asp:dropdownlist><asp:label id="LBL_SISAUTILIZATION" runat="server" Visible="False">100</asp:label><asp:textbox onkeypress="return digitsonly()" id="TXT_LC_PERCENTAGE" runat="server" Visible="False"
			...
			<TR id="TR_COLL4" runat="server">
				<TD class="tdbgcolor2" colSpan="2"><asp:button id="BTN_ADD" runat="server" Width="125px" CssClass="button1" Text="Add Request" onclick="BTN_ADD_Click"></asp:button><asp:button id="BTN_CANCEL" runat="server" Width="125px" CssClass="button1" Text="Cancel" Visible="False" onclick="BTN_CANCEL_Click"></asp:button></TD>
			</TR>
