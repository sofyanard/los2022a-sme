...
{
	/// <summary>
	/// Summary description for WorksheetReportCRP.
	/// </summary>
	public partial class WorksheetReportCRP : System.Web.UI.Page
	{
		...
		private void bindData()
		{
			...
			conn.QueryString = "select * from VW_IT_RATING_HISTORY where cu_ref='" + Request.QueryString["curef"] + "' and ap_regno ='" + Request.QueryString["regno"] + "' order by ap_signdate asc ";
			conn.ExecuteQuery();
