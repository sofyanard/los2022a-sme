<%@ Page language="c#" Codebehind="RejecteMas.aspx.cs" AutoEventWireup="True" Inherits="SME.ITTP.RejecteMas" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>RejecteMas</title>
					...
					<TR>
						<TD colSpan="2"><ASP:DATAGRID id="DataGrid1" runat="server" AutoGenerateColumns="False" Width="100%" CellPadding="1"
								...
								<Columns>
									...
									<asp:BoundColumn DataField="AP_RELMNGR" HeaderText="PIC">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
									</asp:BoundColumn>
