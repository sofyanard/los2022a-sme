<%@ Page language="c#" Codebehind="RejecteMasDetail.aspx.cs" AutoEventWireup="True" Inherits="SME.ITTP.RejecteMasDetail" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>RejecteMasDetail</title>
				...
				<table cellSpacing="2" cellPadding="2" width="100%">
					<TR>
						<TD class="tdNoBorder"><!--<img src="../Image/HeaderDetailDataEntry.jpg">-->
							<TABLE id="Table2">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>Reject eMas Detail</B></TD>
								</TR>
							</TABLE>
						</TD>
