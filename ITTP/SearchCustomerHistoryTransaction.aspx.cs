...
{
	/// <summary>
	/// Summary description for SearchCustomerHistoryTransaction.
	/// </summary>
	public partial class SearchCustomerHistoryTransaction : System.Web.UI.Page
	{
		...
		private void DatGrd_ItemCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			{
				case "View":	
					Response.Redirect("HistoryTransaction.aspx?curef=" + e.Item.Cells[0].Text + "&mc=" + Request.QueryString["mc"]);
					break;					
			}
		}
