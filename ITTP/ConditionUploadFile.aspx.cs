...
{
	/// <summary>
	/// Summary description for ConditionUploadFile.
	/// </summary>
	public partial class ConditionUploadFile : System.Web.UI.Page
	{
			...
			for (int i = 0; i < uploadedFiles.Count; i++)
			{
				...
				try
				{
					if (userPostedFile.ContentLength > 0)
					{
						...
						conn.QueryString = "select COVFILENAME from IT_COVENANT_FILEUPLOAD where AP_REGNO = '" + Request.QueryString["regno"] + 
						...
						if (mField == 0)
						{
							conn.QueryString = "exec IT_COVENANT_FILE_UPLOAD '" + 
