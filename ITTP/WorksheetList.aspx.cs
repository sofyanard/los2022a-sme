...
{
	/// <summary>
	/// Summary description for WorksheetList.
	/// </summary>
	public partial class WorksheetList : System.Web.UI.Page
	{
		...
		{
			conn.QueryString = "SELECT * FROM VW_IT_CREOPR_SUCCESS_LIST " +
		...
		private void DataGrid1_ItemCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			switch(((LinkButton)e.CommandSource).CommandName)
			{
				case "view":
					...
					Response.Redirect("WorksheetReport.aspx?regno=" + regno + "&curef=" + curef +
