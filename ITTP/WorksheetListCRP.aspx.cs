...
{
	/// <summary>
	/// Summary description for WorksheetListCRP.
	/// </summary>
	public partial class WorksheetListCRP : System.Web.UI.Page
	{
		...
		{
			conn.QueryString = "SELECT * FROM VW_IT_CRP_ACCEPT " +
		...
		private void DataGrid1_ItemCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			switch(((LinkButton)e.CommandSource).CommandName)
			{
				case "view":
					...
					Response.Redirect("WorksheetReportCRP.aspx?regno=" + regno + "&curef=" + curef +
