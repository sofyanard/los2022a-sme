...
*/
		private void fillDLL()
		{
			...
			string sql = "";
			sql = "select a.DOCID, DOCDESC from apptbo a left join RFTBODOC b on a.DOCID = b.DOCID where ap_regno = '"+ TXT_AP_REGNO.Text + "'";
		...
		protected void DDL_SENDTO_SelectedIndexChanged(object sender, System.EventArgs e)
		{
