<%@ Page language="c#" Codebehind="ApprovalPermohonan.aspx.cs" AutoEventWireup="True" Inherits="SME.ITTP.ApprovalPermohonan" %>
						...
						<TD>
							<TABLE id="Table3" style="WIDTH: 1196px; HEIGHT: 132px" cellSpacing="1" cellPadding="1"
								...
								<TR>
									...
									<TD style="HEIGHT: 44px"><asp:dropdownlist id="ddl_decovrreason" runat="server" CssClass="mandatory" Width="72px"></asp:dropdownlist><asp:label id="LBL_DECSTA" runat="server" Width="280px"></asp:label><asp:button id="btn_override" runat="server" CssClass="button1" Width="125px" Text="Override" onclick="BTN_OVERRIDE_Click"></asp:button></TD>
								</TR>
								<TR>
