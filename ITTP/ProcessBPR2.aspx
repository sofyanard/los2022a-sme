<%@ Page language="c#" Codebehind="ProcessBPR2.aspx.cs" AutoEventWireup="True" Inherits="SME.ITTP.ProcessBPR2" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>ProcessBPR2</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
									...
									<TR id="TR_JENISPENGAJUAN" runat="server">
										<TD style="HEIGHT: 190px">
											<TABLE id="Table3" cellSpacing="1" cellPadding="1" width="100%" border="0">
												<TR>
													<TD class="TDBGColor1" style="WIDTH: 413px; HEIGHT: 45px"><FONT size="2">Earmark 
															Facility NCL</FONT></TD>
													<TD style="WIDTH: 19px; HEIGHT: 45px"><FONT size="2">:</FONT></TD>
													<TD style="HEIGHT: 45px"><FONT size="2">&nbsp; </FONT>
														<asp:radiobuttonlist id="RDO_NCL" runat="server" RepeatDirection="Horizontal" AutoPostBack="True" Height="8px"
															Width="150px">
												...
												<TR>
													<TD class="TDBGColor1" style="WIDTH: 413px; HEIGHT: 21px"><asp:label id="Label3" runat="server">AA No.</asp:label></TD>
													<TD style="WIDTH: 19px; HEIGHT: 21px"><FONT size="2">:</FONT></TD>
													<TD style="HEIGHT: 21px"><FONT size="2"><asp:dropdownlist id="DDL_AANO" runat="server" AutoPostBack="True" Width="304px" Enabled="False"></asp:dropdownlist>
														</FONT>
														<asp:label id="LBL_REMAINING" runat="server" Height="14px" Width="168px">Remaining Limit   :</asp:label><asp:label id="LBL_CP_LIMIT" runat="server" Height="14px" Width="168px"></asp:label></TD>
												</TR>
												<TR>
													<TD class="TDBGColor1" style="WIDTH: 413px; HEIGHT: 17px"><FONT size="2"></FONT></TD>
													<TD style="WIDTH: 19px; HEIGHT: 17px"><FONT size="2"></FONT></TD>
													<TD style="HEIGHT: 17px"><FONT size="2">
															<asp:Label id="Label4" runat="server" Width="304px"></asp:Label>
															<asp:label id="LBL_PENDING" runat="server" Height="14px" Width="168px">Pending Transaction Limit :</asp:label><asp:label id="LBL_TRX_LIMIT" runat="server" Height="14px" Width="168px"></asp:label></FONT></TD>
												</TR>
												<TR>
													<TD class="TDBGColor1" style="WIDTH: 413px; HEIGHT: 21px"><FONT size="2">Facility</FONT></TD>
													<TD style="WIDTH: 19px; HEIGHT: 21px"><FONT size="2">:</FONT></TD>
													<TD style="HEIGHT: 21px"><asp:dropdownlist id="DDL_PRODUCTID1" runat="server" AutoPostBack="True" Height="16px" Width="56px"
															CssClass="mandatory2"></asp:dropdownlist><asp:dropdownlist id="DDL_ACC_SEQ" runat="server" AutoPostBack="True" Width="48px" CssClass="mandatory2"></asp:dropdownlist><asp:label id="LBL_PRODUCTID1" runat="server" Visible="False"></asp:label><FONT size="2"></FONT></TD>
												</TR>
												<TR>
													<TD class="TDBGColor1" style="WIDTH: 413px; HEIGHT: 23px"><FONT size="2">Reason</FONT></TD>
													<TD style="WIDTH: 19px; HEIGHT: 23px"><FONT size="2">:</FONT></TD>
													<TD style="HEIGHT: 23px"><asp:textbox id="TXT_CP_NOTES" runat="server" Width="300px" CssClass="mandatory" MaxLength="50"></asp:textbox><FONT size="2"></FONT></TD>
												</TR>
												<TR>
													<TD class="TDBGColor1" style="WIDTH: 413px"><FONT size="2">Transaction Type</FONT></TD>
													<TD style="WIDTH: 19px"><FONT size="2">:</FONT></TD>
													<TD><asp:dropdownlist id="DDL_APPTYPE" runat="server" Height="24px" Width="304px" CssClass="mandatory"></asp:dropdownlist><asp:label id="LBL_SEQ" runat="server" Visible="False"></asp:label><FONT size="2"></FONT></TD>
												</TR>
											</TABLE>
											<asp:label id="LBL_REGNO" runat="server" Visible="False"></asp:label><asp:label id="LBL_CUREF" runat="server" Visible="False"></asp:label><asp:label id="LBL_USERID" runat="server" Visible="False"></asp:label><asp:label id="LBL_KET_CODE" runat="server" Visible="False"></asp:label></TD>
									</TR>
									-->
									<TR>
										<TD colSpan="2">
																	...
																	<TD>
																		<TABLE id="Table3" style="WIDTH: 1196px; HEIGHT: 132px" cellSpacing="1" cellPadding="1"
																			...
																			<TR>
																				...
																				<TD style="HEIGHT: 26px"><asp:dropdownlist id="DDL_PRODUCTID" runat="server" AutoPostBack="True" Width="296px" CssClass="mandatory">
																						<asp:ListItem Value="1" Selected="True">KMK KUK</asp:ListItem>
																					</asp:dropdownlist></TD>
																			</TR>
																			<TR>
																				<TD class="TDBGColor1" style="WIDTH: 406px; HEIGHT: 17px"><FONT size="2">Purpose Code</FONT></TD>
																				<TD style="HEIGHT: 17px">:</TD>
																				<TD style="HEIGHT: 17px"><FONT size="2"><asp:dropdownlist id="DDL_CP_LOANPURPOSE" runat="server" Width="296px" CssClass="mandatory">
																							<asp:ListItem Value="Kredit Usaha " Selected="True">Kredit Usaha </asp:ListItem>
																						</asp:dropdownlist></FONT></TD>
																			</TR>
																			<TR>
																				<TD class="TDBGColor1" style="WIDTH: 406px; HEIGHT: 22px"><FONT size="2">Amount</FONT></TD>
																				<TD style="HEIGHT: 22px"><FONT size="2">:</FONT></TD>
																				<TD style="HEIGHT: 22px"><asp:textbox id="TXT_CP_EXLIMITVAL" runat="server" Width="300px" CssClass="mandatory2" MaxLength="50">5.000.000</asp:textbox><FONT size="2"></FONT></TD>
																			</TR>
																			<TR>
																			...
																			<TR>
																				...
																				<TD style="HEIGHT: 22px">:</TD>
																				<TD style="HEIGHT: 22px"><asp:textbox id="TXT_CP_LIMIT" runat="server" BorderStyle="None" ReadOnly="True">5.000.000</asp:textbox></TD>
																			</TR>
																			<TR>
																				<TD class="TDBGColor1" style="WIDTH: 406px; HEIGHT: 22px"><FONT size="2">Tenor</FONT></TD>
																				<TD style="HEIGHT: 22px"><FONT size="2">:</FONT></TD>
																				<TD style="HEIGHT: 22px"><asp:textbox id="TXT_CP_JANGKAWKT" runat="server" Width="24px" CssClass="mandatory2" MaxLength="50"></asp:textbox><asp:dropdownlist id="DDL_CP_TENORCODE" runat="server" CssClass="mandatory2">
																						<asp:ListItem Value="Bulan" Selected="True">Bulan</asp:ListItem>
											...
											<TABLE id="table10" style="WIDTH: 1216px; HEIGHT: 575px">
												<TR id="TR_COLL2" runat="server">
													<TD>
														<TABLE id="table11">
															<TR>
																<TD align="center" colSpan="2"><ASP:DATAGRID id="DatGrd" runat="server" Width="1206px" CellPadding="1" PageSize="7" AutoGenerateColumns="False">
															...
															<TR>
																<TD class="td" vAlign="top" align="center" colSpan="2">
																	<TABLE id="Table4" style="WIDTH: 1206px; HEIGHT: 385px" cellSpacing="0" cellPadding="0"
																		width="1206">
																		<TR>
																			<TD colSpan="3"><asp:radiobuttonlist id="RDO_COLLATERAL" runat="server" RepeatDirection="Horizontal" AutoPostBack="True"
																					Width="150px">
																		...
																		<TR>
																			...
																			<TD class="TDBGColorValue"><asp:textbox onkeypress="return digitsonly()" id="TXT_CL_FOREIGNVAL" onblur="FormatCurrency(this), FormatCurrency(document.Form1.TXT_CL_VALUE)"
																				...
																				Rp&nbsp;
																				<asp:textbox id="TXT_CL_VALUE" runat="server" Width="200px" BorderStyle="None" ReadOnly="True"></asp:textbox></TD>
																		</TR>
																		<TR>
																			...
																			<TD class="TDBGColorValue"><asp:textbox onkeypress="return digitsonly()" id="TXT_CL_FOREIGNVAL2" onblur="FormatCurrency(this), FormatCurrency(document.Form1.TXT_CL_VALUE2)"
																				...
																				Rp&nbsp;
																				<asp:textbox id="TXT_CL_VALUE2" runat="server" Width="200px" BorderStyle="None" ReadOnly="True"></asp:textbox></TD>
																		</TR>
																		<TR>
																			...
																			<TD class="TDBGColorValue"><asp:textbox onkeypress="return digitsonly()" id="TXT_CL_FOREIGNVALINS" onblur="FormatCurrency(this), FormatCurrency(document.Form1.TXT_CL_VALUEINS)"
																				...
																				Rp&nbsp;
																				<asp:textbox id="TXT_CL_VALUEINS" runat="server" Width="200px" BorderStyle="None" ReadOnly="True"></asp:textbox></TD>
																		</TR>
																		<TR>
																			...
																			<TD class="TDBGColorValue"><asp:textbox onkeypress="return digitsonly()" id="TXT_CL_FOREIGNVALIKAT" onblur="FormatCurrency(this), FormatCurrency(document.Form1.TXT_CL_VALUEIKAT)"
																				...
																				Rp&nbsp;
																				<asp:textbox id="TXT_CL_VALUEIKAT" runat="server" Width="200px" BorderStyle="None" ReadOnly="True"></asp:textbox></TD>
																		</TR>
																		<TR>
																			...
																			<TD class="TDBGColorValue"><asp:textbox onkeypress="return digitsonly()" id="TXT_CL_FOREIGNVALPPA" onblur="FormatCurrency(this), FormatCurrency(document.Form1.TXT_CL_VALUEPPA)"
																				...
																				Rp&nbsp;
																				<asp:textbox id="TXT_CL_VALUEPPA" runat="server" Width="200px" BorderStyle="None" ReadOnly="True"></asp:textbox></TD>
																		</TR>
																		<TR>
																			...
																			<TD class="TDBGColorValue"><asp:textbox onkeypress="return digitsonly()" id="TXT_CL_FOREIGNVALLIQ" onblur="FormatCurrency(this), FormatCurrency(document.Form1.TXT_CL_VALUELIQ)"
																				...
																				Rp&nbsp;
																				<asp:textbox id="TXT_CL_VALUELIQ" runat="server" Width="200px" BorderStyle="None" ReadOnly="True"></asp:textbox></TD>
																		</TR>
																		<TR>
						...
						<TABLE>
							<TR>
								<TD class="TDBGColor2" vAlign="top" align="center" width="50%" colSpan="2">&nbsp;
									<asp:button id="BTN_SAVECOLL" runat="server" Width="125px" CssClass="Button1" Text="Save Collateral"></asp:button></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
			...
			<TR id="TR_COLL4" runat="server">
				<TD class="tdbgcolor2" colSpan="2"><asp:button id="BTN_ADD" runat="server" Width="125px" CssClass="button1" Text="Add Request"></asp:button><asp:button id="BTN_CANCEL" runat="server" Width="125px" CssClass="button1" Text="Cancel" Visible="False"></asp:button></TD>
			</TR>
			<TR id="TR_COLL3" runat="server">
				<TD colSpan="2">
					<TABLE class="td" id="Table8" cellSpacing="1" cellPadding="1" width="100%" border="0">
						...
						<TR>
							<TD><ASP:DATAGRID id="DATAGRID1" runat="server" Width="100%" PageSize="5" AutoGenerateColumns="False"
									AllowPaging="True">
									<AlternatingItemStyle CssClass="TblAlternating"></AlternatingItemStyle>
									<Columns>
						...
						<TR id="TR_BUTTONS1" runat="server">
							<TD class="tdbgcolor2"><asp:button id="BTN_SAVE" runat="server" Visible="False" Width="180px" Enabled="False" CssClass="button1"
									Text="Save Request"></asp:button><asp:listbox id="ListBox2" runat="server" Visible="False" Height="25px" Width="10px"></asp:listbox></TD>
						</TR>
					</TABLE>
				</TD>
			</TR>
