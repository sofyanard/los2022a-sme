...
{
	/// <summary>
	/// Summary description for ListReview.
	/// </summary>
	public partial class ListReview : System.Web.UI.Page
	{
		...
		{	
			...
			*/
			//{
				conn.QueryString = "exec IT_LIST_APPROVAL2 '"+txt_regno.Text+"', '"+lbl_userid.Text+"'";
				conn.ExecuteQuery();
			//}
		...
		private void dgListApproval_ItemCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			switch (((LinkButton)e.CommandSource).CommandName)
			{
				case "view":
				{
					...
					Response.Redirect("Acceptance.aspx?regno="+e.Item.Cells[0].Text+
