...
namespace SME.CBI
{
	...
	/// </summary>
	public partial class BankRelationCBI : System.Web.UI.Page
	{
			...
			if (!IsPostBack)
			{
				...
				*/
				...
				try
				{
					...
					HPL_ATASNAMA0.NavigateUrl = "BankRelationCBI.aspx?regno="+Request.QueryString["regno"]+"&curef="+Request.QueryString["curef"]+"&code=0"+"&mc="+Request.QueryString["mc"] + "&de=" + Request.QueryString["de"]+"&tc="+Request.QueryString["tc"]+"&par="+Request.QueryString["par"];
					HPL_ATASNAMA1.NavigateUrl = "BankRelationCBI.aspx?regno="+Request.QueryString["regno"]+"&curef="+Request.QueryString["curef"]+"&code=1"+"&mc="+Request.QueryString["mc"] + "&de=" + Request.QueryString["de"]+"&tc="+Request.QueryString["tc"]+"&par="+Request.QueryString["par"];
					//-----------------------------------------
					//HPL_ATASNAMA2.NavigateUrl = "BankRelation.aspx?regno="+Request.QueryString["regno"]+"&curef="+Request.QueryString["curef"]+"&code=2";

					HPL_SALDORATA.NavigateUrl = "BankRelationCBI.aspx?regno="+Request.QueryString["regno"]+"&curef="+Request.QueryString["curef"]+"&code=2"+"&mc="+Request.QueryString["mc"] + "&de=" + Request.QueryString["de"]+"&tc="+Request.QueryString["tc"]+"&par="+Request.QueryString["par"];
				}
				catch
				{
				}
		...
		private void BTN_SAVE_Click(object sender, System.EventArgs e)
		{
			...
			*/
			...
			conn.QueryString = "exec DE_HUBUNGANBANK '" +Request.QueryString["curef"]+ "', " +tool.ConvertDate(TXT_CI_BMGIRO_DAY.Text,DDL_CI_BMGIRO_MONTH.SelectedValue,TXT_CI_BMGIRO_YEAR.Text)+ ", "+
				...
				", '" +TXT_CA_NOTE.Text+ "', null, null, null, null, null, null,'" +CA_ACCOUNTSTATUS+ "'";
		...
		*/
		...
		private void BTN_SAVEGRP_Click(object sender, System.EventArgs e)
		{
			...
			{
				double nilai = 0;
				try { nilai = double.Parse(DatGridMandiriLoan.Items[i].Cells[4].Text); } 
				catch {}
