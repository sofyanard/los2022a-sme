<%@ Page CodeBehind="DocUmum.aspx.cs" Language="c#" AutoEventWireup="True" Inherits="SME.CBI.DocUmum" %>
						...
						<td><ASP:DATAGRID id="DGR_DU" runat="server" Width="100%" CellPadding="1" PageSize="1" AutoGenerateColumns="False" onselectedindexchanged="DGR_DU_SelectedIndexChanged">
								...
								<Columns>
									...
									<asp:TemplateColumn HeaderText="Received Date">
										...
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
										<ItemTemplate>
											<asp:TextBox onkeypress="return numbersonly()" id="TXT_AT_RECEIVEDATEDAY" Runat="server" MaxLength="2" Columns="2"></asp:TextBox>
											<asp:DropDownList id="DDL_AT_RECEIVEDATEMONTH" Runat="server"></asp:DropDownList>
											<asp:TextBox onkeypress="return numbersonly()" id="TXT_AT_RECEIVEDATEYEAR" Runat="server" MaxLength="4" Columns="4"></asp:TextBox>
										</ItemTemplate>
									</asp:TemplateColumn>
