<%@ Page CodeBehind="DocJaminan.aspx.cs" Language="c#" AutoEventWireup="True" Inherits="SME.CBI.DocJaminan" %>
		...
		<form id="Form1" method="post" runat="server">
			<center>
				<table cellSpacing="0" cellPadding="0" width="100%" border="0">
					<TR>
						<TD vAlign="top"></TD>
						<TD vAlign="top"><asp:dropdownlist id="DDL_JAMINAN" AutoPostBack="True" Runat="server" onload="DDL_JAMINAN_Load" onselectedindexchanged="DDL_JAMINAN_SelectedIndexChanged"></asp:dropdownlist><asp:label id="LBL_REGNO" Runat="server" Visible="False"></asp:label><asp:label id="LBL_CUREF" Runat="server" Visible="False"></asp:label><asp:label id="LBL_TC" Runat="server" Visible="False"></asp:label><input type="hidden" name="sta">
						</TD>
					</TR>
					<tr>
						<TD></TD>
					...
					<TR>
						<TD></TD>
						<TD><asp:dropdownlist id="DropDownList1" runat="server" Visible="False" onselectedindexchanged="DropDownList1_SelectedIndexChanged"></asp:dropdownlist></TD>
					</TR>
					<TR>
						<TD></TD>
						<TD>
							<TABLE id="Table1" style="HEIGHT: 23px" cellSpacing="1" cellPadding="1" width="100%" border="1">
								<TR>
									...
									<TD><asp:dropdownlist id="DDL_LIST2" runat="server" Width="352px"></asp:dropdownlist><asp:button id="Button1" runat="server" Text="Insert" onclick="Button1_Click"></asp:button></TD>
								</TR>
							</TABLE>
						</TD>
					</TR>
