<%@ Page language="c#" Codebehind="InfoPerusahaan.aspx.cs" AutoEventWireup="True" Inherits="SME.CBI.InfoPerusahaan" ErrorPage="../SME_Error.aspx" %>
		...
		<form id="Form1" method="post" runat="server">
			<center>
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
							...
							<TABLE id="Table9" border="0" cellSpacing="2" cellPadding="2" width="100%">
								<TR>
									<TD style="HEIGHT: 43px" vAlign="top" width="50%" colSpan="2"><asp:radiobuttonlist id="RDO_RFCUSTOMERTYPE" onclick="setMandatory2()" runat="server" AutoPostBack="True"
											RepeatDirection="Horizontal" onselectedindexchanged="RDO_RFCUSTOMERTYPE_SelectedIndexChanged"></asp:radiobuttonlist></TD>
								</TR>
								<TR>
									...
									<TD class="td" vAlign="top" align="center">
										<TABLE id="Table11" cellSpacing="0" cellPadding="0" width="100%">
											...
											<TR>
												...
												<TD></TD>
												<TD class="TDBGColorValue" align="left"><asp:radiobuttonlist id="RDO_KEY_PERSON" runat="server" Width="150px" AutoPostBack="True" RepeatDirection="Horizontal" onselectedindexchanged="RDO_KEY_PERSON_SelectedIndexChanged">
												...
												<TD>
													<TABLE id="Table6" cellSpacing="0" cellPadding="0" width="100%">
														...
														<TR>
															...
															<TD style="HEIGHT: 8px" class="TDBGColorValue"><asp:dropdownlist id="DDL_AI_AA_NO" runat="server" AutoPostBack="True" CssClass="mandatory" onselectedindexchanged="DDL_AI_AA_NO_SelectedIndexChanged"></asp:dropdownlist><asp:textbox id="TXT_AI_AA_NO" onkeypress="return kutip_satu()" runat="server" Visible="False"
								...
								<TR>
									<TD class="TDBGColor2">
										...
										<asp:button id="BTN_UPDATE_HOLDERACC" runat="server" Visible="False" Width="75px" CssClass="button1"
											Text="Update" onclick="BTN_UPDATE_HOLDERACC_Click"></asp:button><asp:button id="BTN_SAVE_HOLDERACC" runat="server" Width="75px" CssClass="button1" Text="Save" onclick="BTN_SAVE_HOLDERACC_Click"></asp:button><asp:button id="BTN_CANCEL_HOLDERACC" runat="server" Width="75px" CssClass="button1" Text="Cancel" onclick="BTN_CANCEL_HOLDERACC_Click"></asp:button>
										<% } %>
									</TD>
								</TR>
								<TR>
					...
					<% } %>
					<TR>
						<TD class="TDBGColor2" vAlign="top" width="50%" colSpan="2" align="center"><asp:label id="LBL_TC" runat="server" Visible="False"></asp:label><asp:label id="LBL_CUREF" runat="server" Visible="False"></asp:label><asp:button id="BTN_SAVE" runat="server" Width="100px" CssClass="Button1" Text="Save" onclick="BTN_SAVE_Click"></asp:button>
