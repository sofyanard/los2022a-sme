...
namespace SME.CBI
{
	...
	/// </summary>
	public partial class VASiteVisit : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			if (!IsPostBack)
			{
				...
				//cari semua aplikasi yang punya curef ini
				//20102008COR1000004
		...
		{
			conn.QueryString = "select * from VW_CUST_FOR_SITEVISIT where CU_REF = '" + Request.QueryString["curef"] + "' AND AP_REGNO = '" + Request.QueryString["regnosite"] + "'";
			conn.ExecuteQuery();
		...
		protected void BTN_SAVE_Click(object sender, System.EventArgs e)
		{
				...
				//Tools.popMessage(this, TXT_SV_MANAGEMENT.Text.ToString());
		...
		protected void BTN_PRINT_Click(object sender, System.EventArgs e)
		{
			...
			Response.Redirect("SiteVisitPrint.aspx?&regno=" + Request.QueryString["regno"]);
