<%@ Page language="c#" Codebehind="GeneralInfoCBI.aspx.cs" AutoEventWireup="True" Inherits="SME.CBI.GeneralInfoCBI" enableViewState="True" %>
...
<HTML>
	...
	<body leftMargin="0" topMargin="0" MS_POSITIONING="GridLayout">
		<form id="Fmain" name="Fmain" action="CBIInsert.aspx?" method="post" target="main">
		</form>
			...
			<center>
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					...
					-->
							...
							<TD class="td" vAlign="top" width="50%">
								<TABLE id="Table6" cellSpacing="0" cellPadding="0" width="100%">
									...
									<TR>
										...
										<TD class="TDBGColorValue" style="HEIGHT: 12px"><asp:dropdownlist id="DDL_PROG_CODE" runat="server" CssClass="mandatory" AutoPostBack="True" onselectedindexchanged="DDL_PROG_CODE_SelectedIndexChanged"></asp:dropdownlist></TD>
									</TR>
									<TR>
									...
									<TR>
										...
										<TD></TD>
										<TD class="TDBGColorValue"><asp:dropdownlist id="DDL_CHANNEL_CODE" runat="server"></asp:dropdownlist><asp:textbox id="TXT_CON" runat="server" ReadOnly="True" Width="1px" AutoPostBack="True" BorderStyle="None" ontextchanged="TXT_CON_TextChanged"></asp:textbox></TD>
									</TR>
									<TR>
								...
								<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" runat="server">
									...
									<TR>
										...
										<TD class="TDBGColorValue">
											...
											<asp:checkbox id="CHB_CU_NAMAPELAPORAN" Runat="server" Text="Same with Name" AutoPostBack="True" oncheckedchanged="CHB_CU_NAMAPELAPORAN_CheckedChanged"></asp:checkbox>
										</TD>
									</TR>
									<TR>
							...
							<TD class="td" vAlign="top" width="50%" colSpan="2">
								<TABLE id="Table8" cellSpacing="0" cellPadding="0" width="100%">
									<TR>
										...
										<TD style="WIDTH: 15px"></TD>
										<TD class="TDBGColorValue" style="WIDTH: 117px" width="117"><asp:radiobuttonlist id="RDO_BI_CHECKING" runat="server" Width="150px" AutoPostBack="True" RepeatDirection="Horizontal" onselectedindexchanged="RDO_BI_CHECKING_SelectedIndexChanged">
						...
						<TR>
							<TD class="TDBGColor2" vAlign="top" align="center" colSpan="2"><asp:button id="BTN_SAVE" runat="server" CssClass="Button1" Width="100px" Text="Save" onclick="BTN_SAVE_Click"></asp:button><asp:button id="BTN_SAVECON" runat="server" CssClass="Button1" Width="100px" Text="Save" onclick="BTN_SAVE_Click"></asp:button>
							&nbsp;<INPUT class="Button1" onclick="keluar()" type="button" value=" Finish "></TD>
						</TR>
					</TBODY>
				</TABLE>
			</center>
