<%@ Page CodeBehind="DocFasilitas.aspx.cs" Language="c#" AutoEventWireup="True" Inherits="SME.CBI.DocFasilitas" %>
						...
						<TD>
							<TABLE id="Table1" cellSpacing="1" cellPadding="1" width="100%" border="1">
								<TR>
									...
									<TD><asp:dropdownlist id="DDL_LIST2" runat="server" Width="352px"></asp:dropdownlist><asp:button id="Button1" runat="server" Text="Insert" onclick="Button1_Click"></asp:button>
