...
{
	/// <summary>
	/// Summary description for NsabahGroupInfoCBI.
	/// </summary>
	public partial class NsabahGroupInfoCBI : System.Web.UI.Page
	{
		...
		private void ViewData()
		{
			...
			conn.ExecuteQuery();
			if (conn.GetFieldValue("sg_BUSSUNITid") == "CB100" || Request.QueryString["mc"] == "CBI01")
			{
				TR_COMPANY.Visible = false;
				TR_PERSONAL.Visible = false;
