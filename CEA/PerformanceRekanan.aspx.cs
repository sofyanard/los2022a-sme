...
{
	/// <summary>
	/// Summary description for PerformanceRekanan.
	/// </summary>
	public class PerformanceRekanan : System.Web.UI.Page
	{
		...
		protected System.Web.UI.WebControls.DropDownList DDL_REGION;
		protected System.Web.UI.WebControls.DropDownList DDL_SBU;
		protected System.Web.UI.WebControls.DropDownList DDL_JNS_REK;
		protected System.Web.UI.WebControls.DropDownList DDL_Rekanan;
		protected System.Web.UI.WebControls.Button BTN_Cancel;
		protected System.Web.UI.WebControls.Label Label1;
		protected Microsoft.Samples.ReportingServices.ReportViewer ReportViewer2;
		protected System.Web.UI.WebControls.Button BTN_Find;
		protected System.Web.UI.WebControls.DropDownList DDL_KLASIFIKASI;
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if (!IsPostBack)
			{
				...
				//penambahan filtering KLASIFIKASI 13-2-2013 Oleh Ariel
		...
		{    
			...
			this.DDL_REGION.SelectedIndexChanged += new System.EventHandler(this.DDL_REGION_SelectedIndexChanged);
			this.DDL_JNS_REK.SelectedIndexChanged += new System.EventHandler(this.DDL_JNS_REK_SelectedIndexChanged);
		...
		{	
			...
			ReportViewer2.ReportPath = "/SMEReports/RptRekananPerformance1&kriterianya=" + kriterianya;
		}
		...
		private void DDL_JNS_REK_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			FillRekanan();
		}
