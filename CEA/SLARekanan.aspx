<%@ Page language="c#" Codebehind="SLARekanan.aspx.cs" AutoEventWireup="True" Inherits="SME.CEA.SLARekanan" %>
<%@ Register TagPrefix="cc1" Namespace="Microsoft.Samples.ReportingServices" Assembly="ReportViewer" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>SLARekanan</title>
					...
					<TR>
						<TD align="center" colSpan="2">
							<TABLE class="td" id="Table1" cellSpacing="1" cellPadding="1" width="550" border="1" height="195">
								<TR>
									<TD class="tdHeader1">SLA REKANAN</TD>
								</TR>
								<TR>
									<TD vAlign="top" align="center">
										<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
											...
											<TR>
												...
												<TD class="TDBGColorValue" style="HEIGHT: 15px"><asp:DropDownList ID="DDL_SBU" Runat="server" onselectedindexchanged="DDL_SBU_SelectedIndexChanged"></asp:DropDownList></TD>
											</TR>
											<TR>
												<TD class="TDBGColor1">Jenis Rekanan</TD>
												<TD></TD>
												<TD class="TDBGColorValue"><asp:DropDownList ID="DDL_JNS_REK" Runat="server" AutoPostBack="True" onselectedindexchanged="DDL_JNS_REK_SelectedIndexChanged"></asp:DropDownList></TD>
											</TR>
											<TR>
