<%@ Page language="c#" Codebehind="Quantitative.aspx.cs" AutoEventWireup="True" Inherits="SME.CEA.Quantitative" %>
				...
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					<TR>
						<TD class="tdNoBorder">
							<TABLE id="Table8">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>Scoring - Asuransi 
											Kerugian</B></TD>
								</TR>
							</TABLE>
						</TD>
					...
					<TR>
						<TD class="tdHeader1" vAlign="top" width="50%" colSpan="2">Scoring Asuransi 
							Kerugian<asp:label id="lbl_no_registrasi" runat="server" Visible="False"></asp:label><asp:label id="lbl_cu_nama" runat="server"></asp:label><asp:label id="lbl_cu_kota" runat="server" Visible="False"></asp:label><asp:label id="lbl_comkota" runat="server" Visible="False"></asp:label></TD>
					</TR>
					<TR>
					...
					<TR id="TR_PERSONAL" runat="server">
						<TD class="td" vAlign="top" width="50%">
							<TABLE id="Table20" cellSpacing="0" cellPadding="0" width="100%">
								...
								<TR>
									<TD class="TDBGColor1">Hutang Klaim</TD>
									<TD></TD>
								...
								<TR>
									<TD class="TDBGColor1">Estimasi Klaim retensi Sendiri</TD>
									<TD></TD>
								...
								<TR>
									<TD class="TDBGColor1">Premi yang Belum Merupakan Pendapatan (PYBMP)</TD>
									<TD></TD>
									<TD class="TDBGColorValue"><asp:textbox onkeypress="return kutip_satu()" id="cu_gelarssdh" runat="server" Width="296px"
											MaxLength="50"></asp:textbox></TD>
								</TR>
								<TR>
									<TD class="TDBGColor1">Jumlah Ekuitas</TD>
									<TD></TD>
									<TD class="TDBGColorValue" style="HEIGHT: 17px"><asp:textbox onkeypress="return kutip_satu()" id="Textbox5" runat="server" Width="296px" MaxLength="15"></asp:textbox></TD>
								</TR>
								<TR>
									<TD class="TDBGColor1">Premi Bruto</TD>
									<TD></TD>
								...
								<TR>
									<TD class="TDBGColor1">Premi Bruto Tahun Sebelumnya</TD>
									<TD></TD>
								...
								<TR>
									<TD class="TDBGColor1">Premi Bruto - Premi reasuransi</TD>
									<TD></TD>
								...
								<TR>
									<TD class="TDBGColor1">Jumlah Beban Klaim</TD>
									<TD></TD>
								...
								<TR>
									<TD class="TDBGColor1">Beban Komisi Bersih</TD>
									<TD></TD>
								...
								<TR>
									<TD class="TDBGColor1">Beban Underwriting Lain</TD>
									<TD></TD>
								...
								<TR>
									<TD class="TDBGColor1">Hasil Underwriting</TD>
									<TD></TD>
						...
						<TD class="td" vAlign="top" width="50%">
							<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" runat="server">
								<TR>
									<TD class="TDBGColor1">Beban Usaha</TD>
									<TD style="WIDTH: 15px"></TD>
									<TD class="TDBGColorValue"><asp:textbox onkeypress="return kutip_satu()" id="Textbox11" runat="server" Width="296px" MaxLength="15"></asp:textbox></TD>
								</TR>
								<TR>
								...
								<TR>
									<TD class="TDBGColor1">Jumlah Tenaga Ahli Asuransi</TD>
									<TD></TD>
									<TD class="TDBGColorValue"><asp:textbox onkeypress="return kutip_satu()" id="Textbox16" runat="server" Width="128px" MaxLength="25"></asp:textbox>Orang</TD>
								</TR>
								<TR>
									<TD class="TDBGColor1" style="HEIGHT: 22px">Jumlah Kapasitas Treaty</TD>
									<TD style="HEIGHT: 22px"></TD>
									<TD class="TDBGColorValue" style="HEIGHT: 22px"><asp:textbox onkeypress="return kutip_satu()" id="Textbox17" runat="server" Width="128px" MaxLength="25"></asp:textbox></TD>
								</TR>
								<TR>
