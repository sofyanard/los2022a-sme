<%@ Page language="c#" Codebehind="ScoringPenilai.aspx.cs" AutoEventWireup="True" Inherits="SME.CEA.ScoringPenilai" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>ScoringPenilai</title>
				...
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					<TR>
						<TD class="tdNoBorder">
							<TABLE id="Table8">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>Scoring - Penilai</B></TD>
								</TR>
							</TABLE>
						</TD>
					...
					<TR>
						<TD class="tdHeader1" vAlign="top" width="50%" colSpan="2">Scoring Penilai<asp:label id="lbl_no_registrasi" runat="server" Visible="False"></asp:label><asp:label id="lbl_cu_nama" runat="server"></asp:label><asp:label id="lbl_cu_kota" runat="server" Visible="False"></asp:label><asp:label id="lbl_comkota" runat="server" Visible="False"></asp:label></TD>
					</TR>
					<TR>
					...
					<TR id="TR_PERSONAL" runat="server">
						<TD class="td" vAlign="top" width="50%">
							<TABLE id="Table20" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									<TD class="TDBGColor1" style="WIDTH: 351px">Rata-rata Pengalaman Pengurus</TD>
									<TD></TD>
									<TD class="TDBGColorValue"><asp:textbox onkeypress="return kutip_satu()" id="Textbox3" runat="server" Width="160px" MaxLength="15"></asp:textbox>Tahun</TD>
								</TR>
								<TR>
									<TD class="TDBGColor1" style="WIDTH: 351px">Jumlah Tenaga Ahli</TD>
									<TD></TD>
									<TD class="TDBGColorValue"><asp:textbox onkeypress="return kutip_satu()" id="cu_gelarsblm" runat="server" Width="160px"
											MaxLength="15"></asp:textbox>Orang</TD>
								</TR>
								<TR>
									<TD class="TDBGColor1" style="WIDTH: 351px">Jumlah Tenaga Ahli Berregister MAPPI</TD>
									<TD></TD>
									<TD class="TDBGColorValue"><asp:textbox onkeypress="return kutip_satu()" id="Textbox4" runat="server" Width="160px" MaxLength="15"></asp:textbox>Orang</TD>
								</TR>
								<TR>
									<TD class="TDBGColor1" style="WIDTH: 351px; HEIGHT: 28px">Jumlah Tenaga Ahli 
										Berizin Penilai (Termasuk pengurus perusahaan)</TD>
									<TD style="HEIGHT: 28px"></TD>
									<TD class="TDBGColorValue" style="HEIGHT: 28px"><asp:textbox onkeypress="return kutip_satu()" id="cu_gelarssdh" runat="server" Width="160px"
											MaxLength="50"></asp:textbox>Orang</TD>
								</TR>
								<TR>
									<TD class="TDBGColor1" style="WIDTH: 351px">Jumlah Penandatanganan Laporan</TD>
									<TD></TD>
									<TD class="TDBGColorValue" style="HEIGHT: 17px"><asp:textbox onkeypress="return kutip_satu()" id="Textbox5" runat="server" Width="160px" MaxLength="15"></asp:textbox>Orang</TD>
								</TR>
								<TR>
									<TD class="TDBGColor1" style="WIDTH: 351px">Anggota Direksi atau Partner terdaftar 
										di Bapepam</TD>
									<TD></TD>
									<TD class="TDBGColorValue" style="HEIGHT: 17px"><asp:textbox onkeypress="return kutip_satu()" id="Textbox6" runat="server" Width="160px" MaxLength="15"></asp:textbox>Orang</TD>
								</TR>
								<TR>
									<TD class="TDBGColor1" style="WIDTH: 351px">Jumlah Cabang</TD>
									<TD></TD>
									<TD class="TDBGColorValue" style="HEIGHT: 17px">
										<asp:textbox onkeypress="return kutip_satu()" id="Textbox10" runat="server" Width="160px" MaxLength="15"></asp:textbox>Kantor</TD>
								</TR>
								<TR>
									<TD class="TDBGColor1" style="WIDTH: 351px">Jumlah Penilaian dengan nilai asset 
										&gt; Rp. 100 Milyar atau perusahaan Tbk dalam Setahun Terakhir</TD>
									<TD></TD>
									<TD class="TDBGColorValue" style="HEIGHT: 17px"><asp:textbox onkeypress="return kutip_satu()" id="Textbox7" runat="server" Width="160px" MaxLength="15"></asp:textbox></TD>
								</TR> <!-- Additional Field : Right --></TABLE>
						</TD>
						<TD class="td" vAlign="top" width="50%">
							<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" runat="server">
								<TR>
									<TD class="TDBGColor1" style="WIDTH: 284px; HEIGHT: 21px">Reputasi</TD>
								...
								<TR>
									<TD class="TDBGColor1" style="WIDTH: 284px">Kinerja Pembayaran Klaim</TD>
									<TD></TD>
								...
								<TR>
									<TD class="TDBGColor1" style="WIDTH: 284px">Pelayanan</TD>
									<TD></TD>
									<TD class="TDBGColorValue"><asp:radiobutton id="Radiobutton9" runat="server" GroupName="OPT_LMP_D" Text="Baik"></asp:radiobutton>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<asp:radiobutton id="Radiobutton8" runat="server" GroupName="OPT_LMP_D" Text="Cukup" Checked="True"></asp:radiobutton>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<asp:radiobutton id="Radiobutton7" runat="server" GroupName="OPT_LMP_D" Text="Kurang"></asp:radiobutton></TD>
								</TR>
								<TR>
									<TD class="TDBGColor1" style="WIDTH: 284px"></TD>
									<TD></TD>
					...
					<tr>
						<td class="td" colSpan="2">
							<table width="100%">
								...
								<TR>
									<TD class="TDBGColor1" width="20%">Skor Kualitatis</TD>
									<TD>:</TD>
									<TD class="TDBGColorValue" width="30%">
