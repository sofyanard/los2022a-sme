<%@ Page language="c#" Codebehind="DataPerusahaanInput.aspx.cs" AutoEventWireup="True" Inherits="SME.CEA.CBI.DataPerusahaan" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>DataPerusahaan</title>
					...
					<TD class="td" vAlign="top" align="center" width="50%">
						<TABLE id="Table33" cellSpacing="0" cellPadding="0" width="100%">
							...
							<TR>
								...
								<TD style="WIDTH: 15px; HEIGHT: 20px"></TD>
								<TD class="TDBGColorValue" style="HEIGHT: 20px"><asp:dropdownlist id="DDL_CITY_CAB" runat="server" AutoPostBack="True" onselectedindexchanged="DDL_CITY_CAB_SelectedIndexChanged"></asp:dropdownlist></TD>
								<TD><asp:label id="LBL_CITY_CAB" runat="server" Visible="False"></asp:label></TD>
							</TR>
							<TR>
								<TD class="TDBGColor1" style="WIDTH: 100px">Kecamatan</TD>
								<TD style="WIDTH: 15px; HEIGHT: 20px"></TD>
								<TD class="TDBGColorValue" style="HEIGHT: 20px"><asp:dropdownlist id="DDL_KAB_CAB" runat="server" AutoPostBack="True" Enabled="False" onselectedindexchanged="DDL_KAB_CAB_SelectedIndexChanged"></asp:dropdownlist></TD>
								<TD><asp:label id="LBL_KAB_CAB" runat="server" Visible="False"></asp:label></TD>
							</TR>
							<TR>
								<TD class="TDBGColor1">Zipcode</TD>
								<TD>:</TD>
								<TD><asp:textbox id="TXT_ZIPCD_CAB" runat="server" AutoPostBack="True" Columns="5" ontextchanged="TXT_ZIPCD_CAB_TextChanged"></asp:textbox></TD>
