<%@ Page language="c#" Codebehind="AnalisaInput.aspx.cs" AutoEventWireup="True" Inherits="SME.CEA.CBI.AnalisaInput" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>AnalisaInput</title>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table4" width="100%" border="0">
				<TBODY>
					...
					<TR>
						<TD align="center" colSpan="2"><asp:button id="BTN_UPDATE" Text="Update Status" CssClass="button1" Runat="server" Visible="False" onclick="BTN_UPDATE_Click"></asp:button></TD>
					</TR>
				</TBODY>
			</TABLE>
		</form>
