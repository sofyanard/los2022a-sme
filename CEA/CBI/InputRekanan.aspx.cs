...
{
	/// <summary>
	/// Summary description for InputRekanan.
	/// </summary>
	public partial class InputRekanan : System.Web.UI.Page
	{
		...
		protected void BTN_ADD_Click(object sender, EventArgs e)
		{
			...
			/*try 
			{
				KTPExp = Int64.Parse(Tools.toISODate(TXT_TGLEXP_KTP.Text, DDL_BLNEXP_KTP.SelectedValue, TXT_THNEXP_KTP.Text));
			} 
			catch 
			{
				//GlobalTools.popMessage(this, "Tanggal berdiri perusahaan tidak valid!");
