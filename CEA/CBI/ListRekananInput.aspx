<%@ Page language="c#" Codebehind="ListRekananInput.aspx.cs" AutoEventWireup="True" Inherits="SME.CEA.CBI.ListRekanan" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>ListRekanan</title>
							...
							<TABLE class="td" id="Table1" style="WIDTH: 590px; HEIGHT: 200px" cellSpacing="1" cellPadding="1"
								...
								<TR>
									<TD vAlign="bottom" align="center">
										...
										<asp:button id="BTN_NEW" runat="server" Width="200px" Text="New Rekanan" CssClass="button1" onclick="BTN_NEW_Click"></asp:button>
										<% } else { %>
										<% } %>
										&nbsp;
										<asp:button id="btn_Find" runat="server" Width="200px" Text="Existing Rekanan" CssClass="button1" onclick="btn_Find_Click"></asp:button></TD>
								</TR>
							</TABLE>
						</TD>
					</TR>
