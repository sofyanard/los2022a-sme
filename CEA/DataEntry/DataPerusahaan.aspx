<%@ Page language="c#" Codebehind="DataPerusahaan.aspx.cs" AutoEventWireup="True" Inherits="SME.CEA.DataEntry.DataPerusahaan" %>
	...
	<body leftMargin="0" topMargin="0" onload="setMandatory2()" MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE cellSpacing="2" cellPadding="2" width="100%">
				...
				<tr>
					<TD class="tdNoBorder" style="HEIGHT: 41px" align="center" colSpan="2"><asp:placeholder id="MenuDataPerusahaan" runat="server"></asp:placeholder></TD>
				</tr>
				<TR>
