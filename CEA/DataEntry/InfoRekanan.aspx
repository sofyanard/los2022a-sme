<%@ Page language="c#" Codebehind="InfoRekanan.aspx.cs" AutoEventWireup="True" Inherits="SME.CEA.DataEntry.InfoRekanan" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>InfoRekanan</title>
		...
		<form id="Form1" method="post" runat="server">
			<center>
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					...
					<TR>
						<TD vAlign="top" width="50%" colSpan="2">
							<TABLE id="Table7" cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TR>
									<TD style="WIDTH: 648px"><asp:radiobuttonlist id="RDO_RFCUSTOMERTYPE" runat="server" RepeatDirection="Horizontal" AutoPostBack="True" onselectedindexchanged="RDO_RFCUSTOMERTYPE_SelectedIndexChanged"></asp:radiobuttonlist></TD>
									<TD align="right">
										<table style="WIDTH: 363px; HEIGHT: 36px">
											<tr>
												<td class="TDBGColor1" width="130">Nomor Aplikasi</td>
												<td align="right"><asp:textbox id="TXT_NO_REG" Height="28px" Runat="server" Width="222px" ReadOnly="True"></asp:textbox></td>
											</tr>
										</table>
									</TD>
								</TR>
					...
					<TR id="TR_RBI" runat="server">
						<TD class="td" vAlign="top" colSpan="2">
							<TABLE id="Table18" cellSpacing="1" cellPadding="1" width="100%" border="0">
								<TR>
									<TD style="FONT-WEIGHT: bold; WIDTH: 228px">Rekanan Basic Information</TD>
									<TD></TD>
									<TD><asp:radiobuttonlist id="RDO_RBI" runat="server" RepeatDirection="Horizontal" Width="150px">
					...
					<TR>
						<TD class="td" vAlign="top" width="100%" colSpan="2"><ASP:DATAGRID id="DatGridDoc" runat="server" Width="100%" AutoGenerateColumns="False" CellPadding="1"
								AllowPaging="True">
									...
									<TD class="td" vAlign="top" width="50%">
										<TABLE id="Table65" cellSpacing="1" cellPadding="2" width="100%">
											...
											<TR>
												...
												<TD style="WIDTH: 15px; HEIGHT: 39px"></TD>
												<TD class="TDBGColorValue" style="HEIGHT: 39px" align="left"><asp:radiobuttonlist id="RDO_INI" runat="server" RepeatDirection="Horizontal" AutoPostBack="True" Width="150px" onselectedindexchanged="RDO_INI_SelectedIndexChanged">
														<asp:ListItem Value="Y" Selected="True">Ya</asp:ListItem>
														<asp:ListItem Value="N">Tidak</asp:ListItem>
													</asp:radiobuttonlist></TD>
