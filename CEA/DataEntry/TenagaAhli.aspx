<%@ Page language="c#" Codebehind="TenagaAhli.aspx.cs" AutoEventWireup="True" Inherits="dbrbm.Data_Entry.TenagaAhli" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>TenagaAhli</title>
					...
					<TR>
						<TD class="td" vAlign="top" width="50%" colSpan="2">
							<TABLE id="Table6" cellSpacing="0" cellPadding="0" width="100%">
								...
								<TR>
									<TD class="TDBGColor1">Sertifikasi</TD>
									<TD style="WIDTH: 15px"></TD>
					...
					<TR>
						<TD class="td" vAlign="top" align="center" width="50%" colSpan="2"><ASP:DATAGRID id="DatGrd" runat="server" Width="100%" CellPadding="1" AutoGenerateColumns="False"
								...
								<Columns>
									...
									<asp:BoundColumn DataField="bid_keahlian" HeaderText="Bidang Keahlian">
