<%@ Page language="c#" Codebehind="Interview.aspx.cs" AutoEventWireup="True" Inherits="SME.CEA.Interview" %>
				...
				<TABLE id="Table13" cellSpacing="2" cellPadding="2" width="100%">
						...
						<TD class="td" vAlign="top" width="50%">
							<TABLE id="Table6" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									...
									<TD><asp:label id="LBL_DAY" runat="server" Visible="False"></asp:label><asp:label id="LBL_IVW_MONTH" runat="server" Visible="False"></asp:label><asp:label id="LBL_YEAR" runat="server" Visible="False"></asp:label></TD>
								</TR>
								<TR>
						...
						<TD class="td" vAlign="top" width="50%">
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									...
									<TD><asp:label id="LBL_PESERTA1" runat="server" Visible="False"></asp:label></TD>
								</TR>
								<TR>
									...
									<TD><asp:label id="LBL_PESERTA2" runat="server" Visible="False"></asp:label></TD>
								</TR>
								<TR>
									<TD class="TDBGColor1" width="150"></TD>
									<TD style="WIDTH: 15px"></TD>
									<TD class="TDBGColorValue"><asp:textbox id="TXT_PESERTA3" runat="server" Width="300px"></asp:textbox></TD>
									<TD><asp:label id="LBL_PESERTA3" runat="server" Visible="False"></asp:label></TD>
								</TR>
							</TABLE>
						</TD>
					</TR>
					...
					<TR>
						<TD colSpan="2"><ASP:DATAGRID id="DGR_IVW" runat="server" Width="100%" AutoGenerateColumns="False" CellPadding="1"
								...
								<Columns>
									...
									<asp:TemplateColumn HeaderText="HISTORY SKALA" Visible="false">
										<HeaderStyle Width="10%" CssClass="tdSmallHeader"></HeaderStyle>
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
										<ItemTemplate>
											<asp:Label id="LBL_RADIOBUTTON_HIST" runat="server"></asp:Label>
										</ItemTemplate>
									</asp:TemplateColumn>
								</Columns>
						...
						<TD class="td" align="center" colSpan="2">
							<TABLE id="Table1" cellSpacing="1" cellPadding="1" width="100%" align="left" border="1">
								...
								<TR>
									...
									<TD><asp:label id="LBL_SUB_TOT1" runat="server" Visible="False"></asp:label></TD>
								</TR>
								<TR>
									...
									<TD><asp:label id="LBL_COMENT1" runat="server" Visible="False"></asp:label></TD>
								...
								<TR>
									...
									<TD><asp:label id="LBL_SUB_TOT2" runat="server" Visible="False"></asp:label></TD>
								</TR>
								<TR>
									...
									<TD><asp:label id="LBL_COMENT2" runat="server" Visible="False"></asp:label></TD>
								...
								<TR>
									...
									<TD><asp:label id="LBL_SUB_TOT3" runat="server" Visible="False"></asp:label></TD>
								</TR>
								<TR>
									...
									<TD><asp:label id="LBL_COMENT3" runat="server" Visible="False"></asp:label></TD>
								...
								<TR>
									...
									<TD><asp:label id="LBL_SUB_TOT4" runat="server" Visible="False"></asp:label></TD>
								</TR>
								<TR>
									...
									<TD><asp:label id="LBL_COMENT4" runat="server" Visible="False"></asp:label></TD>
								...
								<TR>
									...
									<TD><asp:label id="LBL_SUB_TOT5" runat="server" Visible="False"></asp:label></TD>
								</TR>
								<TR>
									...
									<TD><asp:label id="LBL_COMENT5" runat="server" Visible="False"></asp:label></TD>
								...
								<TR>
									...
									<TD style="HEIGHT: 44px"><asp:label id="LBL_CAT" runat="server" Visible="False" Width="48px" align="center"></asp:label></TD>
								</TR>
								<TR>
					...
					<tr align="center">
						<td class="TDBGColor2" vAlign="top" align="center" width="100%" colSpan="2"><asp:button id="BTN_SAVE" runat="server" CssClass="Button1" Text="Save" onclick="BTN_SAVE_Click"></asp:button>&nbsp;&nbsp;&nbsp;
							...
							<asp:button id="BTN_PRINT" runat="server" CssClass="Button1" Text="Print"></asp:button></td>
					</tr>
					<TR>
