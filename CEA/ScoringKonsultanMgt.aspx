<%@ Page language="c#" Codebehind="ScoringKonsultanMgt.aspx.cs" AutoEventWireup="True" Inherits="SME.CEA.ScoringKonsultanMgt" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>ScoringKonsultanMgt</title>
				...
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					<TR>
						<TD class="tdNoBorder">
							<TABLE id="Table8">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>Scoring - Konsultan 
											Manajemen</B></TD>
								</TR>
							</TABLE>
						</TD>
					...
					<TR>
						<TD class="tdHeader1" vAlign="top" width="50%" colSpan="2">Scoring Konsultan 
							Manajemen<asp:label id="lbl_no_registrasi" runat="server" Visible="False"></asp:label><asp:label id="lbl_cu_nama" runat="server"></asp:label><asp:label id="lbl_cu_kota" runat="server" Visible="False"></asp:label><asp:label id="lbl_comkota" runat="server" Visible="False"></asp:label></TD>
					</TR>
					<TR>
					...
					<TR id="TR_PERSONAL" runat="server">
						<TD class="td" vAlign="top" width="50%">
							<TABLE id="Table20" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									<TD class="TDBGColor1">Pengalaman Pengurus</TD>
									<TD></TD>
									<TD class="TDBGColorValue"><asp:textbox onkeypress="return kutip_satu()" id="Textbox3" runat="server" Width="136px" MaxLength="15"></asp:textbox>Tahun</TD>
								</TR>
								<TR>
									<TD class="TDBGColor1">Jumlah Tenaga Ahli</TD>
									<TD></TD>
									<TD class="TDBGColorValue"><asp:textbox onkeypress="return kutip_satu()" id="cu_gelarsblm" runat="server" Width="136px"
											MaxLength="15"></asp:textbox>Orang</TD>
								</TR>
								<TR>
									<TD class="TDBGColor1">Rata-rata Pengalaman Ahli</TD>
									<TD></TD>
									<TD class="TDBGColorValue"><asp:textbox onkeypress="return kutip_satu()" id="Textbox4" runat="server" Width="136px" MaxLength="15"></asp:textbox>Tahun</TD>
								</TR>
								<TR>
									<TD class="TDBGColor1">Jumlah Proyek</TD>
									<TD></TD>
									<TD class="TDBGColorValue"><asp:textbox onkeypress="return kutip_satu()" id="cu_gelarssdh" runat="server" Width="136px"
											MaxLength="50"></asp:textbox></TD>
								</TR>
								<TR>
									<TD class="TDBGColor1">
										<P>Pengalaman denagan Nilai Proyek/Asset &gt; 300 M /Tbk</P>
									</TD>
									<TD></TD>
									<TD class="TDBGColorValue" style="HEIGHT: 17px"><asp:textbox onkeypress="return kutip_satu()" id="Textbox5" runat="server" Width="135px" MaxLength="15"></asp:textbox></TD>
						...
						<TD class="td" vAlign="top" width="50%">
							<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" runat="server">
								...
								<TR>
									<TD class="TDBGColor1">Kinerja</TD>
									<TD></TD>
