<%@ Page language="c#" Codebehind="GenInfoWatchlist3-1.aspx.cs" AutoEventWireup="True" Inherits="SME.LMS.PortfolioWatchlistChecking.GenInfoWatchlist3_1" %>
<%@ Register TagPrefix="uc1" TagName="DocExport" Src="CommonForm/DocExport.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>GenInfoWatchlist3-1</title>
						...
						<TABLE id="Table10" cellSpacing="0" cellPadding="0" width="100%">
							<TR>
								...
								<TD class="TDBGColorValue"><asp:textbox onkeypress="return numbersonly()" id="TXT_TGL_NOTA" runat="server" Width="24px"
										...
										ReadOnly="True" MaxLength="4" Columns="4"></asp:textbox></TD>
							</TR>
							<TR>
				...
				<tr>
					<td colSpan="3">
						<table id="Table33" cellSpacing="0" cellPadding="0" width="100%">
							...
							<tr>
								<td class="TDBGColor2" colSpan="2"><asp:button id="Button1" CssClass="button1" Runat="server" Text="SAVE" onclick="Button1_Click"></asp:button>&nbsp;<asp:button id="BTN_CLEAR_PERIODE" CssClass="button1" Runat="server" Text="CLEAR" onclick="BTN_CLEAR_PERIODE_Click"></asp:button>
								</td>
							</tr>
							<tr>
								<td></td>
							...
							<TR>
								<td>
									<table>
										<TR>
											<TD class="TDBGColor1" style="WIDTH: 129px">Advice Assign to</TD>
											<TD style="WIDTH: 15px">:</TD>
											<TD class="TDBGColorValue"><asp:dropdownlist id="DDL_ASG" Width="200px" Runat="server" AutoPostBack="True" Enabled="False"></asp:dropdownlist></TD>
										</TR>
									</table>
								</td>
							</TR>
							<tr>
								<td class="TDBGColor2" colSpan="2"><asp:button id="BTN_FWD" CssClass="button1" Runat="server" Text="FORWARD TO ACCEPT" onclick="BTN_FWD_Click"></asp:button></td>
							</tr>
						</table>
					</td>
				</tr>
