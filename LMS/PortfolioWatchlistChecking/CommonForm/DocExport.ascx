<%@ Control Language="c#" AutoEventWireup="True" Codebehind="DocExport.ascx.cs" Inherits="SME.LMS.PortfolioWatchlistChecking.CommonForm.DocExport" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
	<TR>
		<TD class="tdHeader1" vAlign="top" width="50%" colSpan="2">Nota Analisa</TD>
	</TR>
	<TR>
