...
<%@ Page language="c#" Codebehind="GenInfoWatchlist2.aspx.cs" AutoEventWireup="True" Inherits="SME.LMS.PortfolioWatchlistChecking.GenInfoWatchlist2" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>GenInfoWatchlist2</title>
			...
			<TABLE id="Table4" width="100%" border="0">
				...
				<TR>
					<TD class="td" vAlign="top" width="50%">
						...
						<asp:label id="LBL_LOAN_TYPE_ID" runat="server" Visible="False"></asp:label><asp:label id="LBL_USERID" runat="server" Visible="False"></asp:label></TD>
					<TD class="td" vAlign="top" width="50%">
						<TABLE id="Table10" cellSpacing="0" cellPadding="0" width="100%">
							<TR>
								...
								<TD class="TDBGColorValue"><asp:textbox onkeypress="return numbersonly()" id="TXT_TGL_NOTA" runat="server" ReadOnly="True"
										Width="24px" Columns="4" MaxLength="2"></asp:textbox><asp:dropdownlist id="DDL_BLN_NOTA" runat="server" Enabled="False"></asp:dropdownlist><asp:textbox onkeypress="return numbersonly()" id="TXT_THN_NOTA" runat="server" ReadOnly="True"
				...
				<tr>
					<td colSpan="3">
						<table id="Table33" cellSpacing="0" cellPadding="0" width="100%">
							...
							<tr>
								<td class="TDBGColor2" colSpan="2"><asp:button id="BTN_ACCEPT" Text="ACCEPT" Runat="server" CssClass="button1" onclick="BTN_ACCEPT_Click"></asp:button>&nbsp;<asp:button id="BTN_ACQ" Text="ACQUIRE INFO" Runat="server" CssClass="button1" onclick="BTN_ACQ_Click"></asp:button>
								</td>
							</tr>
						</table>
					</td>
