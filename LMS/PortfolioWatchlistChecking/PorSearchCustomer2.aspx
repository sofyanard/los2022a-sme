<%@ Page language="c#" Codebehind="PorSearchCustomer2.aspx.cs" AutoEventWireup="false" Inherits="SME.LMS.PortfolioWatchlistChecking.PorSearchCustomer2" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>PorSearchCustomer2</title>
				...
				<TABLE id="Table4" width="100%" border="0">
					<TR>
						<TD align="left" colSpan="1">
							<TABLE id="Table3">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>Portfolio Watchlist 
											Checking</B></TD>
								</TR>
							</TABLE>
						</TD>
							...
							<TABLE class="td" id="Table1" style="WIDTH: 590px; HEIGHT: 124px" cellSpacing="1" cellPadding="1"
								...
								<TR>
									<TD vAlign="bottom" align="center">
										...
										<asp:button id="BTN_NEW" runat="server" Width="200px" Text="New LMS" CssClass="button1"></asp:button>&nbsp;
										<asp:button id="btn_Find" runat="server" Width="200px" Text="Existing LMS" CssClass="button1"></asp:button></TD>
								</TR>
							</TABLE>
						</TD>
					</TR>
