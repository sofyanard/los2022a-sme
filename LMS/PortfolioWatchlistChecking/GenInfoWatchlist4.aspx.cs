...
{
	/// <summary>
	/// Summary description for GenInfoWatchlist4.
	/// </summary>
	public partial class GenInfoWatchlist4 : System.Web.UI.Page
	{
		...
		{    
			...
			this.DATGRD_PORTFOLIO.ItemCommand += new System.Web.UI.WebControls.DataGridCommandEventHandler(this.DATGRD_PORTFOLIO_ItemCommand);
		...
		private void DATGRD_PORTFOLIO_ItemCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
		...
		{
			Response.Redirect("RevFinishWC.aspx?tc=" + Request.QueryString["tc"] + "&mc=" + Request.QueryString["mc"] );
		}
