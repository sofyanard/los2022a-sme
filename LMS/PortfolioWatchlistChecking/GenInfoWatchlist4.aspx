...
<%@ Page language="c#" Codebehind="GenInfoWatchlist4.aspx.cs" AutoEventWireup="True" Inherits="SME.LMS.PortfolioWatchlistChecking.GenInfoWatchlist4" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>GenInfoWatchlist4</title>
					...
					<TD class="td" vAlign="top" width="50%">
						<TABLE id="Table6" cellSpacing="0" cellPadding="0" width="100%">
							<TR>
								...
								<TD class="TDBGColorValue"><asp:textbox id="TXT_NO_NOTA" runat="server" BorderStyle="None" ReadOnly="True" Width="300px"></asp:textbox></TD>
							</TR>
							<TR>
								<TD class="TDBGColor1">Periode</TD>
								<TD style="WIDTH: 15px">:</TD>
								<TD class="TDBGColorValue"><asp:textbox id="TXT_PERIODE" runat="server" BorderStyle="None" ReadOnly="True" Width="300px"></asp:textbox></TD>
							</TR>
							<TR>
								<TD class="TDBGColor1">No. LMS</TD>
								<TD style="WIDTH: 15px">:</TD>
								<TD class="TDBGColorValue"><asp:textbox id="TXT_NO_LMS" runat="server" BorderStyle="None" ReadOnly="True" Width="300px"></asp:textbox></TD>
							</TR>
						</TABLE>
					...
					<TD class="td" vAlign="top" width="50%">
						<TABLE id="Table10" cellSpacing="0" cellPadding="0" width="100%">
							<TR>
								...
								<TD style="WIDTH: 15px">:</TD>
								<TD class="TDBGColorValue"><asp:textbox onkeypress="return numbersonly()" id="TXT_TGL_NOTA" runat="server" ReadOnly="True"
										Width="24px" Columns="4" MaxLength="2"></asp:textbox><asp:dropdownlist id="DDL_BLN_NOTA" runat="server" Enabled="False"></asp:dropdownlist><asp:textbox onkeypress="return numbersonly()" id="TXT_THN_NOTA" runat="server" Width="36px"
										Columns="4" MaxLength="4" Enabled="False"></asp:textbox></TD>
							</TR>
							<TR>
								<TD class="TDBGColor1">Analyst</TD>
								<TD>:</TD>
								<TD class="TDBGColorValue" style="HEIGHT: 17px"><asp:textbox id="TXT_ANALYST" runat="server" BorderStyle="None" ReadOnly="True" Width="300px"></asp:textbox></TD>
							</TR>
							<TR>
								<TD class="TDBGColor1">LMS Date</TD>
								<TD>:</TD>
								<TD class="TDBGColorValue" style="HEIGHT: 17px"><asp:textbox id="TXT_LMS_DATE" runat="server" ReadOnly="True" Width="300px"></asp:textbox></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
				<tr>
					<td colSpan="3">
						<table id="Table33" cellSpacing="0" cellPadding="0" width="100%">
							...
							<tr>
								<td class="TDBGColor2" colSpan="2"><asp:button id="Button1" Text="SAVE" Runat="server" CssClass="button1" onclick="Button1_Click"></asp:button>&nbsp;<asp:button id="BTN_CLEAR_PERIODE" Visible="False" Text="CLEAR" Runat="server" CssClass="button1" onclick="BTN_CLEAR_PERIODE_Click"></asp:button>
								</td>
							</tr>
							<tr>
								<td></td>
							...
							<TR>
								<td>
									<table>
										<TR>
											<TD class="TDBGColor1" style="WIDTH: 129px">Assign to Advice</TD>
											<TD style="WIDTH: 15px">:</TD>
											<TD class="TDBGColorValue"><asp:dropdownlist id="DDL_ASG" Width="200px" Runat="server" Enabled="False" AutoPostBack="True"></asp:dropdownlist></TD>
											<td>&nbsp;<asp:button id="BTN_ASG" Width="141px" Visible="False" Text="Assign to Advice" Runat="server"
							...
							<tr>
								<td class="TDBGColor2" colSpan="2"><asp:button id="BTN_FINISH" CssClass="button1" Runat="server" Text="FINISH" onclick="BTN_FINISH_Click"></asp:button></td>
							</tr>
						</table>
					</td>
				</tr>
