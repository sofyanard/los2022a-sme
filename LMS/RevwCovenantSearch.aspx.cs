...
{
	/// <summary>
	/// Summary description for RevwCovenantSearch.
	/// </summary>
	public partial class RevwCovenantSearch : System.Web.UI.Page
	{
		...
		{
			string qry = "SELECT * FROM VW_REVIEWCOVENANT_FINDCUST WHERE 1=1 ";
