...
{
	/// <summary>
	/// Summary description for RptDebiturDetail.
	/// </summary>
	public partial class RptDebiturDetail : System.Web.UI.Page
	{
		...
		{
			string uid, tgl1, tgl2, bu, area, cbc, br, rm, cif, cunm;
			...
			cif = TXT_CU_CIF.Text;
			cunm = TXT_CU_NAME.Text;

			//ReportViewer1.ReportPath = "/SMEReports/LMSRptDebiturDetail&uid=" + uid + "&tgl1=" + tgl1 + "&tgl2=" + tgl2 + "&bu=" + bu + "&area=" + area + "&cbc=" + cbc + "&br=" + br + "&rm=" + rm + "&cif=" + cif + "&cunm=" + cunm + "&rs:Command=Render";
            ...
            ReportViewer2.ServerReport.ReportPath = "/SMEReports/LMSRptDebiturDetail";
            ...
            paramList.Add(new ReportParameter("cif", cif, false));
            paramList.Add(new ReportParameter("cunm", cunm, false));
