<%@ Page language="c#" Codebehind="ListDocTrack.aspx.cs" AutoEventWireup="True" Inherits="SME.DocumentTracking.ListDocTrack" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<center>
				<TABLE id="Table4" width="100%" border="0" DESIGNTIMEDRAGDROP="10">
					<TR>
						<TD align="left" colSpan="1">
							<TABLE id="Table3">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>Document 
											Tracking&nbsp;List</B></TD>
								</TR>
							</TABLE>
						</TD>
								...
								<TR>
									<TD vAlign="top" align="center">
										<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
											<TR>
												<TD class="TDBGColor1" width="170">Nomor Aplikasi</TD>
												<TD width="5"></TD>
												<TD class="TDBGColorValue">
													<asp:textbox onkeypress="return kutip_satu()" id="TXT_REGNO" runat="server" MaxLength="20" Width="200px"></asp:textbox></TD>
											</TR>
											<TR>
											...
											<TR>
												<TD vAlign="top" align="center" colSpan="3" height="10">
													<asp:button id="btn_Find" runat="server" Text="Find" Width="81px" CssClass="button1" onclick="btn_Find_Click"></asp:button>&nbsp;
												</TD>
											</TR>
										</TABLE>
									</TD>
					...
					<TR>
						<TD colSpan="2">
							<ASP:DATAGRID id="DatGrd" runat="server" Width="100%" CellPadding="1" AutoGenerateColumns="False"
								...
								<Columns>
									<asp:BoundColumn DataField="AP_REGNO" HeaderText="Nomor Aplikasi">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
									</asp:BoundColumn>
									<asp:BoundColumn DataField="CU_REF" HeaderText="Nomor Customer">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
									</asp:BoundColumn>
