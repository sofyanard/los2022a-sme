<%@ Page language="c#" Codebehind="AIP2.aspx.cs" AutoEventWireup="True" Inherits="SME.InitialDataEntry.AIP2" %>
		...
		<form id="Form1" method="post" runat="server">
			<center>
				<TABLE cellSpacing="0" cellPadding="0" width="100%">
						...
						<TD style="WIDTH: 669px; HEIGHT: 102px" align="right" colSpan="2">
							<TABLE id="Table4" width="100%">
								<TR>
									...
									<TD style="HEIGHT: 24px"><asp:textbox id="TXT_NO" runat="server" ForeColor="Black" Font-Size="X-Small" MaxLength="100"
											Width="200px">123456</asp:textbox><FONT face="Tahoma" size="2"><STRONG></STRONG></FONT></TD>
								</TR>
								<TR>
									<TD style="WIDTH: 78px; HEIGHT: 23px"><FONT face="Tahoma" size="2">Tanggal</FONT></TD>
									<TD style="HEIGHT: 23px"><FONT face="Tahoma" size="2">:</FONT></TD>
									<TD style="HEIGHT: 23px"><FONT face="Tahoma" size="2"><asp:textbox id="TXT_CURTIME" runat="server" ForeColor="Black" MaxLength="100" Width="200px"
												ReadOnly="True" Font-Size="X-Small"></asp:textbox><STRONG></STRONG></FONT></TD>
								</TR>
								<TR>
									<TD style="WIDTH: 78px"><FONT face="Tahoma" size="2">Lampiran</FONT></TD>
									<TD><FONT face="Tahoma" size="2">:</FONT></TD>
									<TD><asp:textbox id="TXT_LAMP" runat="server" ForeColor="Black" MaxLength="100" Width="200px" Font-Size="X-Small">-</asp:textbox></TD>
								</TR>
							</TABLE>
						</TD>
					...
					<TR>
						<TD style="HEIGHT: 20px" vAlign="top" align="left" width="100%" colSpan="2"></TD>
					</TR>
					<TR>
							...
							<P>
								<TABLE id="Table5" cellSpacing="1" cellPadding="1" width="100%" align="center" border="0">
									<TBODY>
										...
										<TR>
											<TD style="HEIGHT: 3px" align="left" width="100%"><asp:textbox id="TXT_CUST_NAME" runat="server" ForeColor="Black" MaxLength="100" Width="200px"
													Font-Size="X-Small"></asp:textbox><FONT face="Tahoma" size="2"><STRONG></STRONG></FONT></TD>
										</TR>
										<TR>
											<TD style="HEIGHT: 23px" align="left" width="100%"><asp:textbox id="TXT_ADDR" runat="server" ForeColor="Black" MaxLength="100" Width="200px" Font-Size="X-Small"></asp:textbox><FONT face="Tahoma" size="2"><STRONG></STRONG></FONT></TD>
										</TR>
										<TR>
										...
										<TR>
											<TD style="HEIGHT: 20px" align="left" width="100%"><asp:textbox id="TXT_CITY" runat="server" ForeColor="Black" MaxLength="100" Width="200px" Font-Size="X-Small"></asp:textbox><FONT face="Tahoma" size="2"><STRONG></STRONG></FONT></TD>
										</TR>
										<TR>
											<TD align="left" width="100%"><asp:textbox id="TXT_POSTCODE" runat="server" ForeColor="Black" MaxLength="100" Width="200px"
													Font-Size="X-Small"></asp:textbox><FONT face="Tahoma" size="2"><STRONG></STRONG></FONT></TD>
										</TR>
										<TR>
										</TR>
					...
					<TR>
						<TD vAlign="top" align="left" width="100%" colSpan="2"><P><FONT face="Tahoma"><FONT size="2">Perihal 
							...
							<P><STRONG><FONT face="Tahoma" size="2">
										<asp:textbox id="TXT_NOMINAL_CP_LIMIT" runat="server" ForeColor="Black" MaxLength="100" Width="192px"
											ReadOnly="True" Font-Size="X-Small" BorderStyle="Ridge" Visible="False"></asp:textbox></FONT></STRONG></P>
						</TD>
						<TD vAlign="top" align="left" width="100%"></TD>
					</TR>
					<TR>
						<TD vAlign="top" align="left" width="100%" colSpan="2"><P class="MsoNormal"><SPAN style="TEXT-ALIGN: justify; mso-ansi-language: EN-US"><FONT face="Tahoma" size="2">Terima 
										...
										kredit </FONT>
									<asp:textbox id="TXT_PRODUCTDESC1" runat="server" ForeColor="Black" MaxLength="100" Width="450px"
										Font-Size="X-Small"></asp:textbox>,<FONT face="Tahoma" size="2">dengan ini kami 
										beritahukan bahwa secara prinsip Bank Mandiri dapat menyetujui permohonan 
										kredit&nbsp; </FONT>
									<asp:textbox id="TXT_PRODUCTDESC2" runat="server" ForeColor="Black" MaxLength="100" Width="450px"
										Font-Size="X-Small"></asp:textbox><FONT face="Tahoma" size="2">&nbsp; Saudara 
										dengan limit sementara sebesar Rp.&nbsp; </FONT>
									<asp:textbox id="TXT_CP_LIMIT" runat="server" ForeColor="Black" MaxLength="100" Width="112px"
				...
				<TABLE cellSpacing="1" cellPadding="1" width="100%" align="center" border="0">
					...
					<TR>
						<TD style="HEIGHT: 703px" vAlign="top" align="center" width="3%"></TD>
						<TD style="HEIGHT: 703px" vAlign="top" align="center" width="100%"><asp:panel id="PNL_PERSONAL" runat="server" Height="676px" DESIGNTIMEDRAGDROP="750">
								<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
									<TR>
										<TD style="HEIGHT: 18px" width="3%"><FONT face="Tahoma" size="2"></FONT></TD>
										<TD style="WIDTH: 19px; HEIGHT: 18px" borderColor="black" align="center" width="19"><FONT face="Tahoma" size="2">a.</FONT></TD>
										<TD style="HEIGHT: 18px" borderColor="black"><FONT face="Tahoma" size="2">Copy 
									...
									<TR>
										<TD width="3%"><FONT face="Tahoma" size="2"></FONT></TD>
										<TD style="WIDTH: 19px" borderColor="black" align="center" width="19"><FONT face="Tahoma" size="2">d.</FONT></TD>
									...
									<TR>
										...
										<TD borderColor="#000000"><FONT face="Tahoma" size="2">&nbsp;&nbsp;&nbsp; </FONT>
											<asp:TextBox id="TXT_LGL" runat="server" Width="248px" Font-Size="X-Small" ForeColor="Black"
									...
									<TR>
										...
										<TD borderColor="black"><FONT face="Tahoma" size="2">NPWP</FONT></TD>
									</TR>
									<TR>
									...
									<TR>
										...
										<TD borderColor="black"><FONT face="Tahoma" size="2">SPT Pajak tahun terakhir</FONT></TD>
									</TR>
									<TR>
										<TD width="3%"><FONT face="Tahoma" size="2"></FONT></TD>
						...
						<TD style="HEIGHT: 703px" vAlign="top" align="center" width="100%"></TD>
					</TR>
					<TR>
						<TD style="HEIGHT: 71px" width="3%"></TD>
						<TD style="HEIGHT: 71px" align="justified" width="100%">
					...
					<TR>
						...
						<TD align="justified" width="100%">
							<P><FONT style="TEXT-ALIGN: justify" face="Tahoma" size="2">Dalam hal dokumen yang 
					...
					<TR>
						...
						<TD style="HEIGHT: 30px" align="justified" width="100%"><FONT style="TEXT-ALIGN: justify" face="Tahoma" size="2">Apabila 
					...
					<TR>
						...
						<TD align="justified" width="100%"><FONT face="Tahoma" size="2">Apabila dari hasil 
								...
								<asp:textbox id="TXT_PRODUCTDESC3" runat="server" ForeColor="Black" MaxLength="100" Width="450px"
									Font-Size="X-Small"></asp:textbox>&nbsp;Saudara.</FONT></TD>
						<TD width="100%"></TD>
					</TR>
					<TR>
						<TD width="3%"></TD>
					...
					<TR>
						<TD width="3%"></TD>
						<TD align="justified" width="100%"><FONT style="TEXT-ALIGN: justify" face="Tahoma" size="2">Apabila 
					...
					<TR>
						<TD width="3%"></TD>
						<TD width="100%"><asp:textbox id="TXT_BRANCH" runat="server" ForeColor="Black" Font-Size="X-Small" MaxLength="100"
								Width="200px"></asp:textbox></TD>
						<TD width="100%"></TD>
					</TR>
					<TR>
						<TD style="HEIGHT: 101px" vAlign="bottom" width="3%"></TD>
						<TD style="HEIGHT: 101px" vAlign="bottom" width="100%"><asp:textbox id="TXT_OFFICER" runat="server" ForeColor="Black" Font-Size="X-Small" MaxLength="100"
								Width="200px"></asp:textbox></TD>
						<TD style="HEIGHT: 101px" vAlign="bottom" width="100%"></TD>
					</TR>
					<TR>
						<TD width="3%"></TD>
						<TD width="100%"><FONT face="Tahoma" size="2"><asp:textbox id="TXT_BO" runat="server" ForeColor="Black" Font-Size="X-Small" MaxLength="100"
									Width="200px"></asp:textbox></FONT></TD>
						<TD width="100%"></TD>
					</TR>
					<TR>
						<TD align="center" width="3%"></TD>
						<TD align="center" width="100%"></FONT></TD>
						<TD align="center" width="100%"></TD>
					</TR>
					<tr>
						<TD align="center" width="3%"></TD>
						<td align="center" width="100%">&nbsp;&nbsp;&nbsp;
							<asp:button id="PrintBtn" runat="server" CssClass="Button1" Text="Print" Width="75px" onclick="PrintBtn_Click"></asp:button></td>
						<TD align="center" width="100%"></TD>
					</tr>
				</TABLE>
		</form>
