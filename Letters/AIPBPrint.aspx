<%@ Page language="c#" Codebehind="AIPBPrint.aspx.cs" AutoEventWireup="True" Inherits="SME.InitialDataEntry.AIPBPrint" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>AIPBPrint</title>
		<script language="javascript">
function print_frame() {
	window.parent.frameaip1.focus();
	window.print();
}
		</script>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" style="Z-INDEX: 101; LEFT: 8px; POSITION: absolute; TOP: 8px" cellSpacing="1"
				...
				<TR>
					<TD></TD>
					<TD align="center">
						<INPUT id="BTN_PRINT" CssClass="Button1" onclick="print_frame(); window.close();" type="button" value="Print"
