<%@ Page language="c#" Codebehind="RejectLetterAll.aspx.cs" AutoEventWireup="True" Inherits="SME.Letters.RejectLetterAll" %>
				...
				<TABLE cellSpacing="1" cellPadding="1" width="100%">
						...
						<TD style="WIDTH: 655px; HEIGHT: 68px" align="right" colSpan="2">
							<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TR>
									...
									<TD style="HEIGHT: 20px"><asp:textbox id="LBL_NO" runat="server" Width="200px" MaxLength="50" ForeColor="Black" Font-Size="X-Small">12345678
									</asp:textbox><FONT face="Tahoma" size="2"></FONT>
									</TD>
								</TR>
								<TR>
					...
					<TR>
						...
						<TD style="WIDTH: 666px; HEIGHT: 69px" align="left"><B><FONT face="Tahoma" size="2">
									...
									<asp:Label id="Label7" runat="server" ForeColor="White"></asp:Label></FONT></B></TD>
					...
					<TR>
						...
						<TD style="WIDTH: 666px" align="left" colSpan="2"><FONT face="Tahoma"><FONT size="2">
									...
									<asp:Label id="Label4" runat="server" Font-Size="X-Small" Font-Bold="True"> Permohonan Kredit Saudara</asp:Label></FONT></FONT></TD>
					</TR>
					<TR>
						<TD style="WIDTH: 119px" align="left"></TD>
						<TD style="WIDTH: 666px" align="left" colSpan="2"></TD>
					...
					<TR>
						...
						<TD style="WIDTH: 666px; HEIGHT: 26px" align="left" colSpan="2">
							<P class="MsoNormal"><SPAN style="mso-ansi-language: EN-US"><asp:label id="LBL_BODY11" runat="server" Font-Size="X-Small" ForeColor="Black"></asp:label>
									<asp:label id="LBL_BODY12" runat="server" Font-Size="X-Small" ForeColor="Black"></asp:label></SPAN><SPAN style="mso-ansi-language: EN-US">
									<o:p></o:p></SPAN></P>
						</TD>
					</TR>
					<TR>
						...
						<TD style="WIDTH: 666px; HEIGHT: 25px" align="left" colSpan="2">
							<asp:Table id="ProductTable" runat="server" Font-Size="X-Small" Visible="False"></asp:Table></TD>
					</TR>
					<TR>
						...
						<TD style="WIDTH: 666px" align="left" colSpan="2">
							<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
								...
								<TR>
									<TD style="HEIGHT: 23px">
										<P class="MsoNormal"><SPAN style="mso-ansi-language: EN-US"><FONT size="2">
													<asp:textbox id="TXT_BRANCH1" runat="server" Font-Size="X-Small" ForeColor="Black" MaxLength="50"
								...
								<TR>
									<TD>
										<P class="MsoNormal"><SPAN style="mso-ansi-language: EN-US">
												<asp:textbox id="TXT_BRANCH2" runat="server" Font-Size="X-Small" ForeColor="Black" MaxLength="50"
				...
				<TABLE cellSpacing="2" cellPadding="2" width="100%" align="center" border="0">
					...
					<tr>
						<td align="center" width="100%">&nbsp;
							<asp:button id="PrintBtn" runat="server" CssClass="Button1" Text="Print Reject Letter" onclick="PrintBtn_Click"></asp:button>&nbsp;
							<asp:button id="BackBtn" runat="server" Text="Back To Initial Data Entry" CssClass="Button1" onclick="BackBtn_Click"></asp:button>
						</td>
					</tr>
				</TABLE>
		</form>
