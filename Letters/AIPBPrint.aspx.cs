...
namespace SME.InitialDataEntry
{
	...
	public partial class AIPBPrint : System.Web.UI.Page
	{
		...
		private void view() 
		{
			...
			this.PH1.Controls.Add(new LiteralControl("<iframe src='AIP1Print.aspx?TXT_NO=" + TXT_NO + "&TXT_CURTIME=" + TXT_CURTIME + "&TXT_LAMP=" + TXT_LAMP+ "&TXT_PRODUCTDESC1=" + TXT_PRODUCTDESC1 + 
				...
				"&TXT_NOMINAL_CP_LIMIT=" + TXT_NOMINAL_CP_LIMIT+"&regno="+ REGNO + "' id='frameaip1' frameborder='0' width=1000 height=2000></iframe>"));			
		}
