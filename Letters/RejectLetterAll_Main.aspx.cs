...
namespace SME.SPPK
{
	...
	public partial class RejectLetterAll_Main : System.Web.UI.Page
	{
		...
		private void view() 
		{
			...
			string apptype = Request.QueryString["apptype"];
			...
			this.PH1.Controls.Add(new LiteralControl("<iframe src='RejectLetterAllPrint.aspx?regno=" + regno +"&apptype=" + apptype + "&nomor=" + par1 + "&curtime=" + par2 + "&cu_name=" + par3 + "&ADDR1=" + par4 + 
				"&CITY=" + par5 + "&MNGR=" + par6 + "&ZIPCODE=" + par7 + "&BRANCH1=" + BRANCH1 + "&BRANCH2=" + BRANCH2 + "&PRODUCTDESC=" + par8 +"' id='framereject' frameborder='0' width=1000 height=1000></iframe>"));			
		}
	}
}
