...
{ 
	public partial class AIP2 : System.Web.UI.Page
	{
		...
		//protected Connection conn = new Connection("Data Source=10.123.12.30;Initial Catalog=SMEDEV;uid=sa;pwd=");asdfasdf
		...
		{	
			Response.Redirect("AIPB2Print.aspx?TXT_NO=" + TXT_NO.Text + "&TXT_CURTIME= " + TXT_CURTIME.Text + "&TXT_LAMP=" + TXT_LAMP.Text + 
