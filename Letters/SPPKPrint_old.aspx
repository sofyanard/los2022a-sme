<%@ Page language="c#" Codebehind="SPPKPrint_old.aspx.cs" AutoEventWireup="True" Inherits="SME.SPPK.SPPKPrint_old" %>
					...
					<TR id="TRPRINT">
						<TD class="tdHeader1" align="left" width="6%" colSpan="3" style="HEIGHT: 21px"><asp:label id="LBL_REGNO" runat="server" Visible="False"></asp:label>
							<INPUT type="button" value="Print" onclick="cetak()" class="button1" style="WIDTH: 49px; HEIGHT: 26px"
								id="TRPrint"> 
								<INPUT class="button1" onclick = "javascript:history.back()" style="WIDTH: 49px; HEIGHT: 26px" onclick="cetak()" type="button"
								value="Back">
