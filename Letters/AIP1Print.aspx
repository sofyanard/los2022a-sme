<%@ Page language="c#" Codebehind="AIP1Print.aspx.cs" AutoEventWireup="True" Inherits="SME.InitialDataEntry.AIP1Print" %>
			...
			<center>
				<TABLE cellSpacing="0" cellPadding="0" width="100%">
						...
						<TD style="WIDTH: 669px; HEIGHT: 102px" align="right" colSpan="2">
							<TABLE id="Table4" width="100%">
								<TR>
									...
									<TD style="WIDTH: 6px; HEIGHT: 24px"><FONT face="Tahoma" size="2">:</FONT></TD>
									<TD style="HEIGHT: 24px"><asp:label id="LBL_NO" runat="server" ForeColor="#0000C0" Font-Size="X-Small" MaxLength="100"></asp:label><FONT face="Tahoma" size="2"><STRONG></STRONG></FONT></TD>
								</TR>
								<TR>
									<TD style="WIDTH: 78px; HEIGHT: 24px"><FONT face="Tahoma" size="2">Tanggal</FONT></TD>
									<TD style="WIDTH: 6px; HEIGHT: 24px"><FONT face="Tahoma" size="2">:</FONT></TD>
									<TD style="HEIGHT: 24px"><FONT face="Tahoma" size="2"><asp:label id="LBL_CURTIME" runat="server" ForeColor="#0000C0" MaxLength="100" ReadOnly="True"
												Font-Size="X-Small"></asp:label><STRONG></STRONG></FONT></TD>
								</TR>
								<TR>
									<TD style="WIDTH: 78px"><FONT face="Tahoma" size="2">Lampiran</FONT></TD>
									<TD style="WIDTH: 6px"><FONT face="Tahoma" size="2">:</FONT></TD>
									<TD><asp:label id="LBL_LAMP" runat="server" ForeColor="#0000C0" MaxLength="100" Font-Size="X-Small"></asp:label></TD>
								</TR>
							</TABLE>
						</TD>
							...
							<P>
								<TABLE id="Table5" cellSpacing="1" cellPadding="1" width="100%" align="center" border="0">
									<TBODY>
										...
										<TR>
											<TD style="HEIGHT: 3px" align="left" width="100%"><asp:label id="LBL_CUST_NAME" runat="server" ForeColor="#0000C0" MaxLength="100" ReadOnly="True"
													Font-Size="X-Small"></asp:label><FONT face="Tahoma" size="2"><STRONG></STRONG></FONT></TD>
										</TR>
										<TR>
											<TD style="HEIGHT: 23px" align="left" width="100%"><asp:label id="LBL_ADDR" runat="server" ForeColor="#0000C0" MaxLength="100" ReadOnly="True"
													Font-Size="X-Small"></asp:label><FONT face="Tahoma" size="2"><STRONG></STRONG></FONT></TD>
										</TR>
										<TR>
											<TD style="HEIGHT: 23px" align="left" width="100%">
												<asp:label id="LBL_ADDR2" runat="server" MaxLength="100" Font-Size="X-Small" ForeColor="#0000C0"
													ReadOnly="True"></asp:label></TD>
										</TR>
										<TR>
											<TD style="HEIGHT: 23px" align="left" width="100%">
												<asp:label id="LBL_ADDR3" runat="server" MaxLength="100" Font-Size="X-Small" ForeColor="#0000C0"
													ReadOnly="True"></asp:label></TD>
										</TR>
										<TR>
											<TD style="HEIGHT: 20px" align="left" width="100%"><asp:label id="LBL_CITY" runat="server" ForeColor="#0000C0" MaxLength="100" ReadOnly="True"
													Font-Size="X-Small"></asp:label><FONT face="Tahoma" size="2"><STRONG></STRONG></FONT></TD>
										</TR>
										<TR>
											<TD align="left" width="100%"><asp:label id="LBL_POSTCODE" runat="server" ForeColor="#0000C0" MaxLength="100" ReadOnly="True"
													Font-Size="X-Small"></asp:label><FONT face="Tahoma" size="2"><STRONG></STRONG></FONT></TD>
										</TR>
										<TR>
										</TR>
					...
					<TR>
						<TD vAlign="top" align="left" width="100%" colSpan="2"><P><FONT face="Tahoma"><FONT size="2">Perihal 
							...
							<P><STRONG><FONT face="Tahoma" size="2">
										<asp:label id="LBL_NOMINAL_CP_LIMIT" runat="server" ForeColor="Black" MaxLength="100" ReadOnly="True"
					...
					<TR>
						<TD vAlign="top" align="left" width="100%" colSpan="2"><P class="MsoNormal"><SPAN style="TEXT-ALIGN: justify; mso-ansi-language: EN-US"><FONT face="Tahoma" size="2">Terima 
										...
										kredit </FONT>
									<asp:label id="LBL_PRODUCTDESC1" runat="server" ForeColor="#0000C0" MaxLength="100" ReadOnly="True"
										Font-Size="X-Small"></asp:label>, &nbsp;<FONT face="Tahoma" size="2">dengan ini 
										kami beritahukan bahwa secara prinsip Bank Mandiri dapat menyetujui permohonan 
										kredit&nbsp; </FONT>
									<asp:label id="LBL_PRODUCTDESC2" runat="server" ForeColor="#0000C0" MaxLength="100" ReadOnly="True"
										Font-Size="X-Small"></asp:label><FONT face="Tahoma" size="2">&nbsp; Saudara 
										dengan limit sementara sebesar Rp.&nbsp; </FONT>
									<asp:label id="LBL_CP_LIMIT" runat="server" ForeColor="#0000C0" MaxLength="100" ReadOnly="True"
				...
				<TABLE cellSpacing="1" cellPadding="1" width="100%" align="center" border="0">
					...
					<TR>
						...
						<TD style="HEIGHT: 34px" vAlign="top" align="center" width="100%">
						...
						<TD style="HEIGHT: 34px" vAlign="top" align="center" width="100%"></TD>
					</TR>
					</TR>
					<TR>
						<TD vAlign="top" align="center" width="3%"></TD>
						<TD vAlign="top" align="center" width="100%"><asp:panel id="PNL_COMP" runat="server" Height="600px" BorderColor="Black">
								<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
									<TBODY>
										...
										<TR>
											<TD width="3%" style="HEIGHT: 21px"><FONT face="Tahoma" size="2"></FONT></TD>
											<TD style="WIDTH: 19px; HEIGHT: 21px" borderColor="black" align="center" width="19"><FONT face="Tahoma" size="2">c.</FONT></TD>
											<TD borderColor="black" style="HEIGHT: 21px"><FONT face="Tahoma" size="2">Foto terakhir 
													pemohon uk 6x6 (2 lbr) <FONT style="VERTICAL-ALIGN: super" size="1">1)</FONT> </FONT>
											</TD>
										</TR>
										<TR>
											<TD width="3%"><FONT face="Tahoma" size="2"></FONT></TD>
										...
										<TR>
											...
											<TD borderColor="#000000"><FONT face="Tahoma" size="2">&nbsp;&nbsp;&nbsp; </FONT>
												<asp:label id="LBL_LGL" runat="server" ForeColor="#0000C0" Height="17px" TextMode="MultiLine"
										...
										<TR>
											<TD width="3%"></TD>
											<TD style="WIDTH: 19px" borderColor="#000000" align="center" width="19"></TD>
											<TD borderColor="#000000"><U><FONT style="TEXT-ALIGN: justify" face="Tahoma" size="2">Ket:</FONT></U>&nbsp;&nbsp;<FONT style="VERTICAL-ALIGN: baseline" size="1">1)</FONT>
					...
					<TR>
						<TD width="3%"></TD>
						<TD style="WIDTH: 19px" borderColor="#000000" align="center" width="19"></TD>
						<TD borderColor="#000000">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2) Tidak 
							diperlukan apabila permohonan kredit s/d Rp 50 juta</TD>
					</TR>
					<TR>
						<TD width="3%"></TD>
						<TD style="WIDTH: 19px" borderColor="#000000" align="center" width="19"></TD>
						<TD borderColor="#000000">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 3) NPWP Badan 
							Usaha dan pengurus</TD>
					</TR>
					</TD></TR></TABLE>
				</asp:panel></TD>
