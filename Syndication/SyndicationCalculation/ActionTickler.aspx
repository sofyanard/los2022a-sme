<%@ Page language="c#" Codebehind="ActionTickler.aspx.cs" AutoEventWireup="True" Inherits="SME.Syndication.SyndicationCalculation.ActionTickler" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
  <HEAD>
		<TITLE>ActionTickler</TITLE>
				...
				<TABLE width="100%" border="0">
					<TR>
						<TD align="left" width="50%">
							<TABLE id="Table1">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>ACTION TICKLER</B></TD>
								</TR>
							</TABLE>
						</TD>
					...
					<TR>
						<TD class="tdHeader1" colSpan="2">SETUP DETAIL</TD>
					</TR>
					<TR>
						...
						<TD class="td" style="HEIGHT: 7px" vAlign="top" width="50%">
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									<TD class="TDBGColor1" width="50%"><asp:label id="LBL_TXT_ACTION_TYPE" runat="server">Action Type :</asp:label></TD>
									<TD class="TDBGColorValue"><asp:dropdownlist id="DDL_ACTION_TYPE" runat="server" Width="100%"></asp:dropdownlist></TD>
								</TR>
								<TR>
									<TD class="TDBGColor1" width="50%"><asp:label id="LBL_TXT_ACTION_DATE" runat="server">Action Date :</asp:label></TD>
									<TD class="TDBGColorValue" colSpan="2"><asp:textbox onkeypress="return numbersonly()" id="TXT_ACTION_DAY" runat="server" Width="24px"
											MaxLength="2" Columns="4"></asp:textbox><asp:dropdownlist id="DDL_ACTION_MONTH" runat="server"></asp:dropdownlist><asp:textbox onkeypress="return numbersonly()" id="TXT_ACTION_YEAR" runat="server" Width="36px"
					...
					<TR>
						<TD class="td" vAlign="top" align="center" width="50%" colSpan="2"><asp:datagrid id="DATA_GRID" runat="server" Width="100%" AllowPaging="True" AutoGenerateColumns="False">
								...
								<Columns>
									...
									<asp:BoundColumn DataField="PRODUCT_CODE" HeaderText="Product">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
										<ItemStyle HorizontalAlign="Left"></ItemStyle>
									</asp:BoundColumn>
									...
									<asp:BoundColumn DataField="ACTION_DATE" HeaderText="Action Date">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
									</asp:BoundColumn>
									<asp:TemplateColumn HeaderText="Function">
