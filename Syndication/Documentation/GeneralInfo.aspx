<%@ Page language="c#" Codebehind="GeneralInfo.aspx.cs" AutoEventWireup="True" Inherits="SME.Syndication.Documentation.GeneralInfo" %>
						...
						<TD class="td" style="HEIGHT: 7px" vAlign="top" width="50%">
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%">
								...
								<TR>
									...
									<TD class="TDBGColorValue"><asp:textbox id="TXT_SECTOR4" runat="server" Width="100%" Enabled="False"></asp:textbox></TD>
								</TR>
								<TR>
