<%@ Page language="c#" Codebehind="DokumenLegalitas.aspx.cs" AutoEventWireup="True" Inherits="SME.Syndication.Documentation.DokumenLegalitas" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<TITLE>DokumenLegalitas</TITLE>
				...
				<TABLE width="100%" border="0">
					<TR>
						<TD align="left" width="50%">
							<TABLE id="Table1">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>DOKUMEN LEGALITAS</B></TD>
								</TR>
							</TABLE>
						</TD>
