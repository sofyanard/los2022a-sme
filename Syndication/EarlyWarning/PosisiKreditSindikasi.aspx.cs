...
{
	/// <summary>
	/// Summary description for PosisiKreditSindikasi.
	/// </summary>
	public partial class PosisiKreditSindikasi : System.Web.UI.Page
	{
		...
		{	
			...
			ReportViewer1.ReportPath = "/SMEReports/RptSdcPosisiKredit&date1=" + tanggal1 + "&date2=" + tanggal2 + "&cust=" + cust + "&bank=" + bank;
		}
