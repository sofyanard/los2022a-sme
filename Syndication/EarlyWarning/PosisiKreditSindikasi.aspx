<%@ Page language="c#" Codebehind="PosisiKreditSindikasi.aspx.cs" AutoEventWireup="True" Inherits="SME.Syndication.EarlyWarning.PosisiKreditSindikasi" %>
<%@ Register TagPrefix="cc1" Namespace="Microsoft.Samples.ReportingServices" Assembly="ReportViewer" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<TITLE>PosisiKreditSindikasi</TITLE>
					...
					<TR>
						<TD align="center" colSpan="2">
							<TABLE class="td" id="Table2" cellSpacing="1" cellPadding="1" width="550" border="1" height="195">
								<TR>
									<TD class="tdHeader1">POSISI KREDIT SINDIKASI / CLUB DEAL</TD>
								</TR>
								<TR>
