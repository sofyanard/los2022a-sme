...
namespace SME.VerificationAssignment
{
	...
	/// </summary>
	public partial class AppraisalAssignmentCBI : System.Web.UI.Page
	{
		...
		{
			/*conn.QueryString = "select * from VW_NEED_APPRAISAL WHERE CU_REF = '"+ Request.QueryString["curef"] +"'";*/
		...
		private void ViewListCollateral()
		{
			...
			/*conn.QueryString = "select * from VW_VER_ASSIGN_LISTCOLATERAL where CU_REF = '"+ Request.QueryString["curef"] +"'";*/
			...
			for (int i = 0; i < row; i++)
			{
				/*LBL_AP_REGNO.Text = dt.Rows[i][0].ToString();*/
				...
				/*t.NavigateUrl = Directory + dt.Rows[i][5].ToString() +".aspx?regno="+LBL_AP_REGNO.Text+"&curef="+ Request.QueryString["curef"] +"&coltypeid="+ CL_TYPE +"&CL_SEQ="+ CL_SEQ + STS_APPR;*/
				...
				label1.ID = "LBL_AP_REGNO" + i;
				label1.Text = LBL_AP_REGNO.Text;
				...
				***/
				...
				/*this.Table_List.Rows[no_row].Cells[1].Controls.Add(label1);*/
		...
		private void BTN_PROCESS_Click(object sender, System.EventArgs e)
		{
			...
			/*LBL_AP_REGNO = (Label) Table_List.FindControl("LBL_AP_REGNO"+idx);*/
			...
			else
			{
				try 
				{
					/*conn.QueryString = "exec VERIFICATION_ASSIGNMENT '" +LBL_AP_REGNO.Text+ "', '" +Request.QueryString["curef"]+ "', "+*/
			...
			try
			{
				conn.QueryString = "SP_AUDITTRAIL_APP '" + 
					/*LBL_AP_REGNO.Text + "',null,null,null,'" + */
		...
		private void BTN_CANCEL_Click(object sender, System.EventArgs e)
		{
			...
			TXT_CL_SEQ = (TextBox) Table_List.FindControl("TXT_CL_SEQ"+idx);
			/*LBL_AP_REGNO = (Label) Table_List.FindControl("LBL_AP_REGNO"+idx);*/
			/*conn.QueryString = "exec VERIFICATION_ASSIGNMENT '" +LBL_AP_REGNO.Text.ToString()+ "', '" +Request.QueryString["curef"]+ "', "+*/
			conn.QueryString = "exec VERIFICATION_ASSIGNMENT '" +Request.QueryString["regno"]+ "', '" +Request.QueryString["curef"]+ "', "+
			...
			/*conn.QueryString = "sp_appr_list 'Delete','" + LBL_AP_REGNO.Text.ToString() + "','" + */
			...
			{
				conn.QueryString = "SP_AUDITTRAIL_APP '" + 
					/*LBL_AP_REGNO.Text.ToString() + "',null,null,null,'" + */
					Request.QueryString["regno"] + "',null,null,null,'" + 
					Request.QueryString["curef"] + "','" + 
		...
		private void BTN_REAPPRAISED_Click(object sender, System.EventArgs e)
		{
			...
			/*conn.QueryString = "update APPLICATION set AP_APPRSTATUS = '0' where AP_REGNO = '"+LBL_AP_REGNO.Text.ToString()+"'";*/
			conn.QueryString = "update APPLICATION set AP_APPRSTATUS = '0' where AP_REGNO = '"+Request.QueryString["regno"]+"'";
			conn.ExecuteNonQuery();

			/*conn.QueryString = "update LISTASSIGNMENT set LA_APPRSTATUS = '0', LA_CREDITOPR = NULL, OFFICERSEQ = NULL  where AP_REGNO = '"+LBL_AP_REGNO.Text.ToString()+"' and CU_REF = '"+*/
			...
			//ahmad: delete appr_list
			double clseq = Double.Parse(idx) + 1;
			/*conn.QueryString = "sp_appr_list 'Delete','" + LBL_AP_REGNO.Text.ToString() + "','" + Request.QueryString["curef"] + "','"+TXT_CL_SEQ.Text.Trim()+"','',''";*/
		...
		private void b1_OnClick(object sender, EventArgs e)
		{
			...
			Label LBL_AP_REGNO = (Label) Table_List.FindControl("LBL_AP_REGNO" + idx);
