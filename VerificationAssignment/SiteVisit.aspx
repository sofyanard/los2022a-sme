<%@ Page language="c#" Codebehind="SiteVisit.aspx.cs" AutoEventWireup="True" Inherits="SME.VerificationAssignment.SiteVisit" %>
					...
					<TBODY>
						...
						<TR>
							...
							<TD class="td" vAlign="top" width="50%">
								<TABLE cellSpacing="0" cellPadding="0" width="100%">
									<TR>
										<TD class="TDBGColor1" width="150">Analis</TD>
										<TD style="WIDTH: 15px"></TD>
										<TD class="TDBGColorValue">
						...
						<TR>
							<TD class="TDBGColor2" vAlign="top" align="center" width="50%" colSpan="2">
								<asp:button id="BTN_UPDATE" runat="server" CssClass="Button1" Text="Update" Enabled="False" onclick="BTN_UPDATE_Click"></asp:button>
                                <asp:button id="BTN_SAVE" runat="server" Text="Simpan" CssClass="Button1" 
                                    onclick="BTN_SAVE_Click"></asp:button>&nbsp;<asp:button id="BTN_PRINT" 
                                    runat="server" Text="Lihat" CssClass="Button1" Enabled="False" 
                                    onclick="BTN_PRINT_Click"></asp:button>&nbsp;</TD>
						</TR>
						<tr>
							<td width="100%"></td>
						</tr>
