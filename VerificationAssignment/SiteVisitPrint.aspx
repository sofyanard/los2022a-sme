<%@ Page language="c#" Codebehind="SiteVisitPrint.aspx.cs" AutoEventWireup="True" Inherits="SME.VerificationAssignment.SiteVisitPrint" %>
							        ...
							        <TD style="BORDER-TOP-STYLE: none; BORDER-RIGHT-STYLE: none; BORDER-LEFT-STYLE: none; BORDER-BOTTOM-STYLE: none"
								        ...
								        <TABLE id="Table12" cellSpacing="1" cellPadding="1" width="100%" border="0">
									        <TR>
										        ...
										        <TD width="1%">:</TD>
										        <TD width="24%"><asp:label id="LBL_SV_DATE2" runat="server" Width="100%"></asp:label></TD>
									        </TR>
									        <TR>
										        <TD width="10%"><nobr>Customer</nobr></TD>
										        <TD width="1%">:</TD>
										        <TD width="24%"><asp:label id="LBL_SV_NAME2" runat="server" Width="100%"></asp:label></TD>
										        <TD width="30%"></TD>
										        <TD width="10%"><nobr>Dibuat oleh</nobr></TD>
										        <TD width="1%">:</TD>
										        <TD width="24%"><asp:label id="LBL_AP_RELMNGR2" runat="server" Width="100%"></asp:label></TD>
									        </TR>
									        <TR height="150">
