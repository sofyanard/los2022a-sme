<%@ Page language="c#" Codebehind="EditNasabah.aspx.cs" AutoEventWireup="True" Inherits="SME.CreditProposal.Channeling.EditNasabah" %>
									...
									<td>
										<table width="100%">
											...
											<TR>
												...
												<TD style="WIDTH: 1.31%">:</TD>
												<TD class="TDBGColorValue"><asp:dropdownlist id="DDL_BI_SEKTOREKONOMI_1" runat="server" Width="100%" Enabled="False" onselectedindexchanged="DDL_BI_SEKTOREKONOMI_1_SelectedIndexChanged"></asp:dropdownlist></TD>
											</TR>
											<TR>
