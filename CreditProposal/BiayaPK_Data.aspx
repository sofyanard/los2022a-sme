<%@ Page language="c#" Codebehind="BiayaPK_Data.aspx.cs" AutoEventWireup="True" Inherits="SME.CreditProposal.BiayaPK_Data" %>
									...
									<td class="td" vAlign="top">
										<TABLE cellSpacing="0" cellPadding="0" width="100%">
											...
											<tr>
												...
												<td></td>
												<td class="TDBGColorValue"><asp:textbox onkeypress="return kutip_satu()" id="TXT_CP_PKNO" Columns="35" Runat="server" MaxLength="35"
											...
											<tr>
												...
												<td class="TDBGColorValue"><asp:textbox onkeypress="return numbersonly()" id="TXT_CP_PKDATEDAY" Columns="2" Runat="server"
														MaxLength="2" ReadOnly="True"></asp:textbox><asp:dropdownlist id="DDL_CP_PKDATEMONTH" Runat="server" Enabled="False"></asp:dropdownlist><asp:textbox onkeypress="return numbersonly()" id="TXT_CP_PKDATEYEAR" Columns="4" Runat="server"
