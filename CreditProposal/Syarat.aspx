<%@ Page language="c#" Codebehind="Syarat.aspx.cs" AutoEventWireup="True" Inherits="SME.CreditProposal.Syarat" %>
		...
		<form id="Form1" method="post" runat="server">
			<center>
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					...
					<TR>
						<TD align="center" width="100%" colSpan="2"><asp:button id="BTNINSERT_PK" 
                                runat="server" Width="75px" CssClass="button1" Text="Tambah" 
                                onclick="BTNINSERT_PK_Click"></asp:button></TD>
					</TR>
					<TR>
					...
					<TR>
						<TD align="center" width="100%" colSpan="2"><asp:button id="BTNINSERT_TERBIT" 
                                runat="server" Width="75px" CssClass="button1" Text="Tambah" 
                                onclick="BTNINSERT_TERBIT_Click"></asp:button></TD>
					</TR>
					<TR>
					...
					<TR>
						<TD align="center" width="100%" colSpan="2"><asp:button id="BTNINSERT_LAIN" 
                                runat="server" Width="75px" CssClass="button1" Text="Tambah" 
                                onclick="BTNINSERT_LAIN_Click"></asp:button></TD>
					</TR>
					<TR>
						<TD class="TDBGColor2" vAlign="top" align="center" width="50%" colSpan="2">&nbsp;<asp:button id="updatestatus" runat="server" CssClass="Button1" Text="Update Status" Visible="False"></asp:button>&nbsp;<asp:button 
                                id="barcode" runat="server" CssClass="Button1" Text="Lihat Nota Analisa" 
                                Visible="False"></asp:button>&nbsp;
							<asp:button id="Button1" runat="server" CssClass="Button1" 
                                Text="Lihat Resume Nota Analisa" Visible="False"></asp:button></TD>
					</TR>
				</TABLE>
			</center>
		</form>
