<%@ Page language="c#" Codebehind="BiayaPK_DataCBIbackup.aspx.cs" AutoEventWireup="True" Inherits="SME.CreditProposal.BiayaPK_DataCBIbackup" %>
								...
								<tr>
									...
									<td class="td" vAlign="top">
										<TABLE cellSpacing="0" cellPadding="0" width="100%">
											...
											<tr>
												<td class="TDBGColor1">No. PK
												</td>
												<td></td>
												<td class="TDBGColorValue"><asp:textbox onkeypress="return kutip_satu()" id="TXT_CP_PKNO" Columns="35" Runat="server" MaxLength="35"></asp:textbox></td>
											</tr>
											<tr>
												<td class="TDBGColor1">Tanggal PK
												</td>
												<td></td>
												<td class="TDBGColorValue"><asp:textbox onkeypress="return numbersonly()" id="TXT_CP_PKDATEDAY" Columns="2" Runat="server"
														MaxLength="2"></asp:textbox><asp:dropdownlist id="DDL_CP_PKDATEMONTH" Runat="server"></asp:dropdownlist><asp:textbox onkeypress="return numbersonly()" id="TXT_CP_PKDATEYEAR" Columns="4" Runat="server"
										...
										<TABLE cellSpacing="0" cellPadding="0" width="100%">
											...
											<tr>
												...
												<td class="TDBGColorValue"><asp:textbox onkeypress="return digitsonly()" id="TXT_CP_BEAPROVISI_PCT" Columns="6" Runat="server"
														MaxLength="6" Width="50px" AutoPostBack="True" ontextchanged="TXT_CP_BEAPROVISI_PCT_TextChanged"></asp:textbox>%
					...
					<tr>
						<td><asp:datagrid id="DataGrid1" runat="server" Width="100%" CellPadding="1" AutoGenerateColumns="False"
								...
								<Columns>
									...
									<asp:BoundColumn DataField="AN_POLICYNO" HeaderText="No Policy">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
									</asp:BoundColumn>
									...
									<td class="td" vAlign="top" width="50%">
										<TABLE cellSpacing="0" cellPadding="0" width="100%">
											<tr>
												...
												<td width="15"></td>
												<td class="TDBGColorValue"><asp:dropdownlist id="DDL_CP_INSRCOMP" Runat="server" AutoPostBack="True"></asp:dropdownlist></td>
											</tr>
											<tr>
											...
											<TR>
												<TD class="TDBGColor1">No Policy</TD>
												<TD></TD>
										...
										<TABLE cellSpacing="0" cellPadding="0" width="100%">
											...
											<TR>
												...
												<TD class="TDBGColorValue"><asp:textbox onkeypress="return digitsonly()" id="TXT_CP_INSRAMNT" Columns="25" Runat="server"
														CssClass="angka" MaxLength="20"></asp:textbox></TD>
											</TR>
											<TR>
