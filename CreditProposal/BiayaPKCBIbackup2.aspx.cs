...
namespace SME.CreditProposal
{
	...
	/// </summary>
	public partial class BiayaPKCBIbackup2 : System.Web.UI.Page
	{
...
//			}
		...
		protected void BTN_SAVE_Click(object sender, System.EventArgs e)
		{
			...
			Response.Redirect("/SME/CreditProposal/FasilitasLegalSigning.aspx?na=2&regno="+LBL_REGNO.Text+"&curef="+LBL_CUREF.Text+"&mc="+Request.QueryString["mc"]+"&tc="+LBL_TC.Text+"");
		}
