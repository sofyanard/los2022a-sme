<%@ Page language="c#" Codebehind="BiayaPKCBIbackup2.aspx.cs" AutoEventWireup="True" Inherits="SME.CreditProposal.BiayaPKCBIbackup2" %>
						...
						<TD class="tdNoBorder" align="right" colSpan="2">
							<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TR>
									...
									<TD style="TEXT-ALIGN: right"><asp:imagebutton id="BTN_BACK" runat="server" ImageUrl="../Image/back.jpg" onclick="BTN_BACK_Click"></asp:imagebutton><A href="../Body.aspx"><IMG src="/SME/Image/MainMenu.jpg"></A><A href="../Logout.aspx" target="_top"><IMG src="/SME/Image/Logout.jpg"></A></TD>
								</TR>
							</TABLE>
						</TD>
					</TR>
