<%@ Page language="c#" Codebehind="SelfReport.aspx.cs" AutoEventWireup="True" Inherits="SME.JiwaService.SelfReport" %>
					...
					<TR>
						<TD align="center" colSpan="2">
							<TABLE class="td" id="Table2" cellSpacing="1" cellPadding="1" width="550" border="1" height="195">
								<TR>
									<TD class="tdHeader1">SELF ASSESSMENT REPORTING</TD>
								</TR>
								<TR>
									<TD vAlign="top" align="center">
										<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
											<TR>
												<TD class="TDBGColor1" width="25%" style="HEIGHT: 15px">Group Name :</TD>
												<TD class="TDBGColorValue" width="75%" style="HEIGHT: 15px"><asp:DropDownList ID="DDL_GROUP" Runat="server" AutoPostBack="True" Width="100%" onselectedindexchanged="DDL_GROUP_SelectedIndexChanged"></asp:DropDownList></TD>
											</TR>
											<TR>
												<TD class="TDBGColor1" width="25%" style="HEIGHT: 15px">Department Name :</TD>
												<TD class="TDBGColorValue" width="75%" style="HEIGHT: 15px"><asp:DropDownList ID="DDL_DEPT" Runat="server" Width="100%"></asp:DropDownList></TD>
											</TR>
											<TR>
												<TD class="TDBGColor1" width="25%" style="HEIGHT: 15px">Date :</TD>
												<TD class="TDBGColorValue" width="75%" style="HEIGHT: 15px">
