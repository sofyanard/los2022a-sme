<%@ Page language="c#" Codebehind="PendingReport.aspx.cs" AutoEventWireup="True" Inherits="SME.JiwaService.PendingReport" %>
					...
					<TR>
						<TD align="center" colSpan="2">
							<TABLE class="td" id="Table2" cellSpacing="1" cellPadding="1" width="550" border="1" height="195">
								<TR>
									<TD class="tdHeader1">PENDING TASK LIST REPORTING</TD>
								</TR>
								<TR>
									<TD vAlign="top" align="center">
										<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
											<TR>
												<TD class="TDBGColor1" width="25%">Pending Position :</TD>
												<TD class='A"TDBGColorValue"' width="75%"><asp:DropDownList ID="DDL_POSITION" Runat="server" AutoPostBack="True" Width="100%"></asp:DropDownList></TD>
											</TR>
											<TR>
												<TD class="TDBGColor1" width="25%">Date :</TD>
