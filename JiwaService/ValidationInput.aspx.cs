...
{
	/// <summary>
	/// Summary description for ValidationInput.
	/// </summary>
	public partial class ValidationInput : System.Web.UI.Page
	{
		...
		private void DatGrd_ItemCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			{
				case "view":
					Response.Redirect("ScoreResult.aspx?sta=exist&seq=" + e.Item.Cells[0].Text + "&gc=" + e.Item.Cells[1].Text + "&dc=" + e.Item.Cells[3].Text + "&userid=" + e.Item.Cells[5].Text + "&mc=" + Request.QueryString["mc"] + "&exist=1");
					break;
			}
		}
	}
