<%@ Page language="c#" Codebehind="CustomerParamAll.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.General.JiwaService.CustomerParamAll" %>
		...
		<FORM id="Form1" method="post" runat="server">
			<CENTER>
				<TABLE width="100%" border="0">
					...
					<TR>
						<TD class="td" style="HEIGHT: 7px" vAlign="top" width="50%">
							<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									...
									<TD class='A"TDBGColorValue"' width="50%"><asp:dropdownlist id="DDL_GRPTYPEID" runat="server" Width="100%" CssClass="Mandatory" AutoPostBack="True" onselectedindexchanged="DDL_GRPTYPEID_SelectedIndexChanged"></asp:dropdownlist></TD>
								</TR>
								<TR>
								...
								<TR>
									...
									<TD class="TDBGColorValue"><asp:textbox id="TXT_NO" runat="server" Width="100%" Visible="False" BorderStyle="None"></asp:textbox></TD>
								</TR>
							</TABLE>
						</TD>
						<TD class="td" vAlign="top" width="50%">
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									<TD class="TDBGColor1" width="40%"><asp:label id="LBL_TXT_QUESTION" runat="server">Pertanyaan :</asp:label></TD>
									<TD class="TDBGColorValue"><asp:textbox id="TEXT_QUESTION" runat="server" Width="100%" CssClass="Mandatory" TextMode="MultiLine"
											Height="38px"></asp:textbox></TD>
								</TR>
							</TABLE>
						</TD>
					</TR>
					...
					<TR>
						<TD class="td" vAlign="top" align="center" width="50%" colSpan="2"><asp:datagrid id="DGR_QUEST" runat="server" Width="100%" AutoGenerateColumns="False" AllowPaging="True">
					...
					<TR>
						<TD class="td" vAlign="top" align="center" width="50%" colSpan="2"><asp:datagrid id="DGR_REQUESTQUEST" runat="server" Width="100%" AutoGenerateColumns="False" AllowPaging="True">
								<AlternatingItemStyle CssClass="TblAlternating"></AlternatingItemStyle>
								<Columns>
									<asp:BoundColumn DataField="NO" HeaderText="No">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
