<%@ Page language="c#" Codebehind="DeptParamAll.aspx.cs" AutoEventWireup="True" Inherits="CuBES_Maintenance.Parameter.General.JiwaService.DeptParamAll" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<TITLE>DeptParamAll</TITLE>
		...
		<script language="javascript">
			...
			{
				conf = confirm("Data will be lost! Are you sure you want to delete?");
				if (conf)
				{
					return true;
				}
				...
				<TABLE width="100%" border="0">
					<TR>
						<TD align="left">
							<TABLE id="Table1">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>DEPARTMENT PROVIDER</B></TD>
								</TR>
							</TABLE>
						</TD>
					...
					<TR>
						<td class="td" style="HEIGHT: 7px" vAlign="top" width="50%">
							<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									<TD class="TDBGColor1" width="50%"><asp:label id="LBL_TXT_GROUPTYPE" runat="server">Group Name :</asp:label></TD>
									<TD class='A"TDBGColorValue"'><asp:dropdownlist id="DDL_GRPTYPEID" runat="server" AutoPostBack="True" Width="100%"></asp:dropdownlist></TD>
								</TR>
								<TR>
									<TD class="TDBGColor1" width="50%"><asp:label id="LBL_TXT_DEPTNAME" runat="server">Department Name :</asp:label></TD>
									<TD class="TDBGColorValue"><asp:textbox id="TXT_DEPTNAME" runat="server" Width="100%" CssClass="mandatory"></asp:textbox></TD>
								</TR>
								<TR>
									<TD><asp:label id="LBL_DEPTID" runat="server" Visible="False"></asp:label></TD>
									<TD class="TDBGColorValue"><asp:textbox id="TXT_DEPTCODE" runat="server" BorderStyle="None" Width="352px" Visible="False"></asp:textbox></TD>
								</TR>
							</TABLE>
						</td>
					</TR>
					...
					<TR>
						<TD class="td" vAlign="top" align="center" width="50%" colSpan="2">
							<asp:datagrid id="DGR_DEPT" runat="server" Width="100%" AutoGenerateColumns="False" AllowPaging="True">
					...
					<TR>
						<TD class="td" vAlign="top" align="center" width="50%" colSpan="2">
							<asp:datagrid id="DGR_REQUESTDEPT" runat="server" Width="100%" AutoGenerateColumns="False" AllowPaging="True">
								<AlternatingItemStyle CssClass="TblAlternating"></AlternatingItemStyle>
								<Columns>
									<asp:BoundColumn DataField="G_CODE" Visible="False">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
