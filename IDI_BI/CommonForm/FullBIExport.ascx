<%@ Control Language="c#" AutoEventWireup="True" Codebehind="FullBIExport.ascx.cs" Inherits="SME.IDI_BI.CommonForm.FullBIExport" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
