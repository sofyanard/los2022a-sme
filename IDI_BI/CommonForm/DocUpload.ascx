<%@ Control Language="c#" AutoEventWireup="True" Codebehind="DocUpload.ascx.cs" Inherits="SME.IDI_BI.CommonForm.DocUpload" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
