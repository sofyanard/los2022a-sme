<%@ Page language="c#" Codebehind="SupervisionManagementReporting.aspx.cs" AutoEventWireup="True" Inherits="SME.MAS.SupervisionManagement.Reporting.SupervisionManagementReporting" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>SupervisionManagementReporting</title>
				...
				<TABLE id="Table4" width="100%" border="0">
					<TR>
						<TD align="left" colSpan="1">
							<TABLE id="Table3">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>Supervision Management 
											Reporting</B></TD>
								</TR>
							</TABLE>
						</TD>
								...
								<TR>
									<TD vAlign="bottom" align="center">
										<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
											<TR>
												<TD class="TDBGColor1" style="WIDTH: 151px">Periode</TD>
												<TD>:</TD>
											...
											<TR>
												<TD class="TDBGColor1" style="WIDTH: 151px">Distrik</TD>
												<TD>:</TD>
												<TD class="TDBGColorValue"><asp:dropdownlist id="DDL_DISTRIK" Runat="server" AutoPostBack="True"></asp:dropdownlist></TD>
											</TR>
											<TR>
												<TD class="TDBGColor1" style="WIDTH: 151px">Cluster</TD>
												<TD>:</TD>
												<TD class="TDBGColorValue"><asp:dropdownlist id="DDL_CLUSTER" Runat="server" AutoPostBack="True"></asp:dropdownlist></TD>
											</TR>
											<TR>
