<%@ Page language="c#" Codebehind="PrintUnitReview.aspx.cs" AutoEventWireup="True" Inherits="SME.MAS.SupervisionManagement.MicroCreditQuality.UnitReview.PrintUnitReview" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>PrintUnitReview</title>
		...
		<form id="Form1" method="post" runat="server">
			<center>
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="570">
							...
							<TABLE id="Table65" cellSpacing="1" cellPadding="2" width="100%">
								...
								<TR>
									...
									<TD class="TDBGColorValue"><asp:textbox onkeypress="return numbersonly()" id="TXT_TGL_KUNJUNGAN1" runat="server" MaxLength="2"
											Width="24px" ReadOnly="True" Columns="4"></asp:textbox><asp:dropdownlist id="DDL_BLN_KUNJUNGAN1" runat="server" Enabled="False"></asp:dropdownlist><asp:textbox onkeypress="return numbersonly()" id="TXT_THN_KUNJUNGAN1" runat="server" MaxLength="4"
											Width="36px" ReadOnly="True" Columns="4"></asp:textbox>&nbsp;to&nbsp;
										<asp:textbox onkeypress="return numbersonly()" id="TXT_TGL_KUNJUNGAN2" runat="server" MaxLength="2"
											Width="24px" ReadOnly="True" Columns="4"></asp:textbox><asp:dropdownlist id="DDL_BLN_KUNJUNGAN2" runat="server" Enabled="False"></asp:dropdownlist><asp:textbox onkeypress="return numbersonly()" id="TXT_THN_KUNJUNGAN2" runat="server" MaxLength="4"
											Width="36px" ReadOnly="True" Columns="4"></asp:textbox></TD>
								</TR>
							</TABLE>
						</TD>
					</TR>
						...
						<TD class="td" vAlign="top" width="100%" colSpan="5">
							<TABLE id="Table4" cellSpacing="1" cellPadding="2" width="100%">
								<TR>
									...
									<TD width="1%">:</TD>
									<TD class="TDBGColorValue" style="HEIGHT: 31px" align="left"><asp:radiobuttonlist id="RDO_LOKASI_SO1" runat="server" Width="140px" Enabled="False" AutoPostBack="True"
									...
									<TD class="TDBGColorValue" style="HEIGHT: 31px" align="left"><asp:radiobuttonlist id="RDO_LOKASI_SO2" runat="server" Width="140px" Enabled="False" AutoPostBack="True"
											RepeatDirection="Vertical">
											<asp:ListItem Value="1">&lt;5 km</asp:ListItem>
											<asp:ListItem Value="2">5 s.d 10 km</asp:ListItem>
											<asp:ListItem Value="3">10 s.d 20 km</asp:ListItem>
									...
									<TD class="TDBGColorValue" style="HEIGHT: 31px" align="left"><asp:radiobuttonlist id="RDO_LOKASI_SO3" runat="server" Width="140px" Enabled="False" AutoPostBack="True"
											RepeatDirection="Vertical">
											<asp:ListItem Value="1">&lt;5 km</asp:ListItem>
											<asp:ListItem Value="2">5 s.d 10 km</asp:ListItem>
											<asp:ListItem Value="3">10 s.d 20 km</asp:ListItem>
									...
									<TD class="TDBGColorValue" style="HEIGHT: 31px" align="left"><asp:radiobuttonlist id="RDO_LOKASI_SO4" runat="server" Width="140px" Enabled="False" AutoPostBack="True"
											RepeatDirection="Vertical">
											<asp:ListItem Value="1">&lt;5 km</asp:ListItem>
											<asp:ListItem Value="2">5 s.d 10 km</asp:ListItem>
											<asp:ListItem Value="3">10 s.d 20 km</asp:ListItem>
					...
					<TR>
						<TD colSpan="2"><ASP:DATAGRID id="DGR_POTFOLIO_UNIT" runat="server" Width="100%" CellPadding="1" AutoGenerateColumns="False">
								<AlternatingItemStyle CssClass="TblAlternating"></AlternatingItemStyle>
								<Columns>
									<asp:BoundColumn Visible="False" DataField="seq" HeaderText="seq">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
						...
						<TD class="td" vAlign="top" width="100%">
							<TABLE id="Table4" cellSpacing="1" cellPadding="2" width="100%">
								<TR>
									...
									<TD class="TDBGColorValue" align="left" width="15%"><asp:radiobuttonlist id="RDO_MMM1" runat="server" Width="100%" Enabled="False" AutoPostBack="True" RepeatDirection="Horizontal">
								...
								<TR>
									...
									<TD class="TDBGColorValue" align="left" width="15%"><asp:radiobuttonlist id="RDO_MMM2" runat="server" Width="100%" Enabled="False" AutoPostBack="True" RepeatDirection="Horizontal">
											<asp:ListItem Value="Y">Ya</asp:ListItem>
											<asp:ListItem Value="N">Tidak</asp:ListItem>
										</asp:radiobuttonlist></TD>
								</TR>
								<TR>
									...
									<TD class="TDBGColorValue" align="left" width="15%"><asp:radiobuttonlist id="RDO_MMM3" runat="server" Width="100%" Enabled="False" AutoPostBack="True" RepeatDirection="Horizontal">
											<asp:ListItem Value="Y">Ya</asp:ListItem>
											<asp:ListItem Value="N">Tidak</asp:ListItem>
										</asp:radiobuttonlist></TD>
								</TR>
								<TR>
									...
									<TD class="TDBGColorValue" align="left" width="15%"><asp:radiobuttonlist id="RDO_MMM4" runat="server" Width="100%" Enabled="False" AutoPostBack="True" RepeatDirection="Horizontal">
											<asp:ListItem Value="Y">Ya</asp:ListItem>
											<asp:ListItem Value="N">Tidak</asp:ListItem>
										</asp:radiobuttonlist></TD>
								</TR>
								<TR>
									...
									<TD class="TDBGColorValue" align="left" width="15%"><asp:radiobuttonlist id="RDO_MMM5" runat="server" Width="100%" Enabled="False" AutoPostBack="True" RepeatDirection="Horizontal">
											<asp:ListItem Value="Y">Ya</asp:ListItem>
											<asp:ListItem Value="N">Tidak</asp:ListItem>
										</asp:radiobuttonlist></TD>
								</TR>
								<TR>
									...
									<TD class="TDBGColorValue" align="left" width="15%"><asp:radiobuttonlist id="RDO_MMM6" runat="server" Width="100%" Enabled="False" AutoPostBack="True" RepeatDirection="Horizontal">
											<asp:ListItem Value="Y">Ya</asp:ListItem>
											<asp:ListItem Value="N">Tidak</asp:ListItem>
										</asp:radiobuttonlist></TD>
								</TR>
						...
						<TD class="td" vAlign="top" width="100%">
							<TABLE id="Table4" cellSpacing="1" cellPadding="2" width="100%">
								...
								<TR>
									...
									<TD width="97%"><asp:textbox id="TXT_PERMASALAHAN1" Width="100%" ReadOnly="True" Runat="server" TextMode="MultiLine"></asp:textbox></TD>
								</TR>
								<TR>
									<TD align="center" width="3%">2.</TD>
									<TD width="97%">Informasi Lain Yang Perlu Mendapat Perhatian</TD>
								</TR>
								<TR>
									<TD align="center" width="3%"></TD>
									<TD width="97%"><asp:textbox id="TXT_PERMASALAHAN2" Width="100%" ReadOnly="True" Runat="server" TextMode="MultiLine"></asp:textbox></TD>
								</TR>
								<TR>
									<TD align="center" width="3%">3.</TD>
								...
								<TR>
									<TD align="center" width="3%"></TD>
									<TD width="97%"><asp:textbox id="TXT_PERMASALAHAN3" Width="100%" ReadOnly="True" Runat="server" TextMode="MultiLine"></asp:textbox></TD>
								</TR>
							</TABLE>
						</TD>
					</tr>
