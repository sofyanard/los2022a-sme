<%@ Page language="c#" Codebehind="ReviewUnitAccept2.aspx.cs" AutoEventWireup="True" Inherits="SME.MAS.SupervisionManagement.MicroCreditQuality.Acceptance.ReviewUnitAccept2" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>ReviewUnitAccept2</title>
		...
		<form id="Form1" method="post" runat="server">
			<center>
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					...
					<tr align="center">
						<td class="TDBGColor2" vAlign="top" align="center" width="100%" colSpan="2"><asp:button id="BTN_INSERT_PEGAWAI_UNIT" runat="server" Width="75px" CssClass="Button1" Text="INSERT" onclick="BTN_INSERT_PEGAWAI_UNIT_Click"></asp:button>&nbsp;&nbsp;
							<asp:button id="BTN_CLEAR_PEGAWAI_UNIT" runat="server" Width="75px" CssClass="Button1" Text="CLEAR" onclick="BTN_CLEAR_PEGAWAI_UNIT_Click"></asp:button></td>
					</tr>
					<TR>
					...
					<tr align="center">
						<td class="TDBGColor2" vAlign="top" align="center" width="100%" colSpan="2"><asp:button id="BTN_INSERT_MKS" runat="server" Width="75px" CssClass="Button1" Text="INSERT" onclick="BTN_INSERT_MKS_Click"></asp:button>&nbsp;&nbsp;
							<asp:button id="BTN_CLEAR_MKS" runat="server" Width="75px" CssClass="Button1" Text="CLEAR" onclick="BTN_CLEAR_MKS_Click"></asp:button></td>
					</tr>
					<TR>
					...
					<tr align="center">
						<td class="TDBGColor2" vAlign="top" align="center" width="100%" colSpan="2"><asp:button id="BTN_INSERT_PORTFOLIO_UNIT" runat="server" Width="75px" CssClass="Button1" Text="INSERT" onclick="BTN_INSERT_PORTFOLIO_UNIT_Click"></asp:button>&nbsp;&nbsp;
							<asp:button id="BTN_CLEAR_PORTFOLIO_UNIT" runat="server" Width="75px" CssClass="Button1" Text="CLEAR" onclick="BTN_CLEAR_PORTFOLIO_UNIT_Click"></asp:button></td>
					</tr>
					<TR>
				...
				<table id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					...
					<tr>
						...
						<TD class="td" vAlign="top" width="34%">
							<TABLE id="Table4" cellSpacing="1" cellPadding="2" width="100%">
								<TR>
									<TD align="center" width="100%"><asp:textbox onkeypress="return kutip_satu()" id="TXT_DIKETAHUI_OLEH2" runat="server" ReadOnly="True"
											Width="300px" MaxLength="100"></asp:textbox></TD>
								</TR>
							</TABLE>
						</TD>
					...
					<tr align="center">
						<td class="TDBGColor2" vAlign="top" align="center" width="100%" colSpan="5"><asp:button id="BTN_SAVE" runat="server" Width="75px" CssClass="Button1" Text="SAVE" onclick="BTN_SAVE_Click"></asp:button>&nbsp;&nbsp;
