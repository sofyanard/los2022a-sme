<%@ Page language="c#" Codebehind="ListRequest.aspx.cs" AutoEventWireup="True" Inherits="SME.MAS.CollateralAdministration.PickUpSendCollateral.ListRequest" %>
					...
					<TR>
						<TD colSpan="2"><ASP:DATAGRID id="DGR_RESULT" runat="server" Width="100%" AutoGenerateColumns="False" CellPadding="1"
								...
								<Columns>
									...
									<asp:BoundColumn HeaderText="MKA/CAO" DataField="su_fullname">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
									</asp:BoundColumn>
