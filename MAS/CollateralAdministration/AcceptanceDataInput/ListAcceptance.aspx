<%@ Page language="c#" Codebehind="ListAcceptance.aspx.cs" AutoEventWireup="True" Inherits="SME.MAS.CollateralAdministration.AcceptanceDataInput.ListAcceptance" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>ListAcceptance</title>
				...
				<TABLE id="Table4" width="100%" border="0">
					<TR>
						<TD align="left" colSpan="1">
							<TABLE id="Table3">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>LIST ACCEPTANCE</B></TD>
								</TR>
							</TABLE>
						</TD>
					...
					<TR>
						<TD colSpan="2"><ASP:DATAGRID id="DGR_RESULT" runat="server" Width="100%" AutoGenerateColumns="False" CellPadding="1"
								...
								<Columns>
									...
									<asp:BoundColumn HeaderText="MKA/CA" DataField="su_fullname">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
									</asp:BoundColumn>
									...
									<asp:BoundColumn HeaderText="flag" DataField="acc_status" Visible="False">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
									</asp:BoundColumn>
									<asp:BoundColumn HeaderText="mka/ca" DataField="track_by" Visible="False">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
									</asp:BoundColumn>
