<%@ Page language="c#" Codebehind="Collateral_Pg.aspx.cs" AutoEventWireup="True" Inherits="SME.MAS.CollateralAdministration.DetailCollateral.Collateral_Pg" %>
				...
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
						...
						<TD class="td" vAlign="top" width="100%">
							<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%">
								...
								<TR>
									...
									<TD></TD>
									<TD class="TDBGColorValue"><asp:textbox onkeypress="return kutip_satu()" id="TXT_CL_LOGBOOKNO" runat="server" Columns="25"
								...
								<TR>
									...
									<TD></TD>
									<TD class="TDBGColorValue"><asp:textbox onkeypress="return numbersonly()" id="TXT_CL_CONTRACTDATEDAY" runat="server" CssClass="mandatory"
											Columns="2" MaxLength="2"></asp:textbox><asp:dropdownlist id="DDL_CL_CONTRACTDATEMONTH" runat="server" CssClass="mandatory"></asp:dropdownlist><asp:textbox onkeypress="return numbersonly()" id="TXT_CL_CONTRACTDATEYEAR" runat="server" CssClass="mandatory"
								...
								<TR>
									...
									<TD></TD>
									<TD class="TDBGColorValue"><asp:textbox onkeypress="return kutip_satu()" id="TXT_CL_GUARANTEENAME" runat="server" CssClass="mandatory"
											Columns="25" Width="300" MaxLength="50"></asp:textbox></TD>
								</TR>
							</TABLE>
						</TD>
					</TR>
					<TR>
						<TD class="TDBGColor2" vAlign="top" align="center" width="50%" colSpan="2"><asp:button id="btn_save" runat="server" CssClass="button1" Text="Save" onclick="btn_save_Click"></asp:button><asp:button id="BTN_FINISH" runat="server" CssClass="Button1" Width="106px" Text="FINISH" Enabled="False" onclick="BTN_FINISH_Click"></asp:button></TD>
					</TR>
					...
					<TR>
						<TD class="TDBGColor2" vAlign="top" align="center" width="50%" colSpan="2">&nbsp;
							<asp:label id="LBL_CL_SEQ" runat="server" Visible="False"></asp:label><asp:label id="LBL_REGNO" runat="server" Visible="False"></asp:label><asp:label id="LBL_CUREF" runat="server" Visible="False"></asp:label><asp:label id="LBL_TC" runat="server" Visible="False"></asp:label><asp:label id="lbl_pg" runat="server" Visible="False"></asp:label></TD>
					</TR>
				</TABLE>
			</CENTER>
		</form>
