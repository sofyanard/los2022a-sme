<%@ Page language="c#" Codebehind="Collateral_Trcon.aspx.cs" AutoEventWireup="True" Inherits="SME.MAS.CollateralAdministration.DetailCollateral.Collateral_Trcon" %>
		...
		<form id="Form1" method="post" runat="server">
			<CENTER>
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
						...
						<TD class="td" vAlign="top" width="100%">
							<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%">
								...
								<TR>
									...
									<TD></TD>
									<TD class="TDBGColorValue"><asp:textbox onkeypress="return kutip_satu()" id="TXT_CL_CONTRACTNAME" runat="server" CssClass="mandatory"
											Columns="20" Width="400" MaxLength="100"></asp:textbox></TD>
								</TR>
								<TR>
									<TD class="TDBGColor1">No. Kontrak</TD>
									<TD></TD>
									<TD class="TDBGColorValue"><asp:textbox onkeypress="return kutip_satu()" id="TXT_CL_CONTRACTNO" runat="server" CssClass="mandatory"
											Columns="20" MaxLength="20"></asp:textbox><asp:checkbox id="CHB_CL_ISCASHEDVALUE" runat="server"></asp:checkbox>Nilai 
								...
								<TR>
									...
									<TD></TD>
									<TD class="TDBGColorValue"><asp:textbox onkeypress="return numbersonly()" id="TXT_CL_CONTRACTAMNT" onblur="FormatCurrency(this)"
					...
					<TR>
						<TD vAlign="top" align="center" width="50%" colSpan="2"><asp:label id="LBL_CL_SEQ" runat="server" Visible="False"></asp:label><asp:label id="LBL_REGNO" runat="server" Visible="False"></asp:label><asp:label id="LBL_CUREF" runat="server" Visible="False"></asp:label><asp:label id="LBL_TC" runat="server" Visible="False"></asp:label></TD>
					</TR>
				</TABLE>
			</CENTER>
		</form>
