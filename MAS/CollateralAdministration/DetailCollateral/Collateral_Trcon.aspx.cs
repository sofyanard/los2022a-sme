...
namespace SME.MAS.CollateralAdministration.DetailCollateral
{
	...
	public partial class Collateral_Trcon : System.Web.UI.Page
	{
		...
		private void  FillField()
		{
			...
			conn.QueryString="select * from mas_collateral_trcon where acc_number='"+ LBL_REGNO.Text +"' and collateral_id='"+ TXT_SIBS_COLID.Text +"'";
			conn.ExecuteQuery();
		...
		protected void btn_save_Click(object sender, System.EventArgs e)
		{
			if (TXT_CL_DESC.Text!="" &&
				...
				TXT_CL_VALUE.Text!="" &&
				TXT_CL_CONTRACTNAME.Text!="" &&
				TXT_CL_CONTRACTNO.Text!="" &&
				TXT_CL_VALUE2.Text!="")
			{
				SaveData();
			}
		...
		private void SaveData()
		{
			...
			conn.QueryString = "exec MAS_CHANGE_COL_trcon 'save'," +
