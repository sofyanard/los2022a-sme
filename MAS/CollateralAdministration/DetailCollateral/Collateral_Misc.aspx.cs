	...
	public partial class Collateral_Misc : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			if (!IsPostBack)
			{
				...
				lbl_misc.Text=conn.GetFieldValue("coltypedesc");
		...
		private void FillField()
		{
			...
			conn.QueryString = "exec MAS_CHANGE_COL_misc 'get'," +
			...
			try{DDL_CL_VALUEDATEMONTH.SelectedValue	= tool.FormatDate_Month(CL_VALUEDATE);}
			catch{}
		...
		private void SaveData()
		{
			conn.QueryString = "exec MAS_CHANGE_COL_misc 'get'," +
				...
				"'" +TXT_CL_APPRBY.Text  +"','"+ DDL_CL_JNSAGUNAN.SelectedValue +"',NULL,NULL,"+
				...
				"NULL,NULL," +
				"'" + DDL_CL_COLCLASSIFY.SelectedValue + "'," +
				"'" + Session["userID"] + "','" + TXT_BAST_KE_CA.Text + "','" + TXT_BAST_DARI_CA.Text + "','" + ddl_posisi.SelectedValue + "','" + lbl_misc.Text +"'";
			conn.ExecuteQuery();
		}
