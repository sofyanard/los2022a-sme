<%@ Page language="c#" Codebehind="AprvFindCustomer.aspx.cs" AutoEventWireup="True" Inherits="SME.Facilities.AprvFindCustomer" %>
										...
										<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
											...
											<TR>
												...
												<TD style="WIDTH: 400px; HEIGHT: 18px">
													<P class="TDBGColorValue"><asp:textbox id="txt_Date" onkeypress="return digitsonly()" runat="server" Columns="3" MaxLength="2"></asp:textbox>
														<asp:dropdownlist id="ddl_Month" runat="server"></asp:dropdownlist>
														<asp:textbox id="txt_Year" onkeypress="return digitsonly()" runat="server" Columns="3" MaxLength="4"></asp:textbox>&nbsp;s/d
														<asp:textbox id="txt_Date1" onkeypress="return digitsonly()" runat="server" MaxLength="2" Columns="3"></asp:textbox>
														<asp:dropdownlist id="ddl_Month1" runat="server"></asp:dropdownlist>
														<asp:textbox id="txt_Year1" onkeypress="return digitsonly()" runat="server" MaxLength="4" Columns="3"></asp:textbox></P>
												</TD>
											</TR>
											<TR>
											...
											<TR>
												<TD vAlign="top" align="center" colSpan="3" style="WIDTH: 521px"><asp:button id="btn_Find" runat="server" Text="Find" Width="75px" CssClass="button1" onclick="btn_Find_Click"></asp:button></TD>
											</TR>
										</TABLE>
									</TD>
								</TR>
						...
						<TD colSpan="2"><ASP:DATAGRID id="DatGrd" runat="server" CellPadding="1" Width="100%" PageSize="50" AutoGenerateColumns="False"
								...
								<Columns>
									<asp:BoundColumn DataField="AP_REGNO" HeaderText="Application #">
										<HeaderStyle Width="5cm" CssClass="tdSmallHeader"></HeaderStyle>
									</asp:BoundColumn>
