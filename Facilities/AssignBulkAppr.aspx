<%@ Page language="c#" Codebehind="AssignBulkAppr.aspx.cs" AutoEventWireup="True" Inherits="SME.Facilities.AssignBulkAppr" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>AssignBulkAppr</title>
		...
		<form id="Form1" method="post" runat="server">
			<center>
				<TABLE cellSpacing="2" cellPadding="2" width="100%">
					<TR>
						<TD class="tdHeader1" colSpan="2">Pending Application (BU)</TD>
					</TR>
					<TR>
