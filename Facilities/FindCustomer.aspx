<%@ Page language="c#" Codebehind="FindCustomer.aspx.cs" AutoEventWireup="True" Inherits="SME.Facilities.FindCustomer" %>
									...
									<TD vAlign="top">
										<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
											<TR>
												...
												<TD></TD>
												<TD class="TDBGColorValue" style="WIDTH: 342px"><asp:textbox onkeypress="return kutip_satu()" id="TXT_CIF" runat="server" MaxLength="20" Width="200px"></asp:textbox></TD>
											</TR>
											<TR>
											...
											<TR>
												<TD vAlign="top" align="center" colSpan="3" style="WIDTH: 521px"><asp:button id="btn_Find" runat="server" Text="Find" Width="75px" CssClass="button1" onclick="btn_Find_Click"></asp:button>
