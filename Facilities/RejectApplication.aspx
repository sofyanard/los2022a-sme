<%@ Page language="c#" Codebehind="RejectApplication.aspx.cs" AutoEventWireup="True" Inherits="SME.Facilities.RejectApplication" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server" action="RejectApplication.aspx">
			<center>
				<TABLE id="Table4" width="100%" border="0">
									...
									<TD vAlign="top" align="center" colSpan="2">
										<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
											...
											<TR>
												...
												<TD class="TDBGColorValue" width="342" height="20"><asp:textbox onkeypress="return kutip_satu()" id="TXT_NAME" runat="server" MaxLength="20" Width="200px"></asp:textbox></TD>
											</TR>
											<TR>
												<TD class="TDBGColor1" width="197" height="20">Tipe Pelanggan</TD>
												<TD width="9" height="20">:</TD>
												<TD class="TDBGColorValue" width="342" height="20"><asp:radiobutton id="RB_PERSONAL" runat="server" GroupName="kriteria" Text="Personal" AutoPostBack="True" oncheckedchanged="RB_PERSONAL_CheckedChanged"></asp:radiobutton>&nbsp;
													<asp:radiobutton id="RB_COMPANY" runat="server" GroupName="kriteria" Text="Company" AutoPostBack="True" oncheckedchanged="RB_COMPANY_CheckedChanged"></asp:radiobutton></TD>
											</TR>
											<TR>
												<TD class="TDBGColor1" width="197">Tanggal Aplikasi</TD>
												<TD width="9">:</TD>
												<TD class="TDBGColorValue" width="342"><asp:textbox id="TXT_DATE" runat="server" onkeypress="return digitsonly()" Columns="3" MaxLength="2"></asp:textbox><asp:dropdownlist id="DDL_MONTH" runat="server"></asp:dropdownlist><asp:textbox id="TXT_YEAR" onkeypress="return digitsonly()" runat="server" Columns="4" MaxLength="4"></asp:textbox></TD>
											</TR>
											<TR>
											...
											<TR>
												<TD class="TDBGColor1" width="197">Unit</TD>
												<TD width="9">:</TD>
											...
											<TR>
												<TD vAlign="top" align="center" width="100%" colSpan="3"><asp:button id="BTN_FIND" runat="server" Text="Find" Width="75px" CssClass="button1" onclick="BTN_FIND_Click"></asp:button>&nbsp;
													<asp:button id="BTN_CLEAR" runat="server" Text="Clear" Width="75px" CssClass="button1" onclick="BTN_CLEAR_Click"></asp:button>
					...
					<tr>
						<td colSpan="2"><asp:table id="oTable" runat="server" Width="100%" CellPadding="0" CellSpacing="0">
								<asp:TableRow>
					...
					<TR>
						<TD class="tdH" align="left" colSpan="2"><asp:label id="LBL_TEKS" runat="server" Visible="False" Font-Bold="True">Nomor Aplikasi :</asp:label><asp:label id="LBL_APREGNO" runat="server" Visible="False" Font-Bold="True"></asp:label>
							<asp:label id="LBL_STA" runat="server" Visible="False" Font-Bold="True"></asp:label></TD>
					</TR>
					<TR>
						<TD class="tdH" align="center" colSpan="2"><asp:table id="oTable1" runat="server" Width="100%" CellPadding="0" CellSpacing="0" Visible="False">
								<asp:TableRow>
										...
										<TABLE id="Table5" cellSpacing="0" cellPadding="0" width="100%" border="0">
											<TR>
												...
												<TD class="TDBGColorValue">
													<P><asp:radiobuttonlist id="RB_PROSES" runat="server" AutoPostBack="True" RepeatDirection="Horizontal" RepeatLayout="Flow" onselectedindexchanged="RadioButtonList2_SelectedIndexChanged">
											...
											<TR>
												...
												<TD>:</TD>
												<TD class="TDBGColorValue"><asp:dropdownlist id="DDL_REJECT" runat="server" CssClass="mandatory"></asp:dropdownlist><asp:textbox id="TXT_JML" runat="server" Columns="4" MaxLength="4" Visible="False"></asp:textbox><asp:textbox id="TXT_TAMPIL" runat="server" Columns="4" Visible="False"></asp:textbox><asp:textbox id="TXT_TAMPIL1" runat="server" Columns="4" Visible="False"></asp:textbox></TD>
											</TR>
										</TABLE>
									</TD>
								<tr>
									<td align="center">
										<asp:button id="Button2" runat="server" Text="PROSES" CssClass="button1" onclick="Button2_Click"></asp:button>&nbsp;</td>
								</tr>
							</TABLE>
						</td>
					</tr>
