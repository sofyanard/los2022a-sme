<%@ Page language="c#" Codebehind="PostFin.aspx.cs" AutoEventWireup="True" Inherits="SME.LOW.PostFin" %>
							...
							<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									...
									<TD class="TDBGColorValue"><asp:textbox id="TXT_CP_EXLIMITVAL" onkeypress="return digitsonly()" onkeyup="HitungLimit()"
											MaxLength="15" onblur="FormatCurrency(this), FormatCurrency(document.Form1.TXT_CP_LIMIT)" runat="server" CssClass="mandatory"
								...
								<TR>
									...
									<TD class="TDBGColorValue">
										<asp:textbox id="TXT_CP_EXRPLIMIT" onkeyup="HitungLimit()" onkeypress="return numbersonly()"
											MaxLength="15" onblur="FormatCurrency(this), FormatCurrency(document.Form1.TXT_CP_LIMIT)"
