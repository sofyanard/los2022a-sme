<%@ Page language="c#" Codebehind="PerubahanLimit.aspx.cs" AutoEventWireup="True" Inherits="SME.LOW.PerubahanLimit" %>
...
<HTML>
	<HEAD>
		...
		<script language="vbscript">
			...
			obj.TXT_CP_LIMITCHGTO.value = replace(obj.TXT_CP_LIMITCHGTO.value, ".", ",")
		end function
		</script>
								...
								<TR>
									...
									<TD class="TDBGColorValue">
										<asp:dropdownlist id="DDL_CP_LIMITCHG" runat="server" CssClass="mandatory">
											...
											MaxLength="15" Width="200" onblur="FormatCurrency(this), FormatCurrency(document.Form1.TXT_CP_LIMITCHGTO)" runat="server"
