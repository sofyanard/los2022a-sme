<%@ Page language="c#" Codebehind="LOWSearchAnalyst.aspx.cs" AutoEventWireup="True" Inherits="SME.LOW.LOWSearchAnalyst" %>
				...
				<TABLE id="Table4" width="100%" border="0">
					<TR>
						<TD align="left">
							<TABLE id="Table3">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>Analysis&nbsp;List</B></TD>
								</TR>
							</TABLE>
						</TD>
