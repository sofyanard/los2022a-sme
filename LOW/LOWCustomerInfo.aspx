<%@ Page language="c#" Codebehind="LOWCustomerInfo.aspx.cs" AutoEventWireup="True" Inherits="SME.LOW.LOWCustomerInfo" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>LOWCustomerInfo</title>
			...
			<center>
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					<TBODY>
						<TR>
							<TD class="tdNoBorder">
								<TABLE id="Table4">
									<TR>
										<TD class="tdBGColor2" style="WIDTH: 400px" align="center" runat="server" ID="Td1"><B>Initial 
					...
					-->
								...
								<TABLE id="Table20" cellSpacing="0" cellPadding="0" width="100%">
									...
									<TR>
										...
										<TD class="TDBGColorValue" style="HEIGHT: 17px"><asp:textbox onkeypress="return kutip_satu()" id="TXT_CU_ZIPCODE" runat="server" CssClass="mandatory2"
												AutoPostBack="True" Columns="6" MaxLength="6"></asp:textbox><asp:button id="BTN_SEARCHPERSONAL" runat="server" Text="Search"></asp:button></TD>
									</TR>
									<TR>
								...
								<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" runat="server">
									...
									<TR>
										...
										<TD class="TDBGColorValue"><asp:textbox onkeypress="return kutip_satu()" id="TXT_CU_KTPZIPCODE" runat="server" CssClass="mandatory2"
												AutoPostBack="True" Columns="6" MaxLength="6"></asp:textbox><asp:button id="BTN_SEARCHKTPZIP" runat="server" Text="Search"></asp:button></TD>
									</TR>
									<TR>
						...
						<TR id="TR_COMPANY" runat="Server">
							<TD class="td" vAlign="top" width="50%">
								<TABLE id="Table4" cellSpacing="0" cellPadding="0" width="100%">
									...
									<TR>
										<TD class="TDBGColor1" style="WIDTH: 129px; HEIGHT: 14px">Jenis Badan Usaha</TD>
										<TD style="WIDTH: 15px; HEIGHT: 14px"></TD>
										<TD class="TDBGColorValue" style="HEIGHT: 14px"><asp:dropdownlist id="DDL_CU_JNSNASABAH" runat="server" CssClass="mandatory"></asp:dropdownlist></TD>
									</TR>
									<TR>
									...
									<TR>
										...
										<TD class="TDBGColorValue"><asp:textbox onkeypress="return kutip_satu()" id="TXT_CU_COMPZIPCODE" runat="server" CssClass="mandatory"
												AutoPostBack="True" Columns="6" MaxLength="6"></asp:textbox><asp:button id="BTN_SEARCHCOMP" runat="server" Text="Search"></asp:button></TD>
									</TR>
									<TR>
										<TD class="TDBGColor1">Jenis Alamat</TD>
										<TD></TD>
							...
							<TD class="td" vAlign="top" width="50%">
								<TABLE id="Table5" cellSpacing="0" cellPadding="0" width="100%">
									<TR>
										<TD class="TDBGColor1" width="129" style="HEIGHT: 17px">Bidang Usaha</TD>
										<TD style="WIDTH: 15px; HEIGHT: 17px"></TD>
										<TD class="TDBGColorValue" style="HEIGHT: 17px"><asp:dropdownlist id="DDL_CU_COMPBUSSTYPE" runat="server" CssClass="mandatory"></asp:dropdownlist></TD>
									</TR>
									<TR>
						...
						<TR>
							<TD class="TDBGColor2" vAlign="top" align="center" colSpan="2"><asp:button id="BTN_SAVE" runat="server" CssClass="Button1" Width="100px" Text="Save"></asp:button><asp:button id="BTN_SAVECON" runat="server" CssClass="Button1" Width="100px" Text="Save"></asp:button>
