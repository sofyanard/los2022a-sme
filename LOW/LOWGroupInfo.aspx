<%@ Page language="c#" Codebehind="LOWGroupInfo.aspx.cs" AutoEventWireup="True" Inherits="SME.LOW.LOWGroupInfo" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>LOWGroupInfo</title>
			...
			<center>
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					...
					<TR id="TR_PERSONAL" runat="server">
						<TD class="td" vAlign="top" width="50%">
							<TABLE id="Table20" cellSpacing="0" cellPadding="0" width="100%">
								...
								<TR>
									<TD class="TDBGColor1" width="117" style="WIDTH: 117px">Title Before Name</TD>
									<TD style="WIDTH: 5px"></TD>
								...
								<TR>
									<TD class="TDBGColor1" style="WIDTH: 117px; HEIGHT: 20px">Title After Name</TD>
									<TD style="WIDTH: 5px; HEIGHT: 20px"></TD>
									<TD class="TDBGColorValue" style="HEIGHT: 20px">
								...
								<TR>
									...
									<TD class="TDBGColorValue" style="HEIGHT: 17px"><asp:textbox id="TXT_CU_ZIPCODE" runat="server" Columns="6" CssClass="mandatory" MaxLength="6"
											onkeypress="return kutip_satu()" AutoPostBack="True"></asp:textbox>
										<asp:button id="BTN_SEARCHPERSONAL" runat="server" Text="Search"></asp:button></TD>
								</TR>
								<TR>
									<TD class="TDBGColor1" style="WIDTH: 117px">No. Telepon</TD>
									<TD style="WIDTH: 5px"></TD>
								...
								<TR>
									<TD class="TDBGColor1" style="WIDTH: 117px">No. Fax</TD>
									<TD style="WIDTH: 5px"></TD>
								...
								<TR>
									...
									<TD class="TDBGColorValue">
										<asp:textbox id="TXT_CU_COMPZIPCODE" runat="server" Columns="6" CssClass="mandatory" MaxLength="6"
											onkeypress="return kutip_satu()" AutoPostBack="True"></asp:textbox>
										<asp:button id="BTN_SEARCHCOMP" runat="server" Text="Search"></asp:button></TD>
								</TR>
								<TR>
					...
					<TR id="TR_APAMANDIRI" runat="Server">
						<TD class="TDBGColor1" style="HEIGHT: 19px" vAlign="top" width="50%">Apakah pernah 
							menjadi nasabah Bank Mandiri?</TD>
					...
					<TR>
						<TD class="tdHeader1" vAlign="top" width="50%" colSpan="2">Group Info</TD>
					</TR>
					<TR runat="Server" ID="Tr1">
						...
						<TD class="td" vAlign="top" width="50%">
							<TABLE id="Table5" cellSpacing="0" cellPadding="0" width="100%">
								...
								<TR>
									<TD class="TDBGColor1" style="WIDTH: 129px">Remark</TD>
									<TD style="WIDTH: 15px"></TD>
									<TD class="TDBGColorValue">
					...
					<TR>
						<TD class="TDBGColor2" vAlign="top" align="center" width="50%" colSpan="2"><asp:button id="BTN_SAVE" runat="server" Text="Save" CssClass="Button1" Width="100px"></asp:button></TD>
					</TR>
				</TABLE>
			</center>
		</form>
