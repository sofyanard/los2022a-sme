<%@ Page language="c#" Codebehind="LOWBICheckingResult.aspx.cs" AutoEventWireup="True" Inherits="SME.LOW.LOWBICheckingResult" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>LOWBICheckingResult</title>
			...
			<center>
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					<TBODY>
						...
						<TR>
							<TD class="TDBGColor2" colSpan="2"><asp:button id="BTN_UPDATE_BI" runat="server" Text="Update BI" CssClass="Button1"></asp:button></TD>
						</TR>
						<TR>
										...
										<td>
											<TABLE id="Table7" cellSpacing="0" cellPadding="0" width="100%">
												<TR>
													...
													<TD>&nbsp;</TD>
													<TD class="TDBGColorValue" style="HEIGHT: 13px"><asp:dropdownlist id="DDL_NAMA" runat="server" CssClass="mandatory" AutoPostBack="True"></asp:dropdownlist><asp:dropdownlist id="DDL_H_ALAMAT" runat="server" Visible="False"></asp:dropdownlist></TD>
												</TR>
												<TR>
						...
						<TR>
							<TD class="TDBGColor2" vAlign="top" align="center" width="50%" colSpan="2"><asp:label id="LBL_H_SHSEQ" runat="server" Visible="False"></asp:label><asp:button id="BTN_SAVE" runat="server" Text="Save" CssClass="Button1"></asp:button>&nbsp;
								<asp:button id="BTN_CANCEL" runat="server" Text="Cancel" CssClass="Button1"></asp:button><asp:label id="LBL_H_ACCSEQ" runat="server" Visible="False"></asp:label></TD>
						</TR>
						<% } %>
						<TR>
										...
										<td>
											<TABLE id="Table17" cellSpacing="0" cellPadding="0" width="100%">
												<TR>
													<TD class="TDBGColor1">Nama</TD>
													<TD></TD>
													<TD class="TDBGColorValue"><asp:dropdownlist id="DDL_NAMA2" runat="server" CssClass="mandatory" AutoPostBack="True"></asp:dropdownlist><asp:dropdownlist id="DDL_H_ALAMAT2" runat="server" Visible="False"></asp:dropdownlist></TD>
												</TR>
												<TR>
													<TD class="TDBGColor1">Alamat</TD>
													<TD></TD>
						...
						<TR>
							<TD class="TDBGColor2" vAlign="top" align="center" width="50%" colSpan="2"><asp:label id="LBL_H_SHSEQ2" runat="server" Visible="False"></asp:label><asp:button id="BTN_SAVE2" runat="server" Text="Save" CssClass="Button1"></asp:button>&nbsp;
								<asp:button id="BTN_CANCEL2" runat="server" Text="Cancel" CssClass="Button1"></asp:button><asp:label id="LBL_H_ACCSEQ2" runat="server" Visible="False"></asp:label></TD>
						</TR>
						<% } %>
						<!-- <TR>
						...
						<TR>
							<TD class="TDBGColor2" vAlign="top" align="center" width="50%" colSpan="2">
								...
								<asp:button id="BTN_UPDATESTATUS" runat="server" Text="Update Status" CssClass="Button1"></asp:button>
								<%}%>
							</TD>
						</TR>
					</TBODY>
