<%@ Page language="c#" Codebehind="LOWCovenant.aspx.cs" AutoEventWireup="True" Inherits="SME.LOW.LOWCovenant" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" > 

<html>
  <head>
    <title>LOWCovenant</title>
					...
					<TBODY>
						<TR>
							<TD class="tdNoBorder"><!--<img src="../Image/HeaderDetailDataEntry.jpg">-->
								<TABLE id="Table4">
									<TR>
										<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>COVENANT</B></TD>
									</TR>
								</TABLE>
							</TD>
						...
						<TR>
							<TD class="tdHeader1" colSpan="2">Covenant</TD>
						</TR>
						<TR>
							<TD colSpan="2"><ASP:DATAGRID id="DG_COVENANT" runat="server" Width="100%" AutoGenerateColumns="False" PageSize="10"
									...
									<Columns>
										...
										<asp:BoundColumn DataField="SYARATDATE" HeaderText="Syarat Date" DataFormatString="{0:dd-MMM-yyyy}">
											<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
											<ItemStyle HorizontalAlign="Center"></ItemStyle>
										</asp:BoundColumn>
