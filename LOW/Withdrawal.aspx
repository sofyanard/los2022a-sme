<%@ Page language="c#" Codebehind="Withdrawal.aspx.cs" AutoEventWireup="True" Inherits="SME.LOW.Withdrawal" %>
							...
							<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									...
									<TD class="TDBGColorValue"><asp:textbox id="TXT_CP_EXLIMITCHGTO" onkeypress="return numbersonly()" onkeyup="HitungLimit()"
											MaxLength="15" onblur="FormatCurrency(this), FormatCurrency(document.Form1.TXT_CP_LIMITCHGTO)" runat="server" CssClass="mandatory"
								...
								<TR>
									...
									<TD style="WIDTH: 15px"></TD>
									<TD class="TDBGColorValue">
										<asp:textbox id="TXT_CP_EXRPLIMITCHGTO" onkeyup="HitungLimit()" onkeypress="return numbersonly()"
											MaxLength="15" onblur="FormatCurrency(this), FormatCurrency(document.Form1.TXT_CP_LIMITCHGTO)"
								...
								<TR>
									...
									<TD style="WIDTH: 15px"></TD>
									<TD class="TDBGColorValue">
										<asp:textbox id="TXT_CP_LIMITCHGTO" MaxLength="15" onkeypress="return numbersonly()" runat="server"
											Width="200px"></asp:textbox></TD>
								</TR>
								<TR>
