<%@ Page language="c#" Codebehind="LOWPledging.aspx.cs" AutoEventWireup="True" Inherits="SME.LOW.LOWPledging" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>LOWPledging</title>
							...
							<TABLE id="Table3" cellSpacing="1" cellPadding="1" width="100%" border="0">
								<TR>
									...
									<TD><asp:dropdownlist id="DDL_GROUP" runat="server" AutoPostBack="True"></asp:dropdownlist>&nbsp;
										<asp:button id="BTN_NEW" runat="server" Text="Add New Group"></asp:button></TD>
								</TR>
								<TR>
									<TD class="tdbgcolor2" colSpan="3"><asp:button id="BTN_ADD" runat="server" Width="125px" Text="Add" CssClass="button1"></asp:button></TD>
								</TR>
							</TABLE>
						</TD>
					</TR>
