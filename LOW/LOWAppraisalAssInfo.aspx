<%@ Page language="c#" Codebehind="LOWAppraisalAssInfo.aspx.cs" AutoEventWireup="True" Inherits="SME.LOW.LOWAppraisalAssInfo" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>LOWAppraisalAssInfo</title>
					...
					<TBODY>
						<TR>
							<TD class="tdNoBorder"><!--<img src="../Image/HeaderDetailDataEntry.jpg">-->
								<TABLE id="Table4">
									<TR>
										<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>APPRAISAL ASSIGNMENT 
												HISTORY</B></TD>
									</TR>
								</TABLE>
							</TD>
						...
						<TR>
							<TD class="tdHeader1" colSpan="2">Appraisal Assignment History</TD>
						</TR>
						<TR>
						...
						<TR>
							<TD vAlign="top" align="center" width="50%" colSpan="2">
								<asp:button id="BTN_NEW" runat="server" Text="New"></asp:button>
							</TD>
						</TR>
					</TBODY>
				</TABLE>
