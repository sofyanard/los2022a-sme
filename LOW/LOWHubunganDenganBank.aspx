<%@ Page language="c#" Codebehind="LOWHubunganDenganBank.aspx.cs" AutoEventWireup="True" Inherits="SME.LOW.LOWHubunganDenganBank" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" > 

<html>
  <head>
    <title>LOWHubunganDenganBank</title>
										...
										<table id="TBL_SALDO_RATA" cellSpacing="0" cellPadding="2" width="100%" border="1" runat="server">
											...
											<tr>
												<td align="center" width="100%" colSpan="7"><asp:textbox onkeypress="return numbersonly()" id="txt_TempDD" Columns="2" Width="32px" MaxLength="2"
														...
														Text="Hitung Lama" Visible="False" Enabled="False"></asp:button>
