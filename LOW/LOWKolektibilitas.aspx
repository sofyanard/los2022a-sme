<%@ Page language="c#" Codebehind="LOWKolektibilitas.aspx.cs" AutoEventWireup="True" Inherits="SME.LOW.LOWKolektibilitas" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>LOWKolektibilitas</title>
		...
		<form id="Form1" method="post" runat="server">
			<center>
				<TABLE id="Table4" style="Z-INDEX: 101; LEFT: 0px; POSITION: absolute; TOP: 0px" width="100%"
							...
							<TABLE id="Table1" cellSpacing="1" cellPadding="1" width="100%" border="1">
								...
								<TR>
									<TD class="TDBGColor2" colSpan="2">
										<asp:button id="BTN_CARI" runat="server" CssClass="Button1" Text="Search"></asp:button></TD>
								</TR>
							</TABLE>
						</TD>
					</TR>
					...
					<TR>
						<TD class="TDBGColor2" align="center" colSpan="2"><asp:button id="BTN_SAVE" runat="server" Width="70px" Text="Save" CssClass="Button1"></asp:button></TD>
					</TR>
				</TABLE>
			</center>
		</form>
