<%@ Page language="c#" Codebehind="BICheckingResultEntry.aspx.cs" AutoEventWireup="True" Inherits="SME.CreditOperations.BIChecking.BICheckingResultEntry" %>
			...
			<center>
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					<TBODY>
						...
						<TR>
							<TD class="tdHeader1" colSpan="2">INPUT HASIL&nbsp; IDI BI</TD>
						</TR>
						<tr>
						...
						<TR>
							<TD class="tdHeader1" colSpan="2">Informasi BlackList</TD>
						</TR>
						<TR>
							<TD colSpan="2">
						...
						<TR>
							<TD class="TDBGColor2" colSpan="2"><asp:button id="BTN_UPDATE_BI" runat="server" 
                                    Text="Simpan" CssClass="Button1" onclick="BTN_UPDATE_BI_Click"></asp:button></TD>
						</TR>
						<TR>
										...
										<td>
											<TABLE id="Table8" cellSpacing="0" cellPadding="0" width="100%">
												...
												<TR>
													...
													<TD></TD>
													<TD class="TDBGColorValue"><asp:textbox id="TXT_BRP_LIMIT" onkeypress="return digitsonly()" onblur="FormatCurrency(this)"
										...
										<td>
											<TABLE id="Table9" cellSpacing="0" cellPadding="0" width="100%">
												...
												<TR>
													...
													<TD></TD>
													<TD class="TDBGColorValue"><asp:textbox onkeypress="return kutip_satu()" id="TXT_BRP_JAMINAN" runat="server" MaxLength="30" onblur="FormatCurrency(this)"></asp:textbox></TD>
												</TR>
                                                <TR>
													<TD class="TDBGColor1">Angsuran</TD>
													<TD></TD>
													<TD class="TDBGColorValue"><asp:textbox id="TXT_ANGSURAN" runat="server" 
                                                            MaxLength="30" onkeypress="return digitsonly()" onblur="FormatCurrency(this)" 
						...
						<TR>
							<TD class="TDBGColor2" vAlign="top" align="center" width="50%" colSpan="2"><asp:label id="LBL_H_SHSEQ" runat="server" Visible="False"></asp:label>
                                <asp:button id="BTN_SAVE" runat="server" Text="Simpan" CssClass="Button1" 
                                    onclick="BTN_SAVE_Click"></asp:button>&nbsp;
								<asp:button id="BTN_CANCEL" runat="server" Text="Batal" CssClass="Button1" 
                                    onclick="BTN_CANCEL_Click"></asp:button><asp:label id="LBL_H_ACCSEQ" runat="server" Visible="False"></asp:label></TD>
						</TR>
						<% } %>
						<TR>
						...
						<TR>
							<TD class="TDBGColor2" vAlign="top" align="center" width="50%" colSpan="2"><asp:label id="LBL_H_SHSEQ2" runat="server" Visible="False"></asp:label>
                                <asp:button id="BTN_SAVE2" runat="server" Text="Simpan" CssClass="Button1" 
                                    onclick="BTN_SAVE2_Click"></asp:button>&nbsp;
								<asp:button id="BTN_CANCEL2" runat="server" Text="Batal" CssClass="Button1" 
                                    onclick="BTN_CANCEL2_Click"></asp:button><asp:label id="LBL_H_ACCSEQ2" runat="server" Visible="False"></asp:label></TD>
						</TR>
						<% } %>
						<TR>
