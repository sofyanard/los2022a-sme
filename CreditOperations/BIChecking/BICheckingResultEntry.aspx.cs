...
namespace SME.CreditOperations.BIChecking
{
	...
	/// </summary>
	public partial class BICheckingResultEntry : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
            ...
            DocumentUpload1.GroupTemplate = "BICHECKING";
		}
		...
		private void SecureData() 
		{
			...
			if (bi == "0")
			{
				...
				{
					DataGrid1.Items[i].Cells[22].Visible = false;
				}
		...
		private void ViewData()
		{
			...
			if(conn.GetRowCount() <= 0)
			{
				conn.QueryString = "select VW_INFOUMUM.*, bi.BS_BIDATAAVAIL "+
					"from VW_INFOUMUM left join bi_status bi on VW_INFOUMUM.ap_regno = bi.ap_regno "+
					"where VW_INFOUMUM.AP_REGNO = '"+ Request.QueryString["curef"].Trim() +"C' ";
				conn.ExecuteQuery();
			}
		...
		private void DataGrid1_ItemCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			switch(((LinkButton)e.CommandSource).CommandName)
			{
				case "edit":
                    ...
                    TXT_ANGSURAN.Text = e.Item.Cells[18].Text.Trim();
					//cleans '&nbsp;'
		...
		protected void BTN_SAVE_Click(object sender, System.EventArgs e)
		{
			...
			string regno=TXT_AP_REGNO.Text.Trim(),
                ...
                pangsuran = tool.ConvertFloat(TXT_ANGSURAN.Text.Trim()),
			...
			conn.QueryString = "exec BC_BI_RESULT_SAVE '" + regno + "', " + brseq + ", " +
				csseq + ", '" + pbank + "', '" + pjeniskredit + "', '" + prekening + "', '" +
		...
		protected void BTN_SAVE2_Click(object sender, System.EventArgs e)
		{
            ...
            conn.QueryString = "exec BC_BI_RESULT_SAVE '" + regno + "', " + brseq + ", " +
                ...
                ctaksasi + ", " + ctglnilai + ", '" + cref + "', '" + bidataavail + "' , NULL";
			try
			{
				conn.ExecuteNonQuery();
			} 
