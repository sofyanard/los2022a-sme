	...
	public partial class AsuransiJiwa : System.Web.UI.Page
	{
		...
		private void viewData() 
		{
			...
			conn.QueryString = "select * " +
				"from applifeinsurance " +
				"where  " +
				"ap_regno = '" + ap_regno + "' " +
				"and seq = '" + seq + "'";
			conn.ExecuteQuery();

			this.TXT_ALI_AMOUNT.Text = conn.GetFieldValue("ALI_AMOUNT");
			this.TXT_ALI_DURATION.Text = conn.GetFieldValue("ALI_DURATION");
			this.TXT_ALI_PREMI.Text = conn.GetFieldValue("ALI_PREMI");
