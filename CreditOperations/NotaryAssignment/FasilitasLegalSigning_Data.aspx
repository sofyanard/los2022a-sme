<%@ Page language="c#" Codebehind="FasilitasLegalSigning_Data.aspx.cs" AutoEventWireup="True" Inherits="SME.CreditOperations.NotaryAssignment.FasilitasLegalSigning_Data" %>
		...
		<center>
			<form id="Form1" method="post" runat="server">
				<TABLE cellSpacing="0" cellPadding="0" width="100%">
								...
								<tr>
									<td class="td" vAlign="top" width="50%">
										<TABLE cellSpacing="0" cellPadding="0" width="100%">
											...
											<tr>
												<td class="TDBGColor1">Tipe Suku Bunga</td>
												<td></td>
								...
								<tr>
										...
										<TABLE cellSpacing="0" cellPadding="0" width="100%">
											...
											<tr>
												...
												<td class="TDBGColorValue"><asp:textbox onkeypress="return digitsonly()" id="TXT_CP_BEAPROVISI_PCT" Columns="6" Runat="server"
														CssClass="angkamandatory" MaxLength="6" Width="50px" AutoPostBack="True" ontextchanged="TXT_CP_BEAPROVISI_PCT_TextChanged"></asp:textbox>%
									...
									<td class="td" vAlign="top">
										<TABLE cellSpacing="0" cellPadding="0" width="100%">
											...
											<TR>
												<TD class="TDBGColor1">Biaya Lainnya</TD>
												<TD></TD>
					...
					<tr>
						<td><asp:datagrid id="DataGrid1" runat="server" Width="100%" CellPadding="1" AutoGenerateColumns="False"
							...
							<TABLE cellSpacing="2" cellPadding="2" width="100%">
									...
									<td class="td" vAlign="top" width="50%">
										<TABLE cellSpacing="0" cellPadding="0" width="100%">
											<TR>
												...
												<TD width="15"></TD>
												<TD class="TDBGColorValue"><asp:dropdownlist id="DDL_CP_INSRTYPE" Runat="server" AutoPostBack="True" onselectedindexchanged="DDL_CP_INSRTYPE_SelectedIndexChanged"></asp:dropdownlist></TD>
											</TR>
											<tr>
											...
											<tr>
												<td class="TDBGColor1">Rating Asuransi</td>
												<td></td>
								...
								<TR>
									<TD class="td" vAlign="top" align="center" width="50%" colSpan="2"><asp:button id="BTN_TAMBAH" runat="server" Text="Tambah" width="75px" cssclass="button1" onclick="BTN_TAMBAH_Click"></asp:button><asp:label id="LBL_H_SEQ" Runat="server" Visible="False">0</asp:label>
                                        <asp:button id="BTN_CANCEL" runat="server" Text="Batal" width="75px" 
                                            cssclass="button1" Visible="False" onclick="BTN_CANCEL_Click"></asp:button></TD>
								</TR>
							</TABLE>
							<%}%>
						</td>
                    ...
                    <!--
					<TR>
						<TD class="tdHeader1" align="center">Document Export</TD>
					</TR>
					<TR>
						<TD vAlign="top">
								...
								<TR>
									<TD style="WIDTH: 477px" vAlign="top">
										<TABLE id="Table4" cellSpacing="0" cellPadding="0" width="100%">
											<TR>
												...
												<TD class="TDBGColorValue"><asp:dropdownlist id="DDL_FORMAT_TYPE" runat="server" Width="304px" AutoPostBack="True"></asp:dropdownlist><asp:button id="BTN_EXPORT" runat="server" Width="64px" Text="Export" onclick="BTN_EXPORT_Click"></asp:button></TD>
											</TR>
											<TR>
									...
									<TD id="IHIU" vAlign="top" width="50%">
										<TABLE id="Table5" cellSpacing="0" cellPadding="0" width="100%">
											<TR>
												<TD id="IHIUaa">
                                                    <asp:DataGrid ID="DATA_EXPORT" runat="server" Width="468px" CellPadding="1" AutoGenerateColumns="False"
                                            PageSize="1">
                                            <AlternatingItemStyle CssClass="TblAlternating"></AlternatingItemStyle>
                                            <Columns>
                                                <asp:BoundColumn Visible="False" DataField="TEMPLATE_ID">
                                                    <HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
                                                </asp:BoundColumn>
                                                ...
                                                <asp:TemplateColumn>
                                                    ...
                                                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="HL_DELETE" runat="server" CommandName="delete">Delete</asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateColumn>
					...
					<%}%>
					<TR>
						<TD class="TDBGColor2" align="center"><asp:label id="LBL_PRODUCTID" Runat="server" Visible="False"></asp:label><asp:label id="LBL_REGNO" Runat="server" Visible="False"></asp:label><asp:label id="LBL_TC" Runat="server" Visible="False"></asp:label>
                            <asp:button id="BTN_SAVE" Runat="server" CssClass="button1" Text="Simpan" 
                                onclick="BTN_SAVE_Click"></asp:button><asp:label id="LBL_CUREF" Runat="server" Visible="False"></asp:label><asp:label id="LBL_APPTYPE" Runat="server" Visible="False"></asp:label><asp:label id="LBL_PROD_SEQ" Runat="server" Visible="False"></asp:label></TD>
					</TR>
				</TABLE>
			</form>
		</center>
