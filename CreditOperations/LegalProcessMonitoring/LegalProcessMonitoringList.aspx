<%@ Page language="c#" Codebehind="LegalProcessMonitoringList.aspx.cs" AutoEventWireup="True" Inherits="SME.CreditOperations.LegalProcessMonitoring.LegalProcessMonitoringList" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>LegalProcessMonitoringList</title>
										...
										<TABLE id="Table4" cellSpacing="0" cellPadding="0" width="100%" border="0">
											...
											<TR>
												<TD style="WIDTH: 521px" vAlign="top" align="center" colSpan="3">
													<asp:button id="btn_Find" cssclass="button1" width="75px" runat="server" Text="Cari" onclick="btn_Find_Click"></asp:button></TD>
											</TR>
										</TABLE>
									</TD>
								</TR>
