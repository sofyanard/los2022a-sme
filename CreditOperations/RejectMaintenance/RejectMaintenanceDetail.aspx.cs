...
{
	/// <summary>
	/// Summary description for RejectMaintenanceDetail.
	/// </summary>
	public partial class RejectMaintenanceDetail : System.Web.UI.Page
	{
		...
		{
			Response.Redirect("RejectMaintenanceList.aspx?tc=" + Request.QueryString["tc"] + "&mc=" + Request.QueryString["mc"]);
		}
	}
}
