<%@ Page language="c#" Codebehind="AcqInfo.aspx.cs" AutoEventWireup="True" Inherits="SME.BGSpan.Approval.AcqInfo" %>
    ...
    <form id="FAcqInfo" method="post" runat="server">
			<center>
				...
				<table id="Table2" cellSpacing="0" cellPadding="0" width="100%">
					...
					<tr>
						<td align="center" class="TDBGColor2"><asp:Button Runat="server" ID="btn_send" Text="Send" Width="100px" CssClass="button1"></asp:Button>
