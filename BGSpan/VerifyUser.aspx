<%@ Page language="c#" Codebehind="VerifyUser.aspx.cs" AutoEventWireup="True" Inherits="SME.BGSpan.VerifyUser" %>
		...
		<form id="Form1" method="post" runat="server">
			<center><br>
				<TABLE id="Table2" style="Z-INDEX: 102; LEFT: 8px; TOP: 8px" cellSpacing="1" cellPadding="1"
					...
					<TR>
						<TD width="200"></TD>
						<TD class="TDBGColor2" colSpan="2" align="center"><asp:button id="BTN_SAVE" runat="server" Width="67px" CssClass="Button1" Text="Ok"></asp:button><asp:button id="BTN_CANCEL" runat="server" Width="67" CssClass="Button1" Text="Cancel"></asp:button></TD>
						<TD width="330"></TD>
					</TR>
				</TABLE>
			</center>
