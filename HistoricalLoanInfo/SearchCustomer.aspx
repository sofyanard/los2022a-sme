<%@ Page language="c#" Codebehind="SearchCustomer.aspx.cs" AutoEventWireup="True" Inherits="SME.HistoricalLoanInfo.SearchCustomer" %>
									...
									<TD vAlign="top" align="center">
										<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
											...
											<TR>
												...
												<TD></TD>
												<TD class="TDBGColorValue">
													<asp:textbox onkeypress="return numbersonly()" id="TXT_CU_DOB_DD" runat="server" MaxLength="2"
														Columns="2"></asp:textbox>
													<asp:dropdownlist id="DDL_CU_DOB_MM" runat="server"></asp:dropdownlist>
													<asp:textbox onkeypress="return numbersonly()" id="TXT_CU_DOB_YYYY" runat="server" MaxLength="4"
											...
											<TR>
												<TD vAlign="top" align="center" colSpan="3" height="10">
													<asp:button id="btn_Find" runat="server" Text="Find Customer" Width="180px" CssClass="button1">
                                                    </asp:button>
												</TD>
											</TR>
										</TABLE>
