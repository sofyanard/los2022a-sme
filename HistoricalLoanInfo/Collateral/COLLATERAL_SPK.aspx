<%@ Page language="c#" Codebehind="COLLATERAL_SPK.aspx.cs" AutoEventWireup="True" Inherits="SME.HistoricalLoanInfo.Collateral.COLLATERAL_SPK" %>
							...
							<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%">
								...
								<TR>
									...
									<TD class="TDBGColorValue"><asp:TextBox id="TXT_CL_JOBDISTNM" Columns="25" MaxLength="100" onKeypress="return kutip_satu()" Width=400
											runat="server" CssClass="mandatory" Enabled=False ></asp:TextBox></TD>
								</TR>
								<TR>
									...
									<TD class="TDBGColorValue"><asp:TextBox id="TXT_CL_VALUE" Columns="25" MaxLength="21" onKeypress="return numbersonly()"
											runat="server" CssClass="mandatory" onblur = "FormatCurrency(this)" Enabled=False ></asp:TextBox></TD>
								</TR>
								<TR>
