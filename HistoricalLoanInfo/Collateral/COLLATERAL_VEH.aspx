<%@ Page language="c#" Codebehind="COLLATERAL_VEH.aspx.cs" AutoEventWireup="True" Inherits="SME.HistoricalLoanInfo.Collateral.Jaminan_VEH" %>
							...
							<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									...
									<TD class="TDBGColorValue"><asp:textbox id="TXT_CL_DESC" onKeypress="return kutip_satu()" runat="server" CssClass="mandatory" Width=400
											Columns="25" MaxLength="50" Enabled=False ></asp:textbox></TD>
								</TR>
								<TR>
								...
								<TR>
									...
									<TD></TD>
									<TD class="TDBGColorValue"><asp:dropdownlist id="DDL_CL_DEALER" runat="server" Enabled=False ></asp:dropdownlist></TD>
								</TR>
								<TR>
								...
								<TR>
									...
									<TD></TD>
									<TD class="TDBGColorValue"><asp:textbox id="TXT_CL_NOOFUNITS" runat="server" Columns="8" MaxLength="8" onKeypress="return numbersonly()" Enabled=False ></asp:textbox></TD>
								</TR>
								<TR>
								...
								<TR>
									...
									<TD></TD>
									<TD class="TDBGColorValue"><asp:textbox id="TXT_CL_CHASISNO" runat="server" Columns="20" MaxLength="20" onKeypress="return kutip_satu()" Enabled=False ></asp:textbox></TD>
								</TR>
								<TR>
									<TD class="TDBGColor1">Jenis Kendaraan</TD>
									<TD></TD>
									<TD class="TDBGColorValue"><asp:TextBox id="TXT_CL_JNSMOBIL" runat="server" MaxLength="20" Columns="20" onKeypress="return kutip_satu()" Enabled=False ></asp:TextBox></TD>
								</TR>
								<TR>
									<TD class="TDBGColor1">Type / Jenis Unit</TD>
									<TD></TD>
									<TD class="TDBGColorValue"><asp:dropdownlist id="DDL_CL_CARTYPE" runat="server" Enabled=False ></asp:dropdownlist></TD>
								</TR>
								<TR>
								...
								<TR>
									...
									<TD></TD>
									<TD class="TDBGColorValue"><asp:textbox id="TXT_CL_ISSUEDDATEDAY" runat="server" Columns="2" MaxLength="2" onKeypress="return numbersonly()" Enabled=False ></asp:textbox><asp:dropdownlist id="DDL_CL_ISSUEDDATEMONTH" runat="server" Enabled=False ></asp:dropdownlist><asp:textbox id="TXT_CL_ISSUEDDATEYEAR" runat="server" Columns="4" MaxLength="4" onKeypress="return numbersonly()" Enabled=False ></asp:textbox></TD>
								</TR>
								<TR>
									...
									<TD class="TDBGColorValue"><asp:TextBox id="TXT_CL_VALUE" runat="server" CssClass="mandatory" onKeypress="return numbersonly()"
											Columns="25" MaxLength="21" onblur = "FormatCurrency(this)" Enabled=False ></asp:TextBox></TD>
								</TR>
								<TR>
								...
								<TR>
									...
									<TD class="TDBGColorValue"><asp:textbox id="TXT_CL_PPAPVAL" runat="server" MaxLength="21" Columns="25"
											onkeypress="return numbersonly()" CssClass="mandatory" onblur = "FormatCurrency(this)" Enabled=False ></asp:textbox></TD>
								</TR>
								<TR>
									<TD class="TDBGColor1">Lokasi Agunan</TD>
									<TD></TD>
									<TD class="TDBGColorValue"><asp:dropdownlist id="DDL_CL_COLLOC" runat="server" CssClass="mandatory" Enabled=False ></asp:dropdownlist></TD>
								</TR>
								<TR>
