<%@ Page language="c#" Codebehind="COLLATERAL_TRCON.aspx.cs" AutoEventWireup="True" Inherits="SME.HistoricalLoanInfo.Collateral.COLLATERAL_TRCON" %>
						...
						<TD class="td" vAlign="top" width="50%">
							<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%">
								...
								<TR>
									...
									<TD></TD>
									<TD class="TDBGColorValue"><asp:TextBox id="TXT_CL_CONTRACTNAME" runat="server" Columns="20" MaxLength="100" onKeypress="return kutip_satu()" CssClass="mandatory" Width=400 Enabled=False ></asp:TextBox></TD>
								</TR>
								<TR>
									<TD class="TDBGColor1">No. Kontrak</TD>
									<TD></TD>
									<TD class="TDBGColorValue">
										<asp:TextBox id="TXT_CL_CONTRACTNO" runat="server" Columns="20" MaxLength="20" onKeypress="return kutip_satu()"
											CssClass="mandatory" Enabled=False ></asp:TextBox>
								...
								<TR>
									...
									<TD></TD>
									<TD class="TDBGColorValue">
										<asp:TextBox id="TXT_CL_APPRDATEDAY" runat="server" Columns="2" MaxLength="2" onKeypress="return numbersonly()" Enabled=False ></asp:TextBox>
										<asp:DropDownList id="DDL_CL_APPRDATEMONTH" runat="server" Enabled=False ></asp:DropDownList>
										<asp:TextBox id="TXT_CL_APPRDATEYEAR" runat="server" Columns="4" MaxLength="4" onKeypress="return numbersonly()" Enabled=False ></asp:TextBox>
									</TD>
								</TR>
								<TR>
