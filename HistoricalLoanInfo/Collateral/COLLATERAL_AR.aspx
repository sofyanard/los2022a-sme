<%@ Page language="c#" Codebehind="COLLATERAL_AR.aspx.cs" AutoEventWireup="True" Inherits="SME.HistoricalLoanInfo.Collateral.COLLATERAL_AR" %>
							...
							<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									...
									<TD class="TDBGColorValue">
										<asp:textbox id="TXT_CL_DESC" onKeypress="return kutip_satu()" runat="server" MaxLength="50" Width=400
								...
								<TR>
									...
									<TD></TD>
									<TD class="TDBGColorValue">
										<asp:TextBox id="TXT_CL_COLLNAME" MaxLength="30" Columns="25" runat="server" CssClass="mandatory" Width=250
								...
								<TR>
									...
									<TD></TD>
									<TD class="TDBGColorValue">
										<asp:TextBox id="TXT_CL_REVIEWDATEDAY" MaxLength="2" Columns="2" runat="server" onKeypress="return numbersonly()" Enabled=False ></asp:TextBox>
										<asp:dropdownlist id="DDL_CL_REVIEWDATEMONTH" runat="server" Enabled=False ></asp:dropdownlist>
										<asp:TextBox id="TXT_CL_REVIEWDATEYEAR" MaxLength="4" Columns="4" runat="server" onKeypress="return numbersonly()" Enabled=False ></asp:TextBox>
									</TD>
								</TR>
								<TR>
