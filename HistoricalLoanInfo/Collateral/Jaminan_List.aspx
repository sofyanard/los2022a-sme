<%@ Page language="c#" Codebehind="Jaminan_List.aspx.cs" AutoEventWireup="True" Inherits="SME.HistoricalLoanInfo.Collateral.Jaminan_List" %>
			...
			<table Width="100%" class="BackGroundList">
				...
				<tr>
					<td class="TDBGColor2" vAlign="top" align="center">
						<asp:Button CssClass="Button1" Text="Insert" runat="server" ID="BTN_SAVE" Width="70px">
                        </asp:Button>
						<asp:Button CssClass="Button1" Text="Delete" runat="server" ID="BTN_DELETE" Width="70px">
                        </asp:Button>
