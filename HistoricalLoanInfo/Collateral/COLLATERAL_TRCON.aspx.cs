...
namespace SME.HistoricalLoanInfo.Collateral
{
	...
	public partial class COLLATERAL_TRCON : System.Web.UI.Page
	{
		...
		{
			conn.QueryString = "select CL_VALUE, CL_DESC, CL_CURRENCY, CL_COLCLASSIFY, CL_CONTRACTNAME, "+
				"CL_CONTRACTNO, CL_ISCASHEDVALUE, CL_CONTRACTAMNT, CL_APPRDATE, CL_APPRDATE, CL_GUARANTEEVAL, CL_DEALER, CL_PROPVALUE, SIBS_COLID "+
				"from VW_BACKUP_COLL_TRCON "+
