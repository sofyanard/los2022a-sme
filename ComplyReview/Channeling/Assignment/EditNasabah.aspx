<%@ Page language="c#" Codebehind="EditNasabah.aspx.cs" AutoEventWireup="True" Inherits="SME.ComplyReview.Channeling.Assignment.EditNasabah" %>
				...
				<table id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					<tr>
						...
						<TD class="tdNoBorder" align="right">
							<A href="UploadData.aspx?curef=<%=Request.QueryString["curef"]%>&mc=<%=Request.QueryString["mc"]%>&tc=<%=Request.QueryString["tc"]%>&regno=<%=Request.QueryString["regno"]%>&productid=<%=Request.QueryString["productid"]%>&aano=<%=Request.QueryString["aano"]%>&prodseq=<%=Request.QueryString["prodseq"]%>&parentregno=<%=Request.QueryString["parentregno"]%>"><IMG src="../../../Image/back.jpg"></IMG></a><A href="../../../Body.aspx"><IMG src="../../../Image/MainMenu.jpg"></A><A href="../../../Logout.aspx" target="_top"><IMG src="../../../Image/Logout.jpg"></A>
						</TD>
					</tr>
					<tr>
									...
									<td>
										<TABLE class="td" id="Table30" height="35" cellSpacing="1" cellPadding="1" width="100%"
											...
											<TR>
												...
												<TD class="TDBGColorValue" style="WIDTH: 306px"><asp:textbox id="TXT_CU_FIRSTNAME_1" runat="server" Width="100%"></asp:textbox></TD>
												<!-------------------------------------------------------------------------------------------------------->
												<TD class="TDBGColor1" style="WIDTH: 18.7%">No. KTP</TD>
												<TD style="WIDTH: 1.31%">:</TD>
												<TD class="TDBGColorValue">
													<asp:textbox id="TXT_CU_IDCARDNUM_1" runat="server" Width="100%"></asp:textbox></TD>
											</TR>
											<TR>
												<TD class="TDBGColor1" style="WIDTH: 17.71%; HEIGHT: 16px">Alamat</TD>
												<TD style="WIDTH: 0.87%; HEIGHT: 16px">:</TD>
												<TD class="TDBGColorValue" style="WIDTH: 306px; HEIGHT: 16px"><asp:textbox id="TXT_CU_ADDR_1" runat="server" Width="100%" TextMode="MultiLine" Height="40px"></asp:textbox></TD>
												<!-------------------------------------------------------------------------------------------------------->
												<TD class="TDBGColor1" style="WIDTH: 18.7%; HEIGHT: 16px" vAlign="top">Tanggal 
													Berakhir KTP</TD>
												<TD style="WIDTH: 1.31%; HEIGHT: 16px" vAlign="top">:</TD>
												<TD class="TDBGColorValue" style="HEIGHT: 16px" vAlign="top">
													<asp:textbox id="TXT_CU_IDCARDEXP_DAY_1" runat="server" Width="32px"></asp:textbox>
													<asp:dropdownlist id="TXT_CU_IDCARDEXP_MONTH_1" runat="server" Width="112px"></asp:dropdownlist>
													<asp:textbox id="TXT_CU_IDCARDEXP_YEAR_1" runat="server" Width="72px"></asp:textbox></TD>
											</TR>
											<TR>
												<TD class="TDBGColor1" style="WIDTH: 17.71%">Kecamatan</TD>
												<TD style="WIDTH: 0.87%">:</TD>
												<TD class="TDBGColorValue" style="WIDTH: 306px"><asp:textbox id="TXT_KECAMATAN" runat="server" Width="100%"></asp:textbox></TD>
												<!-------------------------------------------------------------------------------------------------------->
												<TD class="TDBGColor1" style="WIDTH: 18.7%">
													NPWP</TD>
												<TD style="WIDTH: 1.31%">:</TD>
												<TD class="TDBGColorValue">
													<asp:textbox id="TXT_CU_NPWP_1" runat="server" Width="100%"></asp:textbox></TD>
											</TR>
											<TR>
												<TD class="TDBGColor1" style="WIDTH: 17.71%">
													Kota</TD>
												<TD style="WIDTH: 0.87%">:</TD>
												<TD class="TDBGColorValue" style="WIDTH: 306px">
													<asp:textbox id="TXT_CITYNAME_1" runat="server" Width="100%"></asp:textbox></TD>
												<!-------------------------------------------------------------------------------------------------------->
												<TD class="TDBGColor1" style="WIDTH: 18.7%">Nama Ibu Kandung</TD>
												<TD style="WIDTH: 1.31%">:</TD>
												<TD class="TDBGColorValue">
													<asp:textbox id="TXT_CU_MOTHER_1" runat="server" Width="100%"></asp:textbox></TD>
											</TR>
											<TR>
												<TD class="TDBGColor1" style="WIDTH: 17.71%">Kode Pos</TD>
												<TD style="WIDTH: 0.87%">:</TD>
												<TD class="TDBGColorValue" style="WIDTH: 306px">
													<asp:textbox id="TXT_CU_ZIPCODE_1" runat="server" Width="88px"></asp:textbox>
													<asp:button id="BTN_SEARCH_ZIPCODE_1" runat="server" Text="Search"></asp:button>
												...
												<TD style="WIDTH: 1.31%">:</TD>
												<TD class="TDBGColorValue">
													<asp:textbox id="TXT_CU_NAMAPELAPORAN_1" runat="server" Width="100%"></asp:textbox></TD>
											</TR>
											<TR>
												...
												<TD style="WIDTH: 1.31%">:</TD>
												<TD class="TDBGColorValue">
													<asp:dropdownlist id="DDL_CU_NEGARADOMISILI_1" runat="server" Width="100%" Enabled="False"></asp:dropdownlist></TD>
											</TR>
											<TR>
												...
												<TD style="WIDTH: 1.31%">:</TD>
												<TD class="TDBGColorValue">
													<asp:textbox id="TXT_CU_NETINCOME_1" runat="server" Width="100%"></asp:textbox></TD>
											</TR>
											<TR>
												...
												<!-------------------------------------------------------------------------------------------------------->
												<TD class="TDBGColor1" style="WIDTH: 18.7%; HEIGHT: 23px">Lokasi DATI II</TD>
												<TD style="WIDTH: 1.31%; HEIGHT: 23px">:</TD>
												<TD class="TDBGColorValue" style="HEIGHT: 23px">
													<asp:dropdownlist id="DDL_CU_LOKASIDATI_2" runat="server" Width="100%" Height="27px"></asp:dropdownlist></TD>
											</TR>
											<TR>
												...
												<!-------------------------------------------------------------------------------------------------------->
												<TD class="TDBGColor1" style="WIDTH: 18.7%">Kewarganegaraan</TD>
												<TD style="WIDTH: 1.31%">:</TD>
												<TD class="TDBGColorValue">
													<asp:dropdownlist id="DDL_CU_CITIZENSHIP_1" runat="server" Width="100%" Enabled="False"></asp:dropdownlist></TD>
											</TR>
											<!-- customer -->
											<TR>
												<TD class="TDBGColor1" style="WIDTH: 17.71%; HEIGHT: 21px">Jenis Kelamin</TD>
												<TD style="WIDTH: 0.87%; HEIGHT: 21px">:</TD>
												<TD class="TDBGColorValue" style="WIDTH: 306px; HEIGHT: 21px">
													<asp:dropdownlist id="DDL_CU_SEX_1" runat="server" Width="100%"></asp:dropdownlist></TD>
												<!-------------------------------------------------------------------------------------------------------->
												<TD class="TDBGColor1" style="WIDTH: 18.7%; HEIGHT: 21px">Hubungan Nasabah BM</TD>
												<TD style="WIDTH: 1.31%; HEIGHT: 21px">:</TD>
												<TD class="TDBGColorValue" style="HEIGHT: 21px">
													<asp:dropdownlist id="DDL_CU_HUBEXECBM_1" runat="server" Width="100%" Enabled="False"></asp:dropdownlist></TD>
											</TR>
											<TR>
												<TD class="TDBGColor2" vAlign="top" align="center" colSpan="7"><asp:button id="btn_Save_CIF_Data" runat="server" Width="100px" Text="SAVE" CssClass="Button1" onclick="btn_Save_CIF_Data_Click"></asp:button><asp:button id="btn_Clear_CIF_Data" runat="server" Width="100px" Text="CLEAR" CssClass="Button1"></asp:button></TD>
											</TR>
										</TABLE>
									</td>
								</tr>
								...
								<tr id="DATA_JAMINAN_TR" runat="server">
									<td>
										<table width="100%">
											...
											<TR>
												<TD class="TDBGColor1" style="WIDTH: 17.71%">Jenis Agunan</TD>
												<TD style="WIDTH: 0.87%">:</TD>
												<TD class="TDBGColorValue" style="WIDTH: 304px"><asp:dropdownlist id="DDL_JENIS_AGUNAN" runat="server" Width="100%"></asp:dropdownlist></TD>
												<!-------------------------------------------------------------------------------------------------------->
											...
											<TR>
												<TD class="TDBGColor2" vAlign="top" align="center" colSpan="7"><asp:button id="btn_Save_Data_Agunan" runat="server" Width="100px" Text="SAVE" CssClass="Button1" onclick="btn_Save_Data_Agunan_Click"></asp:button><asp:button id="btn_Clear_data_agunan" runat="server" Width="100px" Text="CLEAR" CssClass="Button1"></asp:button></TD>
											</TR>
										</table>
									</td>
								</tr>
									...
									<td>
										<table width="100%">
											...
											<TR>
												...
												<TD class="TDBGColorValue" style="HEIGHT: 1px"><asp:dropdownlist id="DDL_BM_SEKTOREKONOMI_1" runat="server" Width="100%" AutoPostBack="True"></asp:dropdownlist></TD>
											</TR>
											<TR>
												...
												<TD style="WIDTH: 1.31%">:</TD>
												<TD class="TDBGColorValue"><asp:dropdownlist id="DDL_BM_SUBSEKTOREKON_1" runat="server" Width="100%" AutoPostBack="True"></asp:dropdownlist></TD>
											</TR>
											<TR>
												...
												<TD class="TDBGColorValue" style="HEIGHT: 18px"><asp:dropdownlist id="DDL_BM_SUBSUBSEKTOREKON_1" runat="server" Width="100%" AutoPostBack="True"></asp:dropdownlist></TD>
											</TR>
											<TR>
											...
											<TR>
												<TD class="TDBGColor2" vAlign="top" align="center" colSpan="7"><asp:button id="btn_Save_Sandi_BI" runat="server" Width="100px" Text="SAVE" CssClass="Button1" onclick="btn_Save_Sandi_BI_Click"></asp:button><asp:button id="btn_Clear_Sandi_BI" runat="server" Width="100px" Text="CLEAR" CssClass="Button1"></asp:button></TD>
											</TR>
										</table>
									</td>
								</tr>
