<%@ Page language="c#" Codebehind="ListComplyReview.aspx.cs" AutoEventWireup="True" Inherits="SME.ComplyReview.Channeling.Assignment.ListComplyReview" %>
					...
					<tr>
						<td style="HEIGHT: 28px" colSpan="2">
							<table>
								...
								<tr>
									<td class="TDBGColor1" style="WIDTH: 154px"><STRONG>Nama Nasabah #</STRONG></td>
									<td style="WIDTH: 5px"><STRONG>:</STRONG></td>
									<td><asp:textbox onkeypress="return kutip_satu()" id="txt_customer" runat="server" MaxLength="20" Columns="30"
											Width="176px"></asp:textbox></td>
									<td style="WIDTH: 5px"></td>
									<td><asp:button id="Button1" runat="server" Width="56px" Text="Find"></asp:button></td>
								</tr>
							</table>
						...
						<td style="WIDTH: 50%" colSpan="2"><asp:datagrid id="dgListChan" runat="server" Width="100%" AutoGenerateColumns="False">
								...
								<Columns>
									...
									<asp:TemplateColumn>
										...
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
										<ItemTemplate>
											<asp:LinkButton id="Linkbutton3" runat="server" CommandName=""></asp:LinkButton>
										</ItemTemplate>
									</asp:TemplateColumn>
