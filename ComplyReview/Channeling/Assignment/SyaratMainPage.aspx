<%@ Page language="c#" Codebehind="SyaratMainPage.aspx.cs" AutoEventWireup="True" Inherits="SME.ComplyReview.Channeling.Assignment.SyaratMainPage" %>
			...
			<center>
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					<TR>
						...
						<TD class="tdNoBorder" align="right"><A href="ListComplyReview.aspx?mc=CHAN005"><IMG src="/SME/Image/back.jpg"></A><A href="../../../Body.aspx"><IMG src="../../../Image/MainMenu.jpg"></A><A href="../../../Logout.aspx" target="_top"><IMG src="../../../Image/Logout.jpg"></A></TD>
					</TR>
					<TR>
					...
					<TR>
						<TD class="TDBGColor2" vAlign="top" align="center" width="50%" colSpan="2">&nbsp;<asp:button id="updatestatus" runat="server" CssClass="Button1" Text="Update Status" Visible="False"></asp:button>&nbsp;<asp:button id="barcode" runat="server" CssClass="Button1" Text="View Nota Analisa" Visible="False"></asp:button>&nbsp;
							<asp:button id="Button1" runat="server" CssClass="Button1" Text="View Resume Nota Analisa" Visible="False"></asp:button></TD>
					</TR>
				</TABLE>
			</center>
		</form>
