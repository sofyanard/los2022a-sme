...
namespace SME.ComplyReview.Channeling.Assignment
{
	...
	/// </summary>
	public partial class ListComplyReview : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			{
				Tools.popMessage(this, "Track updated to Legal, Comply and Review " + Request.QueryString["destination"] + " !");
			}
			else if(Request.QueryString["msg"] == "notok")
			{
				Tools.popMessage(this, "Track updated to Credit Proposal " + Request.QueryString["destination"] + " !");
			}
		}
		...
		{	
			...
			BindData("dgListChan","EXEC CHANNELING_GETLIST_COMPLY_ASSIGNMENT '" + Session["UserID"].ToString() + "','" + txt_customer.Text.ToString() + "'");
		}
		...
		private void dgListChan_ItemCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			switch (((LinkButton)e.CommandSource).CommandName)
			{
				case "ContinuePending":
					...
					conn.ExecuteQuery();*/
					Response.Redirect("AssignmentComplyReview.aspx?curef="+e.Item.Cells[0].Text+"&productid="+e.Item.Cells[5].Text+"&aano="+e.Item.Cells[4].Text+"&prodseq="+e.Item.Cells[6].Text+"&mc=" + Request.QueryString["mc"]+"&tc="+Request.QueryString["tc"]+"&parentregno="+e.Item.Cells[7].Text+"&regno="+e.Item.Cells[1].Text+"&mode=lanjut&prodseqinduk="+e.Item.Cells[10].Text);
