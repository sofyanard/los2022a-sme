...
namespace  SME.ComplyReview.Channeling.Condition
{
	...
	public partial class EditNasabah : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			btn_Save_CIF_Data.Visible = false;
			btn_Clear_CIF_Data.Visible = false;
			btn_Save_Ketentuan_Kredit.Visible = false;
			btn_Clear_Ketentuan_Kredit.Visible = false;
			btn_Save_Data_Agunan.Visible = false;
			btn_Clear_data_agunan.Visible = false;
			btn_Save_Sandi_BI.Visible = false;
			btn_Clear_Sandi_BI.Visible = false;
		...
		private void DDL_BM_SEKTOREKONOMI_1_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			/*
		...
		private void DDL_BM_SUBSEKTOREKON_1_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			/*
			 *	DDL_bmsubsubsektor.Items.Clear();
		...
		private void DDL_BM_SUBSUBSEKTOREKON_1_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			conn.QueryString = "SELECT BI_SEQ, BMSUBSUB_DESC, * FROM RFBMSUBSUBSEKTOREKONOMI WHERE BMSUBSUB_CODE = '" + DDL_BM_SUBSUBSEKTOREKON_1.SelectedValue + "'";
			conn.ExecuteQuery();
			GlobalTools.fillRefList(DDL_BI_SEKTOREKONOMI_1, "SELECT BI_SEQ, BI_DESC FROM RFBICODE WHERE BG_GROUP = '3' AND BI_SEQ = '" + conn.GetFieldValue("BI_SEQ") + "'", true, conn);
		...
		private void btn_Clear_CIF_Data_Click(object sender, System.EventArgs e)
		{
			/*TXT_CU_FIRSTNAME_1.Text = "";
		...
		private void btn_Clear_Ketentuan_Kredit_Click(object sender, System.EventArgs e)
		{
			TXT_CP_LIMIT_1.Text = "";
		...
		private void btn_Clear_data_agunan_Click(object sender, System.EventArgs e)
		{
			TXT_CL_VALUE_1.Text = "";
		...
		private void btn_Clear_Sandi_BI_Click(object sender, System.EventArgs e)
		{
