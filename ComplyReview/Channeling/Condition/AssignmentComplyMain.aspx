<%@ Page language="c#" Codebehind="AssignmentComplyMain.aspx.cs" AutoEventWireup="True" Inherits="SME.ComplyReview.Channeling.Condition.AssignmentComplyMain" %>
	...
	<body leftMargin="0" topMargin="0" MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<center>
					...
					<TBODY>
						<TR>
							<TD class="tdNoBorder"><!--<img src="../Image/HeaderDetailDataEntry.jpg">-->
								<TABLE id="Table2">
									<TR>
										<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B><B>Comply, Review and Legal 
													Doc </B>Condition</B></TD>
									</TR>
								</TABLE>
							</TD>
							<TD class="tdNoBorder" align="right"><A href="ListComplyCOndition.aspx?mc=CHAN006"></A><asp:imagebutton id="BTN_BACK" runat="server" ImageUrl="/SME/Image/back.jpg"></asp:imagebutton><A href="../../../Body.aspx"><IMG src="/SME/Image/MainMenu.jpg"></A><A href="../../../Logout.aspx" target="_top"><IMG src="/SME/Image/Logout.jpg"></A></TD>
						</TR>
						<TR>
						...
						<TR>
							<TD class="td" vAlign="top" width="50%">
								<TABLE id="Table6" cellSpacing="0" cellPadding="0" width="100%">
									<TR>
										<TD class="TDBGColor1" style="WIDTH: 886px; HEIGHT: 23px">Business Unit
										</TD>
										<TD style="WIDTH: 1px; HEIGHT: 23px">:</TD>
										<TD class="TDBGColorValue" style="HEIGHT: 23px"><asp:dropdownlist id="DDL_AP_BOOKINGBRANCH" runat="server" Enabled="False" Width="300px" CssClass="mandatory"></asp:dropdownlist></TD>
									</TR>
									<TR>
										<TD class="TDBGColor1" style="WIDTH: 886px">CO Unit
										</TD>
										<TD style="WIDTH: 1px">:</TD>
										<TD class="TDBGColorValue"><asp:dropdownlist id="DDL_AP_CCOBRANCH" runat="server" Enabled="False" Width="300px" CssClass="mandatory"></asp:dropdownlist></TD>
									</TR>
								</TABLE>
							</TD>
							<TD class="td" vAlign="top" width="50%">
								<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%">
									<TR>
										...
										<TD style="WIDTH: 1px">:</TD>
										<TD class="TDBGColorValue"><asp:textbox id="txt_DD_B" runat="server" Enabled="False" Width="40px" CssClass="mandatory"></asp:textbox>&nbsp;
											<asp:dropdownlist id="ddl_MM_B" runat="server" Enabled="False" Width="152px" CssClass="mandatory"></asp:dropdownlist>&nbsp;
											<asp:textbox id="txt_YY_B" runat="server" Enabled="False" Width="80px" CssClass="mandatory"></asp:textbox></TD>
									</TR>
									<TR>
										<TD class="TDBGColor1">Application Number
										</TD>
										<TD style="WIDTH: 1px">:</TD>
										<TD class="TDBGColorValue"><asp:textbox id="TXT_APPLICATION" runat="server" Enabled="False" Width="290px" CssClass="mandatory"
												BorderStyle="None" ReadOnly="True"></asp:textbox></TD>
									</TR>
								</TABLE>
							</TD>
						</TR>
				...
				<table cellSpacing="2" cellPadding="2" width="100%">
					<TR>
						<TD class="tdHeader1" colSpan="3">LEGAL SIGNING CONDITION</TD>
					</TR>
					<TR id="TR_LEGALSIGNING2" runat="server">
						<TD class="TDBGColor1" style="WIDTH: 16.78%">Syarat</TD>
						<TD style="WIDTH: 0.09%">:</TD>
						<TD class="TDBGColorValue"><asp:dropdownlist id="DDL_PROSES" runat="server" Width="670px" CssClass="mandatory"></asp:dropdownlist></TD>
					</TR>
					<TR>
						<TD class="TDBGColor1" style="WIDTH: 16.78%">Tanggal Dipenuhi</TD>
						<TD style="WIDTH: 0.09%">:</TD>
						<TD class="TDBGColorValue"><asp:textbox id="TXT_TGL" runat="server" Width="32px" CssClass="mandatory"></asp:textbox>&nbsp;
							<asp:dropdownlist id="DDL_BLN" runat="server" Width="136px" CssClass="mandatory"></asp:dropdownlist><asp:textbox id="TXT_THN" runat="server" Width="88px" CssClass="mandatory"></asp:textbox>
							<asp:label id="LBL_REGNO" Visible="False" Runat="server"></asp:label>
							<asp:label id="LBL_TC" Visible="False" Runat="server"></asp:label></TD>
					</TR>
					<TR>
						<TD class="TDBGColor1" style="WIDTH: 16.78%">Keterangan</TD>
						<TD style="WIDTH: 0.09%">:</TD>
						<TD class="TDBGColorValue"><asp:textbox id="TXT_KET" runat="server" Width="654px" TextMode="MultiLine" Height="88px"></asp:textbox>&nbsp;
						</TD>
					</TR>
					<TR>
						<TD class="TDBGColor1" style="WIDTH: 16.78%">Next Periode</TD>
						<TD style="WIDTH: 0.09%">:</TD>
						<TD class="TDBGColorValue"><asp:textbox id="TXT_COV_NEXTDATE_DAY2" runat="server" Width="32px"></asp:textbox>&nbsp;
							<asp:dropdownlist id="DDL_COV_NEXTDATE_MONTH2" runat="server" Width="136px"></asp:dropdownlist><asp:textbox id="TXT_COV_NEXTDATE_YEAR2" runat="server" Width="88px"></asp:textbox></TD>
					</TR>
					<TR>
						<TD class="TDBGColor1" style="WIDTH: 16.78%">Status</TD>
						<TD style="WIDTH: 0.09%">:</TD>
						<TD class="TDBGColorValue"><asp:checkbox id="CHK_COV_ISFINISH2" runat="server" Text="Check For Finished"></asp:checkbox></TD>
					</TR>
					<TR>
						<TD class="tdNoBorder" style="WIDTH: 133px" align="left"></TD>
					</TR>
				</table>
				<table style="WIDTH: 100%; HEIGHT: 36px">
					<TR id="TR_LEGALSIGNING" runat="server">
						<TD class="TDBGColor2" vAlign="top" align="center" colSpan="2"><asp:button id="BTN_DF_INPUT" runat="server" Width="153px" CssClass="BUTTON1" Text="SAVE" onclick="BTN_DF_INPUT_Click"></asp:button><asp:button id="BTN_PRINT" runat="server" Width="150px" CssClass="BUTTON1" Text="PRINT" onclick="BTN_PRINT_Click"></asp:button><asp:button id="BTN_UPDATE" runat="server" Width="153px" CssClass="BUTTON1" Text="UPDATE STATUS" onclick="BTN_UPDATE_Click"></asp:button><asp:button id="BTN_RETURNTOBU" runat="server" Width="153px" CssClass="BUTTON1" Text="RETURN TO BU" onclick="BTN_RETURNTOBU_Click"></asp:button></TD>
					</TR>
					<TR>
						<TD class="td" colSpan="2"><asp:datagrid id="DGR_LIST" runat="server" Width="100%" PageSize="1" AutoGenerateColumns="False"
							...
							</asp:datagrid><asp:textbox id="TXT_TEMP_PK" runat="server" Width="1px" BorderStyle="None" ReadOnly="True"></asp:textbox></TD>
					</TR>
					<TR>
						<TD class="tdHeader1" colSpan="2">End User Facility</TD>
					</TR>
					<TR>
						<TD class="td" colSpan="2"><asp:datagrid id="dgListEndUser" runat="server" Width="100%" PageSize="1" AutoGenerateColumns="False"
								...
								<Columns>
									...
									<asp:TemplateColumn HeaderText="Function">
										...
										<ItemTemplate>
											...
											<asp:RadioButton id="rdo_no" runat="server" GroupName="rdg_Decision" Text="Postpone" Checked="True"></asp:RadioButton>
										</ItemTemplate>
										<FooterStyle HorizontalAlign="Center"></FooterStyle>
										<FooterTemplate>
											<asp:LinkButton id="Linkbutton4" runat="server" CommandName="yesall">All Cont</asp:LinkButton>
											<asp:LinkButton id="Linkbutton3" runat="server" CommandName="noall">All Postp</asp:LinkButton>
										</FooterTemplate>
									</asp:TemplateColumn>
								</Columns>
							</asp:datagrid>
