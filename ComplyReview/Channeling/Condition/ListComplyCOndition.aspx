<%@ Page language="c#" Codebehind="ListComplyCOndition.aspx.cs" AutoEventWireup="True" Inherits="SME.ComplyReview.Channeling.Condition.ListComplyCOndition" %>
				...
				<table id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					<TR>
						<TD class="tdNoBorder" style="WIDTH: 805px"><!--<img src="../Image/HeaderDetailDataEntry.jpg">-->
							<TABLE id="Table6">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>Comply, Review and Legal 
											Doc&nbsp;List</B></TD>
								</TR>
							</TABLE>
						</TD>
					...
					<tr>
						<td style="HEIGHT: 28px" colSpan="2">
							<table>
								...
								<tr>
									<td class="TDBGColor1" style="WIDTH: 154px"><STRONG>Name #</STRONG></td>
									<td style="WIDTH: 5px"><STRONG>:</STRONG></td>
