<%@ Page language="c#" Codebehind="BCG_Facility.aspx.cs" AutoEventWireup="True" Inherits="SME.Scoring.BCG_Facility" %>
							...
							<TABLE id="Table1" style="WIDTH: 761px; HEIGHT: 464px" width="761" border="0">
								<TR>
									...
									<TD vAlign="top" align="right">
										<iframe id="if_apptype" style="WIDTH: 800; HEIGHT: 500" name="if_apptype" 
                                            src="" frameBorder="no"
