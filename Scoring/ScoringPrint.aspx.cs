...
{
	/// <summary>
	/// Summary description for ScoringPrint.
	/// </summary>
	public partial class ScoringPrint : System.Web.UI.Page
	{
		protected System.Web.UI.WebControls.TextBox TXT_PSRL_BIAYaUMUMADM;
		...
		private void viewData()
		{
			...
			//==============================================================================
			// isi data grid
			conn.QueryString = "select RFSCORINGRULEREASON.REASON_CODE, RFSCORINGRULEREASON.DESCRIPTION from RFSCORINGRULEREASON,RFSCORINGRULEREASONRESULT where RFSCORINGRULEREASONRESULT.IDRULEREASON = RFSCORINGRULEREASON.ID AND RFSCORINGRULEREASONRESULT.APREGNO ='"+ Request.QueryString["regno"] +"' AND SUMBERDATA='FINALSCORING'";
			conn.ExecuteQuery();
...
//			conn.QueryString ="select * from vw_scoring_print_main where ap_regno='" + Request.QueryString["regno"] + "'";
//			conn.ExecuteQuery();
			...
			/// scoring result
			///
//			conn.QueryString = "select * from scoring_response_tbl where ap_Regno like '%"+ Request.QueryString["regno"] +"%'  AND SUMBERDATA='FINALSCORING'";
//			conn.ExecuteQuery();
...
//			{
				...
				lbl_SMNE_LRJALAN.Text = GlobalTools.MoneyFormat(conn.GetFieldValue("PASV_LBRGJALAN"));
...
//			}
		...
		*/
		...
		{
			Response.Redirect("../CreditProposal/Main.aspx?regno="+ Request.QueryString["regno"] + "&curef=" + Request.QueryString["curef"] + "&mc=" + Request.QueryString["mc"] + "&tc=" + Request.QueryString["tc"]);
		}
