...
{
	/// <summary>
	/// Summary description for PICReporting.
	/// </summary>
	public partial class PICReporting : System.Web.UI.Page
	{
		...
		{	
			...
			if (Tools.isDateValid(this,TXT_TGL1.Text,DDL_BLN1.SelectedValue,TXT_THN1.Text)&&Tools.isDateValid(this, TXT_TGL2.Text,DDL_BLN2.SelectedValue,TXT_THN2.Text))
			{
				...
				if (!Information.IsDate(tanggal1) || !Information.IsDate(tanggal2))
				{
					...
					LoadReport_Load(tanggal1, tanggal2, h_pic_group, pic_name);
			}
			else
			{
		...
		private void LoadReport_Load(string tanggal1, string tanggal2, string h_pic_group, string pic_name)
		{			
			string ReportAddr="";
			...
			ReportViewer2.ReportPath = "/SMEReports/HlpRptPICRespon&date1="+ tanggal1 + "&date2=" + tanggal2 + "&h_pic_group=" + h_pic_group + "&pic_name=" + pic_name + "&rs:Command=Render";
