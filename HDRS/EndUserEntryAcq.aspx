<%@ Page language="c#" Codebehind="EndUserEntryAcq.aspx.cs" AutoEventWireup="True" Inherits="SME.HDRS.EndUserEntryAcq" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>EndUserEntryAcq</title>
				...
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					<TR>
						<TD class="tdNoBorder">
							<TABLE id="Table8">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>END USER ENTRY - ACQUIRE 
											INFO</B></TD>
								</TR>
							</TABLE>
						</TD>
					...
					<tr align="center">
						<td vAlign="top" width="100%" colSpan="2">
							<table id="Table1" cellSpacing="0" cellPadding="0" width="100%" align="left" border="1">
								...
								<tr>
									<td align="center" width="15%" valign="top"><asp:textbox id="TXT_NO_AP" Width="100%" CssClass="Mandatory" Runat="server"></asp:textbox></td>
									<td align="center" width="17%" valign="top"><asp:textbox id="TXT_CUST" Width="100%" CssClass="Mandatory" Runat="server"></asp:textbox></td>
									<td align="center" width="18%" valign="top"><asp:dropdownlist id="DDL_PROBLEM" Width="100%" CssClass="Mandatory" Runat="server"></asp:dropdownlist></td>
					...
					<tr align="center">
						<td class="TDBGColor2" vAlign="top" align="center" width="100%" colSpan="2"><asp:button id="BTN_SAVE" runat="server" Width="61px" CssClass="Button1" Text="SAVE" onclick="BTN_SAVE_Click"></asp:button>&nbsp;&nbsp;&nbsp;
							<asp:button id="BTN_SEND" Runat="server" CssClass="button1" Text="SEND" onclick="BTN_SEND_Click"></asp:button>&nbsp;&nbsp;&nbsp;<asp:button id="BTN_CLEAR" runat="server" Width="62px" CssClass="Button1" Text="CLEAR" onclick="BTN_CLEAR_Click"></asp:button><asp:textbox id="TXT_TEMP" runat="server" BorderStyle="None" ReadOnly="True" Width="1px"></asp:textbox>&nbsp;&nbsp;
						</td>
					</tr>
				</TABLE>
