<%@ Page language="c#" Codebehind="PICReporting.aspx.cs" AutoEventWireup="True" Inherits="SME.HDRS.PICReporting" %>
<%@ Register TagPrefix="cc1" Namespace="Microsoft.Samples.ReportingServices" Assembly="ReportViewer" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>PICReporting</title>
		...
		<form id="Form1" method="post" runat="server">
			<center>
				<TABLE id="Table4" width="100%" border="0">
									...
									<TD vAlign="middle" align="center">
										<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
											<TR>
												...
												<TD class="TDBGColorValue"><asp:textbox onkeypress="return numbersonly()" id="TXT_TGL1" runat="server" MaxLength="2" Columns="2"
														CssClass="mandatory"></asp:textbox><asp:dropdownlist id="DDL_BLN1" runat="server" CssClass="mandatory"></asp:dropdownlist><asp:textbox onkeypress="return numbersonly()" id="TXT_THN1" runat="server" MaxLength="4" Columns="4"
														CssClass="mandatory"></asp:textbox>&nbsp; to &nbsp;
													<asp:textbox onkeypress="return numbersonly()" id="TXT_TGL2" runat="server" MaxLength="2" Columns="2"
														CssClass="mandatory"></asp:textbox><asp:dropdownlist id="DDL_BLN2" runat="server" CssClass="mandatory"></asp:dropdownlist><asp:textbox onkeypress="return numbersonly()" id="TXT_THN2" runat="server" MaxLength="4" Columns="4"
					...
					<TR>
						<TD class="TDBGColor2" vAlign="top" align="center" width="100%" colSpan="2"><asp:button id="BTN_CANCEL" runat="server" CssClass="button1" Text="CANCEL" Width="80px" onclick="BTN_CANCEL_Click"></asp:button>&nbsp;<asp:button id="Button3" runat="server" CssClass="button1" Text="PRINT" Width="80px" Visible="False"></asp:button>&nbsp;<asp:button id="BTN_FIND" runat="server" CssClass="button1" Text="FIND" Width="80px" onclick="BTN_FIND_Click"></asp:button></TD>
					</TR>
					<TR align="center">
