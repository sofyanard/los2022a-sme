<%@ Page language="c#" Codebehind="ACQ2.aspx.cs" AutoEventWireup="True" Inherits="SME.HDRS.ACQ2" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<table id="Table1" cellSpacing="2" cellPadding="2" width="100%">
				...
				<tr>
				<tr>
					<td class="tdNoBorder" align="center" colSpan="2"><asp:label id="lbl_regnum" runat="server" Visible="False"></asp:label><asp:label id="TRACK" runat="server" Visible="False"></asp:label><asp:label id="lbl_prod" runat="server" Visible="False"></asp:label>
						...
						<asp:label id="LBL_APRV" runat="server" Visible="False"></asp:label></td>
				</tr>
				<TR>
