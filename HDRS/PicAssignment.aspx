<%@ Page language="c#" Codebehind="PicAssignment.aspx.cs" AutoEventWireup="True" Inherits="SME.HDRS.PicAssignment" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>PicAssignment</title>
				...
				<table width="100%" border="0">
					<tr>
						<td align="left">
							<TABLE id="Table31">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>PIC ASSIGNMENT</B></TD>
								</TR>
							</TABLE>
						</td>
					...
					<tr id="TR_CATATAN" runat="server">
						<td class="td" vAlign="top" width="60%">
							<TABLE id="Table61" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									<TD class="TDBGColor1" style="HEIGHT: 21px">HRS#</TD>
									<TD style="WIDTH: 15px; HEIGHT: 21px">:</TD>
									<TD class="TDBGColorValue" style="WIDTH: 43px; HEIGHT: 21px"><asp:textbox id="TXT_HRS" runat="server" BorderStyle="None" ReadOnly="True" Width="352px"></asp:textbox></TD>
								</TR>
								<TR>
								...
								<TR>
									...
									<TD style="WIDTH: 15px">:</TD>
									<TD class="TDBGColorValue" style="WIDTH: 43px"><asp:textbox id="TXT_PIC" runat="server" BorderStyle="None" ReadOnly="True" Width="352px"></asp:textbox></TD>
								</TR>
								<TR>
									<TD class="TDBGColor1">Assign To</TD>
									<TD style="WIDTH: 15px">:</TD>
