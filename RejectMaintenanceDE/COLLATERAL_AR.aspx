<%@ Page language="c#" Codebehind="COLLATERAL_AR.aspx.cs" AutoEventWireup="True" Inherits="SME.RejectMaintenanceDE.COLLATERAL_AR" %>
						...
						<TD class="td" vAlign="top" width="50%">
							<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%">
								...
								<TR>
									...
									<TD></TD>
									<TD class="TDBGColorValue"><asp:TextBox id="TXT_CL_COLLNAME" MaxLength="30" Columns="25" runat="server" onKeypress="return kutip_satu()"></asp:TextBox></TD>
								</TR>
								<TR>
