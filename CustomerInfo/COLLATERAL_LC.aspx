<%@ Page language="c#" Codebehind="COLLATERAL_LC.aspx.cs" AutoEventWireup="True" Inherits="SME.CustomerInfo.COLLATERAL_LC" %>
							...
							<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									...
									<TD class="TDBGColorValue"><asp:textbox id="TXT_CL_DESC" onKeypress="return kutip_satu()" runat="server" MaxLength="50"
											Columns="25" CssClass="mandatory" Width="300px"></asp:textbox></TD>
								</TR>
								<TR>
								...
								<TR>
									...
									<TD></TD>
									<TD class="TDBGColorValue"><asp:textbox id="TXT_CL_ISSUEBANK" onKeypress="return kutip_satu()" runat="server" MaxLength="30"
											Columns="25"></asp:textbox></TD>
								</TR>
								<TR>
									<TD class="TDBGColor1">Nama Penerbit L/C</TD>
									<TD></TD>
									<TD class="TDBGColorValue"><asp:textbox id="TXT_CL_ISSUENAME" onKeypress="return kutip_satu()" runat="server" MaxLength="100"
											Columns="25" Width="300px"></asp:textbox></TD>
								</TR>
								<TR>
								...
								<TR>
									...
									<TD></TD>
									<TD class="TDBGColorValue"><asp:textbox id="TXT_CL_COMPNAME" onKeypress="return kutip_satu()" runat="server" MaxLength="50"
											Columns="25" Width="300px"></asp:textbox></TD>
								</TR>
								<TR>
