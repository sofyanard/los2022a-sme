<%@ Page language="c#" Codebehind="ObligoKontraktor.aspx.cs" AutoEventWireup="True" Inherits="SME.CustomerInfo.ObligoKontraktor" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>ObligoKontraktor</title>
			...
			<center>
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					<TBODY>
						...
						<TR>
							<TD class="TDBGColor2" vAlign="top" align="center" colSpan="2" id="TR_BTN1" runat="server"><asp:button id="BTN_SAVE" runat="server" Width="80px" CssClass="Button1" Text="Save" onclick="BTN_SAVE_Click"></asp:button>&nbsp;
						...
						<TR>
							<TD class="TDBGColor2" vAlign="top" align="center" colSpan="2" id="TR_BTN2" runat="server"><asp:button id="BTN_SAVE2" runat="server" Width="80px" CssClass="Button1" Text="Save" onclick="BTN_SAVE2_Click"></asp:button>&nbsp;
								<asp:button id="BTN_CLEAR2" runat="server" Width="80px" CssClass="Button1" Text="Clear" onclick="BTN_CLEAR2_Click"></asp:button>&nbsp;
