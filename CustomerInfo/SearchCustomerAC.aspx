<%@ Page language="c#" Codebehind="SearchCustomerAC.aspx.cs" AutoEventWireup="True" Inherits="SME.CustomerInfo.SearchCustomerAC" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>SearchCustomerAC</title>
									...
									<TD vAlign="top" align="center">
										<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
											...
											<TR>
												...
												<TD></TD>
												<TD class="TDBGColorValue"><asp:textbox onkeypress="return numbersonly()" id="Textbox2" runat="server" MaxLength="2" Columns="2"></asp:textbox><asp:dropdownlist id="DDL_CU_DOB_MM" runat="server"></asp:dropdownlist><asp:textbox onkeypress="return numbersonly()" id="Textbox1" runat="server" MaxLength="4" Columns="4"></asp:textbox></TD>
											</TR>
											<TR>
											...
											<TR>
												<TD vAlign="top" align="center" colSpan="3" height="10"><asp:button id="btn_Find" runat="server" Width="180px" CssClass="button1" Text="Find Existing Customer" onclick="btn_Find_Click"></asp:button>&nbsp;
													<asp:button id="BTN_NEW" runat="server" Width="180px" CssClass="button1" Text="New Customer In LOS" onclick="BTN_NEW_Click"></asp:button></TD>
											</TR>
										</TABLE>
									</TD>
								</TR>
