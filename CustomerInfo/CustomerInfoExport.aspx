<%@ Page language="c#" Codebehind="CustomerInfoExport.aspx.cs" AutoEventWireup="True" Inherits="SME.CustomerInfo.CustomerInfoExport" %>
									...
									<TD style="WIDTH: 366px" vAlign="top" width="366">
										<TABLE id="Table4" style="WIDTH: 456px; HEIGHT: 124px" cellSpacing="0" cellPadding="0"
											...
											<TR>
												...
												<TD class="TDBGColorValue"><asp:dropdownlist id="DDL_FORMATFILE" runat="server" Width="248px" CssClass="mandatory" AutoPostBack="True"></asp:dropdownlist><asp:button id="BTN_EXPORT" runat="server" Width="64px" Text="Export" onclick="BTN_EXPORT_Click"></asp:button></TD>
											</TR>
											<TR>
