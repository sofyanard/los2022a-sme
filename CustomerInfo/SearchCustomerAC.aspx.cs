...
{
	/// <summary>
	/// Summary description for SearchCustomerAC.
	/// </summary>
	public partial class SearchCustomerAC : System.Web.UI.Page
	{
				...
				case "View":
					...
					//{
						...
						*/
						...
						Response.Redirect("AccountCustomer.aspx?sta=exist&curef=" + e.Item.Cells[0].Text + "&tc=" + Request.QueryString["tc"] + "&mc=" + Request.QueryString["mc"] + "&regno=" + e.Item.Cells[0].Text + 'C');
					//}
					//else
		...
		protected void BTN_NEW_Click(object sender, System.EventArgs e)
		{
			...
			Response.Redirect("AccountCustomer.aspx?sta=baru&curef=" + curef + "&regno=" + regno + "&tc=" + Request.QueryString["tc"] + "&mc=" + Request.QueryString["mc"]);
		}
