...
{
	/// <summary>
	/// Summary description for SearchCorporateCustomer.
	/// </summary>
	public partial class SearchCorporateCustomer : System.Web.UI.Page
	{
			...
			switch (((LinkButton)e.CommandSource).CommandName)
			{
				case "View":
					...
					if ((conn.GetFieldValue(0,0) == "") || (conn.GetFieldValue(0,0) == Session["UserID"].ToString()))
						Response.Redirect("InfoCustomer.aspx?sta=exist&curef=" + e.Item.Cells[0].Text + "&tc=" + Request.QueryString["tc"] + "&mc=" + Request.QueryString["mc"]);
					else
