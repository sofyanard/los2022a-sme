<%@ Page language="c#" Codebehind="COLLATERAL_TRCON.aspx.cs" AutoEventWireup="True" Inherits="SME.CustomerInfo.COLLATERAL_TRCON" %>
						...
						<TD class="td" vAlign="top" width="50%">
							<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%">
								...
								<TR>
									...
									<TD></TD>
									<TD class="TDBGColorValue"><asp:TextBox id="TXT_CL_CONTRACTNAME" runat="server" Columns="20" MaxLength="100" onKeypress="return kutip_satu()"
