<%@ Page language="c#" Codebehind="SiteVisitInfo.aspx.cs" AutoEventWireup="True" Inherits="SME.CustomerInfo.SiteVisitInfo" %>
			...
			<center>
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					<TBODY>
						...
						<TR>
							<TD colSpan="2"><ASP:DATAGRID id="DG_SITEVISIT" runat="server" Width="100%" AutoGenerateColumns="False" PageSize="10"
