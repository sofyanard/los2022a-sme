<%@ Page language="c#" Codebehind="COLLATERAL_VEH.aspx.cs" AutoEventWireup="True" Inherits="SME.CustomerInfo.Jaminan_VEH" %>
						...
						<TD class="td" vAlign="top" width="50%">
							<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									...
									<TD width="15"></TD>
									<TD class="TDBGColorValue"><asp:textbox id="TXT_CL_DESC" onKeypress="return kutip_satu()" runat="server" Columns="25" MaxLength="50"
								...
								<TR>
									...
									<TD></TD>
									<TD class="TDBGColorValue"><asp:TextBox ID="TXT_SIBS_COLID" CssClass="mandatory" Runat="server" MaxLength="35" Columns="30"
								...
								<TR>
									...
									<TD></TD>
									<TD class="TDBGColorValue"><asp:textbox id="TXT_CL_OWNER" runat="server" Columns="25" MaxLength="100" onKeypress="return kutip_satu()"
								...
								<TR>
									...
									<TD></TD>
									<TD class="TDBGColorValue"><asp:textbox id="TXT_CL_APPRBY" runat="server" Columns="25" MaxLength="100" onKeypress="return kutip_satu()"
											Width="300px"></asp:textbox></TD>
								</TR>
								<TR>
								...
								<TR runat="server" id="TR_NILAI_BANK">
									...
									<TD class="TDBGColorValue"><asp:TextBox id="TXT_CL_VALUE" runat="server" onKeypress="return numbersonly()" Columns="25"
											CssClass="mandatory" MaxLength="21" onblur="FormatCurrency(this)"></asp:TextBox></TD>
								</TR>
