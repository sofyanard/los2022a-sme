<%@ Page language="c#" Codebehind="SearchCorporateCustomer.aspx.cs" AutoEventWireup="True" Inherits="SME.InitialDataEntry.SearchCorporateCustomer" %>
				...
				<TABLE id="Table4" width="100%" border="0">
					<TR>
						<TD align="left" colSpan="1">
							<TABLE id="Table3">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>Corporate Customer List</B></TD>
								</TR>
							</TABLE>
						</TD>
										...
										<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
											<TR>
												...
												<TD class="TDBGColorValue">
													<asp:textbox onkeypress="return numbersonly()" id="TXT_CU_CIF" runat="server" MaxLength="20" Width="200px"></asp:textbox></TD>
											</TR>
											<TR>
