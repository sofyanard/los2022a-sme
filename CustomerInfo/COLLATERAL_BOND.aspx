<%@ Page language="c#" Codebehind="COLLATERAL_BOND.aspx.cs" AutoEventWireup="True" Inherits="SME.CustomerInfo.COLLATERAL_BOND" %>
						...
						<TD class="td" vAlign="top" width="50%">
							<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%">
								...
								<TR>
									...
									<TD></TD>
									<TD class="TDBGColorValue"><asp:TextBox id="TXT_CL_OWNER"  CssClass="mandatory" MaxLength="100" Columns="20" runat="server" onKeypress="return kutip_satu()"
