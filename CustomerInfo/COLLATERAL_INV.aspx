<%@ Page language="c#" Codebehind="COLLATERAL_INV.aspx.cs" AutoEventWireup="True" Inherits="SME.CustomerInfo.COLLATERAL_INV" %>
						...
						<TD class="td" vAlign="top" width="50%">
							<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									...
									<TD width="15"></TD>
									<TD class="TDBGColorValue"><asp:textbox id="TXT_CL_DESC" runat="server" MaxLength="50" Columns="25" onKeypress="return kutip_satu()"
											CssClass="mandatory" Width="300px"></asp:textbox></TD>
								</TR>
								<TR>
								...
								<TR>
									...
									<TD></TD>
									<TD class="TDBGColorValue"><asp:TextBox id="TXT_CL_NOOFUNITS" runat="server" MaxLength="10" Columns="10" CssClass="mandatory" onkeypress="return numbersonly()"></asp:TextBox></TD>
								</TR>
								<TR>
									<TD class="TDBGColor1">Berat / Jenis Berat</TD>
									<TD></TD>
									<TD class="TDBGColorValue">
										<asp:TextBox id="TXT_CL_WEIGHT" runat="server" MaxLength="10" Columns="10" onKeypress="return numbersonly()" CssClass="mandatory"></asp:TextBox>
										<asp:TextBox id="TXT_CL_WEIGHTTYPE" runat="server" MaxLength="10" Columns="10" onKeypress="return kutip_satu()" CssClass="mandatory"></asp:TextBox> (gram, kg, ...)
									</TD>
								</TR>
								<TR runat="server" id="TR_NILAI_BANK">
									...
									<TD class="TDBGColorValue"><asp:TextBox id="TXT_CL_VALUE" runat="server" Columns="25" MaxLength="21" onkeypress="return digitsonly()"
											onblur="FormatCurrency(this)" CssClass="mandatory"></asp:TextBox></TD>
								</TR>
