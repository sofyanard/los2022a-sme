<%@ Page language="c#" Codebehind="InfoCustomer.aspx.cs" AutoEventWireup="True" Inherits="SME.InitialDataEntry.InfoCustomer" %>
		...
		<form id="Form1" method="post" runat="server">
			<center>
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					...
					<TR>
						<TD class="tdHeader1" vAlign="top" width="50%" colSpan="2">Informasi Nasabah
						...
						<TD class="td" vAlign="top" width="50%">
							<TABLE id="Table20" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									...
									<TD class="TDBGColorValue"><asp:textbox onkeypress="return digitsonly()" id="TXT_CU_CIF_P" runat="server" MaxLength="20"></asp:textbox></TD>
								</TR>
								<TR>
						...
						<TD class="td" vAlign="top" width="50%">
							<TABLE id="Table4" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									...
									<TD style="WIDTH: 15px"></TD>
									<TD class="TDBGColorValue"><asp:textbox onkeypress="return digitsonly()" id="TXT_CU_CIF_C" runat="server" MaxLength="20"></asp:textbox></TD>
								</TR>
								<TR>
					...
					<TR>
						<TD colSpan="2"><asp:checkbox id="CB_WASPADA" runat="server" Text="Nasabah Waspada SAM" Visible="False"></asp:checkbox></TD>
					</TR>
					<TR>
						<TD class="TDBGColor2" vAlign="top" align="center" width="50%" colSpan="2">
                            <asp:button id="BTN_SAVE" runat="server" CssClass="Button1" Width="80px" 
                                Text="Simpan" onclick="BTN_SAVE_Click"></asp:button>&nbsp;<INPUT class="Button1" onclick="keluar()" type="button" size="20" value=" Keluar " disabled></TD>
					</TR>
					<TR>
					...
					<TR>
						<TD class="TDBGColor2" id="TR_A" vAlign="top" align="center" width="50%" colSpan="2">
                            <asp:button id="BTN_NEW" runat="server" CssClass="button1" Width="75px" 
                                Text="Simpan" onclick="BTN_NEW_Click"></asp:button>&nbsp;
							<asp:button id="Button1" runat="server" CssClass="button1" Width="75px" 
					...
					<TR>
						<TD class="td" vAlign="top" align="center" width="50%" colSpan="2"><ASP:DATAGRID id="DatGrd" runat="server" Width="100%" HorizontalAlign="Center" PageSize="5" AllowPaging="True"
								...
								<Columns>
									...
									<asp:ButtonColumn Text="View" CommandName="Edit">
