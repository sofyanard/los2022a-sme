<%@ Page language="c#" Codebehind="Rusun_Entry.aspx.cs" AutoEventWireup="True" Inherits="SME.Appraisal.Rusun_Entry" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>Rusun_Entry</title>
				...
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					<TR>
						<TD class="tdNoBorder">
							<TABLE id="Table2">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>Appraisal : Rusun</B></TD>
								</TR>
							</TABLE>
						</TD>
					...
					<TR>
						<TD class="tdHeader1" vAlign="top" colSpan="2" align="center"><B>Penilaian Jaminan (Non 
								Tanah &amp; Bangunan)</B></TD>
					</TR>
				</TABLE>
						...
						<TD class="td" vAlign="top" width="100%">
							<TABLE cellSpacing="0" cellPadding="0" width="100%">
								...
								<TR>
									...
									<TD></TD>
									<TD class="TDBGColorValue"><asp:TextBox ID="TXT_AR_APPRBR" Runat="server" MaxLength="50" Columns="35"></asp:TextBox></TD>
								</TR>
								<TR>
							...
							<TABLE cellSpacing="0" cellPadding="0" width="100%">
								...
								<tr>
									...
									<td valign="top" colspan="2">
										<table cellspacing="0" cellpadding="0" width="100%">
											<tr>
												<td class="TDBGColor1" width="200">a. Kondisi</td>
												<td width="15"></td>
											...
											<tr>
												<td class="TDBGColor1">d. Umur bangunan</td>
												<td></td>
