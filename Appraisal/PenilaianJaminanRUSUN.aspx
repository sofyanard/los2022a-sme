<%@ Page language="c#" Codebehind="PenilaianJaminanRUSUN.aspx.cs" AutoEventWireup="True" Inherits="SME.Appraisal.PenilaianJaminanRUSUN" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>Penilaian Jaminan RUSUN</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<table style="PADDING-RIGHT: 5pt; PADDING-LEFT: 5pt" cellSpacing="0" cellPadding="0" width="100%"
				border="0">
				<tr>
					<td class="tdHeader1" colSpan="4"><STRONG>PENILAIAN JAMINAN RUMAH SUSUN<FONT style="BACKGROUND-COLOR: #b5c7e7">
							</FONT></STRONG>
					</td>
				</tr>
				<tr>
					<td width="25%">Nama Debitur</td>
					<td width="25%"><asp:textbox onkeypress="return kutip_satu()" id="txt_AR_NMDEBITUR" runat="server" ReadOnly="True"
							Width="100%"></asp:textbox></td>
					<td width="25%">Tanggal/Tahun Pemeriksaan</td>
					<td width="25%"><asp:textbox onkeypress="return numbersonly()" id="txt_AR_APPRDATE_DD" Width="25px" CssClass="mandatory"
							MaxLength="2" Runat="server" Columns="2"></asp:textbox><asp:dropdownlist id="ddl_AR_APPRDATE_MM" CssClass="mandatory" Runat="server"></asp:dropdownlist><asp:textbox onkeypress="return numbersonly()" id="txt_AR_APPRDATE_YY" Width="40px" CssClass="mandatory"
				...
				<TR>
					...
					<TD><asp:textbox onkeypress="return kutip_satu()" id="txt_AR_LOKBLOK" runat="server" Width="100%"
							CssClass="mandatory"></asp:textbox></TD>
					<TD></TD>
					<TD></TD>
				</TR>
				...
				<TR>
					...
					<TD><asp:textbox onkeypress="return kutip_satu()" id="txt_AR_PENGEMBANG" runat="server" Width="100%"></asp:textbox></TD>
					<TD>Pembelian baru</TD>
					<TD><asp:dropdownlist id="ddl_AR_ISNEW" runat="server" Width="60px">
							<asp:ListItem Value="0">Ya</asp:ListItem>
							<asp:ListItem Value="1" Selected="True">Tidak</asp:ListItem>
						</asp:dropdownlist></TD>
				</TR>
				<TR>
					<TD>Jalan ke Lokasi</TD>
					<TD><asp:textbox onkeypress="return kutip_satu()" id="txt_AR_JALAN" runat="server" ReadOnly="True"
							Width="100px"></asp:textbox><asp:textbox onkeypress="return numbersonly()" id="txt_AR_KETJALAN" runat="server" Width="60px"
							CssClass="mandatory" MaxLength="2"></asp:textbox>M</TD>
					<TD>Wilayah</TD>
					<TD><asp:textbox onkeypress="return kutip_satu()" id="txt_AR_WILAYAH" runat="server" ReadOnly="True"
							Width="100%"></asp:textbox></TD>
				</TR>
				<TR>
				...
				<TR>
					...
					<TD><asp:dropdownlist id="ddl_AR_BANJIR" runat="server" Width="72px">
							<asp:ListItem Value="0">Ya</asp:ListItem>
							<asp:ListItem Value="1">Tidak</asp:ListItem>
						</asp:dropdownlist></TD>
				</TR>
				<TR>
					...
					<TD><asp:dropdownlist id="ddl_AR_TEGANGAN" runat="server" Width="72px">
							<asp:ListItem Value="0">Ya</asp:ListItem>
							<asp:ListItem Value="1">Tidak</asp:ListItem>
						</asp:dropdownlist></TD>
				</TR>
				<TR>
					...
					<TD><asp:dropdownlist id="ddl_AR_TNHLONGSOR" runat="server" Width="72px">
							<asp:ListItem Value="0">Ya</asp:ListItem>
							<asp:ListItem Value="1">Tidak</asp:ListItem>
						</asp:dropdownlist></TD>
				</TR>
				<TR>
					...
					<TD><asp:dropdownlist id="ddl_AR_LOKASI" runat="server" Width="100%"></asp:dropdownlist></TD>
					<TD>- Daerah Pencemaran/Polusi</TD>
					<TD><asp:dropdownlist id="ddl_AR_PENCEMARAN" runat="server" Width="72px">
							<asp:ListItem Value="0">Ya</asp:ListItem>
							<asp:ListItem Value="1">Tidak</asp:ListItem>
						</asp:dropdownlist></TD>
				</TR>
				<TR>
					...
					<TD><asp:textbox onkeypress="return kutip_satu()" id="txt_AR_KONDISI" runat="server" ReadOnly="True"
							Width="100%"></asp:textbox></TD>
				</TR>
				<TR>
					<TD></TD>
				...
				<TR class="TDBGColor11">
					<TD align="center">Wilayah
						<asp:dropdownlist id="ddl_AR_SWILAYAH" runat="server" Width="60px" CssClass="mandatory" AutoPostBack="True" onselectedindexchanged="ddl_AR_SWILAYAH_SelectedIndexChanged">
					...
					<TD align="center">Lokasi
						<asp:dropdownlist id="ddl_AR_SLOKASI" runat="server" Width="60px" CssClass="mandatory" AutoPostBack="True" onselectedindexchanged="ddl_AR_SLOKASI_SelectedIndexChanged">
							<asp:ListItem Value="0">--Pilih--</asp:ListItem>
				...
				<TR>
					...
					<TD style="HEIGHT: 22px"></TD>
					<TD style="HEIGHT: 22px"></TD>
					<TD class="TDBGColor" align="center" style="HEIGHT: 22px"><STRONG>Score</STRONG>
				...
				<TR class="TDBGColor11">
					...
					<TD><asp:dropdownlist id="ddl_AR_BKTYPE" runat="server" Width="100%"></asp:dropdownlist></TD>
					<TD>Nomor</TD>
					<TD><asp:textbox onkeypress="return kutip_satu()" id="txt_AR_BKNO" runat="server" Width="100%"></asp:textbox></TD>
				</TR>
				<TR>
					<TD></TD>
					<TD></TD>
				...
				<TR>
					...
					<TD></TD>
					<TD>
						<P><NOBR>Akta</NOBR><NOBR>&nbsp;Jual Beli</NOBR></P>
					</TD>
				...
				<TR class="TDBGColor11">
					...
					<TD>No. Akta</TD>
					<TD><asp:textbox onkeypress="return kutip_satu()" id="txt_AR_IJNO" runat="server" Width="100%"></asp:textbox></TD>
				</TR>
				<TR>
					<TD></TD>
					<TD></TD>
					<TD>Nilai Pengikat (Rp)</TD>
				...
				<TR class="TDBGColor11">
					<TD><STRONG>Izin Mendirikan Bangunan</STRONG></TD>
				...
				<TR>
					...
					<TD><asp:textbox id="txt_AR_HRGPASAR" runat="server" ReadOnly="True" Width="100%"></asp:textbox></TD>
					<TD></TD>
					<TD></TD>
				</TR>
				<TR>
					...
					<TD><asp:textbox id="txt_AR_SFTYMARGIN" runat="server" ReadOnly="True" Width="60px"></asp:textbox></TD>
					<TD align="right"><STRONG>Score</STRONG></TD>
					<TD><asp:textbox id="txt_Score2" runat="server" ReadOnly="True" Width="60px"></asp:textbox>&nbsp;
						<asp:button id="btn_Calc" runat="server" CssClass="Button1" Text="Calculate" onclick="btn_Calc_Click"></asp:button></TD>
				</TR>
				<TR>
					<TD><STRONG>Nilai Pasar Wajar yang Dapat Diterima Bank </STRONG>
					</TD>
					<TD><asp:textbox id="txt_AR_HRGWAJAR" runat="server" ReadOnly="True" Width="100%"></asp:textbox></TD>
					<TD></TD>
					<TD></TD>
				</TR>
				<TR>
				...
				<TR>
					...
					<TD><asp:dropdownlist id="ddl_AR_MARKET" runat="server" Width="100%"></asp:dropdownlist></TD>
					<TD>Permasalahan
					</TD>
					<TD><asp:dropdownlist id="ddl_AR_MASALAH" runat="server" Width="100%"></asp:dropdownlist></TD>
				</TR>
				<TR>
					<TD>Pengikatan Sempurna
					</TD>
					<TD><asp:dropdownlist id="ddl_AR_IKAT" runat="server" Width="100%"></asp:dropdownlist></TD>
					<TD>Penguasaan
					</TD>
					<TD><asp:dropdownlist id="ddl_AR_KUASA" runat="server" Width="100%"></asp:dropdownlist></TD>
				</TR>
				<TR>
					<TD>Lain-Lain</TD>
				...
				<TR>
					<TD class="tdHeader1" colSpan="4">V. PENDAPAT/REKOMENDASI
					</TD>
				</TR>
				<TR>
					<TD colSpan="4"><asp:textbox onkeypress="return kutip_satu()" id="txt_AR_PENDAPAT" runat="server" Width="100%"
							Height="50px" TextMode="MultiLine"></asp:textbox></TD>
				</TR>
				<TR id="TR_TOMBOL">
					<TD class="TDBGColor2" colSpan="4"><asp:button id="btn_Reentry" runat="server" CssClass="Button1" Visible="False" Text="Re-Entry" onclick="btn_Reentry_Click"></asp:button>&nbsp;<asp:button id="btn_Save" runat="server" CssClass="Button1" Text="Save" onclick="btn_Save_Click"></asp:button>&nbsp;
