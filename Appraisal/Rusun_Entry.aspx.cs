...
{
	/// <summary>
	/// Summary description for Rusun_Entry.
	/// </summary>
	public partial class Rusun_Entry : System.Web.UI.Page
	{
		protected Connection conn;
		protected Tools tool = new Tools();
		protected System.Web.UI.WebControls.TextBox TXT_AK_APPRNM;
		...
		{
			conn.QueryString = "exec APPR_ENTRY_RUSUN '"+ vsta +"', '"+ LBL_REGNO.Text +"', '"+ LBL_CUREF.Text +"', '"+
