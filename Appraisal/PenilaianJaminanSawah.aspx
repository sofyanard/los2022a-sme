<%@ Page language="c#" Codebehind="PenilaianJaminanSawah.aspx.cs" AutoEventWireup="True" Inherits="SME.Appraisal.PenilaianJaminanSawah" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>Penilaian Jaminan Sawah</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<table style="PADDING-RIGHT: 5pt; PADDING-LEFT: 5pt" cellSpacing="0" cellPadding="0" width="100%"
				border="0">
				<tr>
					<td class="tdHeader1" colSpan="4"><STRONG> PENILAIAN JAMINAN SAWAH</STRONG></td>
				</tr>
				<tr>
					<td width="25%">Nama Debitur</td>
					<td width="25%"><asp:textbox onkeypress="return kutip_satu()" id="txt_AT_NMDEBITUR" runat="server" ReadOnly="True"
				...
				<TR>
					...
					<TD><asp:textbox onkeypress="return kutip_satu()" id="txt_AT_KEADAANFSK" runat="server" Width="100%"></asp:textbox></TD>
					<TD>Pembelian Baru
					</TD>
					<TD><asp:dropdownlist id="ddl_AT_ISNEW" runat="server" Width="72px">
				...
				<TR>
					...
					<TD><asp:textbox onkeypress="return numbersonly()" id="txt_AT_LUASTNH" runat="server" Width="60px"
							CssClass="mandatory" MaxLength="6"></asp:textbox>M<SUP>2</SUP>
					</TD>
					<TD>Tahun Pembelian
					</TD>
					<TD><asp:textbox onkeypress="return numbersonly()" id="txt_AT_THNBELI" runat="server" Width="72px"
				...
				<TR>
					...
					<TD><asp:textbox onkeypress="return kutip_satu()" id="txt_AT_JALAN" runat="server" ReadOnly="True"
							Width="100px"></asp:textbox><asp:textbox onkeypress="return numbersonly()" id="txt_AT_KETJALAN" runat="server" Width="60px"
							CssClass="mandatory" MaxLength="2"></asp:textbox>M
					</TD>
					<TD>Wilayah</TD>
					<TD><asp:dropdownlist id="ddl_AT_WILAYAH" runat="server" Width="100%"></asp:dropdownlist></TD>
				</TR>
				<TR>
					<TD>Jaringan Listrik
					</TD>
					<TD><asp:dropdownlist id="ddl_AT_LISTRIK" runat="server" Width="60px">
							<asp:ListItem Value="0">Ya</asp:ListItem>
							<asp:ListItem Value="1">Tidak</asp:ListItem>
						</asp:dropdownlist></TD>
					<TD>Peruntukan Wilayah
					</TD>
					<TD><asp:textbox onkeypress="return kutip_satu()" id="txt_AT_SWILUTK" runat="server" ReadOnly="True"
							Width="100%"></asp:textbox></TD>
				</TR>
				<TR>
					<TD>Jaringan Telepon
					</TD>
					<TD><asp:dropdownlist id="ddl_AT_TELP" runat="server" Width="60px">
							<asp:ListItem Value="0">Ya</asp:ListItem>
							<asp:ListItem Value="1">Tidak</asp:ListItem>
						</asp:dropdownlist></TD>
				...
				<TR>
					<TD>Sitem Irigasi/Pengairan</TD>
					<TD><asp:textbox id="txt_AT_SIRIGASI" runat="server" ReadOnly="True" Width="100%"></asp:textbox></TD>
					<TD>- Daerah Rawan Banjir</TD>
					<TD><asp:dropdownlist id="ddl_AT_BANJIR" runat="server" Width="72px">
							<asp:ListItem Value="0">Ya</asp:ListItem>
							<asp:ListItem Value="1">Tidak</asp:ListItem>
						</asp:dropdownlist></TD>
				</TR>
				<TR>
					...
					<TD><asp:dropdownlist id="ddl_AT_STNHPRODUKIF" runat="server" Width="60px">
							<asp:ListItem Value="0">Ya</asp:ListItem>
							<asp:ListItem Value="1">Tidak</asp:ListItem>
						</asp:dropdownlist></TD>
					<TD>- Daerah Tegangan Tinggi</TD>
					<TD><asp:dropdownlist id="ddl_AT_TEGANGAN" runat="server" Width="72px">
							<asp:ListItem Value="0">Ya</asp:ListItem>
							<asp:ListItem Value="1">Tidak</asp:ListItem>
						</asp:dropdownlist></TD>
				</TR>
				<TR>
					<TD>Jarak dari Pemukiman</TD>
					<TD><asp:dropdownlist id="ddl_AT_SJARAKPMK" runat="server" Width="100%"></asp:dropdownlist></TD>
					<TD>- Daerah Rawan Longsor/Gempa Bumi
					</TD>
					<TD><asp:dropdownlist id="ddl_AT_TNHLONGSOR" runat="server" Width="72px">
							<asp:ListItem Value="0">Ya</asp:ListItem>
							<asp:ListItem Value="1">Tidak</asp:ListItem>
						</asp:dropdownlist></TD>
				</TR>
				<TR>
					...
					<TD><asp:dropdownlist id="ddl_AT_SPBU" runat="server" Width="60px">
							<asp:ListItem Value="0">Ya</asp:ListItem>
							<asp:ListItem Value="1">Tidak</asp:ListItem>
						</asp:dropdownlist></TD>
					<TD>- Daerah Pencemaran/Polusi
					</TD>
					<TD><asp:dropdownlist id="ddl_AT_PENCEMARAN" runat="server" Width="72px">
							<asp:ListItem Value="0">Ya</asp:ListItem>
							<asp:ListItem Value="1">Tidak</asp:ListItem>
						</asp:dropdownlist></TD>
				</TR>
				<TR>
					<TD>Tempat Ibadah</TD>
					<TD><asp:dropdownlist id="ddl_AT_IBADAH" runat="server" Width="60px">
							<asp:ListItem Value="0">Ya</asp:ListItem>
							<asp:ListItem Value="1">Tidak</asp:ListItem>
						</asp:dropdownlist></TD>
					<TD>Kualitas Tanah Sawah</TD>
					<TD><asp:textbox onkeypress="return kutip_satu()" id="txt_AT_KUALITAS" runat="server" ReadOnly="True"
							Width="100%"></asp:textbox></TD>
				</TR>
				<TR>
					<TD>Tempat Hiburan
					</TD>
					<TD><asp:dropdownlist id="ddl_AT_HIBURAN" runat="server" Width="60px">
							<asp:ListItem Value="0">Ya</asp:ListItem>
							<asp:ListItem Value="1">Tidak</asp:ListItem>
						</asp:dropdownlist></TD>
					<TD>Contour Tanah</TD>
				...
				<TR class="TDBGColor11">
					<TD align="center">Wilayah
						<asp:dropdownlist id="ddl_AT_SWILAYAH" runat="server" Width="60px" CssClass="mandatory" AutoPostBack="True" onselectedindexchanged="ddl_AT_SWILAYAH_SelectedIndexChanged">
							...
							<asp:ListItem Value="Daerah Pertanian">1</asp:ListItem>
							<asp:ListItem Value="Daerah Perkebunan">2</asp:ListItem>
							<asp:ListItem Value="Daerah Pemukiman">3</asp:ListItem>
							<asp:ListItem Value=" Daerah lainnya">4</asp:ListItem>
						</asp:dropdownlist></TD>
					<TD align="center">Lokasi
						<asp:dropdownlist id="ddl_AT_SLOKASI" runat="server" Width="60px" CssClass="mandatory" AutoPostBack="True" onselectedindexchanged="ddl_AT_SLOKASI_SelectedIndexChanged">
							...
							<asp:ListItem Value="Gang/Pematang">4</asp:ListItem>
							<asp:ListItem Value="Tidak Ada Jalan">5</asp:ListItem>
						</asp:dropdownlist></TD>
					<TD align="center">Kualitas<asp:dropdownlist id="ddl_AT_SKUALITAS" runat="server" Width="60px" CssClass="mandatory" AutoPostBack="True" onselectedindexchanged="ddl_AT_SKUALITAS_SelectedIndexChanged">
							<asp:ListItem Value="0">--Pilih--</asp:ListItem>
					...
					<TD align="center">Sistem Irigasi<asp:dropdownlist id="ddl_AT_SLINGKUNGAN" runat="server" Width="60px" CssClass="mandatory" AutoPostBack="True" onselectedindexchanged="ddl_AT_SLINGKUNGAN_SelectedIndexChanged">
							<asp:ListItem Value="0">--Pilih--</asp:ListItem>
							<asp:ListItem Value="Sangat Baik">1</asp:ListItem>
							<asp:ListItem Value="Baik">2</asp:ListItem>
							<asp:ListItem Value="Cukup/Tadah Hujan">3</asp:ListItem>
							<asp:ListItem Value="Jelek">4</asp:ListItem>
							<asp:ListItem Value="Sangat Jelek">5</asp:ListItem>
						</asp:dropdownlist></TD>
				</TR>
				...
				<TR>
					<TD class="tdHeader1" style="HEIGHT: 21px" colSpan="4">III. PERHITUNGAN PASAR WAJAR 
						YANG DAPAT DITERIMA BANK</TD>
				</TR>
				<TR>
					<TD>Tujuan Penilaian
					</TD>
				...
				<TR>
					<TD colSpan="4"><STRONG>Informasi/Data Harga Pasar per M<SUP>2</SUP></STRONG></TD>
				</TR>
				<TR>
					<TD colSpan="4">
						<TABLE style="PADDING-RIGHT: 5pt; PADDING-LEFT: 5pt" borderColor="black" cellSpacing="0"
							...
							<TR>
								...
								<TD><asp:textbox onkeypress="return kutip_satu()" id="txt_AT_TGL1" Width="100%" MaxLength="10" Runat="server"
							...
							<TR>
								...
								<TD><asp:textbox onkeypress="return kutip_satu()" id="txt_AT_TGL2" Width="100%" MaxLength="10" Runat="server"
										Columns="4"></asp:textbox></TD>
							</TR>
							<TR>
								<TD>Median</TD>
							...
							<TR>
								...
								<TD><asp:textbox onkeypress="return kutip_satu()" id="txt_AT_TGL3" Width="100%" MaxLength="10" Runat="server"
										Columns="4"></asp:textbox></TD>
							</TR>
							<TR>
								<TD>Tertinggi</TD>
				...
				<TR>
					...
					<TD><asp:textbox id="txt_AT_NILPASAR" runat="server" ReadOnly="True" Width="100%"></asp:textbox></TD>
					<TD></TD>
					<TD></TD>
				</TR>
				<TR>
					...
					<TD><asp:textbox id="txt_AT_HRGPASAR" runat="server" ReadOnly="True" Width="100%"></asp:textbox></TD>
					<TD></TD>
					<TD></TD>
				</TR>
				<TR>
					<TD><STRONG>Safety Margin</STRONG></TD>
					<TD><asp:textbox id="txt_AT_SFTYMARGIN" runat="server" ReadOnly="True" Width="60px"></asp:textbox></TD>
					<TD align="right"><STRONG>Score</STRONG></TD>
					<TD><asp:textbox id="txt_Score2" runat="server" ReadOnly="True" Width="60px"></asp:textbox>&nbsp;<asp:button id="btn_Calc" runat="server" CssClass="Button1" Text="Calculate" onclick="btn_Calc_Click"></asp:button></TD>
				</TR>
				<TR>
					<TD><STRONG>Nilai Pasar Wajar yang Dapat Diterima Bank</STRONG></TD>
					<TD><asp:textbox id="txt_AT_HRGWAJAR" runat="server" ReadOnly="True" Width="100%"></asp:textbox></TD>
					<TD></TD>
					<TD></TD>
				</TR>
				<TR>
				...
				<TR id="TR_TOMBOL">
					<TD class="TDBGColor2" colSpan="4"><asp:button id="btn_Reentry" runat="server" CssClass="Button1" Visible="False" Text="Re-Entry" onclick="btn_Reentry_Click"></asp:button>&nbsp;
						...
						<asp:Button id="btn_Delete" runat="server" CssClass="button1" Text="Delete" onclick="btn_Delete_Click"></asp:Button>&nbsp;<asp:button id="btn_UpdateStatus" runat="server" CssClass="Button1" Text="Update Status" onclick="btn_UpdateStatus_Click"></asp:button>&nbsp;<INPUT class="Button1" id="BTN_PRINT" onclick="cetak()" type="button" value="Print" name="BTN_PRINT"></TD>
				</TR>
			</table>
		</form>
	</body>
