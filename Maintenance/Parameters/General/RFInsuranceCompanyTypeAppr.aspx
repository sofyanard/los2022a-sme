<%@ Page language="c#" Codebehind="RFInsuranceCompanyTypeAppr.aspx.cs" AutoEventWireup="True" Inherits="Maintenance.Parameters.General.RFInsuranceCompanyTypeAppr" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>RFInsuranceCompanyTypeAppr</title>
		...
		<form id="Form1" method="post" runat="server">
			<center>
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					...
					<TR>
						<TD class="tdHeader1" colSpan="2">Parameter Insurance Company Type Approval</TD>
					</TR>
					<TR>
