<%@ Page language="c#" Codebehind="RFZipCodeCityParamAppr.aspx.cs" AutoEventWireup="True" Inherits="SME.DataEntry.RFZipCodeCityParamAppr" %>
					...
					<TR>
						<TD style="HEIGHT: 21px" vAlign="top" width="50%" colSpan="2">
							<TABLE id="Table20" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									<TD class="TDBGColor1" style="HEIGHT: 12px" width="129">
										Kota</TD>
