<%@ Page language="c#" Codebehind="RFReasonParam.aspx.cs" AutoEventWireup="True" Inherits="SME.DataEntry.RFReasonParam" %>
					...
					<TR id="TR_PERSONAL" runat="server">
						<TD class="td" vAlign="top" width="50%" colSpan="2">
							<TABLE id="Table20" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									<TD class="TDBGColor1" width="129" style="HEIGHT: 12px">Reason Type</TD>
									<TD style="WIDTH: 15px; HEIGHT: 12px">:</TD>
									<TD class="TDBGColorValue" style="HEIGHT: 12px">
										<asp:dropdownlist id="DDL_REASONTYPE" runat="server" CssClass="mandatory" AutoPostBack="True" onselectedindexchanged="DDL_REASONTYPE_SelectedIndexChanged"></asp:dropdownlist></TD>
								</TR>
								<TR>
									<TD class="TDBGColor1" width="129" style="HEIGHT: 3px">ID</TD>
									<TD style="WIDTH: 15px; HEIGHT: 3px">:</TD>
									<TD class="TDBGColorValue" style="HEIGHT: 3px"><asp:textbox  onkeypress="return kutip_satu()" id="TXT_ID" runat="server" CssClass="mandatory" MaxLength="10"></asp:textbox><asp:label id="LBL_SAVEMODE" runat="server" Visible="False">1</asp:label><asp:label id="LBL_ACTIVE" runat="server" Visible="False"></asp:label><asp:label id="LBL_ID" runat="server" Visible="False"></asp:label><asp:label id="LBL_DESC" runat="server" Visible="False"></asp:label><asp:label id="LBL_DEFAULT_IKAT" runat="server" Visible="False"></asp:label>
										<asp:Label id="LBL_REASONTYPE" runat="server" Visible="False"></asp:Label></TD>
								</TR>
								<TR>
									<TD class="TDBGColor1" style="HEIGHT: 20px" vAlign="top">Description</TD>
									<TD style="HEIGHT: 20px" vAlign="top">:</TD>
									<TD class="TDBGColorValue" style="HEIGHT: 20px"><asp:textbox  onkeypress="return kutip_satu()" id="TXT_DESC" runat="server" CssClass="mandatory" MaxLength="200" Width="700px"></asp:textbox></TD>
					...
					<TR>
						<TD vAlign="top" width="50%" colSpan="2"><ASP:DATAGRID id="DGExisting" runat="server" Width="100%" AllowPaging="True" CellPadding="1" AutoGenerateColumns="False">
								...
								<Columns>
									...
									<asp:BoundColumn Visible="False" DataField="REASONTYPEID" HeaderText="REASONTYPEID"></asp:BoundColumn>
									<asp:BoundColumn DataField="REASONTYPEDESC" HeaderText="Reason Type">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
									</asp:BoundColumn>
