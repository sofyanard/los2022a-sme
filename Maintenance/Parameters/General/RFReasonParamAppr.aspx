<%@ Page language="c#" Codebehind="RFReasonParamAppr.aspx.cs" AutoEventWireup="True" Inherits="SME.DataEntry.RFReasonParamAppr" %>
		...
		<form id="Form1" method="post" runat="server">
			<center>
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					...
					<TR>
						<TD style="HEIGHT: 21px" vAlign="top" width="50%" colSpan="2">
							<TABLE id="Table20" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									<TD class="TDBGColor1" style="HEIGHT: 12px" width="129">Reason Type</TD>
