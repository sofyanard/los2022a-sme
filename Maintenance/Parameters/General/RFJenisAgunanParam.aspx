<%@ Page language="c#" Codebehind="RFJenisAgunanParam.aspx.cs" AutoEventWireup="True" Inherits="SME.DataEntry.RFAgunanParam" %>
		...
		<form id="Form1" method="post" runat="server">
			<center>
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					...
					<TR>
						<TD class="tdHeader1" vAlign="top" align="center" width="50%" colSpan="2">Jenis 
							Agunan</TD>
					</TR>
						...
						<TD class="td" vAlign="top" width="50%" colSpan="2">
							<TABLE id="Table20" cellSpacing="0" cellPadding="0" width="100%">
								...
								<TR>
									...
									<TD class="TDBGColorValue" style="HEIGHT: 20px"><asp:textbox  onkeypress="return kutip_satu()" id="TXT_DESC" runat="server" CssClass="mandatory" MaxLength="30" Width="700px"></asp:textbox></TD>
								</TR>
								<TR>
