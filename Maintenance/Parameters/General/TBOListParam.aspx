<%@ Page language="c#" Codebehind="TBOListParam.aspx.cs" AutoEventWireup="True" Inherits="SME.DataEntry.TBOListParam" %>
		...
		<form id="Form1" method="post" runat="server">
			<center>
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					...
					<TR>
						<TD class="tdHeader1" vAlign="top" align="center" width="50%" colSpan="2">Document 
							To Be Obtained</TD>
					</TR>
						...
						<TD class="td" vAlign="top" width="50%" colSpan="2">
							<TABLE id="Table20" cellSpacing="0" cellPadding="0" width="100%">
								...
								<TR>
									...
									<TD style="WIDTH: 15px">:</TD>
									<TD class="TDBGColorValue"><asp:dropdownlist id="DDL_DOCTYPEDESC" runat="server" CssClass="mandatory" AutoPostBack="True" Visible="False" onselectedindexchanged="DDL_DOCTYPEDESC_SelectedIndexChanged"></asp:dropdownlist>
										<asp:Label id="LBL_SAVEMODE" runat="server" Visible="False">1</asp:Label></TD>
								</TR>
								<TR>
									<TD class="TDBGColor1" style="HEIGHT: 20px" vAlign="top">Document</TD>
								...
								<TR>
									<TD class="TDBGColor1" style="HEIGHT: 20px" vAlign="top">Required</TD>
									<TD style="HEIGHT: 20px" vAlign="top">:</TD>
									<TD class="TDBGColorValue" style="HEIGHT: 20px">
										<asp:RadioButton id="RDO_YES" runat="server" Text="Yes" Checked="True" GroupName="ISMANDATORY"></asp:RadioButton>&nbsp;&nbsp;
										<asp:RadioButton id="RDO_NO" runat="server" Text="No" GroupName="ISMANDATORY"></asp:RadioButton></TD>
								</TR> <!-- Additional Field : Right --></TABLE>
						</TD>
					</TR>
					<TR>
						<TD class="TDBGColor2" vAlign="top" width="50%" colSpan="2"><asp:button id="BTN_SAVE" runat="server" Width="100px" Text="Save" CssClass="Button1" onclick="BTN_SAVE_Click"></asp:button></TD>
					</TR>
					<TR>
						<TD vAlign="top" width="50%" colSpan="2"></TD>
					</TR>
					<TR>
						<TD class="tdHeader1" vAlign="top" width="50%" colSpan="2">Documents Related</TD>
					</TR>
					<TR>
					...
					<TR>
						<TD class="tdHeader1" vAlign="top" width="50%" colSpan="2">Documents Requested</TD>
					</TR>
					<TR>
