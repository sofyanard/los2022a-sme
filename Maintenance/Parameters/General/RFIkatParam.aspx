<%@ Page language="c#" Codebehind="RFIkatParam.aspx.cs" AutoEventWireup="True" Inherits="SME.DataEntry.RFIkatParam" %>
					...
					<TR id="TR_PERSONAL" runat="server">
						<TD class="td" vAlign="top" width="50%" colspan="2">
							<TABLE id="Table20" cellSpacing="0" cellPadding="0" width="100%">
								...
								<TR>
									<TD class="TDBGColor1" style="HEIGHT: 20px" vAlign="top">Default</TD>
									<TD style="HEIGHT: 20px" vAlign="top">:</TD>
									<TD class="TDBGColorValue" style="HEIGHT: 20px">
										<asp:DropDownList id="DDL_DEFAULT" runat="server">
