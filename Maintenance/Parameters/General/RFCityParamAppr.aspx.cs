...
namespace SME.DataEntry
{
	...
	/// </summary>
	public partial class RFCityParamAppr : System.Web.UI.Page
	{
		...
		private void fillDDLCollType() 
		{
			...
			{
				DDL_REASONTYPE.Items.Add(new ListItem(conn.GetFieldValue(i, "AREANAME"), conn.GetFieldValue(i, "AREAID")));
			}
		}
		...
		{
			conn.QueryString = "exec PARAM_GENERAL_RFCITY_APPR '" + id + "','"+ approvalFlag +"'";
			try 
			{
