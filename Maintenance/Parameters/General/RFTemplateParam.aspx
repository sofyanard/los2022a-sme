<%@ Page language="c#" Codebehind="RFTemplateParam.aspx.cs" AutoEventWireup="True" Inherits="SME.DataEntry.RFTemplateParam" %>
							...
							<TABLE id="Table20" cellSpacing="0" cellPadding="0" width="100%">
								...
								<TR>
									...
									<TD class="TDBGColorValue" style="HEIGHT: 20px">
										<asp:textbox  onkeypress="return kutip_satu()" id="TXT_DESC" runat="server" MaxLength="500" Width="700px" CssClass="mandatory"></asp:textbox></TD>
