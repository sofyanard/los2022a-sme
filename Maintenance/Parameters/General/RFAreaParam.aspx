<%@ Page language="c#" Codebehind="RFAreaParam.aspx.cs" AutoEventWireup="True" Inherits="SME.DataEntry.RFAreaParam" %>
		...
		<form id="Form1" method="post" runat="server">
			<center>
				<TABLE id="Table1" cellSpacing="2" cellPadding="2" width="100%">
					...
					<TR>
						<TD class="tdHeader1" vAlign="top" align="center" width="50%" colSpan="2">Area</TD>
					</TR>
						...
						<TD class="td" vAlign="top" width="50%" colSpan="2">
							<TABLE id="Table20" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									...
									<TD class="TDBGColorValue"><asp:textbox id="TXT_ID"  onkeypress="return kutip_satu()" runat="server" CssClass="mandatory" MaxLength="10"></asp:textbox><asp:label id="LBL_SAVEMODE" runat="server" Visible="False">1</asp:label><asp:label id="LBL_ACTIVE" runat="server" Visible="False"></asp:label><asp:label id="LBL_ID" runat="server" Visible="False"></asp:label><asp:label id="LBL_DESC" runat="server" Visible="False"></asp:label><asp:label id="LBL_DEFAULT_IKAT" runat="server" Visible="False"></asp:label></TD>
								</TR>
								<TR>
									<TD class="TDBGColor1" style="HEIGHT: 20px" vAlign="top">Description</TD>
									<TD style="HEIGHT: 20px" vAlign="top">:</TD>
									<TD class="TDBGColorValue" style="HEIGHT: 20px"><asp:textbox id="TXT_DESC"  onkeypress="return kutip_satu()" runat="server" CssClass="mandatory" MaxLength="30" Width="700px"></asp:textbox></TD>
								</TR>
								<TR>
									<TD class="TDBGColor1" style="HEIGHT: 20px" vAlign="top">Reg Manager</TD>
									<TD style="HEIGHT: 20px" vAlign="top">:</TD>
									<TD class="TDBGColorValue" style="HEIGHT: 20px"><asp:dropdownlist id="DDL_COLTYPEID" runat="server" CssClass="mandatory"></asp:dropdownlist></TD>
					...
					<TR>
						<TD vAlign="top" width="50%" colSpan="2"><ASP:DATAGRID id="DGExisting" runat="server" Width="100%" AllowPaging="True" CellPadding="1" AutoGenerateColumns="False">
								...
								<Columns>
									...
									<asp:BoundColumn Visible="False" DataField="AREAREGMANAGER" HeaderText="AREAREGMANAGER"></asp:BoundColumn>
									<asp:BoundColumn DataField="SU_FULLNAME" HeaderText="Reg Manager">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
									</asp:BoundColumn>
