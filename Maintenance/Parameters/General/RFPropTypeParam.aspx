<%@ Page language="c#" Codebehind="RFPropTypeParam.aspx.cs" AutoEventWireup="True" Inherits="SME.DataEntry.RFPropTypeParam" %>
							...
							<TABLE id="Table20" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									...
									<TD class="TDBGColorValue">
										<asp:textbox  onkeypress="return kutip_satu()" id="TXT_ID" runat="server" MaxLength="10" CssClass="mandatory"></asp:textbox>
								...
								<TR>
									...
									<TD class="TDBGColorValue" style="HEIGHT: 20px">
										<asp:textbox  onkeypress="return kutip_satu()" id="TXT_DESC" runat="server" MaxLength="30" Width="700px" CssClass="mandatory"></asp:textbox></TD>
								</TR>
								<TR>
									<TD class="TDBGColor1" style="HEIGHT: 20px" vAlign="top">Link Page</TD>
									<TD style="HEIGHT: 20px" vAlign="top">:</TD>
									<TD class="TDBGColorValue" style="HEIGHT: 20px">
										<asp:TextBox  onkeypress="return kutip_satu()" id="TXT_PROPTYPELINK" runat="server" MaxLength="100" Width="200px"></asp:TextBox></TD>
						...
						<TD vAlign="top" width="50%" colSpan="2">
							<ASP:DATAGRID id="DGExisting" runat="server" Width="100%" AutoGenerateColumns="False" CellPadding="1"
								...
								<Columns>
									...
									<asp:BoundColumn DataField="PROPTYPELINK" HeaderText="Link Page">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
									</asp:BoundColumn>
