...
namespace CuBES.NET.ParamMaintenance
{
	...
	/// </summary>
	public partial class AreaParamApproval : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			conn.QueryString = "SELECT PARAMNAME,PARAMLINK FROM RFPARAMETER WHERE ISMAKER='0' AND PG_ID='2' ORDER BY PARAMNAME";
			conn.ExecuteQuery();
