...
namespace CuBES.NET.ParamMaintenance
{
	...
	/// </summary>
	public partial class GeneralParam : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			conn.QueryString = "SELECT PARAMNAME,PARAMLINK FROM RFPARAMETER WHERE ISMAKER='1' AND PG_ID='1' ORDER BY PARAMNAME";
			conn.ExecuteQuery();
