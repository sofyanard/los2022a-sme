<%@ Page language="c#" Codebehind="BackupWalletMainVersionOne.aspx.cs" AutoEventWireup="True" Inherits="SME.AccountPlanning.WalletShareTarget.BackupWalletMainVersionOne" %>
					...
					<TR>
						<TD class="td" vAlign="top" align="center" width="50%" colSpan="2"><asp:datagrid id="DGR_WALLETSIZE" runat="server" Width="100%" AutoGenerateColumns="False" AllowPaging="True">
								...
								<Columns>
									...
									<asp:BoundColumn DataField="UnitForVolume" HeaderText="Unit for Volume">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
									</asp:BoundColumn>
									<asp:BoundColumn DataField="WalletSizeModelVolume" HeaderText="Wallet Size (model) - Volume">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
									</asp:BoundColumn>
									<asp:BoundColumn DataField="WalletSizeModelIncome" HeaderText="Wallet Size (model) - Income">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
									</asp:BoundColumn>
									<asp:BoundColumn DataField="WalletSizeAdjustedVolume" HeaderText="Wallet Size (adjusted) - Volume">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
									</asp:BoundColumn>
									<asp:BoundColumn DataField="WalletSizeAdjustedIncome" HeaderText="Wallet Size (adjusted) - Income">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
									</asp:BoundColumn>
									<asp:BoundColumn DataField="MandiriCurrentVolume" HeaderText="Mandiri Current - Volume">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
									</asp:BoundColumn>
									<asp:BoundColumn DataField="MandiriCurrentIncome" HeaderText="Mandiri Current - Income">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
									</asp:BoundColumn>
									<asp:BoundColumn DataField="MandiriCurrentWalletShare" HeaderText="Mandiri Current - W.Share(%)">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
									</asp:BoundColumn>
									<asp:BoundColumn DataField="TargetVolume" HeaderText="Target - Volume">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
									</asp:BoundColumn>
									<asp:BoundColumn DataField="TargetIncome" HeaderText="Target - Income">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
									</asp:BoundColumn>
									<asp:BoundColumn DataField="TargetWalletShare" HeaderText="Target - W.Share(%)">
										<HeaderStyle CssClass="tdSmallHeader"></HeaderStyle>
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
									</asp:BoundColumn>
								</Columns>
