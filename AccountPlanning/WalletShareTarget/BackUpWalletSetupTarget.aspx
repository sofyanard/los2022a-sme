<%@ Page language="c#" Codebehind="BackUpWalletSetupTarget.aspx.cs" AutoEventWireup="True" Inherits="SME.AccountPlanning.WalletShareTarget.BackUpWalletSetupTarget" %>
				...
				<TABLE id="MAIN_TABLE" width="100%" border="0" runat="server">
					<TR>
						<TD align="left" width="50%">
							<TABLE id="Table1">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B> WALLET SIZE INQUIRY</B></TD>
								</TR>
							</TABLE>
						</TD>
