<%@ Page language="c#" Codebehind="BenchmarkParam.aspx.cs" AutoEventWireup="True" Inherits="SME.AccountPlanning.Parameter.Maker.BenchmarkParam" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<TITLE>BenchmarkParam</TITLE>
				...
				<TABLE width="100%" border="0">
					<TR>
						<TD align="left">
							<TABLE id="Table1">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>BENCHMARK PARAMETER - 
											MAKER</B></TD>
								</TR>
							</TABLE>
						</TD>
					...
					<TR>
						<TD class="td" vAlign="top" width="50%" style="HEIGHT: 7px">
							<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%">
								...
								<TR>
									<TD class="TDBGColor1" width="50%"><asp:label id="Label1" runat="server">Value :</asp:label></TD>
									<TD class='A"TDBGColorValue"'><asp:textbox id="TXT_VALUES" runat="server" Width="100%" CssClass="Mandatory"></asp:textbox></TD>
								</TR>
								<TR>
									<TD>
