<%@ Page language="c#" Codebehind="CustomerList.aspx.cs" AutoEventWireup="True" Inherits="SME.AccountPlanning.ActionPlan.CustomerList" %>
								...
								<TR>
									<TD vAlign="top" align="center">
										<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
											...
											<TR>
												<TD class="TDBGColor1" style="HEIGHT: 14px" width="30%"><asp:label id="LBL_TXT_CST" runat="server">Anchor Team Lead / RM :</asp:label></TD>
											...
											<TR>
												<TD class="TDBGColor2" vAlign="top" align="center" width="100%" colSpan="2"><asp:button id="BTN_Find" runat="server" Width="200px" Text="FIND EXISTING" CssClass="button1" onclick="BTN_Find_Click"></asp:button>&nbsp;&nbsp;
													<asp:button id="BTN_New" runat="server" Width="200px" Text="NEW" CssClass="button1" onclick="BTN_New_Click"></asp:button></TD>
											</TR>
										</TABLE>
									</TD>
								</TR>
