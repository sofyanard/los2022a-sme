...
<%@ Page language="c#" Codebehind="UploadData.aspx.cs" AutoEventWireup="True" Inherits="SME.Booking.Channelin.UploadData" %>
								...
								<Columns>
									...
									<asp:TemplateColumn>
										...
										<ItemTemplate>
											...
											<asp:LinkButton id="Linkbutton2" runat="server" Visible="False" CommandName="Delete">Delete</asp:LinkButton>
										</ItemTemplate>
									</asp:TemplateColumn>
