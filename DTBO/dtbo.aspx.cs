	...
	public partial class dtbo : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			if (!IsPostBack)
			{
                ...
                h4.Text = "Dokumen Upload";
                h4.Font.Bold = true;
                h4.NavigateUrl = "DocUpload.aspx?regno=" + LBL_REGNO.Text + "&curef=" + LBL_CUREF.Text + "&tc=" + LBL_TC.Text + "&dtbo=" + LBL_DTBO.Text;
                h4.Target = "IFR_DTBO";
		...
		private void ViewData()
		{
			...
			{
				conn.QueryString = "select * from VW_DTBOCUINFO "+
					"where ap_regno = '"+ LBL_CUREF.Text +"C'";
				conn.ExecuteQuery();
			}
