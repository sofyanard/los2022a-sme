<%@ Page CodeBehind="DocJaminan.aspx.cs" Language="c#" AutoEventWireup="True" Inherits="DTBO.DocJaminan" %>
					...
					<TR>
						...
						<TD>
							<TABLE id="Table1" style="HEIGHT: 23px" cellSpacing="1" cellPadding="1" width="100%" border="1">
								<TR>
									<TD style="WIDTH: 185px" align="right">Nama Dokumen</TD>
									<TD><asp:dropdownlist id="DDL_LIST2" runat="server" Width="352px"></asp:dropdownlist>
                                        <asp:button id="Button1" runat="server" Text="Tambah" onclick="Button1_Click"></asp:button></TD>
								</TR>
							</TABLE>
						</TD>
					</TR>
