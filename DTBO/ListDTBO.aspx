<%@ Page language="c#" Codebehind="ListDTBO.aspx.cs" AutoEventWireup="True" Inherits="SME.DTBO.ListDTBO" %>
				...
				<TABLE cellSpacing="2" cellPadding="2" width="100%">
					<TR>
						<TD class="tdNoBorder">
							<TABLE id="Table6">
								<TR>
									<TD class="tdBGColor2" style="WIDTH: 400px" align="center"><B>Daftar DTBO</B></TD>
								</TR>
							</TABLE>
						</TD>
								...
								<TR>
									<TD vAlign="top" align="center">
										<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
											...
											<TR>
												<TD class="TDBGColor1">Aplikasi #</TD>
												<TD width="17"></TD>
										...
										<asp:button id="BTN_CARI" Runat="server" Width="75px" Text="Cari" 
                                            CssClass="button1" onclick="BTN_CARI_Click"></asp:button></TD>
								</TR>
							</TABLE>
						</TD>
					</TR>
