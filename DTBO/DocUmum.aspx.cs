			...
			{								
				...
				if (EXPDATE != "null")
				{
					if (Tools.isDateValid(this,((TextBox)DGR_DU.Items[NO_DOC].Cells[5].FindControl("TXT_AT_EXPDATEDAY")).Text,((DropDownList)DGR_DU.Items[NO_DOC].Cells[5].FindControl("DDL_AT_EXPDATEMONTH")).SelectedValue,((TextBox)DGR_DU.Items[NO_DOC].Cells[5].FindControl("TXT_AT_EXPDATEYEAR")).Text))
					{
                        ...
                        xdd = ((TextBox)DGR_DU.Items[NO_DOC].Cells[5].FindControl("TXT_AT_EXPDATEDAY")).Text;
                        xmm = ((DropDownList)DGR_DU.Items[NO_DOC].Cells[5].FindControl("DDL_AT_EXPDATEMONTH")).SelectedValue;
                        xyyyy = ((TextBox)DGR_DU.Items[NO_DOC].Cells[5].FindControl("TXT_AT_EXPDATEYEAR")).Text;
                        //xdate = xmm + "/" + xdd + "/" + xyyyy;
                        xdate = xdd + "-" + xmm + "-" + xyyyy;
