<%@ Page language="c#" Codebehind="dtbo.aspx.cs" AutoEventWireup="True" Inherits="SME.DTBO.dtbo" %>
	...
	<body leftMargin="0" topMargin="0" MS_POSITIONING="GridLayout">
					...
					<TR>
						...
						<TD class="td" vAlign="top">
							<TABLE cellSpacing="0" cellPadding="0" width="100%">
								...
								<TR>
									<TD class="TDBGColor1">Segment</TD>
									<TD></TD>
		...
		<script language="javascript">
			...
			function simpan()
			{
                ...
                */
			    var theframe = document.getElementById('IFR_DTBO');
			    var theframeDoc = (theframe.contentWindow || theframe.contentDocument);
			    if (theframeDoc.document) theframeDoc = theframeDoc.document;
			    var theelement = theframeDoc.getElementById('TXT_TEST');
			    theelement.value = "save";
			    var theform = theframeDoc.getElementById('Form1');
                theform.submit();
			}
		</script>
	</body>
